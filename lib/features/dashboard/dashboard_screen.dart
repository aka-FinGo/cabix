              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    const Text("Moliya, osonlashgan va nazorat ostida.",
                    ...
                    children: [
                      ...
                      stats.when(
                        data: (s) => GridView.count(
                          ...
                          children: [
                            DashboardWidgets.buildWebStatCard(
                                title: "Umumiy Balans",
                                amountStr: "${s['balance']}",
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ref.watch(chartSpotsProvider).when(
                                    data: (spots) =>
                                        DashboardWidgets.buildBarChart(spots),
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                  ...
                                  child: catStats.when(
                                    data: (data) =>
                                        DashboardWidgets.buildPieChart(data),
                                    loading: () => const Center(
                                        child: CircularProgressIndicator()),
                                    error: (_, __) => const SizedBox(),
                                  )),
                              const SizedBox(height: 32),
                              _buildLegendItem(
                                  "Oylik", "40%", const Color(0xFF1E3A8A)),
                              const SizedBox(height: 12),
                              _buildLegendItem(
                                  "Xizmatlar", "35%", const Color(0xFF3B82F6)),
                              const SizedBox(height: 12),
                              _buildLegendItem(
                                  "Boshqa", "25%", const Color(0xFFBFDBFE)),
                            ]),
                      ),
                      const SizedBox(height: 32),
              ...
              data: (s) => Row(children: [
                Expanded(
                    child: DashboardWidgets.buildMobileStatItem(
                        "Kirim", s['income'] ?? 0, Colors.green)),
                const SizedBox(width: 16),
                Expanded(
                    child: DashboardWidgets.buildMobileStatItem(
                        "Chiqim", s['expense'] ?? 0, Colors.red)),
              ]),
          ...
          children: ['Kun', 'Hafta', 'Oy', 'Yil']
              .map((p) => Padding(
                    ...
                    child: ChoiceChip(
                      ...
                      labelStyle: TextStyle(
                          color: period == p ? Colors.white : Colors.grey),
                    ),
                  ))
              .toList()),
    );
