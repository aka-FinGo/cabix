...
public class WindowInsetsCompat {
    ...
    public static class Impl20 extends Impl {
        ...
        final Insets getSystemWindowInsets() {
            ...
            Insets of = Insets.of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            this.mSystemWindowInsets = of;
            return of;
        }
    ...
    private static class Impl21 extends Impl20 {
        ...
        final Insets getStableInsets() {
            ...
            Insets of = Insets.of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            this.mStableInsets = of;
            return of;
        }
    ...
    private static class Impl29 extends Impl28 {
        ...
        Insets getSystemGestureInsets() {
            ...
            Insets compatInsets = Insets.toCompatInsets(systemGestureInsets);
            this.mSystemGestureInsets = compatInsets;
            return compatInsets;
        }
        ...
        Insets getMandatorySystemGestureInsets() {
            ...
            Insets compatInsets = Insets.toCompatInsets(mandatorySystemGestureInsets);
            this.mMandatorySystemGestureInsets = compatInsets;
            return compatInsets;
        }
        ...
        Insets getTappableElementInsets() {
            ...
            Insets compatInsets = Insets.toCompatInsets(tappableElementInsets);
            this.mTappableElementInsets = compatInsets;
            return compatInsets;
        }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m7328m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m7328m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m7328m = HalfKt$$ExternalSyntheticApiModelOutline0.m7329m(windowInsets);
            } else {
                m7328m = HalfKt$$ExternalSyntheticApiModelOutline0.m7328m();
            }
            this.mPlatBuilder = m7328m;
        }
