...
public final class NotificationManagerCompat {
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup m7261m = ColorKt$$ExternalSyntheticApiModelOutline0.m7261m((Object) it.next());
                if (Api26Impl.getId(m7261m).equals(str)) {
                    return m7261m;
                }
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup m7261m = ColorKt$$ExternalSyntheticApiModelOutline0.m7261m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m7261m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m7261m, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    private void pushSideChannelQueue(Task task) {
        synchronized (sLock) {
            ...
            if (sideChannelManager == null) {
                sideChannelManager = new SideChannelManager(this.mContext.getApplicationContext());
