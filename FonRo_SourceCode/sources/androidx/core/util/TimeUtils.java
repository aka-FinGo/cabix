...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        int i9 = i5 + 1;
        boolean z = i != 0;
        int printField = printField(cArr2, i2, 'd', i9, false, 0);
        int printField2 = printField(cArr2, i3, 'h', printField, printField != i9, z ? 2 : 0);
        int printField3 = printField(cArr2, i4, 'm', printField2, printField2 != i9, z ? 2 : 0);
        int printField4 = printField(cArr2, floor, 's', printField3, printField3 != i9, z ? 2 : 0);
        int printField5 = printField(cArr2, i7, 'm', printField4, true, (!z || printField4 == i9) ? 0 : 3);
        cArr2[printField5] = 's';
