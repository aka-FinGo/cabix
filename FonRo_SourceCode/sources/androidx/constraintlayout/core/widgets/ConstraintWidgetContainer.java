...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    /* JADX WARN: Removed duplicated region for block: B:109:0x0252 A[ADDED_TO_REGION] */
    ...
    */
    ...
    private void addHorizontalChain(ConstraintWidget constraintWidget) {
        ...
        if (i >= chainHeadArr.length) {
            chainHeadArr = (ChainHead[]) Arrays.copyOf(chainHeadArr, chainHeadArr.length * 2);
            this.mHorizontalChainsArray = chainHeadArr;
        }
        chainHeadArr[this.mHorizontalChainsSize] = new ChainHead(constraintWidget, 0, isRtl());
    ...
    private void addVerticalChain(ConstraintWidget constraintWidget) {
        ...
        chainHeadArr[this.mVerticalChainsSize] = new ChainHead(constraintWidget, 1, isRtl());
