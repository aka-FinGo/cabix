...
public class CLToken extends CLElement {
    ...
    public CLToken(char[] cArr) {
        ...
        this.mTokenTrue = new char[]{'t', 'r', AbstractJsonLexerKt.UNICODE_ESC, 'e'};
        this.mTokenFalse = new char[]{'f', 'a', 'l', 's', 'e'};
        this.mTokenNull = new char[]{'n', AbstractJsonLexerKt.UNICODE_ESC, 'l', 'l'};
    }
