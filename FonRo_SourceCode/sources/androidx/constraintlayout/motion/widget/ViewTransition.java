...
public class ViewTransition {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:33:0x0060, code lost:
        ...
        if (r2.equals(androidx.constraintlayout.motion.widget.ViewTransition.CUSTOM_METHOD) != false) goto L22;
     */
    ...
    */
    public ViewTransition(android.content.Context r6, org.xmlpull.v1.XmlPullParser r7) {
        /*
            ...
            r5.mContext = r6
            int r2 = r7.getEventType()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
        L2e:
            r3 = 1
            if (r2 == r3) goto Ld5
            r3 = 2
            ...
            goto Lc6
        L39:
            java.lang.String r2 = r7.getName()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            boolean r2 = r1.equals(r2)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            if (r2 == 0) goto Lc6
            goto Ld5
        L45:
            java.lang.String r2 = r7.getName()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            int r3 = r2.hashCode()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            switch(r3) {
                case -1962203927: goto L84;
                case -1239391468: goto L74;
                case 61998586: goto L6a;
                case 366511058: goto L5a;
                case 1791837707: goto L51;
                default: goto L50;
        ...
        L51:
            ...
            boolean r3 = r2.equals(r3)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            if (r3 == 0) goto L93
            goto L62
        L5a:
            ...
            if (r3 == 0) goto L93
        L62:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r5.mConstraintDelta     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r6, r7, r2)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            goto Lc6
        L6a:
            boolean r3 = r2.equals(r1)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            if (r3 == 0) goto L93
            r5.parseViewTransitionTags(r6, r7)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            goto Lc6
        L74:
            java.lang.String r3 = "KeyFrameSet"
            boolean r3 = r2.equals(r3)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            if (r3 == 0) goto L93
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r2.<init>(r6, r7)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r5.mKeyFrames = r2     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            goto Lc6
        L84:
            java.lang.String r3 = "ConstraintOverride"
            boolean r3 = r2.equals(r3)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            if (r3 == 0) goto L93
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r6, r7)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r5.mConstraintDelta = r2     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            goto Lc6
        L93:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r3.<init>()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.String r4 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r3.append(r4)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.String r4 = " unknown tag "
            r3.append(r4)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r3.append(r2)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.String r2 = r3.toString()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            android.util.Log.e(r1, r2)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r2.<init>()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.String r3 = ".xml:"
            r2.append(r3)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            int r3 = r7.getLineNumber()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            r2.append(r3)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            java.lang.String r2 = r2.toString()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            android.util.Log.e(r1, r2)     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
        Lc6:
            int r2 = r7.next()     // Catch: java.io.IOException -> Lcc org.xmlpull.v1.XmlPullParserException -> Ld1
            goto L2e
        Lcc:
            r5 = move-exception
    ...
    public static class Animate {
        ...
        void mutateReverse() {
            ...
            boolean interpolate = motionController.interpolate(motionController.mView, f, nanoTime, this.mCache);
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, final View... viewArr) {
        ...
        motionLayout.transitionToEnd(new Runnable() { // from class: androidx.constraintlayout.motion.widget.ViewTransition$$ExternalSyntheticLambda0
            ...
            public final void run() {
                ViewTransition.this.m7251x14d7500(viewArr);
            }
        });
    }
    ...
    public /* synthetic */ void m7251x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
            for (View view : viewArr) {
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it.hasNext()) {
                keyFrames2.addKey(it.next().mo7250clone().setViewId(id));
            }
