    ...
    public boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            if (this.mTransformPivotTarget != Key.UNSET) {
                ...
                if (view5 == null) {
                    view5 = ((View) view3.getParent()).findViewById(this.mTransformPivotTarget);
                    this.mTransformPivotView = view5;
                }
                if (view5 != null) {
                    float top = (view5.getTop() + this.mTransformPivotView.getBottom()) / 2.0f;
