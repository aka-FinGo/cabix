...
public final class LongListNavType extends CollectionNavType<List<? extends Long>> {
    ...
    public void put(Bundle bundle, String key, List<Long> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7572putLongArrayimpl(m7550constructorimpl, key, CollectionsKt.toLongArray(value));
        } else {
    ...
    public List<Long> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7506getLongArrayimpl(m7464constructorimpl, key));
    }
}
