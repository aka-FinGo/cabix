...
public final class StringListNavType extends CollectionNavType<List<? extends String>> {
    ...
    public void put(Bundle bundle, String key, List<String> value) {
        ...
        if (value != null) {
            SavedStateWriter.m7584putStringArrayimpl(m7550constructorimpl, key, (String[]) value.toArray(new String[0]));
        } else {
    ...
    public List<String> get(Bundle bundle, String key) {
        ...
        return ArraysKt.toList(SavedStateReader.m7536getStringArrayimpl(m7464constructorimpl, key));
    }
}
