...
public final class NavArgument {
    ...
    public final boolean verify(String name, Bundle bundle) {
        ...
        if (!this.isNullable) {
            ...
            if (SavedStateReader.m7465containsimpl(m7464constructorimpl, name) && SavedStateReader.m7543isNullimpl(m7464constructorimpl, name)) {
                return false;
            }
        }
        try {
