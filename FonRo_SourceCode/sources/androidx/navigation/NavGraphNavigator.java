...
public class NavGraphNavigator extends Navigator<NavGraph> {
    ...
    private final void navigate(NavBackStackEntry entry, NavOptions navOptions, Navigator.Extras navigatorExtras) {
        ...
        if (startDestinationRoute != null) {
            if (!Intrinsics.areEqual(startDestinationRoute, navDestination.getRoute())) {
                ...
                if (matchingArgs != null && !SavedStateReader.m7542isEmptyimpl(SavedStateReader.m7464constructorimpl(matchingArgs))) {
                    ...
                    SavedStateWriter.m7554putAllimpl(m7550constructorimpl, matchingArgs);
            ...
            if (!navDestination.getArguments().isEmpty()) {
                List<String> missingRequiredArguments = NavArgumentKt.missingRequiredArguments(navDestination.getArguments(), new Function1() { // from class: androidx.navigation.NavGraphNavigator$$ExternalSyntheticLambda0
                    ...
                    public final Object invoke(Object obj) {
                        return Boolean.valueOf(NavGraphNavigator.navigate$lambda$6(Ref.ObjectRef.this, (String) obj));
                    }
                });
    ...
    public static final boolean navigate$lambda$6(Ref.ObjectRef objectRef, String key) {
        ...
        return objectRef.element == 0 || !SavedStateReader.m7465containsimpl(SavedStateReader.m7464constructorimpl((Bundle) objectRef.element), key);
    }
}
