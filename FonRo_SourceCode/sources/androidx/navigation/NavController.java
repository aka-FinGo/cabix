...
public class NavController {
    ...
    /* compiled from: NavController.android.kt */
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\bæ\u0080\u0001\u0018\u00002\u00020\u0001J(\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00072\u000e\u0010\b\u001a\n\u0018\u00010\tj\u0004\u0018\u0001`\nH&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u000bÀ\u0006\u0001"}, d2 = {"Landroidx/navigation/NavController$OnDestinationChangedListener;", "", "onDestinationChanged", "", "controller", "Landroidx/navigation/NavController;", FirebaseAnalytics.Param.DESTINATION, "Landroidx/navigation/NavDestination;", "arguments", "Landroid/os/Bundle;", "Landroidx/savedstate/SavedState;", "navigation-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes5.dex */
    ...
    public NavController(Context context) {
        ...
        this.impl = new NavControllerImpl(this, new Function0() { // from class: androidx.navigation.NavController$$ExternalSyntheticLambda2
            ...
            public final Object invoke() {
                return NavController.impl$lambda$0(NavController.this);
            }
        });
        ...
        this.navInflater = LazyKt.lazy(new Function0() { // from class: androidx.navigation.NavController$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return NavController.navInflater_delegate$lambda$10(NavController.this);
            }
        });
    }
    ...
    public class NavControllerNavigatorState extends NavigatorState {
        ...
        public void pop(final NavBackStackEntry popUpTo, final boolean saveState) {
            ...
            this.this$0.impl.pop$navigation_runtime_release(this, popUpTo, saveState, new Function0() { // from class: androidx.navigation.NavController$NavControllerNavigatorState$$ExternalSyntheticLambda1
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return NavController.NavControllerNavigatorState.pop$lambda$0(NavController.NavControllerNavigatorState.this, popUpTo, saveState);
                }
            });
        }
        ...
        public void markTransitionComplete(final NavBackStackEntry entry) {
            ...
            this.this$0.impl.markTransitionComplete$navigation_runtime_release(this, entry, new Function0() { // from class: androidx.navigation.NavController$NavControllerNavigatorState$$ExternalSyntheticLambda0
                @Override // kotlin.jvm.functions.Function0
                public final Object invoke() {
                    return NavController.NavControllerNavigatorState.markTransitionComplete$lambda$1(NavController.NavControllerNavigatorState.this, entry);
                }
            });
        }
    ...
    private final boolean tryRelaunchUpToExplicitStack() {
        ...
        Bundle m7550constructorimpl = SavedStateWriter.m7550constructorimpl(bundleOf);
        Intrinsics.checkNotNull(intent);
        SavedStateWriter.m7574putParcelableimpl(m7550constructorimpl, KEY_DEEP_LINK_INTENT, intent);
        Bundle bundle = extras.getBundle(KEY_DEEP_LINK_EXTRAS);
        if (bundle != null) {
            SavedStateWriter.m7554putAllimpl(m7550constructorimpl, bundle);
        }
                    ...
                    if (activity.getIntent() != null) {
                        ...
                        if (activity2.getIntent().getData() != null) {
                            ...
                            if ((matchDeepLinkComprehensive != null ? matchDeepLinkComprehensive.getMatchingArgs() : null) != null && (addInDefaultArgs = matchDeepLinkComprehensive.getDestination().addInDefaultArgs(matchDeepLinkComprehensive.getMatchingArgs())) != null) {
                                SavedStateWriter.m7554putAllimpl(m7550constructorimpl, addInDefaultArgs);
                            }
                        }
                    }
                }
    ...
    */
    ...
    public final boolean handleDeepLink(NavDeepLinkRequest request) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            SavedStateWriter.m7554putAllimpl(SavedStateWriter.m7550constructorimpl(bundleOf2), bundleOf);
    ...
    private final boolean handleDeepLink(int[] deepLink, Bundle[] args, boolean newTask) {
        ...
        if (newTask) {
            ...
            while (i < deepLink.length) {
                ...
                navigate(findDestination$default, bundle, NavOptionsBuilderKt.navOptions(new Function1() { // from class: androidx.navigation.NavController$$ExternalSyntheticLambda5
                    @Override // kotlin.jvm.functions.Function1
                    public final Object invoke(Object obj) {
                        return NavController.handleDeepLink$lambda$21(NavDestination.this, this, (NavOptionsBuilder) obj);
                    }
        ...
        NavGraph navGraph3 = navControllerImpl.get_graph();
    ...
    */
    ...
    public final void writeIntent$navigation_runtime_release(NavDeepLinkRequest request, Bundle args) {
        ...
        SavedStateWriter.m7574putParcelableimpl(SavedStateWriter.m7550constructorimpl(args), KEY_DEEP_LINK_INTENT, intent);
    }
    ...
    public Bundle saveState() {
        ...
        if (this.deepLinkHandled) {
            if (saveState$navigation_runtime_release == null) {
                ...
                SavedStateWriter.m7550constructorimpl(saveState$navigation_runtime_release);
            }
            SavedStateWriter.m7556putBooleanimpl(SavedStateWriter.m7550constructorimpl(saveState$navigation_runtime_release), KEY_DEEP_LINK_HANDLED, this.deepLinkHandled);
        }
    ...
    public void restoreState(Bundle navState) {
        ...
        if (navState != null) {
            Boolean m7476getBooleanOrNullimpl = SavedStateReader.m7476getBooleanOrNullimpl(SavedStateReader.m7464constructorimpl(navState), KEY_DEEP_LINK_HANDLED);
            this.deepLinkHandled = m7476getBooleanOrNullimpl != null ? m7476getBooleanOrNullimpl.booleanValue() : false;
        }
    }
    ...
    */
    ...
    /* compiled from: NavController.android.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\fH\u0007R\u0010\u0010\u0004\u001a\u00020\u00058\u0006X\u0087T¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00058\u0006X\u0087T¢\u0006\u0002\n\u0000R\u0016\u0010\u0007\u001a\u00020\u00058\u0006X\u0087T¢\u0006\b\n\u0000\u0012\u0004\b\b\u0010\u0003R\u0010\u0010\t\u001a\u00020\u00058\u0006X\u0087T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Landroidx/navigation/NavController$Companion;", "", "<init>", "()V", "KEY_DEEP_LINK_IDS", "", "KEY_DEEP_LINK_ARGS", "KEY_DEEP_LINK_EXTRAS", "getKEY_DEEP_LINK_EXTRAS$annotations", "KEY_DEEP_LINK_HANDLED", "KEY_DEEP_LINK_INTENT", "deepLinkSaveState", "", "enableDeepLinkSaveState", "", "saveState", "navigation-runtime_release"}, k = 1, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes5.dex */
