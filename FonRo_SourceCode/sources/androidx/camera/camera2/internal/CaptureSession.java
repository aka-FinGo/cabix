...
public final class CaptureSession implements CaptureSessionInterface {
            ...
            if (this.mState.ordinal() == 1) {
                ...
                FutureChain transformAsync = FutureChain.from(opener.startWithDeferrableSurface(arrayList, 5000L)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda5
                    ...
                    public final ListenableFuture apply(Object obj) {
                        return CaptureSession.this.m74lambda$open$0$androidxcameracamera2internalCaptureSession(sessionConfig, cameraDevice, (List) obj);
                    }
    ...
    public ListenableFuture<Void> m74lambda$open$0$androidxcameracamera2internalCaptureSession(List<Surface> list, SessionConfig sessionConfig, CameraDevice cameraDevice) {
        synchronized (this.mSessionLock) {
    ...
    public ListenableFuture<Void> release(boolean z) {
        synchronized (this.mSessionLock) {
            switch (this.mState) {
                ...
                case RELEASING:
                    ListenableFuture<Void> listenableFuture = this.mReleaseFuture;
                    if (listenableFuture == null) {
                        listenableFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda4
                            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                                return CaptureSession.this.m75lambda$release$1$androidxcameracamera2internalCaptureSession(completer);
                            }
                        });
                        this.mReleaseFuture = listenableFuture;
                    }
    ...
    public /* synthetic */ Object m75lambda$release$1$androidxcameracamera2internalCaptureSession(CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mSessionLock) {
    ...
    void issuePendingCaptureRequest() {
        this.mRequestMonitor.getRequestsProcessedFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda6
            ...
            public final void run() {
                CaptureSession.this.m73x337815aa();
            }
    ...
    public /* synthetic */ void m73x337815aa() {
        synchronized (this.mSessionLock) {
                ...
                if (this.mStillCaptureFlow.shouldStopRepeatingBeforeCapture(arrayList, z)) {
                    ...
                    cameraBurstCaptureCallback.setCaptureSequenceCallback(new CameraBurstCaptureCallback.CaptureSequenceCallback() { // from class: androidx.camera.camera2.internal.CaptureSession$$ExternalSyntheticLambda3
                        ...
                        public final void onCaptureSequenceCompletedOrAborted(CameraCaptureSession cameraCaptureSession, int i, boolean z2) {
                            CaptureSession.this.m72xac56a034(cameraCaptureSession, i, z2);
                        }
                    });
                }
    ...
    public /* synthetic */ void m72xac56a034(CameraCaptureSession cameraCaptureSession, int i, boolean z) {
        synchronized (this.mSessionLock) {
            if (this.mState == State.OPENED) {
                issueRepeatingCaptureRequests(this.mSessionConfig);
            }
    ...
    private static Map<SessionConfig.OutputConfig, OutputConfigurationCompat> createMultiResolutionOutputConfigurationCompats(Map<Integer, List<SessionConfig.OutputConfig>> map, Map<DeferrableSurface, Surface> map2) {
        ...
        for (Integer num : map.keySet()) {
            ...
            for (SessionConfig.OutputConfig outputConfig : map.get(num)) {
                ...
                ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m();
