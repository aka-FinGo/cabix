...
public final class AutoValue_Packet<T> extends Packet<T> {
    ...
    public int hashCode() {
        ...
        Exif exif = this.exif;
        return this.cameraCaptureResult.hashCode() ^ ((((((((((((hashCode ^ (exif == null ? 0 : exif.hashCode())) * 1000003) ^ this.format) * 1000003) ^ this.size.hashCode()) * 1000003) ^ this.cropRect.hashCode()) * 1000003) ^ this.rotationDegrees) * 1000003) ^ this.sensorToBufferTransform.hashCode()) * 1000003);
    }
}
