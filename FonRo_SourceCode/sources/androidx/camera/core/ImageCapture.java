...
public final class ImageCapture extends UseCase {
    ...
    protected UseCaseConfig<?> onMergeConfig(CameraInfoInternal cameraInfoInternal, UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        if (num != null) {
            ...
            builder.getMutableConfig().insertOption(ImageInputConfig.OPTION_INPUT_FORMAT, Integer.valueOf(Notifier.ID_ORDERS));
    ...
    private static class ImageCaptureCapabilitiesImpl implements ImageCaptureCapabilities {
        ...
        private boolean isUltraHdrSupported() {
            CameraInfo cameraInfo = this.mCameraInfo;
            if (cameraInfo instanceof CameraInfoInternal) {
                return ((CameraInfoInternal) cameraInfo).getSupportedOutputFormats().contains(Integer.valueOf(Notifier.ID_ORDERS));
            }
            return false;
        }
    }
    ...
    private SessionConfig.Builder createPipeline(String str, ImageCaptureConfig imageCaptureConfig, StreamSpec streamSpec) {
        ...
        TakePictureManager takePictureManager = this.mTakePictureManager;
        if (takePictureManager == null) {
            takePictureManager = new TakePictureManager(this.mImageCaptureControl);
            this.mTakePictureManager = takePictureManager;
        }
        takePictureManager.setImagePipeline(this.mImagePipeline);
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.ImageCapture$$ExternalSyntheticLambda0
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                ImageCapture.this.m156lambda$createPipeline$3$androidxcameracoreImageCapture(sessionConfig, sessionError);
            }
        });
    ...
    public /* synthetic */ void m156lambda$createPipeline$3$androidxcameracoreImageCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        List<SessionConfig> m;
        if (getCamera() == null) {
            return;
        }
        ...
        public ImageCapture build() {
            ...
            if (num == null) {
                if (ImageCapture.isOutputFormatUltraHdr(getMutableConfig())) {
                    getMutableConfig().insertOption(ImageInputConfig.OPTION_INPUT_FORMAT, Integer.valueOf(Notifier.ID_ORDERS));
