...
public class VirtualCameraAdapter implements UseCase.StateChangeCallback {
    ...
    public Map<UseCase, OutConfig> getChildrenOutConfigs(SurfaceEdge surfaceEdge, int i, boolean z) {
        ...
        for (UseCase useCase : this.mChildren) {
            ...
            hashMap.put(useCase, virtualCameraAdapter.calculateOutConfig(useCase, this.mResolutionsMerger, this.mParentCamera, surfaceEdge, i, z));
    ...
    public Map<UseCase, DualOutConfig> getChildrenOutConfigs(SurfaceEdge surfaceEdge, SurfaceEdge surfaceEdge2, int i, boolean z) {
        ...
        for (UseCase useCase : this.mChildren) {
            ...
            hashMap.put(useCase, DualOutConfig.of(virtualCameraAdapter.calculateOutConfig(useCase, this.mResolutionsMerger, this.mParentCamera, surfaceEdge, i2, z), virtualCameraAdapter.calculateOutConfig(useCase, virtualCameraAdapter.mSecondaryResolutionsMerger, (CameraInternal) Objects.requireNonNull(virtualCameraAdapter.mSecondaryParentCamera), surfaceEdge3, i2, z)));
            this = virtualCameraAdapter;
