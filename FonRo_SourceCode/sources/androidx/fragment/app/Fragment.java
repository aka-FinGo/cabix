...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m7392lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m7392lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m7392lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m7392lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
    ...
    private AnimationInfo ensureAnimationInfo() {
        ...
        this.mAnimationInfo = animationInfo2;
