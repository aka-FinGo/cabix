...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, boolean z, SpecialEffectsController.Operation operation, SpecialEffectsController.Operation operation2) {
                ...
                if (cloneTransition == null) {
                    ...
                    if (arrayList12.isEmpty()) {
                        ...
                        if (operation6.getFinalState() == SpecialEffectsController.Operation.State.GONE) {
                            ...
                            ArrayList<View> arrayList14 = new ArrayList<>(arrayList12);
        ...
        fragmentTransitionImpl.setNameOverridesReordered(getContainer(), arrayList15, arrayList16, prepareSetNameOverridesReordered, arrayMap6);
        FragmentTransition.setViewVisibility(arrayList17, i8);
        fragmentTransitionImpl.swapSharedElementTargets(obj4, arrayList15, arrayList16);
        return hashMap7;
    }
