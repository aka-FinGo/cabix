...
public final class ComponentActivity$activityResultRegistry$1 extends ActivityResultRegistry {
    ...
    public <I, O> void onLaunch(final int requestCode, ActivityResultContract<I, O> contract, I input, ActivityOptionsCompat options) {
        ...
        Intent createIntent = contract.createIntent(componentActivity3, input);
        if (createIntent.getExtras() != null) {
            Bundle extras = createIntent.getExtras();
            Intrinsics.checkNotNull(extras);
            if (extras.getClassLoader() == null) {
                createIntent.setExtrasClassLoader(componentActivity2.getClassLoader());
            }
        }
        ...
        ActivityCompat.startActivityForResult(componentActivity2, createIntent, requestCode, bundle2);
    }
}
