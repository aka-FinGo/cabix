...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Toolbar> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            mapObject5 = propertyMapper.mapObject(Routes.MENU, R.attr.menu);
    ...
    */
    ...
    public DecorToolbar getWrapper() {
        ...
        ToolbarWidgetWrapper toolbarWidgetWrapper2 = new ToolbarWidgetWrapper(this, true);
        this.mWrapper = toolbarWidgetWrapper2;
    ...
    void updateBackInvokedCallbackState() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            OnBackInvokedCallback onBackInvokedCallback = this.mBackInvokedCallback;
            if (onBackInvokedCallback == null) {
                onBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new Runnable() { // from class: androidx.appcompat.widget.Toolbar$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        Toolbar.this.collapseActionView();
                    }
                });
                this.mBackInvokedCallback = onBackInvokedCallback;
            }
            Api33Impl.tryRegisterOnBackInvokedCallback(findOnBackInvokedDispatcher, onBackInvokedCallback);
