...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public void setExclusiveCheckable(boolean z) {
        try {
            ...
            if (method == null) {
                method = this.mWrappedObject.getClass().getDeclaredMethod("setExclusiveCheckable", Boolean.TYPE);
                this.mSetExclusiveCheckableMethod = method;
            }
            method.invoke(this.mWrappedObject, Boolean.valueOf(z));
        } catch (Exception e) {
