...
@Metadata(d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0007\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0001H\u008a@"}, d2 = {"<anonymous>", "", "delta"}, k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (scrollCaptureScrollByAction != null) {
                ...
                Offset m4114boximpl = Offset.m4114boximpl(Offset.m4117constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
                this.Z$0 = reverseScrolling;
                this.label = 1;
                obj = scrollCaptureScrollByAction.invoke(m4114boximpl, this);
        ...
        long m4135unboximpl = ((Offset) obj).m4135unboximpl();
        return Boxing.boxFloat(z ? -Float.intBitsToFloat((int) (m4135unboximpl & 4294967295L)) : Float.intBitsToFloat((int) (m4135unboximpl & 4294967295L)));
    }
}
