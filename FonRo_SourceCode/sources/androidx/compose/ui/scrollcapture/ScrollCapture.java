...
public final class ScrollCapture implements ComposeScrollCaptureCallback.ScrollCaptureSessionListener {
    ...
    public final void onScrollCaptureSearch(View view, SemanticsOwner semanticsOwner, CoroutineContext coroutineContext, Consumer<ScrollCaptureTarget> targets) {
        ...
        long m7146getTopLeftnOccac = scrollCaptureCandidate.getViewportBoundsInWindow().m7146getTopLeftnOccac();
        ScrollCaptureTarget m = Paint29$$ExternalSyntheticApiModelOutline0.m(view, RectHelper_androidKt.toAndroidRect(IntRectKt.roundToIntRect(boundsInRoot)), new Point(IntOffset.m7117getXimpl(m7146getTopLeftnOccac), IntOffset.m7118getYimpl(m7146getTopLeftnOccac)), Paint29$$ExternalSyntheticApiModelOutline0.m6484m((Object) composeScrollCaptureCallback));
