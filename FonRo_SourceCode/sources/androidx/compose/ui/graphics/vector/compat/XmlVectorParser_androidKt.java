...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m5103getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m4737getButtKaPHkGw();
        }
        return m5102getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m5102getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m4737getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m4739getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4738getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m5105getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m4748getMiterLxFBmk8();
        }
        return m5104getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m5104getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m4748getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m4747getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m4749getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet) {
        long m4420getUnspecified0d7_KjU;
        int m4324getSrcIn0nO6VwU;
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m4420getUnspecified0d7_KjU = Color.INSTANCE.m4420getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m4420getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m4420getUnspecified0d7_KjU = Color.INSTANCE.m4420getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m4420getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4324getSrcIn0nO6VwU();
        } else if (i == 3) {
            m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4326getSrcOver0nO6VwU();
        } else if (i == 5) {
            m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4324getSrcIn0nO6VwU();
        } else if (i == 9) {
            m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4323getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4315getModulate0nO6VwU();
                    break;
                case 15:
                    m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4320getScreen0nO6VwU();
                    break;
                case 16:
                    m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4318getPlus0nO6VwU();
                    break;
                default:
                    m4324getSrcIn0nO6VwU = BlendMode.INSTANCE.m4324getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m4324getSrcIn0nO6VwU;
        float m6989constructorimpl = Dp.m6989constructorimpl(dimension / resources.getDisplayMetrics().density);
        float m6989constructorimpl2 = Dp.m6989constructorimpl(dimension2 / resources.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m6989constructorimpl, m6989constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m5102getStrokeLineCapCSYIeUk = m5102getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m4737getButtKaPHkGw());
        int m5104getStrokeLineJoinkLtJ_vA = m5104getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m4747getBevelLxFBmk8());
        ...
        obtainAttributes.recycle();
        builder.m5070addPathoIyEayM(list, namedInt == 0 ? PathFillType.INSTANCE.m4667getNonZeroRgk1Os() : PathFillType.INSTANCE.m4666getEvenOddRgk1Os(), str, obtainBrushFromComplexColor(namedComplexColor), namedFloat, obtainBrushFromComplexColor(namedComplexColor2), namedFloat3, namedFloat4, m5102getStrokeLineCapCSYIeUk, m5104getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
