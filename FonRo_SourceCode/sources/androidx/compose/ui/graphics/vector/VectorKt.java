...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m4737getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m4748getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m4324getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m4419getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m4667getNonZeroRgk1Os();
    ...
    public static final boolean m5086rgbEqualOWjLjI(long j, long j2) {
        return Color.m4390getRedimpl(j) == Color.m4390getRedimpl(j2) && Color.m4389getGreenimpl(j) == Color.m4389getGreenimpl(j2) && Color.m4387getBlueimpl(j) == Color.m4387getBlueimpl(j2);
    }
    ...
    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        ...
        return BlendMode.m4295equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4324getSrcIn0nO6VwU()) || BlendMode.m4295equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m4326getSrcOver0nO6VwU());
    }
}
