...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent(GroupComponent groupComponent) {
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4182boximpl(Size.INSTANCE.m4203getZeroNHjbRc()), null, 2, null);
        this.viewportSize = mutableStateOf$default2;
        this.previousDrawSize = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
        ...
        this.drawVectorBlock = new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.graphics.vector.VectorComponent$drawVectorBlock$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    drawContext.getTransform().mo4863scale0AR0LA0(f, f2, m4141getZeroF1C5BW0);
                    root.draw(drawScope);
                } finally {
    ...
    public final int m5079getCacheBitmapConfig_sVssgQ$ui_release() {
        ImageBitmap mCachedImage = this.cacheDrawScope.getMCachedImage();
        return mCachedImage != null ? mCachedImage.mo4233getConfig_sVssgQ() : ImageBitmapConfig.INSTANCE.m4604getArgb8888_sVssgQ();
    }
    ...
    public final long m5080getViewportSizeNHjbRc$ui_release() {
        return ((Size) this.viewportSize.getValue()).m4199unboximpl();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m5081setViewportSizeuvyYCjk$ui_release(long j) {
        this.viewportSize.setValue(Size.m4182boximpl(j));
    }

    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        int m4604getArgb8888_sVssgQ;
        if (this.root.getIsTintable() && this.root.getTintColor() != 16 && VectorKt.tintableWithAlphaMask(getIntrinsicColorFilter$ui_release()) && VectorKt.tintableWithAlphaMask(colorFilter)) {
            m4604getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4603getAlpha8_sVssgQ();
        } else {
            m4604getArgb8888_sVssgQ = ImageBitmapConfig.INSTANCE.m4604getArgb8888_sVssgQ();
        }
        int i = m4604getArgb8888_sVssgQ;
        if (this.isDirty || !Size.m4190equalsimpl0(this.previousDrawSize, drawScope.mo4935getSizeNHjbRc()) || !ImageBitmapConfig.m4599equalsimpl0(i, m5079getCacheBitmapConfig_sVssgQ$ui_release())) {
            this.tintFilter = ImageBitmapConfig.m4599equalsimpl0(i, ImageBitmapConfig.INSTANCE.m4603getAlpha8_sVssgQ()) ? ColorFilter.Companion.m4425tintxETnrds$default(ColorFilter.INSTANCE, this.root.getTintColor(), 0, 2, null) : null;
            this.rootScaleX = Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() >> 32)) / Float.intBitsToFloat((int) (m5080getViewportSizeNHjbRc$ui_release() >> 32));
            this.rootScaleY = Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() & 4294967295L)) / Float.intBitsToFloat((int) (m5080getViewportSizeNHjbRc$ui_release() & 4294967295L));
            this.cacheDrawScope.m5062drawCachedImageFqjB98A(i, IntSize.m7155constructorimpl((((int) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() & 4294967295L)))) & 4294967295L) | (((int) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() >> 32)))) << 32)), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo4935getSizeNHjbRc();
        }
        if (colorFilter == null) {
    ...
    public String toString() {
        String str = "Params: \tname: " + this.name + "\n\tviewportWidth: " + Float.intBitsToFloat((int) (m5080getViewportSizeNHjbRc$ui_release() >> 32)) + "\n\tviewportHeight: " + Float.intBitsToFloat((int) (m5080getViewportSizeNHjbRc$ui_release() & 4294967295L)) + "\n";
