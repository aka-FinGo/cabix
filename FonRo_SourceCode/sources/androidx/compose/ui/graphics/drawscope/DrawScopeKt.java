...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m4983rotateRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4934getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4862rotateUv8p0NA(f, j);
            function1.invoke(drawScope);
        } finally {
    ...
    public static /* synthetic */ void m4985rotateRadRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4934getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4862rotateUv8p0NA(DegreesKt.degrees(f), j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static /* synthetic */ void m4987scaleFgt4K4Q$default(DrawScope drawScope, float f, float f2, long j, Function1 function1, int i, Object obj) {
        if ((i & 4) != 0) {
            j = drawScope.mo4934getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4863scale0AR0LA0(f, f2, j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static /* synthetic */ void m4989scaleRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.mo4934getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4863scale0AR0LA0(f, f, j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static /* synthetic */ void m4978clipRectrOu3jXo$default(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1 function1, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() >> 32));
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() & 4294967295L));
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
            i = ClipOp.INSTANCE.m4373getIntersectrtfAjoo();
        }
        int i3 = i;
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4859clipRectN_I0leg(f5, f6, f7, f8, i3);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static /* synthetic */ void m4976clipPathKD09W0M$default(DrawScope drawScope, Path path, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.INSTANCE.m4373getIntersectrtfAjoo();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4858clipPathmtrdDE(path, i);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static final void m4980drawymL40Pk(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        drawContext.mo4857setSizeuvyYCjk(j);
    ...
    public static /* synthetic */ void m4981drawymL40Pk$default(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1 function1, int i, Object obj) {
        if ((i & 16) != 0) {
            graphicsLayer = null;
        }
        Density density2 = drawScope.getDrawContext().getDensity();
    ...
    public static final void m4982rotateRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4984rotateRadRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4986scaleFgt4K4Q(DrawScope drawScope, float f, float f2, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4988scaleRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4977clipRectrOu3jXo(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().mo4859clipRectN_I0leg(f, f2, f3, f4, i);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static final void m4975clipPathKD09W0M(DrawScope drawScope, Path path, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final /* synthetic */ void m4979drawGRGpd60(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, Function1<? super DrawScope, Unit> function1) {
        Density density2 = drawScope.getDrawContext().getDensity();
        LayoutDirection layoutDirection2 = drawScope.getDrawContext().getLayoutDirection();
        Canvas canvas2 = drawScope.getDrawContext().getCanvas();
        long mo4856getSizeNHjbRc = drawScope.getDrawContext().mo4856getSizeNHjbRc();
