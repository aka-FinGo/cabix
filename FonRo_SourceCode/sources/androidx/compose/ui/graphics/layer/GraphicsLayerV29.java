...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.renderNode = m;
        this.size = Size.INSTANCE.m4203getZeroNHjbRc();
        m.setClipToBounds(false);
        m5051applyCompositingStrategyZ1X6vPc(m, CompositingStrategy.INSTANCE.m5015getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo5044setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m4217toAndroidBlendModes9anfk8(i));
    ...
    public void mo5043setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m4438toArgb8_81llA(j));
    }
    ...
    public void mo5049setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m4438toArgb8_81llA(j));
    }
    ...
    private final void m5051applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m5011equalsimpl0(i, CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
            return;
        }
        boolean m5011equalsimpl0 = CompositingStrategy.m5011equalsimpl0(i, CompositingStrategy.INSTANCE.m5016getModulateAlphake2Ky5w());
    ...
    private final void updateLayerProperties() {
        ...
        if (requiresCompositingLayer) {
            m5051applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w());
        } else {
            m5051applyCompositingStrategyZ1X6vPc(renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo5048setPositionH0pRuoY(int x, int y, long size) {
        ...
        this.size = IntSizeKt.m7172toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo4857setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5011equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
