...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m4141getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m5052applyCompositingLayerWpw9cng(int compositingStrategy) {
        ...
        if (CompositingStrategy.m5011equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w())) {
            ...
            boolean m5011equalsimpl0 = CompositingStrategy.m5011equalsimpl0(compositingStrategy, CompositingStrategy.INSTANCE.m5016getModulateAlphake2Ky5w());
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m5052applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w());
        } else {
            m5052applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m5011equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m4295equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m4326getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo5043setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m4438toArgb8_81llA(j));
        }
    }
    ...
    public void mo5049setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m4438toArgb8_81llA(j));
        }
    }
    ...
    /* compiled from: GraphicsViewLayer.android.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Landroidx/compose/ui/graphics/layer/GraphicsViewLayer$Companion;", "", "()V", "PlaceholderCanvas", "Landroid/graphics/Canvas;", "getPlaceholderCanvas", "()Landroid/graphics/Canvas;", "mayRenderInSoftware", "", "getMayRenderInSoftware", "()Z", "ui-graphics_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
