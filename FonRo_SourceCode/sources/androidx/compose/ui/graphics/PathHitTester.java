...
public final class PathHitTester {
    ...
    public final boolean m4668containsk4lQ0M(long position) {
        int i;
        int lineWinding;
        if (!this.path.isEmpty() && this.bounds.m4151containsk4lQ0M(position)) {
            ...
            if (PathFillType.m4662equalsimpl0(this.path.mo4257getFillTypeRgk1Os(), PathFillType.INSTANCE.m4666getEvenOddRgk1Os())) {
                i &= 1;
            }
            if (i != 0) {
                return true;
