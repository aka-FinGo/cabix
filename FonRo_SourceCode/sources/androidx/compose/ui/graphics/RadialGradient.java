...
public final class RadialGradient extends ShaderBrush {
    ...
    public /* synthetic */ RadialGradient(List list, List list2, long j, float f, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(list, (i2 & 2) != 0 ? null : list2, j, f, (i2 & 16) != 0 ? TileMode.INSTANCE.m4757getClamp3opZhB0() : i, null);
    }
    ...
    public long getIntrinsicSize() {
        if ((Float.floatToRawIntBits(this.radius) & Integer.MAX_VALUE) < 2139095040) {
            float f = this.radius;
            return Size.m4185constructorimpl((Float.floatToRawIntBits(f * 2.0f) << 32) | (Float.floatToRawIntBits(f * 2.0f) & 4294967295L));
        }
    ...
    public Shader mo4353createShaderuvyYCjk(long size) {
        float intBitsToFloat;
        float intBitsToFloat2;
        long j = this.center;
        if ((9223372034707292159L & j) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            long m4204getCenteruvyYCjk = SizeKt.m4204getCenteruvyYCjk(size);
            intBitsToFloat = Float.intBitsToFloat((int) (m4204getCenteruvyYCjk >> 32));
            intBitsToFloat2 = Float.intBitsToFloat((int) (m4204getCenteruvyYCjk & 4294967295L));
        } else {
        ...
        long m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(intBitsToFloat) << 32) | (4294967295L & Float.floatToRawIntBits(intBitsToFloat2)));
        float f = this.radius;
        if (f == Float.POSITIVE_INFINITY) {
            f = Size.m4193getMinDimensionimpl(size) / 2.0f;
        }
        return ShaderKt.m4701RadialGradientShader8uybcMk(m4117constructorimpl, f, list, list2, this.tileMode);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.colors, radialGradient.colors) && Intrinsics.areEqual(this.stops, radialGradient.stops) && Offset.m4122equalsimpl0(this.center, radialGradient.center) && this.radius == radialGradient.radius && TileMode.m4753equalsimpl0(this.tileMode, radialGradient.tileMode);
    }

    public int hashCode() {
        int hashCode = this.colors.hashCode() * 31;
        List<Float> list = this.stops;
        return ((((((hashCode + (list != null ? list.hashCode() : 0)) * 31) + Offset.m4127hashCodeimpl(this.center)) * 31) + Float.hashCode(this.radius)) * 31) + TileMode.m4754hashCodeimpl(this.tileMode);
    }
    ...
    public String toString() {
        ...
        if ((this.center & 9223372034707292159L) != androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            str = "center=" + ((Object) Offset.m4133toStringimpl(this.center)) + ", ";
        } else {
            str = "";
        }
        if ((Float.floatToRawIntBits(this.radius) & Integer.MAX_VALUE) < 2139095040) {
        ...
        return "RadialGradient(colors=" + this.colors + ", stops=" + this.stops + ", " + str + str2 + "tileMode=" + ((Object) TileMode.m4755toStringimpl(this.tileMode)) + ')';
    }
}
