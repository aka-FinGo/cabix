...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m4141getZeroF1C5BW0();
    }
    ...
    public final void m5707setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5703addPositionUv8p0NA(long timeMillis, long position) {
    ...
    public final long m5704calculateVelocity9UxMQ8M() {
        return m5705calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m5705calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m7227getXimpl(maximumVelocity) > 0.0f && Velocity.m7228getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m7234toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m7227getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m7228getYimpl(maximumVelocity)));
    }
