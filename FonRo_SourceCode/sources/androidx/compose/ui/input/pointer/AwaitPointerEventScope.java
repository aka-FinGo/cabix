...
public interface AwaitPointerEventScope extends Density {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5518roundToPxR2X_6o(AwaitPointerEventScope awaitPointerEventScope, long j) {
            return AwaitPointerEventScope.super.mo693roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4 */
        public static int m5519roundToPx0680j_4(AwaitPointerEventScope awaitPointerEventScope, float f) {
            return AwaitPointerEventScope.super.mo694roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA */
        public static float m5520toDpGaN1DYA(AwaitPointerEventScope awaitPointerEventScope, long j) {
            return AwaitPointerEventScope.super.mo695toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM */
        public static float m5521toDpu2uoSUM(AwaitPointerEventScope awaitPointerEventScope, float f) {
            return AwaitPointerEventScope.super.mo696toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM */
        public static float m5522toDpu2uoSUM(AwaitPointerEventScope awaitPointerEventScope, int i) {
            return AwaitPointerEventScope.super.mo697toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM */
        public static long m5523toDpSizekrfVVM(AwaitPointerEventScope awaitPointerEventScope, long j) {
            return AwaitPointerEventScope.super.mo698toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o */
        public static float m5524toPxR2X_6o(AwaitPointerEventScope awaitPointerEventScope, long j) {
            return AwaitPointerEventScope.super.mo699toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4 */
        public static float m5525toPx0680j_4(AwaitPointerEventScope awaitPointerEventScope, float f) {
            return AwaitPointerEventScope.super.mo700toPx0680j_4(f);
        }
        ...
        public static long m5526toSizeXkaWNTQ(AwaitPointerEventScope awaitPointerEventScope, long j) {
            return AwaitPointerEventScope.super.mo701toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do */
        public static long m5527toSp0xMU5do(AwaitPointerEventScope awaitPointerEventScope, float f) {
            return AwaitPointerEventScope.super.mo702toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4 */
        public static long m5528toSpkPz2Gy4(AwaitPointerEventScope awaitPointerEventScope, float f) {
            return AwaitPointerEventScope.super.mo703toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4 */
        public static long m5529toSpkPz2Gy4(AwaitPointerEventScope awaitPointerEventScope, int i) {
            return AwaitPointerEventScope.super.mo704toSpkPz2Gy4(i);
        }

        @Deprecated
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public static long m5517getExtendedTouchPaddingNHjbRc(AwaitPointerEventScope awaitPointerEventScope) {
            return AwaitPointerEventScope.super.mo5515getExtendedTouchPaddingNHjbRc();
        }
    ...
    /* renamed from: getExtendedTouchPadding-NH-jbRc */
    default long mo5515getExtendedTouchPaddingNHjbRc() {
