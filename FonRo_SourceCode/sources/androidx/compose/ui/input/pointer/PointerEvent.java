...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> list, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m5540constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m5669constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m5546calculatePointerEventType7fucELk();
    }
    ...
    public final void m5550setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m5546calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
                    ...
                    if (actionMasked != 2) {
                        switch (actionMasked) {
                            ...
                            case 7:
                                break;
                            case 8:
                                return PointerEventType.INSTANCE.m5565getScroll7fucELk();
                            case 9:
                                return PointerEventType.INSTANCE.m5560getEnter7fucELk();
                            case 10:
                                return PointerEventType.INSTANCE.m5561getExit7fucELk();
                            default:
                                return PointerEventType.INSTANCE.m5566getUnknown7fucELk();
                        }
                    }
                    return PointerEventType.INSTANCE.m5562getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m5564getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m5563getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            int i2 = size;
            arrayList2.add(new PointerInputEventData(id, uptimeMillis, position, position2, pressed, pressure, type, internalPointerEvent != null && internalPointerEvent.m5535activeHoverEvent0FcD4WY(pointerInputChange.getId()), null, 0L, 0L, 1792, null));
            i++;
