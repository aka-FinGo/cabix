...
public final class PrimitiveResources_androidKt {
    public static final int integerResource(int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(916701108, i2, -1, "androidx.compose.ui.res.integerResource (PrimitiveResources.android.kt:35)");
        }
        int integer = Resources_androidKt.resources(composer, 0).getInteger(i);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final int[] integerArrayResource(int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-93991766, i2, -1, "androidx.compose.ui.res.integerArrayResource (PrimitiveResources.android.kt:47)");
        }
        int[] intArray = Resources_androidKt.resources(composer, 0).getIntArray(i);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final boolean booleanResource(int i, Composer composer, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-432394447, i2, -1, "androidx.compose.ui.res.booleanResource (PrimitiveResources.android.kt:59)");
        }
        boolean z = Resources_androidKt.resources(composer, 0).getBoolean(i);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final float dimensionResource(int i, Composer composer, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        float m6989constructorimpl = Dp.m6989constructorimpl(Resources_androidKt.resources(composer, 0).getDimension(i) / ((Density) consume).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
