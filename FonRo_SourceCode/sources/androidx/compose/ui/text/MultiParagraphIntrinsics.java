...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, Density density, FontFamily.Resolver resolver) {
        ...
        while (i < size) {
            ...
            arrayList2.add(new ParagraphIntrinsicInfo(ParagraphIntrinsicsKt.ParagraphIntrinsics(text, merge, annotations$ui_text_release, density, resolver, (List<AnnotatedString.Range<Placeholder>>) localPlaceholders), range.getStart(), range.getEnd()));
            i++;
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        return !TextDirection.m6883equalsimpl0(style.getTextDirection(), TextDirection.INSTANCE.m6892getUnspecifieds_7Xco()) ? style : ParagraphStyle.m6314copyykzQM6k$default(style, 0, defaultStyle.getTextDirection(), 0L, null, null, null, 0, 0, null, 509, null);
    }
}
