...
public final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6760copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m6762copy8_81llA(j);
    }
    ...
    public final ColorStyle m6762copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m4385equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public int hashCode() {
        return Color.m4391hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m4392toStringimpl(this.value)) + ')';
    }
    ...
    public final long m6763getValue0d7_KjU() {
        return this.value;
    }
    ...
    public float getAlpha() {
        return Color.m4386getAlphaimpl(mo6759getColor0d7_KjU());
    }
}
