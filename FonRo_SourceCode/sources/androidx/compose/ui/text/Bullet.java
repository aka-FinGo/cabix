...
public final class Bullet implements AnnotatedString.Annotation {
    ...
    public static /* synthetic */ Bullet m6268copy1XB3EBo$default(Bullet bullet, Shape shape, long j, long j2, Brush brush, float f, DrawStyle drawStyle, int i, Object obj) {
        if ((i & 1) != 0) {
            shape = bullet.shape;
        }
        if ((i & 2) != 0) {
        ...
        Brush brush2 = brush;
        long j3 = j2;
        return bullet.m6269copy1XB3EBo(shape, j, j3, brush2, f, drawStyle2);
    }

    /* renamed from: copy-1XB3EBo, reason: not valid java name */
    public final Bullet m6269copy1XB3EBo(Shape shape, long size, long padding, Brush brush, float alpha, DrawStyle drawStyle) {
    ...
    public boolean equals(Object other) {
        ...
        if (other != null && (other instanceof Bullet)) {
            ...
            return Intrinsics.areEqual(this.shape, bullet.shape) && TextUnit.m7180equalsimpl0(this.size, bullet.size) && TextUnit.m7180equalsimpl0(this.padding, bullet.padding) && Intrinsics.areEqual(this.brush, bullet.brush) && this.alpha == bullet.alpha && Intrinsics.areEqual(this.drawStyle, bullet.drawStyle);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((((this.shape.hashCode() * 31) + TextUnit.m7184hashCodeimpl(this.size)) * 31) + TextUnit.m7184hashCodeimpl(this.padding)) * 31;
        Brush brush = this.brush;
        return ((((hashCode + (brush != null ? brush.hashCode() : 0)) * 31) + Float.hashCode(this.alpha)) * 31) + this.drawStyle.hashCode();
    }

    public String toString() {
        return "Bullet(shape=" + this.shape + ", size=" + ((Object) TextUnit.m7190toStringimpl(this.size)) + ", padding=" + ((Object) TextUnit.m7190toStringimpl(this.padding)) + ", brush=" + this.brush + ", alpha=" + this.alpha + ", drawStyle=" + this.drawStyle + ')';
    }
}
