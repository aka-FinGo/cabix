...
public final class TextStyleKt {
    ...
    public static final int m6481resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i) {
        if (TextDirection.m6883equalsimpl0(i, TextDirection.INSTANCE.m6887getContents_7Xco())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                return TextDirection.INSTANCE.m6888getContentOrLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m6889getContentOrRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
        if (!TextDirection.m6883equalsimpl0(i, TextDirection.INSTANCE.m6892getUnspecifieds_7Xco())) {
            return i;
        }
        int i3 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
        if (i3 == 1) {
            return TextDirection.INSTANCE.m6890getLtrs_7Xco();
        }
        if (i3 == 2) {
            return TextDirection.INSTANCE.m6891getRtls_7Xco();
        }
        throw new NoWhenBranchMatchedException();
    }
