    ...
    public static final Pair<List<Font>, Object> firstImmediatelyAvailable(List<? extends Font> list, TypefaceRequest typefaceRequest, AsyncTypefaceCache asyncTypefaceCache, PlatformFontLoader platformFontLoader, Function1<? super TypefaceRequest, ? extends Object> function1) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!FontLoadingStrategy.m6553equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6558getBlockingPKNRLFQ())) {
                if (!FontLoadingStrategy.m6553equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6559getOptionalLocalPKNRLFQ())) {
                    if (FontLoadingStrategy.m6553equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m6557getAsyncPKNRLFQ())) {
                        AsyncTypefaceCache.AsyncTypefaceResult m6520get1ASDuI8 = asyncTypefaceCache.m6520get1ASDuI8(font, platformFontLoader);
                        if (m6520get1ASDuI8 == null) {
                            if (list2 == null) {
                                list2 = CollectionsKt.mutableListOf(font);
                            } else {
                                list2.add(font);
                            }
                        } else if (!AsyncTypefaceCache.AsyncTypefaceResult.m6526isPermanentFailureimpl(m6520get1ASDuI8.m6528unboximpl()) && m6520get1ASDuI8.m6528unboximpl() != null) {
                            return TuplesKt.to(list2, FontSynthesis_androidKt.m6587synthesizeTypefaceFxwP2eA(typefaceRequest.m6612getFontSynthesisGVVA2EU(), m6520get1ASDuI8.m6528unboximpl(), font, typefaceRequest.getFontWeight(), typefaceRequest.m6611getFontStyle_LCdwA()));
                        }
                    } else {
                    ...
                    synchronized (asyncTypefaceCache.cacheLock) {
                        ...
                        if (asyncTypefaceResult != null) {
                            obj2 = asyncTypefaceResult.m6528unboximpl();
                        } else {
                            Unit unit = Unit.INSTANCE;
                            try {
                                Result.Companion companion = Result.INSTANCE;
                                m7870constructorimpl = Result.m7870constructorimpl(platformFontLoader.loadBlocking(font));
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.INSTANCE;
                                m7870constructorimpl = Result.m7870constructorimpl(ResultKt.createFailure(th));
                            }
                            Object obj3 = Result.m7876isFailureimpl(m7870constructorimpl) ? null : m7870constructorimpl;
                            AsyncTypefaceCache.put$default(asyncTypefaceCache, font, platformFontLoader, obj3, false, 8, null);
                            obj2 = obj3;
                        }
                    }
                    if (obj2 != null) {
                        return TuplesKt.to(list2, FontSynthesis_androidKt.m6587synthesizeTypefaceFxwP2eA(typefaceRequest.m6612getFontSynthesisGVVA2EU(), obj2, font, typefaceRequest.getFontWeight(), typefaceRequest.m6611getFontStyle_LCdwA()));
                    }
                }
            } else {
                synchronized (asyncTypefaceCache.cacheLock) {
                    ...
                    if (asyncTypefaceResult2 != null) {
                        obj = asyncTypefaceResult2.m6528unboximpl();
                    } else {
                ...
                return TuplesKt.to(list2, FontSynthesis_androidKt.m6587synthesizeTypefaceFxwP2eA(typefaceRequest.m6612getFontSynthesisGVVA2EU(), obj, font, typefaceRequest.getFontWeight(), typefaceRequest.m6611getFontStyle_LCdwA()));
            }
        }
