    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(DrawStyleSpan_androidKt.m6742toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(DrawStyleSpan_androidKt.m6741toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
