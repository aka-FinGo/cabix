...
public final class TextPainterKt {
    ...
    public static final void m6414drawTextJFhB2K4(DrawScope drawScope, TextMeasurer textMeasurer, AnnotatedString annotatedString, long j, TextStyle textStyle, int i, boolean z, int i2, List<AnnotatedString.Range<Placeholder>> list, long j2, int i3) {
        ...
        try {
            ...
            clip(transform, m6409measurexDpz5zY$default);
            m6409measurexDpz5zY$default.getMultiParagraph().m6289paintLG529CI(drawScope.getDrawContext().getCanvas(), (r14 & 2) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : 0L, (r14 & 4) != 0 ? null : null, (r14 & 8) != 0 ? null : null, (r14 & 16) == 0 ? null : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m4937getDefaultBlendMode0nO6VwU() : i3);
        } finally {
    ...
    public static final void m6418drawTextTPWCCtM(DrawScope drawScope, TextMeasurer textMeasurer, String str, long j, TextStyle textStyle, int i, boolean z, int i2, long j2, int i3) {
        TextLayoutResult m6409measurexDpz5zY$default = TextMeasurer.m6409measurexDpz5zY$default(textMeasurer, new AnnotatedString(str, null, 2, null), textStyle, i, z, i2, null, m6422textLayoutConstraintsv_w8tDc(drawScope, j2, j), drawScope.getLayoutDirection(), drawScope, null, false, 1568, null);
        DrawContext drawContext = drawScope.getDrawContext();
        long mo4856getSizeNHjbRc = drawContext.mo4856getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m6420drawTextd8rzKo(DrawScope drawScope, TextLayoutResult textLayoutResult, long j, long j2, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        float alpha;
        int i2;
        Shadow shadow2;
        ...
        try {
            ...
            if (brush != null && j == 16) {
                ...
                multiParagraph.m6291painthn5TExg(canvas, brush, alpha, shadow2, textDecoration2, drawStyle2, i2);
            } else {
                MultiParagraph multiParagraph3 = textLayoutResult.getMultiParagraph();
                Canvas canvas3 = drawScope.getDrawContext().getCanvas();
                if (j == 16) {
                    j = textLayoutResult.getLayoutInput().getStyle().m6465getColor0d7_KjU();
                }
                multiParagraph3.m6289paintLG529CI(canvas3, TextDrawStyleKt.m6893modulateDxMtmZc(j, f), shadow3, textDecoration3, drawStyle3, i);
            }
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public static final void m6416drawTextLVfH_YU(DrawScope drawScope, TextLayoutResult textLayoutResult, Brush brush, long j, float f, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i) {
        ...
        try {
            ...
            clip(transform, textLayoutResult);
            textLayoutResult.getMultiParagraph().m6291painthn5TExg(drawScope.getDrawContext().getCanvas(), brush, !Float.isNaN(f) ? f : textLayoutResult.getLayoutInput().getStyle().getAlpha(), shadow2, textDecoration2, drawStyle2, i);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
        }
    ...
    private static final void clip(DrawTransform drawTransform, TextLayoutResult textLayoutResult) {
        if (!textLayoutResult.getHasVisualOverflow() || TextOverflow.m6915equalsimpl0(textLayoutResult.getLayoutInput().getOverflow(), TextOverflow.INSTANCE.m6928getVisiblegIe3tQ8())) {
            return;
        }
        DrawTransform.m4992clipRectN_I0leg$default(drawTransform, 0.0f, 0.0f, (int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() & 4294967295L), 0, 16, null);
    }

    /* renamed from: textLayoutConstraints-v_w8tDc, reason: not valid java name */
    private static final long m6422textLayoutConstraintsv_w8tDc(DrawScope drawScope, long j, long j2) {
        int round;
        int i;
        int round2;
        int i2 = 0;
        if (j == InlineClassHelperKt.UnspecifiedPackedFloats || Float.isNaN(Float.intBitsToFloat((int) (j >> 32)))) {
            round = Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() >> 32)) - Float.intBitsToFloat((int) (j2 >> 32))));
            i = 0;
        } else {
        ...
        if (j == InlineClassHelperKt.UnspecifiedPackedFloats || Float.isNaN(Float.intBitsToFloat((int) (j & 4294967295L)))) {
            round2 = Math.round((float) Math.ceil(Float.intBitsToFloat((int) (drawScope.mo4935getSizeNHjbRc() & 4294967295L)) - Float.intBitsToFloat((int) (j2 & 4294967295L))));
        } else {
