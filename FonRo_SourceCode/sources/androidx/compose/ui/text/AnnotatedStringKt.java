...
public final class AnnotatedStringKt {
    ...
    private static final List<AnnotatedString.Range<? extends AnnotatedString.Annotation>> getLocalAnnotations(AnnotatedString annotatedString, int i, int i2, Function1<? super AnnotatedString.Annotation, Boolean> function1) {
        ...
        while (i3 < size2) {
            AnnotatedString.Range<? extends AnnotatedString.Annotation> range2 = annotations$ui_text_release.get(i3);
    ...
    public static final <R> R withBulletListItem(AnnotatedString.Builder.BulletScope bulletScope, Bullet bullet, Function1<? super AnnotatedString.Builder, ? extends R> function1) {
        Bullet bullet2;
        Pair pair = (Pair) CollectionsKt.lastOrNull((List) bulletScope.getBulletListSettingStack$ui_text_release());
        long packedValue = pair != null ? ((TextUnit) pair.getFirst()).getPackedValue() : BulletKt.getDefaultBulletIndentation();
        if (bullet != null) {
            bullet2 = bullet;
        ...
        int pushBullet$ui_text_release = bulletScope.getBuilder().pushBullet$ui_text_release(bullet2);
        try {
            return function1.invoke(bulletScope.getBuilder());
        } finally {
            bulletScope.getBuilder().pop(pushBullet$ui_text_release);
