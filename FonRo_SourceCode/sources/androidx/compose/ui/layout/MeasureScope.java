...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m5774roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo693roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m5775roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo694roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m5776toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo695toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5777toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo696toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m5778toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo697toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m5779toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo698toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m5780toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo699toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m5781toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo700toPx0680j_4(f);
        }
        ...
        public static long m5782toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo701toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m5783toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo702toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5784toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo703toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m5785toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo704toSpkPz2Gy4(i);
        }
