...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
    ...
    private final void subcompose(LayoutNode node, Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        if (nodeState == null) {
            NodeState nodeState2 = new NodeState(slotId, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m5724getLambda1$ui_release(), null, 4, null);
    ...
    private final ReusableComposition subcomposeInto(ReusableComposition existing, LayoutNode container, boolean reuseContent, CompositionContext parent, Function2<? super Composer, ? super Integer, Unit> composable) {
        if (existing == null || existing.getDisposed()) {
            existing = SubcompositionKt.createSubcomposition(container, parent);
        }
        if (!reuseContent) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                ...
                if (measureScope.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot() == null) {
                    ...
                    final MeasureResult invoke = block.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m6929boximpl(j));
                ...
                final MeasureResult invoke2 = function2.invoke(approachMeasureScopeImpl, Constraints.m6929boximpl(j));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object slotId, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$2
            ...
            public void dispose() {
                ...
                LayoutNode layoutNode3 = (LayoutNode) mutableScatterMap2.remove(slotId);
                if (layoutNode3 != null) {
            ...
            public int getPlaceablesCount() {
                ...
                mutableScatterMap2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                LayoutNode layoutNode3 = (LayoutNode) mutableScatterMap2.get(slotId);
            ...
            public void mo5758premeasure0kLqBqw(int index, long constraints) {
                MutableScatterMap mutableScatterMap2;
                mutableScatterMap2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                LayoutNode layoutNode3 = (LayoutNode) mutableScatterMap2.get(slotId);
                ...
                LayoutNodeKt.requireOwner(layoutNode3).mo6055measureAndLayout0kLqBqw(layoutNode3.getChildren$ui_release().get(index), constraints);
