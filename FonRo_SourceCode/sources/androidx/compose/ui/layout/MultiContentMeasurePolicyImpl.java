...
public final /* data */ class MultiContentMeasurePolicyImpl implements MeasurePolicy {
    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return this.measurePolicy.mo996measure3p2s80s(measureScope, MeasureScopeWithLayoutNodeKt.getChildrenOfVirtualChildren(measureScope), j);
    }
