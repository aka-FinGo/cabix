...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int mo693roundToPxR2X_6o(long j) {
        return this.coordinator.mo693roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo694roundToPx0680j_4(float f) {
        return this.coordinator.mo694roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo695toDpGaN1DYA(long j) {
        return this.coordinator.mo695toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo696toDpu2uoSUM(float f) {
        return this.coordinator.mo696toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo697toDpu2uoSUM(int i) {
        return this.coordinator.mo697toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo698toDpSizekrfVVM(long j) {
        return this.coordinator.mo698toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo699toPxR2X_6o(long j) {
        return this.coordinator.mo699toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo700toPx0680j_4(float f) {
        return this.coordinator.mo700toPx0680j_4(f);
    }
    ...
    public long mo701toSizeXkaWNTQ(long j) {
        return this.coordinator.mo701toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo702toSp0xMU5do(float f) {
        return this.coordinator.mo702toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo703toSpkPz2Gy4(float f) {
        return this.coordinator.mo703toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo704toSpkPz2Gy4(int i) {
        return this.coordinator.mo704toSpkPz2Gy4(i);
    }
    ...
    public long mo5708getLookaheadConstraintsmsEJaDk() {
    ...
    public long mo5709getLookaheadSizeYbymL2g() {
        ...
        return IntSize.m7155constructorimpl((measureResult$ui_release.getWidth() << 32) | (measureResult$ui_release.getHeight() & 4294967295L));
    }
