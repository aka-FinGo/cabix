...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m7136getSizeYbymL2g$annotations() {
    }
    ...
    /* compiled from: IntRect.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/unit/IntRect$Companion;", "", "()V", "Zero", "Landroidx/compose/ui/unit/IntRect;", "getZero$annotations", "getZero", "()Landroidx/compose/ui/unit/IntRect;", "ui-unit_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    public final long m7144getSizeYbymL2g() {
    ...
    public final IntRect m7148translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m7117getXimpl(offset), this.top + IntOffset.m7118getYimpl(offset), this.right + IntOffset.m7117getXimpl(offset), this.bottom + IntOffset.m7118getYimpl(offset));
    }
    ...
    public final long m7146getTopLeftnOccac() {
        return IntOffset.m7111constructorimpl((this.left << 32) | (this.top & 4294967295L));
    }

    /* renamed from: getTopCenter-nOcc-ac, reason: not valid java name */
    public final long m7145getTopCenternOccac() {
        return IntOffset.m7111constructorimpl(((this.left + (getWidth() / 2)) << 32) | (this.top & 4294967295L));
    }

    /* renamed from: getTopRight-nOcc-ac, reason: not valid java name */
    public final long m7147getTopRightnOccac() {
        return IntOffset.m7111constructorimpl((this.right << 32) | (this.top & 4294967295L));
    }

    /* renamed from: getCenterLeft-nOcc-ac, reason: not valid java name */
    public final long m7142getCenterLeftnOccac() {
        return IntOffset.m7111constructorimpl(((this.top + (getHeight() / 2)) & 4294967295L) | (this.left << 32));
    }

    /* renamed from: getCenter-nOcc-ac, reason: not valid java name */
    public final long m7141getCenternOccac() {
        return IntOffset.m7111constructorimpl(((this.top + (getHeight() / 2)) & 4294967295L) | ((this.left + (getWidth() / 2)) << 32));
    }

    /* renamed from: getCenterRight-nOcc-ac, reason: not valid java name */
    public final long m7143getCenterRightnOccac() {
        return IntOffset.m7111constructorimpl(((this.top + (getHeight() / 2)) & 4294967295L) | (this.right << 32));
    }

    /* renamed from: getBottomLeft-nOcc-ac, reason: not valid java name */
    public final long m7139getBottomLeftnOccac() {
        return IntOffset.m7111constructorimpl((this.left << 32) | (this.bottom & 4294967295L));
    }

    /* renamed from: getBottomCenter-nOcc-ac, reason: not valid java name */
    public final long m7138getBottomCenternOccac() {
        return IntOffset.m7111constructorimpl(((this.left + (getWidth() / 2)) << 32) | (this.bottom & 4294967295L));
    }

    /* renamed from: getBottomRight-nOcc-ac, reason: not valid java name */
    public final long m7140getBottomRightnOccac() {
        return IntOffset.m7111constructorimpl((this.right << 32) | (this.bottom & 4294967295L));
    }

    /* renamed from: contains--gyyYBs, reason: not valid java name */
    public final boolean m7137containsgyyYBs(long offset) {
        return IntOffset.m7117getXimpl(offset) >= this.left && IntOffset.m7117getXimpl(offset) < this.right && IntOffset.m7118getYimpl(offset) >= this.top && IntOffset.m7118getYimpl(offset) < this.bottom;
    }
