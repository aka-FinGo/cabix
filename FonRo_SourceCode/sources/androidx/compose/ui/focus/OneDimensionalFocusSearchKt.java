...
public final class OneDimensionalFocusSearchKt {
    ...
    public static final boolean m4066oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i, Function1<? super FocusTargetNode, Boolean> function1) {
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i == 1) {
            ...
            if (activeChild != null) {
                return forwardFocusSearch(activeChild, function1) || m4065generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4017getNextdhqQ8s(), function1);
            }
    ...
    private static final boolean backwardFocusSearch(FocusTargetNode focusTargetNode, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (i2 == 1) {
            return backwardFocusSearch(activeChild, function1) || m4065generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4018getPreviousdhqQ8s(), function1) || (activeChild.fetchFocusProperties$ui_release().getCanFocus() && function1.invoke(activeChild).booleanValue());
        }
        if (i2 == 2 || i2 == 3) {
            return m4065generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.INSTANCE.m4018getPreviousdhqQ8s(), function1);
        }
        if (i2 == 4) {
            throw new IllegalStateException(NoActiveChild.toString());
        }
    ...
    private static final boolean m4065generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m4067searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        ...
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m4004searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.OneDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope beyondBoundsScope) {
                boolean m4067searchChildren4C6V_qg;
                if (generation == requireTransactionManager.getGeneration() && (!ComposeUiFlags.isTrackFocusEnabled || activeFocusTargetNode == DelegatableNodeKt.requireOwner(focusTargetNode).getFocusOwner().getActiveFocusTargetNode())) {
                    m4067searchChildren4C6V_qg = OneDimensionalFocusSearchKt.m4067searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1);
                    Boolean valueOf = Boolean.valueOf(m4067searchChildren4C6V_qg);
                    valueOf.getClass();
                    if (m4067searchChildren4C6V_qg || !beyondBoundsScope.getHasMoreContent()) {
                        return valueOf;
                    }
                    return null;
                }
    ...
    public static final boolean m4067searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        ...
        if (FocusDirection.m4009equalsimpl0(i, FocusDirection.INSTANCE.m4017getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
            return false;
        }
        return function1.invoke(focusTargetNode).booleanValue();
    }
