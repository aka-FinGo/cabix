...
public final class MutableRect {
    ...
    public final long m4108getTopLeftF1C5BW0() {
        float f = this.left;
        float f2 = this.top;
    ...
    public final long m4107getTopCenterF1C5BW0() {
    ...
    public final long m4109getTopRightF1C5BW0() {
        float f = this.right;
        float f2 = this.top;
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L));
    }
    ...
    public final long m4104getCenterLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m4103getCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float bottom = this.top + ((getBottom() - getTop()) / 2.0f);
    ...
    public final long m4105getCenterRightF1C5BW0() {
        float f = this.right;
        float bottom = this.top + ((getBottom() - getTop()) / 2.0f);
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(bottom) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }
    ...
    public final long m4101getBottomLeftF1C5BW0() {
        float f = this.left;
    ...
    public final long m4100getBottomCenterF1C5BW0() {
        float right = this.left + ((getRight() - getLeft()) / 2.0f);
        float f = this.bottom;
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(right) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
    }
    ...
    public final long m4102getBottomRightF1C5BW0() {
        float f = this.right;
        float f2 = this.bottom;
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L));
    }
    ...
    public final long m4106getSizeNHjbRc() {
    ...
    public final void m4110translatek4lQ0M(long offset) {
    ...
    public final boolean m4099containsk4lQ0M(long offset) {
