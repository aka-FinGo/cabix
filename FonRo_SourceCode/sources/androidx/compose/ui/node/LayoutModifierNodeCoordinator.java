...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    public LayoutModifierNodeCoordinator(LayoutNode layoutNode, LayoutModifierNode layoutModifierNode) {
        ...
        if ((layoutModifierNode.getNode().getKindSet() & NodeKind.m5994constructorimpl(512)) != 0) {
    ...
    public final void setLayoutModifierNode$ui_release(LayoutModifierNode layoutModifierNode) {
        if (!Intrinsics.areEqual(layoutModifierNode, this.layoutModifierNode)) {
            ...
            if ((node.getKindSet() & NodeKind.m5994constructorimpl(512)) != 0) {
                Intrinsics.checkNotNull(layoutModifierNode, "null cannot be cast to non-null type androidx.compose.ui.layout.ApproachLayoutModifierNode");
    ...
    public final void m5901setLookaheadConstraints_Sx5XlM$ui_release(Constraints constraints) {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo5732measureBRTryo0(long constraints) {
            ...
            LookaheadDelegate.m5928access$setMeasurementConstraintsBRTryo0(lookaheadDelegateForLayoutModifierNode, constraints);
            layoutModifierNodeCoordinator.m5901setLookaheadConstraints_Sx5XlM$ui_release(Constraints.m6929boximpl(constraints));
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateForLayoutModifierNode, layoutModifierNodeCoordinator.getLayoutModifierNode().mo384measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    */
    public androidx.compose.ui.layout.Placeable mo5732measureBRTryo0(long r9) {
        /*
            r8 = this;
        ...
        L1b:
            ...
            androidx.compose.ui.node.NodeCoordinator.m5961access$setMeasurementConstraintsBRTryo0(r0, r9)
            ...
            long r2 = r0.mo5709getLookaheadSizeYbymL2g()
            boolean r2 = r1.mo390isMeasurementApproachInProgressozmzZPI(r2)
            r3 = 0
            r4 = 1
            if (r2 != 0) goto L44
            androidx.compose.ui.unit.Constraints r2 = r8.getLookaheadConstraints()
            boolean r2 = androidx.compose.ui.unit.Constraints.m6934equalsimpl(r9, r2)
            if (r2 != 0) goto L42
            goto L44
        L42:
            r2 = r3
        ...
        L55:
            ...
            androidx.compose.ui.layout.MeasureResult r1 = r1.mo389approachMeasure3p2s80s(r2, r5, r9)
            androidx.compose.ui.node.NodeCoordinator r2 = r8.getWrappedNonNull()
        ...
        L8c:
            ...
            long r4 = r0.mo5740getSizeYbymL2g()
            androidx.compose.ui.node.NodeCoordinator r0 = r8.getWrappedNonNull()
            androidx.compose.ui.node.LookaheadDelegate r0 = r0.getLookaheadDelegate()
            if (r0 == 0) goto Lad
            long r6 = r0.m5931getSizeYbymL2g$ui_release()
            androidx.compose.ui.unit.IntSize r0 = androidx.compose.ui.unit.IntSize.m7152boximpl(r6)
            goto Lae
        Lad:
            r0 = 0
        Lae:
            boolean r0 = androidx.compose.ui.unit.IntSize.m7157equalsimpl(r4, r0)
            if (r0 == 0) goto Lbe
            if (r3 != 0) goto Lbe
        ...
        Lc0:
            ...
            androidx.compose.ui.layout.MeasureResult r1 = r0.mo384measure3p2s80s(r1, r2, r9)
        Ld1:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutModifierNodeCoordinator.mo5732measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
    }
    ...
    public void mo5793placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        super.mo5793placeAtf8xVGno(position, zIndex, layer);
        onAfterPlaceAt();
    }
    ...
    public void mo5733placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        super.mo5733placeAtf8xVGno(position, zIndex, layerBlock);
        onAfterPlaceAt();
    }
    ...
    private final void onAfterPlaceAt() {
        ...
        if (approachMeasureScopeImpl != null) {
            ...
            if (!approachNode.isPlacementApproachInProgress(placementScope, lookaheadDelegate.getLookaheadLayoutCoordinates()) && !approachMeasureScopeImpl.getApproachMeasureRequired()) {
                long j = mo5740getSizeYbymL2g();
                LookaheadDelegate lookaheadDelegate2 = getLookaheadDelegate();
                if (IntSize.m7157equalsimpl(j, lookaheadDelegate2 != null ? IntSize.m7152boximpl(lookaheadDelegate2.m5931getSizeYbymL2g$ui_release()) : null)) {
                    long mo5740getSizeYbymL2g = getWrappedNonNull().mo5740getSizeYbymL2g();
                    LookaheadDelegate lookaheadDelegate3 = getWrappedNonNull().getLookaheadDelegate();
                    if (IntSize.m7157equalsimpl(mo5740getSizeYbymL2g, lookaheadDelegate3 != null ? IntSize.m7152boximpl(lookaheadDelegate3.m5931getSizeYbymL2g$ui_release()) : null)) {
                        z = true;
    ...
    /* compiled from: LayoutModifierNodeCoordinator.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/node/LayoutModifierNodeCoordinator$Companion;", "", "()V", "modifierBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getModifierBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    static {
        ...
        Paint.mo4245setColor8_81llA(Color.INSTANCE.m4411getBlue0d7_KjU());
