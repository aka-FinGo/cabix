...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m5943updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m6929boximpl(constraints);
    ...
    private final boolean m5940doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m5904lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m5904lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m5911lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m5904lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m5904lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m5904lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (parent$ui_release.getLookaheadRoot() == null) {
                ...
                return m5904lookaheadRemeasure_Sx5XlM$ui_release$default;
            }
    ...
    private final boolean m5941doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m5905remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m5905remeasure_Sx5XlM$ui_release$default = layoutNode.m5912remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m5905remeasure_Sx5XlM$ui_release$default = LayoutNode.m5905remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m5905remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
            if (layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                LayoutNode.requestRemeasure$ui_release$default(parent$ui_release, false, false, false, 3, null);
                return m5905remeasure_Sx5XlM$ui_release$default;
            }
    ...
    public final void m5942measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m5940doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m6929boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m5941doRemeasuresdFAvZA(layoutNode, Constraints.m6929boximpl(constraints));
    ...
    public final void registerOnLayoutCompletedListener(Owner.OnLayoutCompletedListener r1) {
        this.onLayoutCompletedListeners.add(r1);
    }
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (affectsLookahead) {
            z = layoutNode.getLookaheadMeasurePending$ui_release() ? m5940doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            ...
            boolean m5941doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m5941doRemeasuresdFAvZA(layoutNode, constraints) : false;
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m5940doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m5941doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    /* compiled from: MeasureAndLayoutDelegate.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u0007\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0005¢\u0006\u0002\u0010\u0007R\u0011\u0010\u0006\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\bR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Landroidx/compose/ui/node/MeasureAndLayoutDelegate$PostponedRequest;", "", "node", "Landroidx/compose/ui/node/LayoutNode;", "isLookahead", "", "isForced", "(Landroidx/compose/ui/node/LayoutNode;ZZ)V", "()Z", "getNode", "()Landroidx/compose/ui/node/LayoutNode;", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
