...
public final class NodeKindKt {
    ...
    public static final boolean m6002contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m6004or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m5994constructorimpl = NodeKind.m5994constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(131072);
        }
        if (node instanceof TraversableNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(262144);
        }
        if (node instanceof BringIntoViewModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(524288);
        }
        if (node instanceof OnUnplacedModifierNode) {
            m5994constructorimpl |= NodeKind.m5994constructorimpl(1048576);
        }
        mutableObjectIntMap.set(classKeyForObject, m5994constructorimpl);
        return m5994constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m5994constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m5854requireCoordinator64DMado(node, NodeKind.m5994constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m5994constructorimpl(128) & i) != 0 && (node instanceof LayoutAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m5994constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode) && i2 != 2) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m5994constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m5994constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).setSemanticsInvalidated$ui_release(true);
            }
            if ((NodeKind.m5994constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m5994constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m5994constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m6003getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m5994constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return element instanceof BringIntoViewModifierNode ? NodeKind.m5994constructorimpl(524288) | m5994constructorimpl : m5994constructorimpl;
    }
}
