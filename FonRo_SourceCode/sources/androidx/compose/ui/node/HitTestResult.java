...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ Object m5894removeFirst() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public /* bridge */ /* synthetic */ Object m5895removeLast() {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final boolean hasHit() {
        long m5893findBestHitDistancefn2tFes = m5893findBestHitDistancefn2tFes();
        return DistanceAndFlags.m5874getDistanceimpl(m5893findBestHitDistancefn2tFes) < 0.0f && DistanceAndFlags.m5877isInLayerimpl(m5893findBestHitDistancefn2tFes) && !DistanceAndFlags.m5876isInExpandedBoundsimpl(m5893findBestHitDistancefn2tFes);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndFlags.m5870compareTo9YPOF3E(m5893findBestHitDistancefn2tFes(), HitTestResultKt.DistanceAndFlags$default(distanceFromEdge, isInLayer, false, 4, null)) > 0;
    }

    /* renamed from: findBestHitDistance-fn2tFes */
    private final long m5893findBestHitDistancefn2tFes() {
        ...
        if (i <= lastIndex) {
            while (true) {
                long m5871constructorimpl = DistanceAndFlags.m5871constructorimpl(this.distanceFromEdgeAndFlags.get(i));
                if (DistanceAndFlags.m5870compareTo9YPOF3E(m5871constructorimpl, DistanceAndFlags$default) < 0) {
                    DistanceAndFlags$default = m5871constructorimpl;
                }
                if ((DistanceAndFlags.m5874getDistanceimpl(DistanceAndFlags$default) < 0.0f && DistanceAndFlags.m5877isInLayerimpl(DistanceAndFlags$default)) || i == lastIndex) {
                    break;
                }
                i++;
            }
    ...
    public final void hitExpandedTouchBounds(Modifier.Node node, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (!DistanceAndFlags.m5876isInExpandedBoundsimpl(m5893findBestHitDistancefn2tFes)) {
            if (DistanceAndFlags.m5874getDistanceimpl(m5893findBestHitDistancefn2tFes) > 0.0f) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        if (this.hitDepth == CollectionsKt.getLastIndex(hitTestResult)) {
            ...
            childHitTest.invoke();
            this.hitDepth = i;
            if (this.hitDepth + 1 == CollectionsKt.getLastIndex(hitTestResult) || DistanceAndFlags.m5876isInExpandedBoundsimpl(m5893findBestHitDistancefn2tFes())) {
        ...
        childHitTest.invoke();
        this.hitDepth = i3;
        long m5893findBestHitDistancefn2tFes2 = m5893findBestHitDistancefn2tFes();
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndFlags.m5870compareTo9YPOF3E(m5893findBestHitDistancefn2tFes, m5893findBestHitDistancefn2tFes2) > 0) {
            int i4 = i2 + 1;
            boolean m5876isInExpandedBoundsimpl = DistanceAndFlags.m5876isInExpandedBoundsimpl(m5893findBestHitDistancefn2tFes2);
            int i5 = this.hitDepth;
            removeNodesInRange(i4, m5876isInExpandedBoundsimpl ? i5 + 2 : i5 + 1);
        } else {
            removeNodesInRange(this.hitDepth + 1, size());
        }
        this.hitDepth = i2;
    ...
    @Override // java.util.List
    public Modifier.Node get(int r1) {
        Object obj = this.values.get(r1);
    ...
    public ListIterator<Modifier.Node> listIterator(int r8) {
        return new HitTestResultIterator(this, r8, 0, 0, 6, null);
    }
    ...
    /* compiled from: HitTestResult.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010*\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\n\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u0082\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B#\u0012\b\b\u0002\u0010\u0003\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0004\u0012\b\b\u0002\u0010\u0006\u001a\u00020\u0004¢\u0006\u0002\u0010\u0007J\t\u0010\u000e\u001a\u00020\u000fH\u0096\u0002J\b\u0010\u0010\u001a\u00020\u000fH\u0016J\t\u0010\u0011\u001a\u00020\u0002H\u0096\u0002J\b\u0010\u0012\u001a\u00020\u0004H\u0016J\b\u0010\u0013\u001a\u00020\u0002H\u0016J\b\u0010\u0014\u001a\u00020\u0004H\u0016R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR\u0011\u0010\u0006\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\tR\u0011\u0010\u0005\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\t¨\u0006\u0015"}, d2 = {"Landroidx/compose/ui/node/HitTestResult$HitTestResultIterator;", "", "Landroidx/compose/ui/Modifier$Node;", FirebaseAnalytics.Param.INDEX, "", "minIndex", "maxIndex", "(Landroidx/compose/ui/node/HitTestResult;III)V", "getIndex", "()I", "setIndex", "(I)V", "getMaxIndex", "getMinIndex", "hasNext", "", "hasPrevious", "next", "nextIndex", "previous", "previousIndex", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    private final class SubList implements List<Modifier.Node>, KMappedMarker {
        ...
        /* renamed from: removeFirst */
        public /* bridge */ /* synthetic */ Object m5896removeFirst() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* renamed from: removeLast */
        public /* bridge */ /* synthetic */ Object m5897removeLast() {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @Override // java.util.List
        public Modifier.Node get(int r2) {
            E e = HitTestResult.this.values.get(r2 + this.minIndex);
            Intrinsics.checkNotNull(e, "null cannot be cast to non-null type androidx.compose.ui.Modifier.Node");
            return (Modifier.Node) e;
        }
        ...
        @Override // java.util.List
        public ListIterator<Modifier.Node> listIterator(int r4) {
            HitTestResult hitTestResult = HitTestResult.this;
            int i = this.minIndex;
            return new HitTestResultIterator(r4 + i, i, this.maxIndex);
        }
