...
public final class LazyWindowInfo implements WindowInfo {
    ...
    public void m6151setKeyboardModifiers5xRPYO0(int i) {
        WindowInfoImpl.INSTANCE.getGlobalKeyboardModifiers$ui_release().setValue(PointerKeyboardModifiers.m5668boximpl(i));
    }
    ...
    public long mo6149getContainerSizeYbymL2g() {
        ...
        if (mutableState == null) {
            ...
            mutableState = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m7152boximpl(function0 != null ? function0.invoke().m7164unboximpl() : IntSize.INSTANCE.m7165getZeroYbymL2g()), null, 2, null);
            this._containerSize = mutableState;
