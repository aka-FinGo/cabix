...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo1127onPreScrollOzD1aCk(long available, int source) {
        int m6169getScrollAxesk4lQ0M;
        int m6171toViewTypeGyEprt8;
        int m6171toViewTypeGyEprt82;
        long m6170toOffsetUv8p0NA;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        m6169getScrollAxesk4lQ0M = NestedScrollInteropConnectionKt.m6169getScrollAxesk4lQ0M(available);
        m6171toViewTypeGyEprt8 = NestedScrollInteropConnectionKt.m6171toViewTypeGyEprt8(source);
        if (nestedScrollingChildHelper.startNestedScroll(m6169getScrollAxesk4lQ0M, m6171toViewTypeGyEprt8)) {
            ...
            m6171toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m6171toViewTypeGyEprt8(source);
            nestedScrollingChildHelper2.dispatchNestedPreScroll(composeToViewOffset, composeToViewOffset2, iArr, null, m6171toViewTypeGyEprt82);
            m6170toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m6170toOffsetUv8p0NA(this.consumedScrollCache, available);
            return m6170toOffsetUv8p0NA;
        }
    ...
    public long mo821onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (nestedScrollingChildHelper.startNestedScroll(m6169getScrollAxesk4lQ0M, m6171toViewTypeGyEprt8)) {
            ...
            m6171toViewTypeGyEprt82 = NestedScrollInteropConnectionKt.m6171toViewTypeGyEprt8(source);
            nestedScrollingChildHelper2.dispatchNestedScroll(composeToViewOffset, composeToViewOffset2, composeToViewOffset3, composeToViewOffset4, null, m6171toViewTypeGyEprt82, this.consumedScrollCache);
            m6170toOffsetUv8p0NA = NestedScrollInteropConnectionKt.m6170toOffsetUv8p0NA(this.consumedScrollCache, available);
            return m6170toOffsetUv8p0NA;
        }
        return Offset.INSTANCE.m4141getZeroF1C5BW0();
    ...
    public Object mo1126onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        float viewVelocity;
        float viewVelocity2;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7227getXimpl(j));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7228getYimpl(j));
        if (!nestedScrollingChildHelper.dispatchNestedPreFling(viewVelocity, viewVelocity2)) {
            j = Velocity.INSTANCE.m7238getZero9UxMQ8M();
        }
    ...
    public Object mo820onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        float viewVelocity;
        float viewVelocity2;
        NestedScrollingChildHelper nestedScrollingChildHelper = this.nestedScrollChildHelper;
        viewVelocity = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7227getXimpl(j2));
        viewVelocity2 = NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m7228getYimpl(j2));
        if (!nestedScrollingChildHelper.dispatchNestedFling(viewVelocity, viewVelocity2, true)) {
            j2 = Velocity.INSTANCE.m7238getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m7218boximpl(j2);
    }
