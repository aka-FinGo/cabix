...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope, OnApplyWindowInsetsListener {
    ...
    public AndroidViewHolder(Context context, CompositionContext compositionContext, int i, NestedScrollDispatcher nestedScrollDispatcher, View view, Owner owner) {
        ...
        final Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(DrawModifierKt.drawBehind(GraphicsLayerModifierKt.m4544graphicsLayerAp8cVGQ$default(PointerInteropFilter_androidKt.pointerInteropFilter(SemanticsModifierKt.semantics(NestedScrollModifierKt.nestedScroll(companion, androidViewHolder_androidKt$NoOpScrollConnection$1, this.dispatcher), true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$coreModifier$1
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            ...
            public final void invoke2(LayoutCoordinates layoutCoordinates) {
                ...
                AndroidViewHolder.this.size = layoutCoordinates.mo5740getSizeYbymL2g();
                ...
                if (windowInsetsCompat != null) {
                    ...
                    if (i2 == iArr4[0]) {
                        ...
                        if (i3 == iArr5[1]) {
                            ...
                            if (IntSize.m7158equalsimpl0(j, j2)) {
                                return;
                            }
                        }
                    }
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.layout$default(measureScope, Constraints.m6944getMinWidthimpl(j), Constraints.m6943getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m6944getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m6944getMinWidthimpl(j));
                }
                if (Constraints.m6943getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m6943getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder2.obtainMeasureSpec(m6944getMinWidthimpl, m6942getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder3 = AndroidViewHolder.this;
                ...
                obtainMeasureSpec2 = androidViewHolder3.obtainMeasureSpec(m6943getMinHeightimpl, m6941getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(composeOffset2) & 4294967295L) | (Float.floatToRawIntBits(composeOffset) << 32));
            ...
            long m4117constructorimpl2 = Offset.m4117constructorimpl((Float.floatToRawIntBits(composeOffset4) & 4294967295L) | (Float.floatToRawIntBits(composeOffset3) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long m5482dispatchPostScrollDzOQY0M = nestedScrollDispatcher.m5482dispatchPostScrollDzOQY0M(m4117constructorimpl, m4117constructorimpl2, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5482dispatchPostScrollDzOQY0M >> 32)));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5482dispatchPostScrollDzOQY0M & 4294967295L)));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4117constructorimpl2 = Offset.m4117constructorimpl((Float.floatToRawIntBits(composeOffset4) & 4294967295L) | (Float.floatToRawIntBits(composeOffset3) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m5482dispatchPostScrollDzOQY0M(m4117constructorimpl, m4117constructorimpl2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(composeOffset2) & 4294967295L) | (Float.floatToRawIntBits(composeOffset) << 32));
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long m5484dispatchPreScrollOzD1aCk = nestedScrollDispatcher.m5484dispatchPreScrollOzD1aCk(m4117constructorimpl, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5484dispatchPreScrollOzD1aCk >> 32)));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Float.intBitsToFloat((int) (m5484dispatchPreScrollOzD1aCk & 4294967295L)));
        }
    }
    ...
    public final WindowInsetsCompat insetToLayoutPosition(WindowInsetsCompat insets) {
        if (insets.hasInsets()) {
            ...
            if (innerCoordinator$ui_release.isAttached()) {
                ...
                long m7134roundk4lQ0M = IntOffsetKt.m7134roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(nodeCoordinator));
                int m7117getXimpl = IntOffset.m7117getXimpl(m7134roundk4lQ0M);
                if (m7117getXimpl < 0) {
                    m7117getXimpl = 0;
                }
                int m7118getYimpl = IntOffset.m7118getYimpl(m7134roundk4lQ0M);
                if (m7118getYimpl < 0) {
                    m7118getYimpl = 0;
                }
                long mo5740getSizeYbymL2g = LayoutCoordinatesKt.findRootCoordinates(nodeCoordinator).mo5740getSizeYbymL2g();
                int i = (int) (mo5740getSizeYbymL2g >> 32);
                int i2 = (int) (mo5740getSizeYbymL2g & 4294967295L);
                long mo5740getSizeYbymL2g2 = innerCoordinator$ui_release.mo5740getSizeYbymL2g();
                long m7134roundk4lQ0M2 = IntOffsetKt.m7134roundk4lQ0M(innerCoordinator$ui_release.mo5743localToRootMKHz9U(Offset.m4117constructorimpl((Float.floatToRawIntBits((int) (mo5740getSizeYbymL2g2 & 4294967295L)) & 4294967295L) | (Float.floatToRawIntBits((int) (mo5740getSizeYbymL2g2 >> 32)) << 32))));
                int m7117getXimpl2 = i - IntOffset.m7117getXimpl(m7134roundk4lQ0M2);
                if (m7117getXimpl2 < 0) {
                    m7117getXimpl2 = 0;
                }
                int m7118getYimpl2 = i2 - IntOffset.m7118getYimpl(m7134roundk4lQ0M2);
                int i3 = m7118getYimpl2 >= 0 ? m7118getYimpl2 : 0;
                if (m7117getXimpl != 0 || m7118getYimpl != 0 || m7117getXimpl2 != 0 || i3 != 0) {
                    return insets.inset(m7117getXimpl, m7118getYimpl, m7117getXimpl2, i3);
                }
            }
        }
        return insets;
    ...
    private final <T> T insetValue(T value, Function4<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> block) {
        ...
        if (innerCoordinator$ui_release.isAttached()) {
            ...
            int i3 = m7118getYimpl2 >= 0 ? m7118getYimpl2 : 0;
            if (m7117getXimpl != 0 || m7118getYimpl != 0 || m7117getXimpl2 != 0 || i3 != 0) {
                return block.invoke(Integer.valueOf(m7117getXimpl), Integer.valueOf(m7118getYimpl), Integer.valueOf(m7117getXimpl2), Integer.valueOf(i3));
            }
        }
        return value;
    }
    ...
    public final WindowInsetsAnimationCompat.BoundsCompat insetBounds(WindowInsetsAnimationCompat.BoundsCompat bounds) {
        ...
        if (innerCoordinator$ui_release.isAttached()) {
            ...
            int i3 = m7118getYimpl2 >= 0 ? m7118getYimpl2 : 0;
            if (m7117getXimpl != 0 || m7118getYimpl != 0 || m7117getXimpl2 != 0 || i3 != 0) {
                int i4 = m7117getXimpl;
                int i5 = i3;
                return new WindowInsetsAnimationCompat.BoundsCompat(inset(bounds.getLowerBound(), i4, m7118getYimpl, m7117getXimpl2, i5), inset(bounds.getUpperBound(), i4, m7118getYimpl, m7117getXimpl2, i5));
            }
        }
        return bounds;
    }
