...
final class CommonRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        ...
        if (Float.isNaN(this.radius)) {
            f = RippleAnimationKt.m1845getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo4935getSizeNHjbRc());
        } else {
            f = contentDrawScope.mo700toPx0680j_4(this.radius);
        }
        this.targetRadius = f;
        ...
        m1842drawRipples4WTKRHQ(contentDrawScope2, m4394unboximpl);
    }
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(this.bounded ? Offset.m4114boximpl(interaction.getPressPosition()) : null, this.targetRadius, this.bounded, null);
    ...
    private final void m1842drawRipples4WTKRHQ(DrawScope drawScope, long j) {
        long j2;
        Iterator<Map.Entry<PressInteraction.Press, RippleAnimation>> it = this.ripples.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (pressedAlpha == 0.0f) {
                ...
                j2 = j;
                value.m1844draw4WTKRHQ(drawScope, Color.m4383copywmQWz5c$default(j2, pressedAlpha, 0.0f, 0.0f, 0.0f, 14, null));
            }
            j = j2;
        }
    }
