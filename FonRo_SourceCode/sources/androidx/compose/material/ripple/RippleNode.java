...
public abstract class RippleNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, DrawModifierNode, LayoutAwareModifierNode {
    ...
    public abstract void mo1840addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius);
    ...
    private RippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.rippleSize = Size.INSTANCE.m4203getZeroNHjbRc();
    ...
    public final long m1852getRippleColor0d7_KjU() {
        return this.color.mo2165invoke0d7_KjU();
    }
    ...
    public void mo688onRemeasuredozmzZPI(long size) {
        ...
        this.rippleSize = IntSizeKt.m7172toSizeozmzZPI(size);
        if (Float.isNaN(this.radius)) {
            mo700toPx0680j_4 = RippleAnimationKt.m1845getRippleEndRadiuscSwnlzA(requireDensity, this.bounded, this.rippleSize);
        } else {
            mo700toPx0680j_4 = requireDensity.mo700toPx0680j_4(this.radius);
        }
        this.targetRadius = mo700toPx0680j_4;
    ...
    public final void handlePressInteraction(PressInteraction pressInteraction) {
        if (pressInteraction instanceof PressInteraction.Press) {
            mo1840addRipple12SF9DM((PressInteraction.Press) pressInteraction, this.rippleSize, this.targetRadius);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (stateLayer != null) {
            stateLayer.m1857drawStateLayermxwnekA(contentDrawScope, this.targetRadius, m1852getRippleColor0d7_KjU());
        }
