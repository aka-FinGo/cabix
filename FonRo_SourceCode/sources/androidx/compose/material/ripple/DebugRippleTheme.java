...
public final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1843defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1855defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1855defaultRippleColor5vOe2sY(Color.INSTANCE.m4410getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1855defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1854defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1854defaultRippleAlphaDxMtmZc(Color.INSTANCE.m4410getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m1854defaultRippleAlphaDxMtmZc;
    }
}
