...
public final class AndroidRippleNode extends RippleNode implements RippleHostKey {
    ...
    public void mo1840addRipple12SF9DM(PressInteraction.Press interaction, long size, float targetRadius) {
        RippleHostView rippleHostView = getOrCreateRippleContainer().getRippleHostView(this);
        rippleHostView.m1847addRippleKOepWvA(interaction, getBounded(), size, MathKt.roundToInt(targetRadius), m1852getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha(), new Function0<Unit>() { // from class: androidx.compose.material.ripple.AndroidRippleNode$addRipple$1$1$1
    ...
    public void drawRipples(DrawScope drawScope) {
        ...
        RippleHostView rippleHostView = this.rippleHostView;
        if (rippleHostView != null) {
            rippleHostView.m1848setRipplePropertiesbiQXAtU(getRippleSize(), MathKt.roundToInt(getTargetRadius()), m1852getRippleColor0d7_KjU(), getRippleAlpha().invoke().getPressedAlpha());
