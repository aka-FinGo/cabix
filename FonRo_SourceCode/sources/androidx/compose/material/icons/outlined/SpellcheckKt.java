...
public final class SpellcheckKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSpellcheck(androidx.compose.material.icons.Icons.Outlined r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1095185203(0x41473333, float:12.45)
            r4 = 1098907648(0x41800000, float:16.0)
            r0.moveTo(r2, r4)
            r2 = 1074119311(0x4005c28f, float:2.09)
            r0.horizontalLineToRelative(r2)
            r6 = 1092018504(0x4116e148, float:9.43)
            r7 = 1077936128(0x40400000, float:3.0)
            r0.lineTo(r6, r7)
            r6 = 1089617265(0x40f23d71, float:7.57)
            r0.lineTo(r6, r7)
            r6 = 1075671204(0x401d70a4, float:2.46)
            r0.lineTo(r6, r4)
            r0.horizontalLineToRelative(r2)
            ...
            r0.horizontalLineToRelative(r2)
            r2 = 1066527621(0x3f91eb85, float:1.14)
            r0.lineToRelative(r2, r7)
            r0.close()
            r2 = 1087226511(0x40cdc28f, float:6.43)
            r6 = 1093664768(0x41300000, float:11.0)
            r0.moveTo(r2, r6)
            r7 = 1091043328(0x41080000, float:8.5)
            r8 = 1085234217(0x40af5c29, float:5.48)
            r0.lineTo(r7, r8)
            r7 = 1093213880(0x41291eb8, float:10.57)
            r0.lineTo(r7, r6)
            r0.lineTo(r2, r6)
            r0.close()
            r2 = 1101838418(0x41acb852, float:21.59)
            r6 = 1094283428(0x413970a4, float:11.59)
            r0.moveTo(r2, r6)
            r2 = -1056870236(0xffffffffc10170a4, float:-8.09)
            r6 = 1090613412(0x410170a4, float:8.09)
            r0.lineToRelative(r2, r6)
            ...
            r2 = 1084416328(0x40a2e148, float:5.09)
