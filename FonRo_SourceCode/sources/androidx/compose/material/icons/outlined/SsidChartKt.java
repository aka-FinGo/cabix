...
public final class SsidChartKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSsidChart(androidx.compose.material.icons.Icons.Outlined r18) {
        /*
        ...
        L8:
            ...
            r4 = 1085213245(0x40af0a3d, float:5.47)
            r0.moveTo(r2, r4)
            r6 = 1094713344(0x41400000, float:12.0)
            r0.lineTo(r6, r6)
            r6 = 1089722122(0x40f3d70a, float:7.62)
            r0.lineTo(r6, r6)
            r6 = 1093664768(0x41300000, float:11.0)
            r7 = 1077936128(0x40400000, float:3.0)
            r0.lineTo(r7, r6)
            r6 = 1091064300(0x410851ec, float:8.52)
            ...
            r0.moveTo(r2, r4)
            r2 = -1063885210(0xffffffffc0966666, float:-4.7)
            r0.horizontalLineToRelative(r2)
            r2 = -1064996700(0xffffffffc08570a4, float:-4.17)
            r6 = 1079362191(0x4055c28f, float:3.34)
            r0.lineToRelative(r2, r6)
            r2 = 1095143260(0x41468f5c, float:12.41)
            r6 = 1086324736(0x40c00000, float:6.0)
            r0.lineTo(r6, r2)
            r2 = -1069547520(0xffffffffc0400000, float:-3.0)
            r9 = 1074287084(0x400851ec, float:2.13)
            r0.lineToRelative(r2, r9)
            r2 = 1099431936(0x41880000, float:17.0)
            r0.lineTo(r7, r2)
            r2 = 1077097267(0x40333333, float:2.8)
            r7 = -1073741824(0xffffffffc0000000, float:-2.0)
            r0.lineToRelative(r2, r7)
            r2 = 1086744166(0x40c66666, float:6.2)
            r0.lineToRelative(r2, r6)
