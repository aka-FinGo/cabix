...
public final class ForkLeftKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        Caused by: java.util.ConcurrentModificationException
        	...
        	... 1 more
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getForkLeft(androidx.compose.material.icons.Icons.Outlined r19) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.ForkLeftKt._forkLeft
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.ForkLeft"
            ...
            r8 = 1090162524(0x40fa8f5c, float:7.83)
            r9 = 1094713344(0x41400000, float:12.0)
            r12.lineTo(r8, r9)
            r17 = 1084584100(0x40a570a4, float:5.17)
            r18 = 1068373115(0x3fae147b, float:1.36)
            r13 = 1069631406(0x3fc147ae, float:1.51)
            r14 = -1096223293(0xffffffffbea8f5c3, float:-0.33)
            r15 = 1080997970(0x406eb852, float:3.73)
            r16 = 1034147594(0x3da3d70a, float:0.08)
            r12.curveToRelative(r13, r14, r15, r16, r17, r18)
            r8 = -1060047421(0xffffffffc0d0f5c3, float:-6.53)
            r9 = 0
            r12.lineToRelative(r9, r8)
            r8 = -1077181153(0xffffffffbfcb851f, float:-1.59)
            r13 = 1070302495(0x3fcb851f, float:1.59)
            r12.lineToRelative(r8, r13)
            r8 = 1092616192(0x41200000, float:10.0)
            r13 = 1088421888(0x40e00000, float:7.0)
            r12.lineTo(r8, r13)
            r12.lineToRelative(r6, r4)
            r12.lineToRelative(r6, r6)
            r6 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r12.lineToRelative(r6, r7)
            r6 = 1097859072(0x41700000, float:15.0)
            r7 = 1088065372(0x40da8f5c, float:6.83)
            r12.lineTo(r6, r7)
            r6 = 1101529088(0x41a80000, float:21.0)
            r12.verticalLineTo(r6)
            r6 = -1073741824(0xffffffffc0000000, float:-2.0)
            r12.lineToRelative(r6, r9)
            r12.verticalLineToRelative(r4)
            r17 = -1062899548(0xffffffffc0a570a4, float:-5.17)
            r18 = -1069547520(0xffffffffc0400000, float:-3.0)
            r13 = -1086660280(0xffffffffbf3ae148, float:-0.73)
            r14 = -1071309128(0xffffffffc0251eb8, float:-2.58)
            r15 = -1069253919(0xffffffffc0447ae1, float:-3.07)
            r16 = -1067576197(0xffffffffc05e147b, float:-3.47)
            r12.curveToRelative(r13, r14, r15, r16, r17, r18)
            r12.lineTo(r0, r2)
            r12.close()
            ...
            androidx.compose.material.icons.outlined.ForkLeftKt._forkLeft = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
