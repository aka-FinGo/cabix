...
public final class NetworkPingKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getNetworkPing(androidx.compose.material.icons.Icons.Outlined r19) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.NetworkPingKt._networkPing
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.NetworkPing"
            ...
            r12.moveTo(r0, r2)
            r4 = 1079655793(0x405a3d71, float:3.41)
            r6 = 1086513480(0x40c2e148, float:6.09)
            r12.lineTo(r4, r6)
            ...
            r12.horizontalLineToRelative(r6)
            r6 = 1084542157(0x40a4cccd, float:5.15)
            r7 = -1062941491(0xffffffffc0a4cccd, float:-5.15)
            r12.lineToRelative(r6, r7)
            r17 = 1100742656(0x419c0000, float:19.5)
            r18 = 1093664768(0x41300000, float:11.0)
            r13 = 1100433326(0x419747ae, float:18.91)
            r14 = 1093612339(0x412f3333, float:10.95)
            r15 = 1100585370(0x4199999a, float:19.2)
            r16 = 1093664768(0x41300000, float:11.0)
            r12.curveTo(r13, r14, r15, r16, r17, r18)
            r17 = 1075838976(0x40200000, float:2.5)
            r18 = -1071644672(0xffffffffc0200000, float:-2.5)
            r13 = 1068540887(0x3fb0a3d7, float:1.38)
            r14 = 0
            ...
            r6 = 1101466173(0x41a70a3d, float:20.88)
            r7 = 1100742656(0x419c0000, float:19.5)
            r8 = 1086324736(0x40c00000, float:6.0)
            r12.reflectiveCurveTo(r6, r8, r7, r8)
            r6 = 1088673546(0x40e3d70a, float:7.12)
            r7 = 1099431936(0x41880000, float:17.0)
            r12.reflectiveCurveTo(r7, r6, r7, r4)
            r17 = 1045220557(0x3e4ccccd, float:0.2)
            r18 = 1064849900(0x3f7851ec, float:0.97)
            r13 = 0
            ...
            androidx.compose.material.icons.outlined.NetworkPingKt._networkPing = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
