...
public final class SquareFootKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getSquareFoot(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1099777966(0x418d47ae, float:17.66)
            r0.moveTo(r2, r2)
            r4 = -1081627116(0xffffffffbf87ae14, float:-1.06)
            r6 = 1065856532(0x3f87ae14, float:1.06)
            r0.lineToRelative(r4, r6)
            r7 = -1086995825(0xffffffffbf35c28f, float:-0.71)
            r0.lineToRelative(r7, r7)
            r0.lineToRelative(r6, r4)
            r8 = -1074245140(0xffffffffbff851ec, float:-1.94)
            ...
            r0.lineToRelative(r7, r7)
            r0.lineToRelative(r6, r4)
            r8 = 1092301619(0x411b3333, float:9.7)
            r0.lineTo(r8, r8)
            r0.lineToRelative(r4, r6)
            r0.lineToRelative(r7, r7)
            r0.lineToRelative(r6, r4)
            r7 = 1088526746(0x40e1999a, float:7.05)
            r0.lineTo(r7, r7)
            r7 = 1086303764(0x40bfae14, float:5.99)
            r8 = 1090634383(0x4101c28f, float:8.11)
            r0.lineTo(r7, r8)
            r7 = 1084814787(0x40a8f5c3, float:5.28)
            r8 = 1089260749(0x40eccccd, float:7.4)
            r0.lineTo(r7, r8)
            r0.lineToRelative(r6, r4)
            ...
            r0.moveTo(r2, r4)
            r6 = -1061662228(0xffffffffc0b851ec, float:-5.76)
            r0.verticalLineToRelative(r6)
            r6 = 1095510262(0x414c28f6, float:12.76)
            r0.lineTo(r6, r4)
