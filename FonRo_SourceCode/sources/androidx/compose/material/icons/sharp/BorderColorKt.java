...
public final class BorderColorKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getBorderColor(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r2.horizontalLineTo(r4)
            r4 = -1065353216(0xffffffffc0800000, float:-4.0)
            r2.verticalLineToRelative(r4)
            r4 = 1101004800(0x41a00000, float:20.0)
            r2.horizontalLineToRelative(r4)
            r2.verticalLineTo(r0)
            r2.close()
            r0 = 1095824835(0x4150f5c3, float:13.06)
            r4 = 1084626043(0x40a6147b, float:5.19)
            r2.moveTo(r0, r4)
            r6 = 1081081856(0x40700000, float:3.75)
            r2.lineToRelative(r6, r6)
            r7 = 1089994752(0x40f80000, float:7.75)
            r8 = 1099956224(0x41900000, float:18.0)
            r2.lineTo(r7, r8)
            r7 = 1082130432(0x40800000, float:4.0)
            r2.horizontalLineTo(r7)
            r7 = -1066401792(0xffffffffc0700000, float:-3.75)
            r2.verticalLineToRelative(r7)
            r2.lineTo(r0, r4)
            r2.close()
            r0 = 1099893309(0x418f0a3d, float:17.88)
            r4 = 1090246410(0x40fbd70a, float:7.87)
            r2.moveTo(r0, r4)
            r2.lineToRelative(r7, r7)
            r7 = 1075964805(0x4021eb85, float:2.53)
            r8 = -1071476900(0xffffffffc0228f5c, float:-2.54)
