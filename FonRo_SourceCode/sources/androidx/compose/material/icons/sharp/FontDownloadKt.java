...
public final class FontDownloadKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFontDownload(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1092542792(0x411ee148, float:9.93)
            r4 = 1096286208(0x41580000, float:13.5)
            r0.moveTo(r2, r4)
            r6 = 1082424033(0x40847ae1, float:4.14)
            r0.horizontalLineToRelative(r6)
            r6 = 1094713344(0x41400000, float:12.0)
            r7 = 1090477097(0x40ff5c29, float:7.98)
            r0.lineTo(r6, r7)
            r0.lineTo(r2, r4)
            r0.close()
            ...
            r0.lineTo(r2, r4)
            r0.close()
            r2 = 1098855219(0x417f3333, float:15.95)
            r4 = 1100218368(0x41940000, float:18.5)
            r0.moveTo(r2, r4)
            r2 = -1080956027(0xffffffffbf91eb85, float:-1.14)
            ...
            r0.lineToRelative(r2, r6)
            r2 = 1086240850(0x40beb852, float:5.96)
            r0.lineTo(r2, r4)
            r2 = -1051721728(0xffffffffc1500000, float:-13.0)
            r4 = 1084458271(0x40a3851f, float:5.11)
            r0.lineToRelative(r4, r2)
            r2 = 1072567419(0x3fee147b, float:1.86)
            r0.horizontalLineToRelative(r2)
            r2 = 1095761920(0x41500000, float:13.0)
            r0.lineToRelative(r4, r2)
            r2 = -1073364337(0xffffffffc005c28f, float:-2.09)
            r0.horizontalLineToRelative(r2)
            r0.close()
