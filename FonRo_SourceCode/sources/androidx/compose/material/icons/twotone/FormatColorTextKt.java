...
public final class FormatColorTextKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFormatColorText(androidx.compose.material.icons.Icons.TwoTone r18) {
        /*
        ...
        L8:
            ...
            r0.close()
            r2 = 1085255188(0x40afae14, float:5.49)
            r4 = 1099431936(0x41880000, float:17.0)
            r0.moveTo(r2, r4)
            r6 = 1075503432(0x401ae148, float:2.42)
            r0.horizontalLineToRelative(r6)
            r7 = 1067618140(0x3fa28f5c, float:1.27)
            r8 = -1067114824(0xffffffffc0651eb8, float:-3.58)
            r0.lineToRelative(r7, r8)
            r7 = 1085590733(0x40b4cccd, float:5.65)
            r0.horizontalLineToRelative(r7)
            r7 = 1098954834(0x4180b852, float:16.09)
            r0.lineTo(r7, r4)
            r0.horizontalLineToRelative(r6)
            ...
            r0.lineTo(r2, r4)
            r0.close()
            r2 = 1094073713(0x41363d71, float:11.39)
            r4 = 1092521820(0x411e8f5c, float:9.91)
            r0.moveTo(r4, r2)
            r2 = -1061599314(0xffffffffc0b947ae, float:-5.79)
            r6 = 1073867653(0x4001eb85, float:2.03)
            r0.lineToRelative(r6, r2)
            r2 = 1039516303(0x3df5c28f, float:0.12)
            r0.horizontalLineToRelative(r2)
            r2 = 1085884334(0x40b947ae, float:5.79)
            r0.lineToRelative(r6, r2)
