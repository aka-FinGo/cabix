...
public final class UnfoldMoreDoubleKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getUnfoldMoreDouble(androidx.compose.material.icons.Icons.TwoTone r18) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.UnfoldMoreDoubleKt._unfoldMoreDouble
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.UnfoldMoreDouble"
            ...
            r6 = 1090162524(0x40fa8f5c, float:7.83)
            r2.moveTo(r4, r6)
            r7 = 1098037330(0x4172b852, float:15.17)
            r8 = 1093664768(0x41300000, float:11.0)
            r2.lineTo(r7, r8)
            r9 = 1068792545(0x3fb47ae1, float:1.41)
            r12 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r2.lineToRelative(r9, r12)
            r13 = 1084227584(0x40a00000, float:5.0)
            r2.lineTo(r4, r13)
            r13 = 1092186276(0x411970a4, float:9.59)
            r14 = 1089281720(0x40ed1eb8, float:7.41)
            r2.lineTo(r14, r13)
            r13 = 1091389358(0x410d47ae, float:8.83)
            r2.lineTo(r13, r8)
            r2.lineTo(r4, r6)
            r2.close()
            ...
            r15 = 0
            r2.lineTo(r4, r15)
            r15 = 1083367752(0x4092e148, float:4.59)
            r2.lineTo(r14, r15)
            r2.lineTo(r13, r8)
            r2.lineTo(r4, r6)
            r2.close()
            r6 = 1101618217(0x41a95c29, float:21.17)
            r2.moveTo(r4, r6)
            r8 = 1099956224(0x41900000, float:18.0)
            r2.lineTo(r13, r8)
            r2.lineToRelative(r12, r9)
            r2.lineTo(r4, r0)
            r0 = -1064115896(0xffffffffc092e148, float:-4.59)
            r2.lineToRelative(r15, r0)
            r2.lineTo(r7, r8)
            r2.lineTo(r4, r6)
            r2.close()
            ...
            androidx.compose.material.icons.twotone.UnfoldMoreDoubleKt._unfoldMoreDouble = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
