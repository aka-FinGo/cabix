...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> mutableInsertEntryAt(int positionMask, K key, V value, MutabilityOwnership owner) {
        ...
        if (mutabilityOwnership == owner) {
            this.buffer = TrieNodeKt.access$insertEntryAtIndex(objArr, entryKeyIndex$runtime_release, key, value);
            this.dataMap = positionMask | this.dataMap;
            return this;
        }
        return new TrieNode<>(positionMask | this.dataMap, this.nodeMap, TrieNodeKt.access$insertEntryAtIndex(objArr, entryKeyIndex$runtime_release, key, value), owner);
    }
    ...
    private final TrieNode<K, V> mutableRemoveEntryAtIndex(int keyIndex, int positionMask, PersistentHashMapBuilder<K, V> mutator) {
        ...
        return new TrieNode<>(positionMask ^ this.dataMap, this.nodeMap, TrieNodeKt.access$removeEntryAtIndex(objArr, keyIndex), mutator.getOwnership());
    }
    ...
    private final TrieNode<K, V> mutableCollisionRemoveEntryAtIndex(int i, PersistentHashMapBuilder<K, V> mutator) {
        ...
        return new TrieNode<>(0, 0, TrieNodeKt.access$removeEntryAtIndex(objArr, i), mutator.getOwnership());
    }
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m3921assert(this.nodeMap == 0);
        CommonFunctionsKt.m3921assert(this.dataMap == 0);
        CommonFunctionsKt.m3921assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m3921assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    public final TrieNode<K, V> mutableRemove(int keyHash, K key, V value, int shift, PersistentHashMapBuilder<K, V> mutator) {
        ...
        if (shift == 30) {
            ...
            persistentHashMapBuilder = mutator;
            mutableRemove = nodeAtIndex$runtime_release.mutableRemove(keyHash, key, value, shift + 5, persistentHashMapBuilder);
        }
