...
public final class SnapshotStateSet<T> implements StateObject, Set<T>, RandomAccess, KMutableSet {
    ...
    private final <R> R writable(Function1<? super StateSetStateRecord<T>, ? extends R> block) {
        Snapshot current;
        R invoke;
        StateRecord firstStateRecord = getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateSet.StateSetStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateSet>");
        ...
        synchronized (SnapshotKt.getLock()) {
            ...
            invoke = block.invoke(SnapshotKt.writableRecord(stateSetStateRecord, this, current));
        }
        SnapshotKt.notifyWrite(current, this);
        return invoke;
    }

    private final <R> R withCurrent(Function1<? super StateSetStateRecord<T>, ? extends R> block) {
        StateRecord firstStateRecord = getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateSet.StateSetStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateSet>");
        return block.invoke(SnapshotKt.current((StateSetStateRecord) firstStateRecord));
    }
    ...
    private final <R> R mutate(Function1<? super Set<T>, ? extends R> block) {
        ...
        do {
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, build);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return invoke;
    ...
    private final boolean conditionalUpdate(Function1<? super PersistentSet<? extends T>, ? extends PersistentSet<? extends T>> block) {
        ...
        do {
            ...
            PersistentSet<? extends T> invoke = block.invoke(set$runtime_release);
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, invoke);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return true;
    ...
    private final StateRecord stateRecordWith(PersistentSet<? extends T> set) {
    ...
    public boolean add(T element) {
        ...
        do {
            ...
            Intrinsics.checkNotNull(set$runtime_release);
            PersistentSet<? extends T> add = set$runtime_release.add((PersistentSet<T>) element);
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, add);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return true;
    ...
    public boolean addAll(Collection<? extends T> elements) {
        ...
        do {
            ...
            Intrinsics.checkNotNull(set$runtime_release);
            PersistentSet<? extends T> addAll = set$runtime_release.addAll(elements);
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, addAll);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return true;
    ...
    public boolean remove(Object element) {
        ...
        do {
            ...
            Intrinsics.checkNotNull(set$runtime_release);
            PersistentSet<? extends T> remove = set$runtime_release.remove((PersistentSet<T>) element);
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, remove);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return true;
    ...
    public boolean removeAll(Collection<? extends Object> elements) {
        ...
        do {
            ...
            Intrinsics.checkNotNull(set$runtime_release);
            PersistentSet<? extends T> removeAll = set$runtime_release.removeAll((Collection<? extends T>) elements);
            ...
            synchronized (SnapshotKt.getLock()) {
                current = Snapshot.INSTANCE.getCurrent();
                attemptUpdate = attemptUpdate((StateSetStateRecord) SnapshotKt.writableRecord(stateSetStateRecord2, this, current), modification, removeAll);
            }
            SnapshotKt.notifyWrite(current, this);
        } while (!attemptUpdate);
        return true;
