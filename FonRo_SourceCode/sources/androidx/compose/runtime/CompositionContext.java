...
public abstract class CompositionContext {
    ...
    public abstract ScatterSet<RecomposeScopeImpl> composeInitialPaused$runtime_release(ControlledComposition composition, ShouldPauseCallback shouldPause, Function2<? super Composer, ? super Integer, Unit> content);
    ...
    public abstract ScatterSet<RecomposeScopeImpl> recomposePaused$runtime_release(ControlledComposition composition, ShouldPauseCallback shouldPause, ScatterSet<RecomposeScopeImpl> invalidScopes);
    ...
    public abstract void reportPausedScope$runtime_release(RecomposeScopeImpl scope);
