...
public final class MovableContentState {
    ...
    public final ScatterMap<MovableContentStateReference, MovableContentState> extractNestedStates$runtime_release(Applier<?> applier, ObjectList<MovableContentStateReference> references) {
        ...
        ObjectList sortedBy = ExtensionsKt.sortedBy(references, new Function1<MovableContentStateReference, Integer>() { // from class: androidx.compose.runtime.MovableContentState$extractNestedStates$referencesToExtract$2
            ...
            public final Integer invoke(MovableContentStateReference movableContentStateReference) {
                return Integer.valueOf(MovableContentState.this.getSlotTable().anchorIndex(movableContentStateReference.getAnchor()));
            }
        });
        if (sortedBy.isEmpty()) {
