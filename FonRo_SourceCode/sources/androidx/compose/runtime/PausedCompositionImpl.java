    ...
    public boolean resume(ShouldPauseCallback shouldPause) {
        try {
            switch (WhenMappings.$EnumSwitchMapping$0[this.state.ordinal()]) {
                ...
                case 2:
                    ScatterSet<RecomposeScopeImpl> recomposePaused$runtime_release = this.context.recomposePaused$runtime_release(this.composition, shouldPause, this.invalidScopes);
