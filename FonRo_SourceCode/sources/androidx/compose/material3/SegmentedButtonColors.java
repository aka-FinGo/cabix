...
public final class SegmentedButtonColors {
    ...
    public static /* synthetic */ SegmentedButtonColors m2538copy2qZNXz8$default(SegmentedButtonColors segmentedButtonColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, int i, Object obj) {
        long j13;
        long j14;
    ...
    public final long m2539borderColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeBorderColor;
        }
        if (enabled && !active) {
    ...
    public final long m2541contentColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
        if (enabled && checked) {
            return this.activeContentColor;
        }
        if (enabled && !checked) {
    ...
    public final long m2540containerColorWaAFU9c$material3_release(boolean enabled, boolean active) {
        if (enabled && active) {
            return this.activeContainerColor;
        }
        if (enabled && !active) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4385equalsimpl0(this.activeBorderColor, segmentedButtonColors.activeBorderColor) && Color.m4385equalsimpl0(this.activeContentColor, segmentedButtonColors.activeContentColor) && Color.m4385equalsimpl0(this.activeContainerColor, segmentedButtonColors.activeContainerColor) && Color.m4385equalsimpl0(this.inactiveBorderColor, segmentedButtonColors.inactiveBorderColor) && Color.m4385equalsimpl0(this.inactiveContentColor, segmentedButtonColors.inactiveContentColor) && Color.m4385equalsimpl0(this.inactiveContainerColor, segmentedButtonColors.inactiveContainerColor) && Color.m4385equalsimpl0(this.disabledActiveBorderColor, segmentedButtonColors.disabledActiveBorderColor) && Color.m4385equalsimpl0(this.disabledActiveContentColor, segmentedButtonColors.disabledActiveContentColor) && Color.m4385equalsimpl0(this.disabledActiveContainerColor, segmentedButtonColors.disabledActiveContainerColor) && Color.m4385equalsimpl0(this.disabledInactiveBorderColor, segmentedButtonColors.disabledInactiveBorderColor) && Color.m4385equalsimpl0(this.disabledInactiveContentColor, segmentedButtonColors.disabledInactiveContentColor) && Color.m4385equalsimpl0(this.disabledInactiveContainerColor, segmentedButtonColors.disabledInactiveContainerColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((Color.m4391hashCodeimpl(this.activeBorderColor) * 31) + Color.m4391hashCodeimpl(this.activeContentColor)) * 31) + Color.m4391hashCodeimpl(this.activeContainerColor)) * 31) + Color.m4391hashCodeimpl(this.inactiveBorderColor)) * 31) + Color.m4391hashCodeimpl(this.inactiveContentColor)) * 31) + Color.m4391hashCodeimpl(this.inactiveContainerColor)) * 31) + Color.m4391hashCodeimpl(this.disabledActiveBorderColor)) * 31) + Color.m4391hashCodeimpl(this.disabledActiveContentColor)) * 31) + Color.m4391hashCodeimpl(this.disabledActiveContainerColor)) * 31) + Color.m4391hashCodeimpl(this.disabledInactiveBorderColor)) * 31) + Color.m4391hashCodeimpl(this.disabledInactiveContentColor)) * 31) + Color.m4391hashCodeimpl(this.disabledInactiveContainerColor);
    }
}
