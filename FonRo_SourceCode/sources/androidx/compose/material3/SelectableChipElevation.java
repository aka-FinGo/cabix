...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
            Object animatable = new Animatable(Dp.m6987boximpl(f), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m6987boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue5, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6994equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m6994equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m6994equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m6994equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m6994equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m6995hashCodeimpl(this.elevation) * 31) + Dp.m6995hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6995hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6995hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6995hashCodeimpl(this.disabledElevation);
    }
}
