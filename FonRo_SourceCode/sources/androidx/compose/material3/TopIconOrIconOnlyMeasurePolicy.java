...
public final class TopIconOrIconOnlyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureResult m2422placeIconX9ElhV4;
        MeasureResult m2424placeLabelAndTopIconqoqLrGI;
        ...
        while (i2 < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(ConstraintsKt.m6961offsetNN6EwU(m6932copyZbe2FdA$default, -measureScope2.mo694roundToPx0680j_4(Dp.m6989constructorimpl(this.indicatorHorizontalPadding * 2.0f)), -measureScope2.mo694roundToPx0680j_4(Dp.m6989constructorimpl(this.indicatorVerticalPadding * 2.0f))));
                int width = mo5732measureBRTryo0.getWidth() + measureScope2.mo694roundToPx0680j_4(Dp.m6989constructorimpl(this.indicatorHorizontalPadding * 2.0f));
                int height = mo5732measureBRTryo0.getHeight() + measureScope2.mo694roundToPx0680j_4(Dp.m6989constructorimpl(this.indicatorVerticalPadding * 2.0f));
                ...
                while (i3 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                        Placeable mo5732measureBRTryo02 = measurable2.mo5732measureBRTryo0(ConstraintsKt.m6957constrainN9IONVI(m6932copyZbe2FdA$default, Constraints.INSTANCE.m6952fixedJhjzzOo(width, height)));
                        int size3 = list.size();
                        int i4 = 0;
                        while (i4 < size3) {
                            Measurable measurable3 = list.get(i4);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), "indicator")) {
                                Placeable mo5732measureBRTryo03 = measurable3.mo5732measureBRTryo0(ConstraintsKt.m6957constrainN9IONVI(m6932copyZbe2FdA$default, Constraints.INSTANCE.m6952fixedJhjzzOo(roundToInt, height)));
                                if (!this.hasLabel) {
                                    m2422placeIconX9ElhV4 = NavigationItemKt.m2422placeIconX9ElhV4(measureScope2, mo5732measureBRTryo0, mo5732measureBRTryo02, mo5732measureBRTryo03, j);
                                    return m2422placeIconX9ElhV4;
                                }
                                int size4 = list.size();
                                while (i < size4) {
                                    Measurable measurable4 = list.get(i);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                        m2424placeLabelAndTopIconqoqLrGI = NavigationItemKt.m2424placeLabelAndTopIconqoqLrGI(measureScope2, measurable4.mo5732measureBRTryo0(ConstraintsKt.m6962offsetNN6EwU$default(m6932copyZbe2FdA$default, 0, -(mo5732measureBRTryo03.getHeight() + measureScope2.mo694roundToPx0680j_4(this.indicatorToLabelVerticalPadding)), 1, null)), mo5732measureBRTryo0, mo5732measureBRTryo02, mo5732measureBRTryo03, j, this.indicatorToLabelVerticalPadding, this.indicatorVerticalPadding, this.topIconItemVerticalPadding);
                                        return m2424placeLabelAndTopIconqoqLrGI;
                                    }
                                    i++;
                                    mo5732measureBRTryo03 = mo5732measureBRTryo03;
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), "icon")) {
                ...
                return maxIntrinsicHeight + (intrinsicMeasurable3 != null ? intrinsicMeasurable3.maxIntrinsicHeight(i) : 0) + intrinsicMeasureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(Dp.m6989constructorimpl(Dp.m6989constructorimpl(this.topIconItemVerticalPadding * 2.0f) + Dp.m6989constructorimpl(this.indicatorVerticalPadding * 2.0f)) + this.indicatorToLabelVerticalPadding));
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
