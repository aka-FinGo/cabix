...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        float f2;
        float f3;
        boolean z = (measurable.maxIntrinsicHeight(Constraints.m6942getMaxWidthimpl(j)) == 0 || measurable.maxIntrinsicWidth(Constraints.m6941getMaxHeightimpl(j)) == 0) ? false : true;
        if (this.isPressed) {
            thumbDiameter = SwitchTokens.INSTANCE.m3645getPressedHandleWidthD9Ej5fM();
        } else if (z || this.checked) {
            thumbDiameter = SwitchKt.getThumbDiameter();
        } else {
            thumbDiameter = SwitchKt.getUncheckedThumbDiameter();
        }
        float f4 = measureScope.mo700toPx0680j_4(thumbDiameter);
        ...
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(Constraints.INSTANCE.m6952fixedJhjzzOo(floatValue, floatValue));
        f = SwitchKt.SwitchHeight;
        final float f5 = measureScope.mo700toPx0680j_4(Dp.m6989constructorimpl(Dp.m6989constructorimpl(f - measureScope.mo696toDpu2uoSUM(f4)) / 2.0f));
        f2 = SwitchKt.SwitchWidth;
        float m6989constructorimpl = Dp.m6989constructorimpl(f2 - SwitchKt.getThumbDiameter());
        f3 = SwitchKt.ThumbPadding;
        float f6 = measureScope.mo700toPx0680j_4(Dp.m6989constructorimpl(m6989constructorimpl - f3));
        boolean z2 = this.isPressed;
        if (z2 && this.checked) {
            f5 = f6 - measureScope.mo700toPx0680j_4(SwitchTokens.INSTANCE.m3651getTrackOutlineWidthD9Ej5fM());
        } else if (z2 && !this.checked) {
            f5 = measureScope.mo700toPx0680j_4(SwitchTokens.INSTANCE.m3651getTrackOutlineWidthD9Ej5fM());
