...
public final class ProgressIndicatorDefaults {
    ...
    private static final float CircularStrokeWidth = ProgressIndicatorTokens.INSTANCE.m3594getTrackThicknessD9Ej5fM();
    private static final int LinearStrokeCap = StrokeCap.INSTANCE.m4738getRoundKaPHkGw();
    private static final int CircularDeterminateStrokeCap = StrokeCap.INSTANCE.m4738getRoundKaPHkGw();
    private static final int CircularIndeterminateStrokeCap = StrokeCap.INSTANCE.m4738getRoundKaPHkGw();
    private static final float LinearTrackStopIndicatorSize = ProgressIndicatorTokens.INSTANCE.m3593getStopSizeD9Ej5fM();
    private static final float LinearIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3590getActiveTrackSpaceD9Ej5fM();
    private static final float CircularIndicatorTrackGapSize = ProgressIndicatorTokens.INSTANCE.m3590getActiveTrackSpaceD9Ej5fM();
    ...
    public static /* synthetic */ void m2458getCircularIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }
    ...
    public static /* synthetic */ void m2459getLinearIndicatorTrackGapSizeD9Ej5fM$annotations() {
    }

    /* renamed from: getLinearTrackStopIndicatorSize-D9Ej5fM$annotations, reason: not valid java name */
    public static /* synthetic */ void m2460getLinearTrackStopIndicatorSizeD9Ej5fM$annotations() {
    }
    ...
    public final long getCircularTrackColor(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m4419getTransparent0d7_KjU;
    }
    ...
    public final void m2461drawStopIndicatorEgI2THU(DrawScope drawScope, float stopSize, long color, int strokeCap) {
        float min = Math.min(drawScope.mo700toPx0680j_4(stopSize), Size.m4191getHeightimpl(drawScope.mo4935getSizeNHjbRc()));
        float m4191getHeightimpl = (Size.m4191getHeightimpl(drawScope.mo4935getSizeNHjbRc()) - min) / 2.0f;
        if (StrokeCap.m4733equalsimpl0(strokeCap, StrokeCap.INSTANCE.m4738getRoundKaPHkGw())) {
            float f = min / 2.0f;
            DrawScope.m4916drawCircleVaOC9Bg$default(drawScope, color, f, OffsetKt.Offset((Size.m4194getWidthimpl(drawScope.mo4935getSizeNHjbRc()) - f) - m4191getHeightimpl, Size.m4191getHeightimpl(drawScope.mo4935getSizeNHjbRc()) / 2.0f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        } else {
            DrawScope.m4929drawRectnJ9OG0$default(drawScope, color, OffsetKt.Offset((Size.m4194getWidthimpl(drawScope.mo4935getSizeNHjbRc()) - min) - m4191getHeightimpl, (Size.m4191getHeightimpl(drawScope.mo4935getSizeNHjbRc()) - min) / 2.0f), SizeKt.Size(min, min), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
}
