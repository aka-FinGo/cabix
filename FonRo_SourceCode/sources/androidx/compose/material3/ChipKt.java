    ...
    */
    ...
    public static final void m1978ChipnkUnTEs(final Modifier modifier, final Function0<Unit> function0, final boolean z, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final long j, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Shape shape, final ChipColors chipColors, final ChipElevation chipElevation, final BorderStroke borderStroke, final float f, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 306783379) != 306783378 || (i5 & 9363) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            long m1959containerColorvNxB06k$material3_release = chipColors.m1959containerColorvNxB06k$material3_release(z);
            ...
            SurfaceKt.m2651Surfaceo_FOJdg(function0, semantics$default, z, shape, m1959containerColorvNxB06k$material3_release, 0L, 0.0f, shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m7003unboximpl() : Dp.m6989constructorimpl(0.0f), borderStroke, mutableInteractionSource2, ComposableLambdaKt.rememberComposableLambda(-1985962652, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$2
                ...
                public final void invoke(Composer composer3, int i7) {
                    ...
                    if ((i7 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        ChipKt.m1979ChipContentfe0OD_I(function25, textStyle, j, function22, null, function23, chipColors.m1970leadingIconContentColorvNxB06k$material3_release(z), chipColors.m1971trailingIconContentColorvNxB06k$material3_release(z), f, paddingValues, composer3, 24576);
                        if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$Chip$3
                ...
                public final void invoke(Composer composer3, int i7) {
                    ChipKt.m1978ChipnkUnTEs(Modifier.this, function0, z, function2, textStyle, j, function22, function23, shape, chipColors, chipElevation, borderStroke, f, paddingValues, mutableInteractionSource, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    public static final void m1980SelectableChipu0RnIRE(final boolean z, final Modifier modifier, final Function0<Unit> function0, final boolean z2, final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Shape shape, final SelectableChipColors selectableChipColors, final SelectableChipElevation selectableChipElevation, final BorderStroke borderStroke, final float f, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 306783379) != 306783378 || (74899 & i5) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            Modifier semantics$default = SemanticsModifierKt.semantics$default(modifier, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$1
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                    SemanticsPropertiesKt.m6218setRolekuIjeqM(semanticsPropertyReceiver, Role.INSTANCE.m6201getCheckboxo7Vup1c());
                }
            }, 1, null);
            long m2564containerColorWaAFU9c$material3_release = selectableChipColors.m2564containerColorWaAFU9c$material3_release(z2, z);
            ...
            startRestartGroup.endReplaceGroup();
            composer2 = startRestartGroup;
            SurfaceKt.m2649Surfaced85dljk(z, function0, semantics$default, z2, shape, m2564containerColorWaAFU9c$material3_release, 0L, 0.0f, shadowElevation$material3_release != null ? shadowElevation$material3_release.getValue().m7003unboximpl() : Dp.m6989constructorimpl(0.0f), borderStroke, mutableInteractionSource2, ComposableLambdaKt.rememberComposableLambda(-577614814, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer composer3, int i7) {
                    ...
                    if ((i7 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        ChipKt.m1979ChipContentfe0OD_I(function2, textStyle, SelectableChipColors.this.m2566labelColorWaAFU9c$material3_release(z2, z), function22, function23, function24, SelectableChipColors.this.m2567leadingIconContentColorWaAFU9c$material3_release(z2, z), SelectableChipColors.this.m2568trailingIconContentColorWaAFU9c$material3_release(z2, z), f, paddingValues, composer3, 0);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$SelectableChip$3
                ...
                public final void invoke(Composer composer3, int i7) {
                    ChipKt.m1980SelectableChipu0RnIRE(z, modifier, function0, z2, function2, textStyle, function22, function23, function24, shape, selectableChipColors, selectableChipElevation, borderStroke, f, paddingValues, mutableInteractionSource, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    public static final void m1979ChipContentfe0OD_I(final Function2<? super Composer, ? super Integer, Unit> function2, final TextStyle textStyle, long j, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final long j2, final long j3, final float f, final PaddingValues paddingValues, Composer composer, final int i) {
        int i2;
        long j4;
        ...
        if ((i3 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            final long j6 = j5;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(j4)), TextKt.getLocalTextStyle().provides(textStyle)}, ComposableLambdaKt.rememberComposableLambda(1748799148, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$ChipContent$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier padding = PaddingKt.padding(SizeKt.m1081defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null), paddingValues);
                        AnonymousClass1 anonymousClass1 = new MeasurePolicy() { // from class: androidx.compose.material3.ChipKt$ChipContent$1.1
                            ...
                            public final MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j7) {
                                ...
                                final Placeable mo5732measureBRTryo0 = measurable3 != null ? measurable3.mo5732measureBRTryo0(Constraints.m6932copyZbe2FdA$default(j7, 0, 0, 0, 0, 10, null)) : null;
                                final int widthOrZero = TextFieldImplKt.widthOrZero(mo5732measureBRTryo0);
                                final int heightOrZero = TextFieldImplKt.heightOrZero(mo5732measureBRTryo0);
                                int size2 = list.size();
                                int i6 = 0;
                                while (true) {
                                    if (i6 >= size2) {
                                ...
                                Placeable mo5732measureBRTryo02 = measurable4 != null ? measurable4.mo5732measureBRTryo0(Constraints.m6932copyZbe2FdA$default(j7, 0, 0, 0, 0, 10, null)) : null;
                                int widthOrZero2 = TextFieldImplKt.widthOrZero(mo5732measureBRTryo02);
                                final int heightOrZero2 = TextFieldImplKt.heightOrZero(mo5732measureBRTryo02);
                                int size3 = list.size();
                                for (int i7 = 0; i7 < size3; i7++) {
                                    Measurable measurable5 = list.get(i7);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable5), "label")) {
                                        final Placeable mo5732measureBRTryo03 = measurable5.mo5732measureBRTryo0(ConstraintsKt.m6962offsetNN6EwU$default(j7, -(widthOrZero + widthOrZero2), 0, 2, null));
                                        int width = mo5732measureBRTryo03.getWidth() + widthOrZero + widthOrZero2;
                                        final int max = Math.max(heightOrZero, Math.max(mo5732measureBRTryo03.getHeight(), heightOrZero2));
                                        final Placeable placeable = mo5732measureBRTryo02;
                                        return MeasureScope.layout$default(measureScope, width, max, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ChipKt.ChipContent.1.1.1
                                            ...
                                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                                ...
                                                Placeable.PlacementScope.placeRelative$default(placementScope2, mo5732measureBRTryo03, widthOrZero, 0, 0.0f, 4, null);
                                                Placeable placeable3 = placeable;
                                                if (placeable3 != null) {
                                                    Placeable.PlacementScope.placeRelative$default(placementScope2, placeable3, widthOrZero + mo5732measureBRTryo03.getWidth(), Alignment.INSTANCE.getCenterVertically().align(heightOrZero2, max), 0.0f, 4, null);
                                                }
                                            }
                                        }, 4, null);
                                    }
                        ...
                        Updater.m3815setimpl(m3808constructorimpl, anonymousClass1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                        ...
                        if (function211 != null || function212 != null) {
                            ...
                            if (function211 != null) {
                                ...
                                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(j7)), function212, composer2, ProvidedValue.$stable);
                                composer2.endReplaceGroup();
                            } else {
                        ...
                        Modifier m1050paddingVpY3zN4 = PaddingKt.m1050paddingVpY3zN4(layoutId2, f2, Dp.m6989constructorimpl(0.0f));
                        ...
                        Modifier materializeModifier3 = ComposedModifierKt.materializeModifier(composer2, m1050paddingVpY3zN4);
                        ...
                        if (function213 != null) {
                            ...
                            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(j8)), function213, composer2, ProvidedValue.$stable);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            composer2.endNode();
                            ComposerKt.sourceInformationMarkerEnd(composer2);
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ChipKt$ChipContent$2
                ...
                public final void invoke(Composer composer2, int i4) {
                    ChipKt.m1979ChipContentfe0OD_I(function2, textStyle, j7, function22, function23, function24, j2, j3, f, paddingValues, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final ChipColors getDefaultSuggestionChipColors(ColorScheme colorScheme) {
        ...
        ChipColors chipColors = new ChipColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getLabelTextColor()), ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getLeadingIconColor()), Color.INSTANCE.m4420getUnspecified0d7_KjU(), Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor()), SuggestionChipTokens.INSTANCE.getDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor()), SuggestionChipTokens.INSTANCE.getDisabledLeadingIconOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m4420getUnspecified0d7_KjU(), null);
    ...
    private static final PaddingValues inputChipPadding(boolean z, boolean z2, boolean z3) {
        return PaddingKt.m1046PaddingValuesa9UjIt4$default((z || !z2) ? Dp.m6989constructorimpl(4.0f) : Dp.m6989constructorimpl(8.0f), 0.0f, z3 ? Dp.m6989constructorimpl(8.0f) : Dp.m6989constructorimpl(4.0f), 0.0f, 10, null);
    }

    static {
        float m6989constructorimpl = Dp.m6989constructorimpl(8.0f);
        HorizontalElementsPadding = m6989constructorimpl;
        AssistChipPadding = PaddingKt.m1044PaddingValuesYgX7TsA$default(m6989constructorimpl, 0.0f, 2, null);
        FilterChipPadding = PaddingKt.m1044PaddingValuesYgX7TsA$default(m6989constructorimpl, 0.0f, 2, null);
        SuggestionChipPadding = PaddingKt.m1044PaddingValuesYgX7TsA$default(m6989constructorimpl, 0.0f, 2, null);
    }
}
