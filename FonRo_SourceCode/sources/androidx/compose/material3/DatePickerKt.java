...
public final class DatePickerKt {
    ...
    private static final float RecommendedSizeForAccessibility = Dp.m6989constructorimpl(48.0f);
    private static final float MonthYearHeight = Dp.m6989constructorimpl(56.0f);
    private static final float DatePickerHorizontalPadding = Dp.m6989constructorimpl(12.0f);
    private static final PaddingValues DatePickerModeTogglePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(0.0f, 0.0f, Dp.m6989constructorimpl(12.0f), Dp.m6989constructorimpl(12.0f), 3, null);
    private static final PaddingValues DatePickerTitlePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(16.0f), Dp.m6989constructorimpl(12.0f), 0.0f, 8, null);
    private static final PaddingValues DatePickerHeadlinePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(Dp.m6989constructorimpl(24.0f), 0.0f, Dp.m6989constructorimpl(12.0f), Dp.m6989constructorimpl(12.0f), 2, null);
    private static final float YearsVerticalPadding = Dp.m6989constructorimpl(16.0f);
    ...
    */
    ...
    public static final DatePickerState m2137rememberDatePickerStateEU0dCGE(Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        final int m2174getPickerjFl4v0 = (i3 & 8) != 0 ? DisplayMode.INSTANCE.m2174getPickerjFl4v0() : i;
        ...
        if (changedInstance || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function0) new Function0<DatePickerStateImpl>() { // from class: androidx.compose.material3.DatePickerKt$rememberDatePickerState$1$1
                ...
                public final DatePickerStateImpl invoke() {
                    return new DatePickerStateImpl(l3, l4, yearRange, m2174getPickerjFl4v0, allDates, defaultLocale, null);
                }
            };
            composer.updateRememberedValue(rememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        DatePickerStateImpl datePickerStateImpl = (DatePickerStateImpl) RememberSaveableKt.m3923rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
    ...
    public static /* synthetic */ DatePickerState m2133DatePickerStatesHin3Bw$default(Locale locale, Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        if ((i2 & 16) != 0) {
            i = DisplayMode.INSTANCE.m2174getPickerjFl4v0();
        }
        if ((i2 & 32) != 0) {
        ...
        return m2132DatePickerStatesHin3Bw(locale, l, l2, intRange2, i, selectableDates2);
    }

    /* renamed from: DatePickerState-sHin3Bw, reason: not valid java name */
    public static final DatePickerState m2132DatePickerStatesHin3Bw(Locale locale, Long l, Long l2, IntRange intRange, int i, SelectableDates selectableDates) {
    ...
    public static final void m2130DateEntryContainerau3_HiA(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final DatePickerColors datePickerColors, final TextStyle textStyle, final float f, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i) {
        ...
        if ((4793491 & i2) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m558backgroundbw27NRU$default = BackgroundKt.m558backgroundbw27NRU$default(SemanticsModifierKt.semantics$default(SizeKt.m1100sizeInqDBjuR0$default(modifier, DatePickerModalTokens.INSTANCE.m3267getContainerWidthD9Ej5fM(), 0.0f, 0.0f, 0.0f, 14, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$1
            ...
            m2131DatePickerHeaderpc5RIQQ(Modifier.INSTANCE, function2, datePickerColors2.getTitleContentColor(), datePickerColors2.getHeadlineContentColor(), f, ComposableLambdaKt.rememberComposableLambda(-229007058, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                public final void invoke(Composer composer3, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        if (function211 != null) {
                            TextKt.ProvideTextStyle(textStyle4, ComposableLambdaKt.rememberComposableLambda(-962031352, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$2$1$1$1$1
                                ...
                                public final void invoke(Composer composer4, int i4) {
                                    ...
                                    Composer m3808constructorimpl4 = Updater.m3808constructorimpl(composer4);
                        ...
                        if (function213 != null || function211 != null || function212 != null) {
                            DividerKt.m2177HorizontalDivider9IZ8Weo(null, 0.0f, datePickerColors4.getDividerColor(), composer3, 0, 3);
                        }
                        composer3.endReplaceGroup();
                        ComposerKt.sourceInformationMarkerEnd(composer3);
                        ComposerKt.sourceInformationMarkerEnd(composer3);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DateEntryContainer$3
                ...
                public final void invoke(Composer composer3, int i3) {
                    DatePickerKt.m2130DateEntryContainerau3_HiA(Modifier.this, function2, function22, function23, datePickerColors, textStyle, f, function24, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m2134DisplayModeToggleButtontER2X8s(Modifier modifier, final int i, final Function1<? super DisplayMode, Unit> function1, Composer composer, final int i2) {
        int i3;
        boolean z;
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            if (DisplayMode.m2169equalsimpl0(i, DisplayMode.INSTANCE.m2174getPickerjFl4v0())) {
                ...
                if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$1$1
                        ...
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m2166boximpl(DisplayMode.INSTANCE.m2173getInputjFl4v0()));
                        }
                    };
                ...
                modifier2 = modifier;
                IconButtonKt.IconButton((Function0) rememberedValue, modifier2, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m2065getLambda1$material3_release(), startRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                ...
                if (z || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    rememberedValue2 = (Function0) new Function0<Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$2$1
                        ...
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2() {
                            function1.invoke(DisplayMode.m2166boximpl(DisplayMode.INSTANCE.m2174getPickerjFl4v0()));
                        }
                    };
                ...
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                modifier2 = modifier;
                IconButtonKt.IconButton((Function0) rememberedValue2, modifier2, false, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m2066getLambda2$material3_release(), startRestartGroup, ((i3 << 3) & 112) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 28);
                startRestartGroup.endReplaceGroup();
            }
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DisplayModeToggleButton$3
                ...
                public final void invoke(Composer composer2, int i4) {
                    DatePickerKt.m2134DisplayModeToggleButtontER2X8s(Modifier.this, i, function1, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public static final void m2135SwitchableDateEntryContentd7iavvg(final Long l, final long j, final int i, final Function1<? super Long, Unit> function1, final Function1<? super Long, Unit> function12, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i2) {
        int i3;
        ...
        if ((306783379 & i4) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final int i5 = -((Density) consume).mo694roundToPx0680j_4(Dp.m6989constructorimpl(48.0f));
            DisplayMode m2166boximpl = DisplayMode.m2166boximpl(i);
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<AnimatedContentTransitionScope<DisplayMode>, ContentTransform>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1
                    ...
                    public final ContentTransform invoke(AnimatedContentTransitionScope<DisplayMode> animatedContentTransitionScope) {
                        ...
                        if (DisplayMode.m2169equalsimpl0(animatedContentTransitionScope.getTargetState().getValue(), DisplayMode.INSTANCE.m2173getInputjFl4v0())) {
                        ...
                        return animatedContentTransitionScope.using(contentTransform, AnimatedContentKt.SizeTransform(true, new Function2<IntSize, IntSize, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$2$1.5
                            ...
                            public /* bridge */ /* synthetic */ FiniteAnimationSpec<IntSize> invoke(IntSize intSize, IntSize intSize2) {
                                return m2139invokeTemP2vQ(intSize.m7164unboximpl(), intSize2.m7164unboximpl());
                            }

                            /* renamed from: invoke-TemP2vQ, reason: not valid java name */
                            public final FiniteAnimationSpec<IntSize> m2139invokeTemP2vQ(long j2, long j3) {
            ...
            final DatePickerColors datePickerColors3 = datePickerColors2;
            composer2 = startRestartGroup;
            AnimatedContentKt.AnimatedContent(m2166boximpl, semantics$default, (Function1) rememberedValue, null, "DatePickerDisplayModeAnimation", null, ComposableLambdaKt.rememberComposableLambda(-459778869, true, new Function4<AnimatedContentScope, DisplayMode, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$3
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public /* bridge */ /* synthetic */ Unit invoke(AnimatedContentScope animatedContentScope, DisplayMode displayMode, Composer composer3, Integer num) {
                    m2140invokefYndouo(animatedContentScope, displayMode.getValue(), composer3, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-fYndouo, reason: not valid java name */
                public final void m2140invokefYndouo(AnimatedContentScope animatedContentScope, int i6, Composer composer3, int i7) {
                    ...
                    if (DisplayMode.m2169equalsimpl0(i6, DisplayMode.INSTANCE.m2174getPickerjFl4v0())) {
                        ...
                        composer3.endReplaceGroup();
                    } else if (DisplayMode.m2169equalsimpl0(i6, DisplayMode.INSTANCE.m2173getInputjFl4v0())) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$SwitchableDateEntryContent$4
                ...
                public final void invoke(Composer composer3, int i6) {
                    DatePickerKt.m2135SwitchableDateEntryContentd7iavvg(l, j, i, function1, function12, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
                }
            });
        }
    }
    ...
    public static final void DatePickerContent(final Long l, final long j, final Function1<? super Long, Unit> function1, final Function1<? super Long, Unit> function12, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            final MutableState mutableState = (MutableState) RememberSaveableKt.m3923rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<MutableState<Boolean>>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$yearPickerVisible$2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // kotlin.jvm.functions.Function0
            ...
            int i3 = i2;
            Modifier m1051paddingVpY3zN4$default = PaddingKt.m1051paddingVpY3zN4$default(companion2, f, 0.0f, 2, null);
            ...
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            int i4 = i3 & 234881024;
            MonthsNavigation(m1051paddingVpY3zN4$default, canScrollForward, canScrollBackward, DatePickerContent$lambda$10, str, function0, function02, (Function0) rememberedValue5, datePickerColors, startRestartGroup, i4 | 6);
            composer2 = startRestartGroup;
            ...
            Modifier m1051paddingVpY3zN4$default2 = PaddingKt.m1051paddingVpY3zN4$default(Modifier.INSTANCE, f, 0.0f, 2, null);
            ...
            AnimatedVisibilityKt.AnimatedVisibility(DatePickerContent$lambda$10(mutableState), ClipKt.clipToBounds(Modifier.INSTANCE), EnterExitTransitionKt.expandVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeIn$default(null, 0.6f, 1, null)), EnterExitTransitionKt.shrinkVertically$default(null, null, false, null, 15, null).plus(EnterExitTransitionKt.fadeOut$default(null, 0.0f, 3, null)), (String) null, ComposableLambdaKt.rememberComposableLambda(1193716082, true, new Function3<AnimatedVisibilityScope, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$2$4$2
                ...
                public final void invoke(AnimatedVisibilityScope animatedVisibilityScope, Composer composer3, int i5) {
                    ...
                    final String m3101getString2EP1pXo = Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_picker_year_picker_pane_title), composer3, 0);
                    Modifier.Companion companion5 = Modifier.INSTANCE;
                    ComposerKt.sourceInformationMarkerStart(composer3, 14727253, "CC(remember):DatePicker.kt#9igjgp");
                    boolean changed3 = composer3.changed(m3101getString2EP1pXo);
                    ...
                    if (changed3 || rememberedValue6 == Composer.INSTANCE.getEmpty()) {
                        rememberedValue6 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerContent$2$4$2$1$1
                            ...
                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                SemanticsPropertiesKt.setPaneTitle(semanticsPropertyReceiver, m3101getString2EP1pXo);
                            }
                        };
                    ...
                    Modifier m1051paddingVpY3zN4$default3 = PaddingKt.m1051paddingVpY3zN4$default(SizeKt.m1085requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m6989constructorimpl(Dp.m6989constructorimpl(DatePickerKt.getRecommendedSizeForAccessibility() * 7.0f) - DividerDefaults.INSTANCE.m2175getThicknessD9Ej5fM())), DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    DatePickerKt.YearPicker(m1051paddingVpY3zN4$default3, j2, (Function1) rememberedValue7, selectableDates2, calendarModel2, intRange2, datePickerColors2, composer3, 6);
                    DividerKt.m2177HorizontalDivider9IZ8Weo(null, 0.0f, datePickerColors2.getDividerColor(), composer3, 0, 3);
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    ComposerKt.sourceInformationMarkerEnd(composer3);
                    composer3.endNode();
                    ComposerKt.sourceInformationMarkerEnd(composer3);
    ...
    public static final void m2131DatePickerHeaderpc5RIQQ(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final long j, final long j2, final float f, final Function2<? super Composer, ? super Integer, Unit> function22, Composer composer, final int i) {
        int i2;
        ...
        if ((74899 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            if (function2 != null) {
                companion = SizeKt.m1081defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, f, 1, null);
            } else {
            ...
            startRestartGroup.endReplaceGroup();
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(j2)), function22, startRestartGroup, ProvidedValue.$stable | ((i3 >> 12) & 112));
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$DatePickerHeader$2
                ...
                public final void invoke(Composer composer2, int i4) {
                    DatePickerKt.m2131DatePickerHeaderpc5RIQQ(Modifier.this, function2, j, j2, f, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void WeekDays(final DatePickerColors datePickerColors, final CalendarModel calendarModel, Composer composer, final int i) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(SizeKt.m1081defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, 0.0f, RecommendedSizeForAccessibility, 1, null), 0.0f, 1, null);
            ...
            while (i7 < size2) {
                ...
                Modifier m1098sizeVpY3zN4 = SizeKt.m1098sizeVpY3zN4(clearAndSetSemantics, f, f);
                ...
                Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(startRestartGroup, m1098sizeVpY3zN4);
                Function0<ComposeUiNode> constructor2 = ComposeUiNode.INSTANCE.getConstructor();
                ...
                TextKt.m2798Text4IGK_g((String) pair.getSecond(), SizeKt.wrapContentSize$default(Modifier.INSTANCE, null, false, 3, null), datePickerColors.getWeekdayContentColor(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m6866boximpl(TextAlign.INSTANCE.m6873getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, value, composer3, 48, 0, 65016);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                composer3.endNode();
                ComposerKt.sourceInformationMarkerEnd(composer3);
    ...
    public static final void Month(final CalendarMonth calendarMonth, final Function1<? super Long, Unit> function1, final long j, final Long l, final Long l2, final SelectedRangeInfo selectedRangeInfo, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !startRestartGroup.getSkipping()) {
                ...
                if (z4 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$rangeSelectionDrawModifier$1$1
                        ...
                        public final void invoke2(ContentDrawScope contentDrawScope) {
                            DateRangePickerKt.m2151drawRangeBackgroundmxwnekA(contentDrawScope, SelectedRangeInfo.this, datePickerColors.getDayInSelectionRangeContainerColor());
            ...
            startRestartGroup.endReplaceGroup();
            Locale defaultLocale = CalendarLocale_androidKt.defaultLocale(startRestartGroup, 0);
            Modifier then = SizeKt.m1085requiredHeight3ABfNKs(Modifier.INSTANCE, Dp.m6989constructorimpl(RecommendedSizeForAccessibility * 6.0f)).then(companion);
            Arrangement.HorizontalOrVertical spaceEvenly = Arrangement.INSTANCE.getSpaceEvenly();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -483455358, "CC(Column)P(2,3,1)85@4251L61,86@4317L133:Column.kt#2w3rfo");
            ...
            while (i7 < i9) {
                ...
                while (i13 < 7) {
                    if (i12 < calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() || i12 >= calendarMonth2.getDaysFromStartOfWeekToFirstOfMonth() + calendarMonth2.getNumberOfDays()) {
                        ...
                        Modifier.Companion companion3 = Modifier.INSTANCE;
                        float f = RecommendedSizeForAccessibility;
                        SpacerKt.Spacer(SizeKt.m1090requiredSizeVpY3zN4(companion3, f, f), composer3, 6);
                        composer3.endReplaceGroup();
                    } else {
                        ...
                        Day(companion4, z10, function0, z7, booleanValue, z9, z8, formatDate, datePickerColors, ComposableLambdaKt.rememberComposableLambda(-2095706591, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$3
                            ...
                            public final void invoke(Composer composer5, int i14) {
                                ...
                                if ((i14 & 3) != 2 || !composer5.getSkipping()) {
                                    ...
                                    TextKt.m2798Text4IGK_g(CalendarLocale_jvmKt.toLocalString$default(daysFromStartOfWeekToFirstOfMonth + 1, 0, 0, false, 7, null), SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Month$1$1$3.1
                                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                        }
                                    ...
                                    }), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m6866boximpl(TextAlign.INSTANCE.m6873getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer5, 0, 0, 130556);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
    ...
    private static final String dayContentDescription(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, Composer composer, int i) {
        ...
        if (z) {
            if (z3) {
                ...
                sb.append(Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_range_picker_start_headline), composer, 0));
                composer.endReplaceGroup();
            } else if (z4) {
                composer.startReplaceGroup(-647723718);
                ComposerKt.sourceInformation(composer, "1916@87202L54");
                Strings.Companion companion2 = Strings.INSTANCE;
                sb.append(Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_range_picker_end_headline), composer, 0));
                composer.endReplaceGroup();
            } else if (z5) {
                composer.startReplaceGroup(-647719783);
                ComposerKt.sourceInformation(composer, "1918@87325L53");
                Strings.Companion companion3 = Strings.INSTANCE;
                sb.append(Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_range_picker_day_in_range), composer, 0));
                composer.endReplaceGroup();
            } else {
        ...
        if (z2) {
            ...
            Strings.Companion companion4 = Strings.INSTANCE;
            sb.append(Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_picker_today_description), composer, 0));
        }
        composer.endReplaceGroup();
    ...
    public static final void Day(final Modifier modifier, final boolean z, final Function0<Unit> function0, final boolean z2, final boolean z3, final boolean z4, final boolean z5, final String str, final DatePickerColors datePickerColors, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((306783379 & i3) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            int i4 = i3 >> 3;
            int i5 = i3 >> 15;
            long m4394unboximpl = datePickerColors2.dayContainerColor$material3_release(z, z7, z6, startRestartGroup, (i5 & 7168) | (i4 & 14) | ((i3 >> 9) & 112) | (i4 & 896)).getValue().m4394unboximpl();
            int i6 = i3 >> 12;
            SurfaceKt.m2649Surfaced85dljk(z, function0, semantics, z3, value, m4394unboximpl, datePickerColors.dayContentColor$material3_release(z4, z, z8, z3, startRestartGroup, (i5 & 14) | (i3 & 112) | (i6 & 896) | (i4 & 7168) | (i6 & 57344)).getValue().m4394unboximpl(), 0.0f, 0.0f, (!z4 || z) ? null : BorderStrokeKt.m585BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m3272getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor()), (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(-2031780827, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Day$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                ...
                public final void invoke(Composer composer2, int i7) {
                    ...
                    if ((i7 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        Modifier m1090requiredSizeVpY3zN4 = SizeKt.m1090requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m3271getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3270getDateStateLayerHeightD9Ej5fM());
                        Alignment center = Alignment.INSTANCE.getCenter();
                        ...
                        Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer2, m1090requiredSizeVpY3zN4);
                        Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                        ComposerKt.sourceInformationMarkerStart(composer2, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
                        if (!(composer2.getApplier() instanceof Applier)) {
                            ComposablesKt.invalidApplier();
            ...
            TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getSelectionYearLabelTextFont(), startRestartGroup, 6), ComposableLambdaKt.rememberComposableLambda(1301915789, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        Strings.Companion companion = Strings.INSTANCE;
                        final String m3101getString2EP1pXo = Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_picker_scroll_to_earlier_years), composer2, 0);
                        Strings.Companion companion2 = Strings.INSTANCE;
                        final String m3101getString2EP1pXo2 = Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_picker_scroll_to_later_years), composer2, 0);
                        GridCells.Fixed fixed = new GridCells.Fixed(3);
                        Modifier semantics$default = SemanticsModifierKt.semantics$default(BackgroundKt.m558backgroundbw27NRU$default(modifier3, containerColor, null, 2, null), false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1.1
                            @Override // kotlin.jvm.functions.Function1
                            public /* bridge */ /* synthetic */ Unit invoke(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                invoke2(semanticsPropertyReceiver);
                                return Unit.INSTANCE;
                        ...
                        Arrangement.HorizontalOrVertical m930spacedBy0680j_4 = arrangement.m930spacedBy0680j_4(f);
                        ...
                        boolean changedInstance = composer2.changedInstance(intRange3) | composer2.changed(rememberLazyGridState) | composer2.changedInstance(coroutineScope) | composer2.changed(m3101getString2EP1pXo) | composer2.changed(m3101getString2EP1pXo2) | composer2.changed(year2) | composer2.changed(year) | composer2.changed(function13) | composer2.changed(selectableDates3) | composer2.changed(datePickerColors3);
                        ...
                        if (changedInstance || rememberedValue2 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue2 = (Function1) new Function1<LazyGridScope, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1$2$1
                                ...
                                public final void invoke2(LazyGridScope lazyGridScope) {
                                    ...
                                    final CoroutineScope coroutineScope2 = coroutineScope;
                                    final String str = m3101getString2EP1pXo;
                                    final String str2 = m3101getString2EP1pXo2;
                                    final int i4 = year2;
                                    final int i5 = year;
                                    ...
                                    LazyGridScope.items$default(lazyGridScope, count, null, null, null, ComposableLambdaKt.composableLambdaInstance(1040623618, true, new Function4<LazyGridItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$YearPicker$1$2$1.1
                                        ...
                                        public final void invoke(LazyGridItemScope lazyGridItemScope, final int i6, Composer composer3, int i7) {
                                            ...
                                            if ((i8 & 145) != 144 || !composer3.getSkipping()) {
                                                ...
                                                Modifier m1090requiredSizeVpY3zN4 = SizeKt.m1090requiredSizeVpY3zN4(Modifier.INSTANCE, DatePickerModalTokens.INSTANCE.m3279getSelectionYearContainerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3278getSelectionYearContainerHeightD9Ej5fM());
                                                ...
                                                ComposerKt.sourceInformationMarkerEnd(composer3);
                                                Modifier semantics$default2 = SemanticsModifierKt.semantics$default(m1090requiredSizeVpY3zN4, false, (Function1) rememberedValue3, 1, null);
                                                if (first == i4) {
                                                    modifier4 = semantics$default2;
                                                    z = true;
                                                } else {
                                                    modifier4 = semantics$default2;
                                                    z = false;
                                                ...
                                                Strings.Companion companion3 = Strings.INSTANCE;
                                                String format = String.format(Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_picker_navigate_to_year_description), composer3, 0), Arrays.copyOf(new Object[]{localString$default}, 1));
                                                Intrinsics.checkNotNullExpressionValue(format, "format(this, *args)");
                                                DatePickerKt.Year(modifier5, z, z2, (Function0) rememberedValue4, isSelectableYear, format, datePickerColors5, ComposableLambdaKt.rememberComposableLambda(882189459, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1.3
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    {
                                                        super(2);
                                                    }
                                                    ...
                                                    public final void invoke(Composer composer4, int i9) {
                                                        ...
                                                        if ((i9 & 3) != 2 || !composer4.getSkipping()) {
                                                            ...
                                                            TextKt.m2798Text4IGK_g(localString$default, SemanticsModifierKt.clearAndSetSemantics(Modifier.INSTANCE, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt.YearPicker.1.2.1.1.3.1
                                                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                                public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                                                }
                                                            ...
                                                            }), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, TextAlign.m6866boximpl(TextAlign.INSTANCE.m6873getCentere0LSkKk()), 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 130556);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        LazyGridDslKt.LazyVerticalGrid(fixed2, semantics$default, rememberLazyGridState, null, false, m930spacedBy0680j_4, horizontalOrVertical, null, false, (Function1) rememberedValue2, composer2, 1769472, 408);
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventEnd();
                            return;
                        }
        ...
        if ((4793491 & i2) != 4793490 || !startRestartGroup.getSkipping()) {
            ...
            if (z4 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                if (!z2 || z) {
                    ...
                    i3 = i2;
                    obj = BorderStrokeKt.m585BorderStrokecXLIe8U(DatePickerModalTokens.INSTANCE.m3272getDateTodayContainerOutlineWidthD9Ej5fM(), datePickerColors.getTodayDateBorderColor());
                }
            ...
            int i6 = i5 & 14;
            int i7 = i3 >> 9;
            long m4394unboximpl = datePickerColors.yearContainerColor$material3_release(z, z3, startRestartGroup, i6 | (i7 & 112) | ((i3 >> 12) & 896)).getValue().m4394unboximpl();
            int i8 = i3 >> 6;
            SurfaceKt.m2649Surfaced85dljk(z, function0, semantics, z3, value, m4394unboximpl, datePickerColors.yearContentColor$material3_release(z2, z, z3, startRestartGroup, i4 | (i8 & 14) | (i8 & 896) | (i7 & 7168)).getValue().m4394unboximpl(), 0.0f, 0.0f, borderStroke, (MutableInteractionSource) null, ComposableLambdaKt.rememberComposableLambda(-1573188346, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$Year$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
    ...
    public static final void MonthsNavigation(final Modifier modifier, final boolean z, final boolean z2, final boolean z3, final String str, final Function0<Unit> function0, final Function0<Unit> function02, final Function0<Unit> function03, DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m1085requiredHeight3ABfNKs = SizeKt.m1085requiredHeight3ABfNKs(SizeKt.fillMaxWidth$default(modifier, 0.0f, 1, null), MonthYearHeight);
            if (z3) {
            ...
            int currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(startRestartGroup, 0);
            CompositionLocalMap currentCompositionLocalMap = startRestartGroup.getCurrentCompositionLocalMap();
            Modifier materializeModifier = ComposedModifierKt.materializeModifier(startRestartGroup, m1085requiredHeight3ABfNKs);
            Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
            ComposerKt.sourceInformationMarkerStart(startRestartGroup, -692256719, "CC(ReusableComposeNode)P(1,2)376@14062L9:Composables.kt#9igjgp");
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            ...
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(datePickerColors2.getNavigationContentColor())), ComposableLambdaKt.rememberComposableLambda(-962805198, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                                        rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DatePickerKt$MonthsNavigation$1$1$1$1$1
                                            ...
                                            /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                            public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                                SemanticsPropertiesKt.m6217setLiveRegionhR3wRGc(semanticsPropertyReceiver, LiveRegionMode.INSTANCE.m6191getPolite0phEisY());
                                    ...
                                    ComposerKt.sourceInformationMarkerEnd(composer3);
                                    TextKt.m2798Text4IGK_g(str3, SemanticsModifierKt.semantics$default(companion, false, (Function1) rememberedValue, 1, null), 0L, 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer3, 0, 0, 131068);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        if (!z3) {
                            ...
                            IconButtonKt.IconButton(function07, null, z5, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m2067getLambda3$material3_release(), composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                            IconButtonKt.IconButton(function08, null, z6, null, null, ComposableSingletons$DatePickerKt.INSTANCE.m2068getLambda4$material3_release(), composer2, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 26);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            ComposerKt.sourceInformationMarkerEnd(composer2);
                            composer2.endNode();
                            ComposerKt.sourceInformationMarkerEnd(composer2);
