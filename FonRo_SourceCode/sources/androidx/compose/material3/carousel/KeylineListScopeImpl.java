...
final class KeylineListScopeImpl implements KeylineListScope {
    ...
    /* compiled from: KeylineList.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u000b\n\u0002\b\n\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0082\b\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\t\u0010\n\u001a\u00020\u0003HÆ\u0003J\t\u0010\u000b\u001a\u00020\u0005HÆ\u0003J\u001d\u0010\f\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u0005HÆ\u0001J\u0013\u0010\r\u001a\u00020\u00052\b\u0010\u000e\u001a\u0004\u0018\u00010\u0001HÖ\u0003J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001J\t\u0010\u0011\u001a\u00020\u0012HÖ\u0001R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0007R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\u0013"}, d2 = {"Landroidx/compose/material3/carousel/KeylineListScopeImpl$TmpKeyline;", "", "size", "", "isAnchor", "", "(FZ)V", "()Z", "getSize", "()F", "component1", "component2", "copy", "equals", WriteOffReason.OTHER, "hashCode", "", "toString", "", "material3_release"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    public final KeylineList m2993createWithAlignmentwaks0t8(float carouselMainAxisSize, float itemSpacing, int carouselAlignment) {
        float f;
        float f2;
        ...
        this.pivotIndex = i;
        if (CarouselAlignment.m2977equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m2981getCenterNUL3oTo())) {
            float f3 = 0.0f;
            if (itemSpacing != 0.0f) {
                int i3 = i2 % 2;
            ...
            f = this.focalItemSize;
            f2 = ((carouselMainAxisSize / 2.0f) - ((f / 2.0f) * i2)) - f3;
        } else {
            boolean m2977equalsimpl0 = CarouselAlignment.m2977equalsimpl0(carouselAlignment, CarouselAlignment.INSTANCE.m2982getEndNUL3oTo());
            f = this.focalItemSize;
            f2 = m2977equalsimpl0 ? carouselMainAxisSize - (f / 2.0f) : f / 2.0f;
        }
        float f4 = f2;
        float f5 = f;
        this.pivotOffset = f4;
        return new KeylineList(createKeylinesWithPivot(this.pivotIndex, f4, this.firstFocalIndex, findLastFocalIndex, f5, carouselMainAxisSize, itemSpacing, this.tmpKeylines));
    }
