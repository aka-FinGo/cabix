...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m6989constructorimpl(48.0f);
    private static final float MenuListItemContainerHeight = Dp.m6989constructorimpl(48.0f);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m6989constructorimpl(12.0f);
    private static final float DropdownMenuVerticalPadding = Dp.m6989constructorimpl(8.0f);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m6989constructorimpl(112.0f);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m6989constructorimpl(280.0f);
    ...
    public static final void m2346DropdownMenuContentQj0Zi0g(final Modifier modifier, final MutableTransitionState<Boolean> mutableTransitionState, final MutableState<TransformOrigin> mutableState, final ScrollState scrollState, final Shape shape, final long j, final float f, final float f2, final BorderStroke borderStroke, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                obj = (Function1) new Function1<GraphicsLayerScope, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$1$1
                    ...
                    public final void invoke2(GraphicsLayerScope graphicsLayerScope) {
                        ...
                        graphicsLayerScope.mo4576setTransformOrigin__ExYCQ(mutableState.getValue().getPackedValue());
                    }
                };
            ...
            ComposableLambda rememberComposableLambda = ComposableLambdaKt.rememberComposableLambda(1573559053, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$2
                ...
                public final void invoke(Composer composer3, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                        ...
                        Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m1051paddingVpY3zN4$default(Modifier.this, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), scrollState, false, null, false, 14, null);
            ...
            int i4 = i3 >> 9;
            int i5 = i3 >> 6;
            SurfaceKt.m2648SurfaceT9BRK9s(graphicsLayer, shape, j, 0L, f, f2, borderStroke, rememberComposableLambda, startRestartGroup, (i4 & 896) | (i4 & 112) | 12582912 | (57344 & i5) | (458752 & i5) | (i5 & 3670016), 8);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    MenuKt.m2346DropdownMenuContentQj0Zi0g(Modifier.this, mutableTransitionState, mutableState, scrollState, shape, j, f, f2, borderStroke, function3, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void DropdownMenuItemContent(final Function2<? super Composer, ? super Integer, Unit> function2, final Function0<Unit> function0, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final boolean z, final MenuItemColors menuItemColors, final PaddingValues paddingValues, final MutableInteractionSource mutableInteractionSource, Composer composer, final int i) {
        ...
        if ((38347923 & i2) != 38347922 || !startRestartGroup.getSkipping()) {
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m1100sizeInqDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.m590clickableO2vRcR0$default(modifier, mutableInteractionSource, RippleKt.m2512rippleOrFallbackImplementation9IZ8Weo(true, 0.0f, 0L, startRestartGroup, 6, 6), z, null, null, function0, 24, null), 0.0f, 1, null), DropdownMenuItemDefaultMinWidth, MenuListItemContainerHeight, DropdownMenuItemDefaultMaxWidth, 0.0f, 8, null), paddingValues);
            ...
            TextKt.ProvideTextStyle(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6).getLabelLarge(), ComposableLambdaKt.rememberComposableLambda(1065051884, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ...
                    if ((i3 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            ProvidedValue<Color> provides = ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(menuItemColors.m2343leadingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides, ComposableLambdaKt.rememberComposableLambda(2035552199, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.1
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m1081defaultMinSizeVpY3zN4$default = SizeKt.m1081defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3432getListItemLeadingIconSizeD9Ej5fM(), 0.0f, 2, null);
                                        ...
                                        Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer3, m1081defaultMinSizeVpY3zN4$default);
                        ...
                        ProvidedValue<Color> provides2 = ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(menuItemColors.m2344textColorvNxB06k$material3_release(z)));
                        ...
                        CompositionLocalKt.CompositionLocalProvider(provides2, ComposableLambdaKt.rememberComposableLambda(-1728894036, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.2
                            ...
                            public final void invoke(Composer composer3, int i4) {
                                ...
                                if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    if (function25 != null) {
                                        m6989constructorimpl = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m6989constructorimpl = Dp.m6989constructorimpl(0.0f);
                                    }
                                    float f = m6989constructorimpl;
                                    if (function26 != null) {
                                        m6989constructorimpl2 = MenuKt.DropdownMenuItemHorizontalPadding;
                                    } else {
                                        m6989constructorimpl2 = Dp.m6989constructorimpl(0.0f);
                                    }
                                    Modifier m1053paddingqDBjuR0$default = PaddingKt.m1053paddingqDBjuR0$default(weight$default, f, 0.0f, m6989constructorimpl2, 0.0f, 10, null);
                        ...
                        if (function23 != null) {
                            ProvidedValue<Color> provides3 = ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(menuItemColors.m2345trailingIconColorvNxB06k$material3_release(z)));
                            ...
                            CompositionLocalKt.CompositionLocalProvider(provides3, ComposableLambdaKt.rememberComposableLambda(580312062, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.MenuKt$DropdownMenuItemContent$1$1.3
                                ...
                                public final void invoke(Composer composer3, int i4) {
                                    ...
                                    if ((i4 & 3) != 2 || !composer3.getSkipping()) {
                                        ...
                                        Modifier m1081defaultMinSizeVpY3zN4$default = SizeKt.m1081defaultMinSizeVpY3zN4$default(Modifier.INSTANCE, ListTokens.INSTANCE.m3440getListItemTrailingIconSizeD9Ej5fM(), 0.0f, 2, null);
