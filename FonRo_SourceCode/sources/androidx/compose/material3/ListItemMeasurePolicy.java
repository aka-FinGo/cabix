...
public final class ListItemMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult mo996measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j) {
        ...
        float m2308verticalPaddingyh95HIg;
        long j2;
        Placeable placeable;
        ...
        float m2308verticalPaddingyh95HIg2;
        int m2307calculateWidthyeHjK3Y;
        int m2306calculateHeightN4Jib3Y;
        MeasureResult place;
        ...
        int i = measureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(listItemStartPadding + listItemEndPadding));
        Measurable measurable = (Measurable) CollectionsKt.firstOrNull((List) list6);
        int minIntrinsicWidth = measurable != null ? measurable.minIntrinsicWidth(Constraints.m6941getMaxHeightimpl(j)) : 0;
        Measurable measurable2 = (Measurable) CollectionsKt.firstOrNull((List) list7);
        subtractConstraintSafely = ListItemKt.subtractConstraintSafely(Constraints.m6942getMaxWidthimpl(m6932copyZbe2FdA$default), minIntrinsicWidth + (measurable2 != null ? measurable2.minIntrinsicWidth(Constraints.m6941getMaxHeightimpl(j)) : 0) + i);
        ...
        m2308verticalPaddingyh95HIg = ListItemKt.m2308verticalPaddingyh95HIg(ListItemType.INSTANCE.m2321invokeZLSjz4$material3_release(CollectionsKt.firstOrNull((List) list4) != null, CollectionsKt.firstOrNull((List) list5) != null, isSupportingMultilineHeuristic));
        long m6961offsetNN6EwU = ConstraintsKt.m6961offsetNN6EwU(m6932copyZbe2FdA$default, -i, -measureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(m2308verticalPaddingyh95HIg * 2.0f)));
        Measurable measurable4 = (Measurable) CollectionsKt.firstOrNull((List) list6);
        Placeable mo5732measureBRTryo0 = measurable4 != null ? measurable4.mo5732measureBRTryo0(m6961offsetNN6EwU) : null;
        ...
        if (measurable5 != null) {
            j2 = m6961offsetNN6EwU;
            placeable = measurable5.mo5732measureBRTryo0(ConstraintsKt.m6962offsetNN6EwU$default(j2, -widthOrZero, 0, 2, null));
        } else {
            j2 = m6961offsetNN6EwU;
            placeable = null;
        }
        ...
        if (measurable6 != null) {
            list2 = list4;
            j3 = j2;
            placeable2 = measurable6.mo5732measureBRTryo0(ConstraintsKt.m6962offsetNN6EwU$default(j2, -widthOrZero2, 0, 2, null));
        } else {
            list2 = list4;
            j3 = j2;
            placeable2 = null;
        ...
        if (measurable7 != null) {
            ...
            placeable3 = measurable7.mo5732measureBRTryo0(ConstraintsKt.m6961offsetNN6EwU(j3, -widthOrZero2, -heightOrZero));
        } else {
            f = listItemStartPadding;
            placeable3 = null;
        }
        ...
        Placeable mo5732measureBRTryo02 = measurable8 != null ? measurable8.mo5732measureBRTryo0(ConstraintsKt.m6961offsetNN6EwU(j3, -widthOrZero2, -heightOrZero2)) : null;
        int m2321invokeZLSjz4$material3_release = ListItemType.INSTANCE.m2321invokeZLSjz4$material3_release(mo5732measureBRTryo02 != null, placeable3 != null, z);
        m2308verticalPaddingyh95HIg2 = ListItemKt.m2308verticalPaddingyh95HIg(m2321invokeZLSjz4$material3_release);
        float m6989constructorimpl = Dp.m6989constructorimpl(2.0f * m2308verticalPaddingyh95HIg2);
        MeasureScope measureScope2 = measureScope;
        m2307calculateWidthyeHjK3Y = ListItemKt.m2307calculateWidthyeHjK3Y(measureScope2, TextFieldImplKt.widthOrZero(mo5732measureBRTryo0), TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeable2), TextFieldImplKt.widthOrZero(mo5732measureBRTryo02), TextFieldImplKt.widthOrZero(placeable3), i, j);
        m2306calculateHeightN4Jib3Y = ListItemKt.m2306calculateHeightN4Jib3Y(measureScope2, TextFieldImplKt.heightOrZero(mo5732measureBRTryo0), TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeable2), TextFieldImplKt.heightOrZero(mo5732measureBRTryo02), TextFieldImplKt.heightOrZero(placeable3), m2321invokeZLSjz4$material3_release, measureScope.mo694roundToPx0680j_4(m6989constructorimpl), j);
        Placeable placeable4 = placeable2;
        place = ListItemKt.place(measureScope, m2307calculateWidthyeHjK3Y, m2306calculateHeightN4Jib3Y, mo5732measureBRTryo0, placeable, placeable4, mo5732measureBRTryo02, placeable3, ListItemType.m2313equalsimpl0(m2321invokeZLSjz4$material3_release, ListItemType.INSTANCE.m2319getThreeLineAlXitO8()), measureScope.mo694roundToPx0680j_4(f), measureScope.mo694roundToPx0680j_4(listItemEndPadding), measureScope.mo694roundToPx0680j_4(m2308verticalPaddingyh95HIg2));
        return place;
    }
    ...
    private final int calculateIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        m2307calculateWidthyeHjK3Y = ListItemKt.m2307calculateWidthyeHjK3Y(intrinsicMeasureScope, intValue, intValue2, intValue3, intValue4, intrinsicMeasurable5 != null ? function2.invoke(intrinsicMeasurable5, Integer.valueOf(i)).intValue() : 0, intrinsicMeasureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(ListItemKt.getListItemStartPadding() + ListItemKt.getListItemEndPadding())), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
        return m2307calculateWidthyeHjK3Y;
    }
    ...
    private final int calculateIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends List<? extends IntrinsicMeasurable>> list, int i, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> function2) {
        ...
        List<? extends IntrinsicMeasurable> list5 = list.get(3);
        List<? extends IntrinsicMeasurable> list6 = list.get(4);
        subtractConstraintSafely = ListItemKt.subtractConstraintSafely(i, intrinsicMeasureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(ListItemKt.getListItemStartPadding() + ListItemKt.getListItemEndPadding())));
        IntrinsicMeasurable intrinsicMeasurable = (IntrinsicMeasurable) CollectionsKt.firstOrNull((List) list5);
        ...
        int m2321invokeZLSjz4$material3_release = ListItemType.INSTANCE.m2321invokeZLSjz4$material3_release(intValue > 0, intValue3 > 0, isSupportingMultilineHeuristic);
        m2308verticalPaddingyh95HIg = ListItemKt.m2308verticalPaddingyh95HIg(m2321invokeZLSjz4$material3_release);
        int i4 = intValue2;
        int i5 = intValue;
        m2306calculateHeightN4Jib3Y = ListItemKt.m2306calculateHeightN4Jib3Y(intrinsicMeasureScope, i2, i3, i4, i5, intValue3, m2321invokeZLSjz4$material3_release, intrinsicMeasureScope.mo694roundToPx0680j_4(Dp.m6989constructorimpl(m2308verticalPaddingyh95HIg * 2.0f)), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null));
        return m2306calculateHeightN4Jib3Y;
    }
}
