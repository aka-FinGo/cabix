...
public final class PullToRefreshModifierNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, NestedScrollConnection {
    ...
    public final void m3129setThreshold0680j_4(float f) {
        this.threshold = f;
    }
    ...
    public final int getThresholdPx() {
        return ((Density) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalDensity())).mo694roundToPx0680j_4(this.threshold);
    }
    ...
    public long mo1127onPreScrollOzD1aCk(long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m5488equalsimpl0(source, NestedScrollSource.INSTANCE.m5500getUserInputWNlRxjI()) && Offset.m4126getYimpl(available) < 0.0f) {
                return m3127consumeAvailableOffsetMKHz9U(available);
            }
    ...
    public long mo821onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (!this.state.isAnimating() && this.enabled) {
            if (NestedScrollSource.m5488equalsimpl0(source, NestedScrollSource.INSTANCE.m5500getUserInputWNlRxjI())) {
                long m3127consumeAvailableOffsetMKHz9U = m3127consumeAvailableOffsetMKHz9U(available);
                ...
                return m3127consumeAvailableOffsetMKHz9U;
            }
            return Offset.INSTANCE.m4141getZeroF1C5BW0();
        }
        return Offset.INSTANCE.m4141getZeroF1C5BW0();
    ...
    */
    public java.lang.Object mo1126onPreFlingQWom1Mo(long r5, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r7) {
        /*
            r4 = this;
        ...
        L34:
            kotlin.ResultKt.throwOnFailure(r7)
            float r5 = androidx.compose.ui.unit.Velocity.m7228getYimpl(r5)
            r6 = 0
            r0.F$0 = r6
            r0.label = r3
        ...
        L48:
            ...
            long r4 = androidx.compose.ui.unit.VelocityKt.Velocity(r4, r5)
            androidx.compose.ui.unit.Velocity r4 = androidx.compose.ui.unit.Velocity.m7218boximpl(r4)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.pulltorefresh.PullToRefreshModifierNode.mo1126onPreFlingQWom1Mo(long, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final long m3127consumeAvailableOffsetMKHz9U(long available) {
        float distancePulled;
        if (this.isRefreshing) {
            distancePulled = 0.0f;
        } else {
            float coerceAtLeast = RangesKt.coerceAtLeast(getDistancePulled() + Offset.m4126getYimpl(available), 0.0f);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0069, code lost:
        ...
        if (animateToThreshold(r0) == r1) goto L28;
     */
    /* JADX WARN: Code restructure failed: missing block: B:33:0x007c, code lost:
    
        if (animateToHidden(r0) == r1) goto L28;
     */
    ...
    */
    public final java.lang.Object onRelease(float r7, kotlin.coroutines.Continuation<? super java.lang.Float> r8) {
        ...
        L52:
            ...
            goto L7e
        L6c:
            kotlin.jvm.functions.Function0<kotlin.Unit> r8 = r6.onRefresh
            r8.invoke()
            goto L7f
        L72:
            r0.L$0 = r6
    ...
    private final float calculateVerticalOffset() {
        ...
        return getThresholdPx() + (getThresholdPx() * (coerceIn - (((float) Math.pow(coerceIn, 2.0d)) / 4.0f)));
    }
