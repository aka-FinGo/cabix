...
public final class TabIndicatorOffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (z) {
            width = state.getValue().get(this.selectedTabIndex).getContentWidth();
        } else {
            width = state.getValue().get(this.selectedTabIndex).getWidth();
        }
        if (this.initialWidth != null) {
            ...
            if (!Dp.m6994equalsimpl0(width, animatable.getTargetValue().m7003unboximpl())) {
            ...
            this.initialWidth = Dp.m6987boximpl(width);
        }
        ...
        if (this.initialOffset != null) {
            ...
            if (!Dp.m6994equalsimpl0(left, animatable3.getTargetValue().m7003unboximpl())) {
            ...
            this.initialOffset = Dp.m6987boximpl(left);
        }
        ...
        if (layoutDirection != layoutDirection2) {
            if (animatable5 != null) {
                left = animatable5.getValue().m7003unboximpl();
            }
            left = Dp.m6989constructorimpl(-left);
        } else if (animatable5 != null) {
            left = animatable5.getValue().m7003unboximpl();
        }
        Animatable<Dp, AnimationVector1D> animatable6 = this.widthAnimatable;
        if (animatable6 != null) {
            width = animatable6.getValue().m7003unboximpl();
        }
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(Constraints.m6932copyZbe2FdA$default(j, measureScope.mo694roundToPx0680j_4(width), measureScope.mo694roundToPx0680j_4(width), 0, 0, 12, null));
        final float f = left;
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.TabIndicatorOffsetNode$measure$4
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.place$default(placementScope, Placeable.this, measureScope.mo694roundToPx0680j_4(f), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
