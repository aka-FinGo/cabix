...
public final class AlertDialogKt {
    private static final float DialogMinWidth = Dp.m6989constructorimpl(280.0f);
    private static final float DialogMaxWidth = Dp.m6989constructorimpl(560.0f);
    private static final float ButtonsMainAxisSpacing = Dp.m6989constructorimpl(8.0f);
    private static final float ButtonsCrossAxisSpacing = Dp.m6989constructorimpl(12.0f);
    private static final PaddingValues DialogPadding = PaddingKt.m1042PaddingValues0680j_4(Dp.m6989constructorimpl(24.0f));
    private static final PaddingValues IconPadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6989constructorimpl(16.0f), 7, null);
    private static final PaddingValues TitlePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6989constructorimpl(16.0f), 7, null);
    private static final PaddingValues TextPadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m6989constructorimpl(24.0f), 7, null);
    ...
    */
    ...
    public static final void m1863AlertDialogImplwrnwzgE(final Function0<Unit> function0, final Function2<? super Composer, ? super Integer, Unit> function2, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Shape shape, final long j, final long j2, final long j3, final long j4, final float f, final DialogProperties dialogProperties, Composer composer, final int i, final int i2) {
            ...
            BasicAlertDialog(function0, modifier, dialogProperties, ComposableLambdaKt.rememberComposableLambda(-1852840226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1
                ...
                public final void invoke(Composer composer2, int i6) {
                    ...
                    if ((i6 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        AlertDialogKt.m1861AlertDialogContent4hvqGtA(ComposableLambdaKt.rememberComposableLambda(1163543932, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                if ((i7 & 3) != 2 || !composer3.getSkipping()) {
                                    ...
                                    AlertDialogKt.m1862AlertDialogFlowRowixp7dh8(f4, f5, ComposableLambdaKt.rememberComposableLambda(1887135077, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt.AlertDialogImpl.1.1.1
                                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                        /* JADX WARN: Multi-variable type inference failed */
                                        {
                                            super(2);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogImpl$2
                ...
                public final void invoke(Composer composer2, int i6) {
                    AlertDialogKt.m1863AlertDialogImplwrnwzgE(function0, function2, modifier, function22, function23, function24, function25, shape, j, j2, j3, j4, f, dialogProperties, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
                }
            });
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1861AlertDialogContent4hvqGtA(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r29, androidx.compose.ui.Modifier r30, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r31, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r33, final androidx.compose.ui.graphics.Shape r34, final long r35, final float r37, final long r38, final long r40, final long r42, final long r44, androidx.compose.runtime.Composer r46, final int r47, final int r48, final int r49) {
        /*
            Method dump skipped, instructions count: 549
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AlertDialogKt.m1861AlertDialogContent4hvqGtA(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.graphics.Shape, long, float, long, long, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* renamed from: AlertDialogFlowRow-ixp7dh8, reason: not valid java name */
    public static final void m1862AlertDialogFlowRowixp7dh8(final float f, final float f2, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
                ...
                rememberedValue = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1
                    ...
                    public final MeasureResult mo356measure3p2s80s(final MeasureScope measureScope, List<? extends Measurable> list, long j) {
                        ...
                        while (i4 < size) {
                            ...
                            Placeable mo5732measureBRTryo0 = list.get(i4).mo5732measureBRTryo0(j);
                            Ref.IntRef intRef5 = intRef3;
                            intRef3 = intRef5;
                            if (measure_3p2s80s$canAddToCurrentSequence(arrayList4, intRef5, measureScope, f3, j, mo5732measureBRTryo0)) {
                                i3 = i4;
                            ...
                            if (!arrayList4.isEmpty()) {
                                intRef3.element += measureScope.mo694roundToPx0680j_4(f3);
                            }
                            arrayList4.add(mo5732measureBRTryo0);
                            intRef3.element += mo5732measureBRTryo0.getWidth();
                            intRef4.element = Math.max(intRef4.element, mo5732measureBRTryo0.getHeight());
                            i4 = i3 + 1;
                            size = i5;
                        }
                        if (!arrayList4.isEmpty()) {
                        ...
                        final int max = Math.max(intRef.element, Constraints.m6944getMinWidthimpl(j));
                        int max2 = Math.max(intRef2.element, Constraints.m6943getMinHeightimpl(j));
                        ...
                        return MeasureScope.layout$default(measureScope, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$1.2
                            ...
                            public final void invoke2(Placeable.PlacementScope placementScope) {
                                ...
                                for (int i7 = 0; i7 < size2; i7++) {
                                    ...
                                    int i8 = 0;
                                    while (i8 < size3) {
                                        iArr[i8] = list4.get(i8).getWidth() + (i8 < CollectionsKt.getLastIndex(list4) ? measureScope2.mo694roundToPx0680j_4(f6) : 0);
                                        i8++;
                                    }
                    ...
                    private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, long j, Placeable placeable) {
                        return list.isEmpty() || (intRef.element + measureScope.mo694roundToPx0680j_4(f3)) + placeable.getWidth() <= Constraints.m6942getMaxWidthimpl(j);
                    }
                    ...
                    private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, List<Placeable> list2, List<Integer> list3, Ref.IntRef intRef2, List<Integer> list4, Ref.IntRef intRef3, Ref.IntRef intRef4) {
                        if (!list.isEmpty()) {
                            intRef.element += measureScope.mo694roundToPx0680j_4(f3);
                        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
                ...
                public final void invoke(Composer composer2, int i5) {
                    AlertDialogKt.m1862AlertDialogFlowRowixp7dh8(f, f2, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
