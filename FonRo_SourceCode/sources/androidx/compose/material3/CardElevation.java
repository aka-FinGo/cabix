...
public final class CardElevation {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6987boximpl(this.defaultElevation), null, 2, null);
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            Object animatable2 = new Animatable(Dp.m6987boximpl(f), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
            composer.updateRememberedValue(animatable2);
            rememberedValue3 = animatable2;
        }
        Animatable animatable3 = (Animatable) rememberedValue3;
        ComposerKt.sourceInformationMarkerEnd(composer);
        Dp m6987boximpl = Dp.m6987boximpl(f);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(m6987boximpl, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) rememberedValue4, composer, 0);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m6994equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m6994equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m6994equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m6994equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m6994equalsimpl0(this.disabledElevation, cardElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m6995hashCodeimpl(this.defaultElevation) * 31) + Dp.m6995hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6995hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6995hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m6995hashCodeimpl(this.disabledElevation);
    }
}
