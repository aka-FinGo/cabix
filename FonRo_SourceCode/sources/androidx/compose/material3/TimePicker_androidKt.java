...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m2848getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2847getHorizontalQJTpgSE();
        } else {
            m2848getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m2848getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2848getVerticalQJTpgSE;
    }
}
