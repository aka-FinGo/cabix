...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long mo1127onPreScrollOzD1aCk(long available, int source) {
        if (!this.this$0.getCanScroll().invoke().booleanValue() || Offset.m4126getYimpl(available) > 0.0f) {
    ...
    public long mo821onPostScrollDzOQY0M(long consumed, long available, int source) {
        ...
        if (Offset.m4126getYimpl(available) < 0.0f || Offset.m4126getYimpl(consumed) < 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
        ...
        if (Offset.m4126getYimpl(consumed) == 0.0f && Offset.m4126getYimpl(available) > 0.0f) {
            this.this$0.getState().setContentOffset(0.0f);
        }
        if (Offset.m4126getYimpl(available) > 0.0f) {
    ...
    */
    public java.lang.Object mo820onPostFlingRZ2iAVY(long r6, long r8, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r10) {
        /*
            r5 = this;
            boolean r0 = r10 instanceof androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1$onPostFling$1
            if (r0 == 0) goto L14
            r0 = r10
        ...
        L38:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 r5 = (androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1) r5
            kotlin.ResultKt.throwOnFailure(r0)
            goto L52
        L42:
            kotlin.ResultKt.throwOnFailure(r0)
        ...
        L52:
            ...
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r0 = r5.this$0
            androidx.compose.material3.TopAppBarState r0 = r0.getState()
            float r8 = androidx.compose.ui.unit.Velocity.m7228getYimpl(r8)
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r9 = r5.this$0
            androidx.compose.animation.core.DecayAnimationSpec r9 = r9.getFlingAnimationSpec()
            androidx.compose.material3.ExitUntilCollapsedScrollBehavior r5 = r5.this$0
        ...
        L7d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo820onPostFlingRZ2iAVY(long, long, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
