...
public final class ListItemKt {
    private static final float ListItemVerticalPadding = Dp.m6989constructorimpl(8.0f);
    private static final float ListItemThreeLineVerticalPadding = Dp.m6989constructorimpl(12.0f);
    private static final float ListItemStartPadding = Dp.m6989constructorimpl(16.0f);
    private static final float ListItemEndPadding = Dp.m6989constructorimpl(16.0f);
    private static final float LeadingContentEndPadding = Dp.m6989constructorimpl(16.0f);
    private static final float TrailingContentStartPadding = Dp.m6989constructorimpl(16.0f);
    ...
    */
    public static final void m2300ListItemHXNGIdc(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r36, androidx.compose.ui.Modifier r37, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r38, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r39, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r40, kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r41, androidx.compose.material3.ListItemColors r42, float r43, float r44, androidx.compose.runtime.Composer r45, final int r46, final int r47) {
        /*
            Method dump skipped, instructions count: 768
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ListItemKt.m2300ListItemHXNGIdc(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.material3.ListItemColors, float, float, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void ListItemLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, Composer composer, final int i) {
        ...
        if ((i2 & 9363) != 9362 || !startRestartGroup.getSkipping()) {
            ...
            function2Arr[1] = function24 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2070getLambda1$material3_release() : function24;
            function2Arr[2] = function25 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2071getLambda2$material3_release() : function25;
            function2Arr[3] = function2 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2072getLambda3$material3_release() : function2;
            function2Arr[4] = function22 == null ? ComposableSingletons$ListItemKt.INSTANCE.m2073getLambda4$material3_release() : function22;
    ...
    public static final int m2307calculateWidthyeHjK3Y(IntrinsicMeasureScope intrinsicMeasureScope, int i, int i2, int i3, int i4, int i5, int i6, long j) {
        if (Constraints.m6938getHasBoundedWidthimpl(j)) {
            return Constraints.m6942getMaxWidthimpl(j);
        }
    ...
    public static final int m2306calculateHeightN4Jib3Y(IntrinsicMeasureScope intrinsicMeasureScope, int i, int i2, int i3, int i4, int i5, int i6, int i7, long j) {
        float m3442getListItemTwoLineContainerHeightD9Ej5fM;
        if (ListItemType.m2313equalsimpl0(i6, ListItemType.INSTANCE.m2318getOneLineAlXitO8())) {
            m3442getListItemTwoLineContainerHeightD9Ej5fM = ListTokens.INSTANCE.m3437getListItemOneLineContainerHeightD9Ej5fM();
        } else {
            m3442getListItemTwoLineContainerHeightD9Ej5fM = ListItemType.m2313equalsimpl0(i6, ListItemType.INSTANCE.m2320getTwoLineAlXitO8()) ? ListTokens.INSTANCE.m3442getListItemTwoLineContainerHeightD9Ej5fM() : ListTokens.INSTANCE.m3439getListItemThreeLineContainerHeightD9Ej5fM();
        }
        return RangesKt.coerceAtMost(Math.max(Math.max(Constraints.m6943getMinHeightimpl(j), intrinsicMeasureScope.mo694roundToPx0680j_4(m3442getListItemTwoLineContainerHeightD9Ej5fM)), i7 + Math.max(i, Math.max(i3 + i4 + i5, i2))), Constraints.m6941getMaxHeightimpl(j));
    }
    ...
    public static final void m2301ProvideTextStyleFromToken3JVO9M(long j, final TypographyKeyTokens typographyKeyTokens, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        long j2;
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            j2 = j;
            ProvideContentColorTextStyleKt.m3029ProvideContentColorTextStyle3JVO9M(j2, TypographyKt.getValue(typographyKeyTokens, startRestartGroup, (i2 >> 3) & 14), function2, startRestartGroup, i2 & 910);
        ...
        if (endRestartGroup != null) {
            ...
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ListItemKt$ProvideTextStyleFromToken$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    ListItemKt.m2301ProvideTextStyleFromToken3JVO9M(j3, typographyKeyTokens, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final boolean isSupportingMultilineHeuristic(Density density, int i) {
        return i > density.mo693roundToPxR2X_6o(TextUnitKt.getSp(30));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: verticalPadding-yh95HIg, reason: not valid java name */
    public static final float m2308verticalPaddingyh95HIg(int i) {
        return ListItemType.m2313equalsimpl0(i, ListItemType.INSTANCE.m2319getThreeLineAlXitO8()) ? ListItemThreeLineVerticalPadding : ListItemVerticalPadding;
    }
}
