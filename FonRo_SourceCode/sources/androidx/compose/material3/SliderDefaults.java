...
public final class SliderDefaults {
    ...
    private static final float TrackStopIndicatorSize = SliderTokens.INSTANCE.m3625getStopIndicatorSizeD9Ej5fM();
    private static final float TickSize = SliderTokens.INSTANCE.m3625getStopIndicatorSizeD9Ej5fM();
    ...
    public final SliderColors m2600colorsq0g_0yA(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, Composer composer, int i, int i2, int i3) {
        long j11;
        ...
        long m4420getUnspecified0d7_KjU = (i3 & 1) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j;
        long m4420getUnspecified0d7_KjU2 = (i3 & 2) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j2;
        long m4420getUnspecified0d7_KjU3 = (i3 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        long m4420getUnspecified0d7_KjU4 = (i3 & 8) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j4;
        long m4420getUnspecified0d7_KjU5 = (i3 & 16) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j5;
        long m4420getUnspecified0d7_KjU6 = (i3 & 32) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j6;
        long m4420getUnspecified0d7_KjU7 = (i3 & 64) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j7;
        long m4420getUnspecified0d7_KjU8 = (i3 & 128) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j8;
        long m4420getUnspecified0d7_KjU9 = (i3 & 256) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j9;
        long m4420getUnspecified0d7_KjU10 = (i3 & 512) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j10;
        if (ComposerKt.isTraceInProgress()) {
            j11 = m4420getUnspecified0d7_KjU;
            ComposerKt.traceEventStart(885588574, i, i2, "androidx.compose.material3.SliderDefaults.colors (Slider.kt:887)");
        } else {
            j11 = m4420getUnspecified0d7_KjU;
        }
        SliderColors m2578copyK518z4 = getDefaultSliderColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2578copyK518z4(j11, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3, m4420getUnspecified0d7_KjU4, m4420getUnspecified0d7_KjU5, m4420getUnspecified0d7_KjU6, m4420getUnspecified0d7_KjU7, m4420getUnspecified0d7_KjU8, m4420getUnspecified0d7_KjU9, m4420getUnspecified0d7_KjU10);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2578copyK518z4;
    }
    ...
    public final SliderColors getDefaultSliderColors$material3_release(ColorScheme colorScheme) {
        ...
        SliderColors sliderColors = new SliderColors(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getHandleColor()), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getActiveTrackColor()), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getInactiveTrackColor()), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getInactiveTrackColor()), ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getActiveTrackColor()), ColorKt.m4429compositeOverOWjLjI(Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledHandleColor()), SliderTokens.INSTANCE.getDisabledHandleOpacity(), 0.0f, 0.0f, 0.0f, 14, null), colorScheme.getSurface()), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledActiveTrackColor()), SliderTokens.INSTANCE.getDisabledActiveTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledInactiveTrackColor()), SliderTokens.INSTANCE.getDisabledInactiveTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledInactiveTrackColor()), SliderTokens.INSTANCE.getDisabledInactiveTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, SliderTokens.INSTANCE.getDisabledActiveTrackColor()), SliderTokens.INSTANCE.getDisabledActiveTrackOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    */
    public final void m2597Thumb9LiSoMs(final androidx.compose.foundation.interaction.MutableInteractionSource r24, androidx.compose.ui.Modifier r25, androidx.compose.material3.SliderColors r26, boolean r27, long r28, androidx.compose.runtime.Composer r30, final int r31, final int r32) {
        /*
            Method dump skipped, instructions count: 457
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderDefaults.m2597Thumb9LiSoMs(androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.Modifier, androidx.compose.material3.SliderColors, boolean, long, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m2599Track4EFweAY(final androidx.compose.material3.SliderState r25, androidx.compose.ui.Modifier r26, boolean r27, androidx.compose.material3.SliderColors r28, kotlin.jvm.functions.Function2<? super androidx.compose.ui.graphics.drawscope.DrawScope, ? super androidx.compose.ui.geometry.Offset, kotlin.Unit> r29, kotlin.jvm.functions.Function3<? super androidx.compose.ui.graphics.drawscope.DrawScope, ? super androidx.compose.ui.geometry.Offset, ? super androidx.compose.ui.graphics.Color, kotlin.Unit> r30, float r31, float r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 767
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderDefaults.m2599Track4EFweAY(androidx.compose.material3.SliderState, androidx.compose.ui.Modifier, boolean, androidx.compose.material3.SliderColors, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, float, float, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void m2598Track4EFweAY(final androidx.compose.material3.RangeSliderState r25, androidx.compose.ui.Modifier r26, boolean r27, androidx.compose.material3.SliderColors r28, kotlin.jvm.functions.Function2<? super androidx.compose.ui.graphics.drawscope.DrawScope, ? super androidx.compose.ui.geometry.Offset, kotlin.Unit> r29, kotlin.jvm.functions.Function3<? super androidx.compose.ui.graphics.drawscope.DrawScope, ? super androidx.compose.ui.geometry.Offset, ? super androidx.compose.ui.graphics.Color, kotlin.Unit> r30, float r31, float r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 767
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderDefaults.m2598Track4EFweAY(androidx.compose.material3.RangeSliderState, androidx.compose.ui.Modifier, boolean, androidx.compose.material3.SliderColors, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function3, float, float, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawTrack-ngJ0SCU, reason: not valid java name */
    public final void m2595drawTrackngJ0SCU(DrawScope drawScope, float[] fArr, float f, float f2, long j, long j2, long j3, long j4, float f3, float f4, float f5, float f6, float f7, Function2<? super DrawScope, ? super Offset, Unit> function2, Function3<? super DrawScope, ? super Offset, ? super Color, Unit> function3, boolean z) {
        float f8;
        float f9;
        float f10;
        float f11;
        float f12;
        long Offset = OffsetKt.Offset(0.0f, Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()));
        long Offset2 = OffsetKt.Offset(Size.m4194getWidthimpl(drawScope.mo4935getSizeNHjbRc()), Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()));
        float f13 = drawScope.mo700toPx0680j_4(f3);
        long Offset3 = OffsetKt.Offset(Offset.m4125getXimpl(Offset) + ((Offset.m4125getXimpl(Offset2) - Offset.m4125getXimpl(Offset)) * f2), Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()));
        long Offset4 = OffsetKt.Offset(Offset.m4125getXimpl(Offset) + ((Offset.m4125getXimpl(Offset2) - Offset.m4125getXimpl(Offset)) * f), Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()));
        float f14 = f13 / 2.0f;
        float f15 = drawScope.mo700toPx0680j_4(f7);
        if (Dp.m6988compareTo0680j_4(f6, Dp.m6989constructorimpl(0.0f)) > 0) {
            f8 = (drawScope.mo700toPx0680j_4(f4) / 2.0f) + drawScope.mo700toPx0680j_4(f6);
            f9 = (drawScope.mo700toPx0680j_4(f5) / 2.0f) + drawScope.mo700toPx0680j_4(f6);
        } else {
            f8 = 0.0f;
            f9 = 0.0f;
        }
        if (!z || Offset.m4125getXimpl(Offset4) <= Offset.m4125getXimpl(Offset) + f8 + f14) {
            f10 = f13;
        } else {
            float m4125getXimpl = Offset.m4125getXimpl(Offset);
            f10 = f13;
            m2596drawTrackPathCx2C_VA(drawScope, Offset.INSTANCE.m4141getZeroF1C5BW0(), SizeKt.Size((Offset.m4125getXimpl(Offset4) - f8) - m4125getXimpl, f13), j, f14, f15);
            if (function2 != null) {
                function2.invoke(drawScope, Offset.m4114boximpl(OffsetKt.Offset(m4125getXimpl + f14, Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()))));
            }
        }
        if (Offset.m4125getXimpl(Offset3) < (Offset.m4125getXimpl(Offset2) - f9) - f14) {
            float m4125getXimpl2 = Offset.m4125getXimpl(Offset3) + f9;
            float m4125getXimpl3 = Offset.m4125getXimpl(Offset2);
            float f16 = f10;
            f11 = f16;
            m2596drawTrackPathCx2C_VA(drawScope, OffsetKt.Offset(m4125getXimpl2, 0.0f), SizeKt.Size(m4125getXimpl3 - m4125getXimpl2, f16), j, f15, f14);
            f12 = f14;
            f15 = f15;
            if (function2 != null) {
                function2.invoke(drawScope, Offset.m4114boximpl(OffsetKt.Offset(m4125getXimpl3 - f12, Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()))));
            }
        } else {
            f11 = f10;
            f12 = f14;
        }
        float m4125getXimpl4 = z ? Offset.m4125getXimpl(Offset4) + f8 : 0.0f;
        float m4125getXimpl5 = Offset.m4125getXimpl(Offset3) - f9;
        float f17 = z ? f15 : f12;
        float f18 = m4125getXimpl5 - m4125getXimpl4;
        if (f18 > f17) {
            m2596drawTrackPathCx2C_VA(drawScope, OffsetKt.Offset(m4125getXimpl4, 0.0f), SizeKt.Size(f18, f11), j2, f17, f15);
        }
        long Offset5 = OffsetKt.Offset(Offset.m4125getXimpl(Offset) + f12, Offset.m4126getYimpl(Offset));
        long Offset6 = OffsetKt.Offset(Offset.m4125getXimpl(Offset2) - f12, Offset.m4126getYimpl(Offset2));
        ClosedFloatingPointRange<Float> rangeTo = RangesKt.rangeTo(Offset.m4125getXimpl(Offset4) - f8, Offset.m4125getXimpl(Offset4) + f8);
        ClosedFloatingPointRange<Float> rangeTo2 = RangesKt.rangeTo(Offset.m4125getXimpl(Offset3) - f9, Offset.m4125getXimpl(Offset3) + f9);
        ...
        while (i < length) {
            ...
            if (function2 == null || ((!z || i2 != 0) && i2 != fArr.length - 1)) {
                ...
                long Offset7 = OffsetKt.Offset(Offset.m4125getXimpl(OffsetKt.m4148lerpWko1d7g(Offset5, Offset6, f19)), Offset.m4126getYimpl(drawScope.mo4934getCenterF1C5BW0()));
                if ((!z || !rangeTo.contains(Float.valueOf(Offset.m4125getXimpl(Offset7)))) && !rangeTo2.contains(Float.valueOf(Offset.m4125getXimpl(Offset7)))) {
                    function3.invoke(drawScope, Offset.m4114boximpl(Offset7), Color.m4374boximpl(z2 ? j3 : j4));
                    i++;
                    i2 = i3;
                }
            }
    ...
    private final void m2596drawTrackPathCx2C_VA(DrawScope drawScope, long j, long j2, long j3, float f, float f2) {
        long CornerRadius = CornerRadiusKt.CornerRadius(f, f);
        long CornerRadius2 = CornerRadiusKt.CornerRadius(f2, f2);
        RoundRect m4177RoundRectZAM2FJo = RoundRectKt.m4177RoundRectZAM2FJo(RectKt.m4165Recttz77jQw(OffsetKt.Offset(Offset.m4125getXimpl(j), 0.0f), SizeKt.Size(Size.m4194getWidthimpl(j2), Size.m4191getHeightimpl(j2))), CornerRadius, CornerRadius2, CornerRadius2, CornerRadius);
        Path path = trackPath;
        Path.addRoundRect$default(path, m4177RoundRectZAM2FJo, null, 2, null);
        DrawScope.m4925drawPathLG529CI$default(drawScope, path, j3, 0.0f, null, null, 0, 60, null);
        path.rewind();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawStopIndicator-x3O1jOs, reason: not valid java name */
    public final void m2594drawStopIndicatorx3O1jOs(DrawScope drawScope, long offset, float size, long color) {
        DrawScope.m4916drawCircleVaOC9Bg$default(drawScope, color, drawScope.mo700toPx0680j_4(size) / 2.0f, offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
    }

    /* renamed from: getTrackStopIndicatorSize-D9Ej5fM, reason: not valid java name */
    public final float m2602getTrackStopIndicatorSizeD9Ej5fM() {
        return TrackStopIndicatorSize;
    }

    /* renamed from: getTickSize-D9Ej5fM, reason: not valid java name */
    public final float m2601getTickSizeD9Ej5fM() {
        return TickSize;
    }
}
