...
public final class TextFieldImplKt {
    ...
    private static final float TextFieldPadding = Dp.m6989constructorimpl(16.0f);
    private static final float HorizontalIconPadding = Dp.m6989constructorimpl(12.0f);
    private static final float SupportingTopPadding = Dp.m6989constructorimpl(4.0f);
    private static final float PrefixSuffixTextPadding = Dp.m6989constructorimpl(2.0f);
    private static final float MinTextLineHeight = Dp.m6989constructorimpl(24.0f);
    private static final float MinFocusedLabelLineHeight = Dp.m6989constructorimpl(16.0f);
    private static final float MinSupportingTextLineHeight = Dp.m6989constructorimpl(16.0f);
    private static final Modifier IconDefaultSizeModifier = SizeKt.m1080defaultMinSizeVpY3zN4(Modifier.INSTANCE, Dp.m6989constructorimpl(48.0f), Dp.m6989constructorimpl(48.0f));
    ...
    */
    ...
    public static final void m3103Decoration3JVO9M(long j, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        final long j2;
        ...
        if ((i2 & 147) == 146 && startRestartGroup.getSkipping()) {
            ...
            ProvideContentColorTextStyleKt.m3029ProvideContentColorTextStyle3JVO9M(j, textStyle, function2, startRestartGroup, i2 & 1022);
            j2 = j;
            textStyle2 = textStyle;
            function22 = function2;
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.internal.TextFieldImplKt$Decoration$1
                ...
                public final void invoke(Composer composer2, int i3) {
                    TextFieldImplKt.m3103Decoration3JVO9M(j2, textStyle2, function22, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final void m3104DecorationIv8Zu3U(final long j, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 19) == 18 && startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.m4374boximpl(j)), function2, startRestartGroup, (i2 & 112) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.internal.TextFieldImplKt$Decoration$2
                ...
                public final void invoke(Composer composer2, int i3) {
                    TextFieldImplKt.m3104DecorationIv8Zu3U(j, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
                }
            });
        }
    }
    ...
    public static final Modifier textFieldBackground(Modifier modifier, final ColorProducer colorProducer, final Shape shape) {
        return DrawModifierKt.drawWithCache(modifier, new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.material3.internal.TextFieldImplKt$textFieldBackground$1
            ...
            public final DrawResult invoke(CacheDrawScope cacheDrawScope) {
                final Outline mo614createOutlinePq9zytI = Shape.this.mo614createOutlinePq9zytI(cacheDrawScope.m3986getSizeNHjbRc(), cacheDrawScope.getLayoutDirection(), cacheDrawScope);
                ...
                return cacheDrawScope.onDrawBehind(new Function1<DrawScope, Unit>() { // from class: androidx.compose.material3.internal.TextFieldImplKt$textFieldBackground$1.1
                    ...
                    public final void invoke2(DrawScope drawScope) {
                        OutlineKt.m4643drawOutlinewDX37Ww$default(drawScope, Outline.this, colorProducer2.mo2165invoke0d7_KjU(), 0.0f, null, null, 0, 60, null);
                    }
                });
            }
        });
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static final void m3105TextFieldTransitionScopeJy8F4Js(androidx.compose.material3.internal.InputPhase r24, long r25, long r27, long r29, boolean r31, kotlin.jvm.functions.Function7<? super androidx.compose.runtime.State<java.lang.Float>, ? super androidx.compose.runtime.State<androidx.compose.ui.graphics.Color>, ? super androidx.compose.runtime.State<androidx.compose.ui.graphics.Color>, ? super androidx.compose.runtime.State<java.lang.Float>, ? super androidx.compose.runtime.State<java.lang.Float>, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, int r34) {
        /*
            Method dump skipped, instructions count: 1108
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.internal.TextFieldImplKt.m3105TextFieldTransitionScopeJy8F4Js(androidx.compose.material3.internal.InputPhase, long, long, long, boolean, kotlin.jvm.functions.Function7, androidx.compose.runtime.Composer, int):void");
    }

    /* renamed from: animateBorderStrokeAsState-NuRrP5Q, reason: not valid java name */
    public static final State<BorderStroke> m3108animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, boolean z3, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        long m2760indicatorColorXeAY9LY$material3_release = textFieldColors.m2760indicatorColorXeAY9LY$material3_release(z, z2, z3);
        if (z) {
            composer2.startReplaceGroup(1023053998);
            ComposerKt.sourceInformation(composer2, "445@17754L84");
            rememberUpdatedState = SingleValueAnimationKt.m436animateColorAsStateeuL9pac(m2760indicatorColorXeAY9LY$material3_release, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer2 = composer;
            composer2.endReplaceGroup();
        } else {
            composer2.startReplaceGroup(1023165505);
            ComposerKt.sourceInformation(composer2, "447@17868L33");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m4374boximpl(m2760indicatorColorXeAY9LY$material3_release), composer2, 0);
            composer2.endReplaceGroup();
        }
        ...
        if (z) {
            ...
            rememberUpdatedState2 = AnimateAsStateKt.m448animateDpAsStateAjpBEmI(z3 ? f : f2, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer2, 48, 12);
            composer2.endReplaceGroup();
        } else {
            composer2.startReplaceGroup(1023478388);
            ComposerKt.sourceInformation(composer2, "455@18183L46");
            rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(Dp.m6987boximpl(f2), composer2, (i >> 15) & 14);
            composer2.endReplaceGroup();
        }
        State<BorderStroke> rememberUpdatedState3 = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m585BorderStrokecXLIe8U(rememberUpdatedState2.getValue().m7003unboximpl(), state.getValue().m4394unboximpl()), composer2, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
