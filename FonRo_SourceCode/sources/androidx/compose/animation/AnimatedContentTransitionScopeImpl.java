...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public EnterTransition mo359slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        if (m378isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
                ...
                public final Integer invoke(int i) {
                    long m377getCurrentSizeYbymL2g;
                    long m377getCurrentSizeYbymL2g2;
                    long m376calculateOffsetemnUabE;
                    Function1<Integer, Integer> function1 = initialOffset;
                    m377getCurrentSizeYbymL2g = this.m377getCurrentSizeYbymL2g();
                    AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                    long j = i;
                    long m7155constructorimpl = IntSize.m7155constructorimpl((j & 4294967295L) | (j << 32));
                    m377getCurrentSizeYbymL2g2 = this.m377getCurrentSizeYbymL2g();
                    m376calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m376calculateOffsetemnUabE(m7155constructorimpl, m377getCurrentSizeYbymL2g2);
                    return function1.invoke(Integer.valueOf(((int) (m377getCurrentSizeYbymL2g >> 32)) - IntOffset.m7117getXimpl(m376calculateOffsetemnUabE)));
                }
            });
        }
        if (m379isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
                ...
                public final Integer invoke(int i) {
                    ...
                    long m7155constructorimpl = IntSize.m7155constructorimpl((j & 4294967295L) | (j << 32));
                    m377getCurrentSizeYbymL2g = this.m377getCurrentSizeYbymL2g();
                    m376calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m376calculateOffsetemnUabE(m7155constructorimpl, m377getCurrentSizeYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m7117getXimpl(m376calculateOffsetemnUabE)) - i));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m373getUpDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
                ...
                public final Integer invoke(int i) {
                    ...
                    AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                    long j = i;
                    long m7155constructorimpl = IntSize.m7155constructorimpl((4294967295L & j) | (j << 32));
                    m377getCurrentSizeYbymL2g2 = this.m377getCurrentSizeYbymL2g();
                    m376calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m376calculateOffsetemnUabE(m7155constructorimpl, m377getCurrentSizeYbymL2g2);
                    return function1.invoke(Integer.valueOf(((int) (m377getCurrentSizeYbymL2g & 4294967295L)) - IntOffset.m7118getYimpl(m376calculateOffsetemnUabE)));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m368getDownDKzdypw())) {
            return EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
                ...
                public final Integer invoke(int i) {
                    ...
                    m377getCurrentSizeYbymL2g = this.m377getCurrentSizeYbymL2g();
                    m376calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m376calculateOffsetemnUabE(m7155constructorimpl, m377getCurrentSizeYbymL2g);
                    return function1.invoke(Integer.valueOf((-IntOffset.m7118getYimpl(m376calculateOffsetemnUabE)) - i));
                }
            });
        }
    ...
    private final boolean m378isLeftgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m370getLeftDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m372getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m369getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl;
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m379isRightgWo6LJ4(int i) {
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m371getRightDKzdypw())) {
            return true;
        }
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m372getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) {
            return true;
        }
        return AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m369getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateOffset-emnUabE, reason: not valid java name */
    public final long m376calculateOffsetemnUabE(long fullSize, long currentSize) {
        return getContentAlignment().mo3942alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo360slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        if (m378isLeftgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
                ...
                public final Integer invoke(int i) {
                    ...
                    long m7164unboximpl = state != null ? ((IntSize) state.getValue()).m7164unboximpl() : IntSize.INSTANCE.m7165getZeroYbymL2g();
                    Function1<Integer, Integer> function1 = targetOffset;
                    long j = i;
                    m376calculateOffsetemnUabE = this.this$0.m376calculateOffsetemnUabE(IntSize.m7155constructorimpl((j & 4294967295L) | (j << 32)), m7164unboximpl);
                    return function1.invoke(Integer.valueOf((-IntOffset.m7117getXimpl(m376calculateOffsetemnUabE)) - i));
                }
            });
        }
        if (m379isRightgWo6LJ4(towards)) {
            return EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
                ...
                public final Integer invoke(int i) {
                    ...
                    long j = i;
                    m376calculateOffsetemnUabE = this.this$0.m376calculateOffsetemnUabE(IntSize.m7155constructorimpl((j & 4294967295L) | (j << 32)), m7164unboximpl);
                    return function1.invoke(Integer.valueOf((-IntOffset.m7117getXimpl(m376calculateOffsetemnUabE)) + ((int) (m7164unboximpl >> 32))));
                }
            });
        }
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m373getUpDKzdypw())) {
        ...
        if (AnimatedContentTransitionScope.SlideDirection.m364equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m368getDownDKzdypw())) {
            return EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
                ...
                public final Integer invoke(int i) {
                    ...
                    long j = i;
                    m376calculateOffsetemnUabE = this.this$0.m376calculateOffsetemnUabE(IntSize.m7155constructorimpl((j & 4294967295L) | (j << 32)), m7164unboximpl);
                    return function1.invoke(Integer.valueOf((-IntOffset.m7118getYimpl(m376calculateOffsetemnUabE)) + ((int) (m7164unboximpl & 4294967295L))));
                }
            });
        }
    ...
    public final long m380getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).m7164unboximpl();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m381setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m7152boximpl(j));
    }
    ...
    public final long m377getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        return state != null ? state.getValue().m7164unboximpl() : m380getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    public static final class SizeModifierNode<S> extends LayoutModifierNodeWithPassThroughIntrinsics {
        ...
        public final long m383lastContinuousSizeOrDefaultmzRDjE0(long r5) {
            long j;
            long j2 = this.lastSize;
            j = AnimatedContentKt.UnspecifiedSize;
            return IntSize.m7158equalsimpl0(j2, j) ? r5 : this.lastSize;
        }
        ...
        public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
            final long m7164unboximpl;
            final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(j);
            if (measureScope.isLookingAhead()) {
                m7164unboximpl = IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L));
            } else if (this.sizeAnimation == null) {
                m7164unboximpl = IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L));
                this.lastSize = IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L));
            } else {
                final long m7155constructorimpl = IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L));
                Transition<S>.DeferredAnimation<IntSize, AnimationVector2D> deferredAnimation = this.sizeAnimation;
                ...
                State<IntSize> animate = deferredAnimation.animate(new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$size$1
                    ...
                    public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> segment) {
                        long m7164unboximpl2;
                        FiniteAnimationSpec<IntSize> mo445createAnimationSpecTemP2vQ;
                        ...
                        if (areEqual) {
                            m7164unboximpl2 = sizeModifierNode.m383lastContinuousSizeOrDefaultmzRDjE0(m7155constructorimpl);
                        } else {
                            State<IntSize> state = sizeModifierNode.getScope().getTargetSizeMap$animation_release().get(segment.getInitialState());
                            m7164unboximpl2 = state != null ? state.getValue().m7164unboximpl() : IntSize.INSTANCE.m7165getZeroYbymL2g();
                        }
                        State<IntSize> state2 = this.this$0.getScope().getTargetSizeMap$animation_release().get(segment.getTargetState());
                        long m7164unboximpl3 = state2 != null ? state2.getValue().m7164unboximpl() : IntSize.INSTANCE.m7165getZeroYbymL2g();
                        SizeTransform value = this.this$0.getSizeTransform().getValue();
                        return (value == null || (mo445createAnimationSpecTemP2vQ = value.mo445createAnimationSpecTemP2vQ(m7164unboximpl2, m7164unboximpl3)) == null) ? AnimationSpecKt.spring$default(0.0f, 400.0f, null, 5, null) : mo445createAnimationSpecTemP2vQ;
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                        return IntSize.m7152boximpl(m385invokeYEO4UFw(obj));
                    }

                    /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                    public final long m385invokeYEO4UFw(S s) {
                        long m383lastContinuousSizeOrDefaultmzRDjE0;
                        boolean areEqual = Intrinsics.areEqual(s, this.this$0.getScope().getInitialState());
                        AnimatedContentTransitionScopeImpl.SizeModifierNode<S> sizeModifierNode = this.this$0;
                        if (areEqual) {
                            m383lastContinuousSizeOrDefaultmzRDjE0 = sizeModifierNode.m383lastContinuousSizeOrDefaultmzRDjE0(m7155constructorimpl);
                            return m383lastContinuousSizeOrDefaultmzRDjE0;
                        }
                        State<IntSize> state = sizeModifierNode.getScope().getTargetSizeMap$animation_release().get(s);
                        return state != null ? state.getValue().m7164unboximpl() : IntSize.INSTANCE.m7165getZeroYbymL2g();
                    }
                });
                this.scope.setAnimatedSize$animation_release(animate);
                m7164unboximpl = animate.getValue().m7164unboximpl();
                this.lastSize = animate.getValue().m7164unboximpl();
            }
            return MeasureScope.layout$default(measureScope, (int) (m7164unboximpl >> 32), (int) (m7164unboximpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifierNode$measure$1
                final /* synthetic */ AnimatedContentTransitionScopeImpl.SizeModifierNode<S> this$0;
                ...
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    Placeable.PlacementScope.m5796place70tqf50$default(placementScope, mo5732measureBRTryo0, this.this$0.getScope().getContentAlignment().mo3942alignKFBX0sM(IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L)), m7164unboximpl, LayoutDirection.Ltr), 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
