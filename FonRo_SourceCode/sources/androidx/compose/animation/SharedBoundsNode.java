...
public final class SharedBoundsNode extends Modifier.Node implements ApproachLayoutModifierNode, DrawModifierNode, ModifierLocalModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        float width = mo5732measureBRTryo0.getWidth();
        float height = mo5732measureBRTryo0.getHeight();
        final long m4185constructorimpl = Size.m4185constructorimpl((Float.floatToRawIntBits(height) & 4294967295L) | (Float.floatToRawIntBits(width) << 32));
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    ...
                    long j2 = m4185constructorimpl;
                    rootLookaheadCoords = sharedBoundsNode.getRootLookaheadCoords();
                    long mo5741localPositionOfR5De75A = rootLookaheadCoords.mo5741localPositionOfR5De75A(coordinates, Offset.INSTANCE.m4141getZeroF1C5BW0());
                    ...
                    if (sharedElement2.getCurrentBounds() == null) {
                        ...
                        sharedElement3.setCurrentBounds(RectKt.m4165Recttz77jQw(mo5741localPositionOfR5De75A, j2));
                    }
                    offset = Offset.m4114boximpl(mo5741localPositionOfR5De75A);
                } else {
                    offset = null;
                }
                ...
                if (offset != null) {
                    ...
                    long j3 = m4185constructorimpl;
                    long m4135unboximpl = offset.m4135unboximpl();
                    sharedElement = sharedBoundsNode2.getSharedElement();
                    sharedElement.m428onLookaheadResultv_w8tDc(sharedBoundsNode2.getState(), j3, m4135unboximpl);
                }
            }
        }, 4, null);
    }
    ...
    private final MeasureResult approachPlace(MeasureScope measureScope, final Placeable placeable) {
        ...
        long mo431calculateSizeJyjRU_E = this.state.getPlaceHolderSize().mo431calculateSizeJyjRU_E(requireLookaheadLayoutCoordinates().mo5740getSizeYbymL2g(), IntSize.m7155constructorimpl((placeable.getWidth() << 32) | (placeable.getHeight() & 4294967295L)));
        return MeasureScope.layout$default(measureScope, (int) (mo431calculateSizeJyjRU_E >> 32), (int) (mo431calculateSizeJyjRU_E & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$approachPlace$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates2 != null) {
                    ...
                    offset = Offset.m4114boximpl(rootCoords.mo5741localPositionOfR5De75A(coordinates2, Offset.INSTANCE.m4141getZeroF1C5BW0()));
                } else {
                    offset = null;
                }
                ...
                if (value != null) {
                    ...
                    m4160getTopLeftF1C5BW0 = value.m4160getTopLeftF1C5BW0();
                } else {
                    ...
                    m4160getTopLeftF1C5BW0 = currentBounds2.m4160getTopLeftF1C5BW0();
                }
                long m4129minusMKHz9U = offset != null ? Offset.m4129minusMKHz9U(m4160getTopLeftF1C5BW0, offset.m4135unboximpl()) : Offset.INSTANCE.m4141getZeroF1C5BW0();
                Placeable.PlacementScope.place$default(placementScope, placeable, Math.round(Float.intBitsToFloat((int) (m4129minusMKHz9U >> 32))), Math.round(Float.intBitsToFloat((int) (m4129minusMKHz9U & 4294967295L))), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public MeasureResult mo389approachMeasure3p2s80s(ApproachMeasureScope approachMeasureScope, Measurable measurable, long j) {
        if (getSharedElement().getFoundMatch()) {
            ...
            if (value != null) {
                long m7168roundToIntSizeuvyYCjk = IntSizeKt.m7168roundToIntSizeuvyYCjk(value.m4158getSizeNHjbRc());
                int i = (int) (m7168roundToIntSizeuvyYCjk >> 32);
                int i2 = (int) (m7168roundToIntSizeuvyYCjk & 4294967295L);
                ...
                j = Constraints.INSTANCE.m6952fixedJhjzzOo(RangesKt.coerceAtLeast(i, 0), RangesKt.coerceAtLeast(i2, 0));
            }
        }
        return approachPlace(approachMeasureScope, measurable.mo5732measureBRTryo0(j));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void updateCurrentBounds(LayoutCoordinates layoutCoordinates) {
        SharedElement sharedElement = getSharedElement();
        long mo5741localPositionOfR5De75A = getRootCoords().mo5741localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4141getZeroF1C5BW0());
        float mo5740getSizeYbymL2g = (int) (layoutCoordinates.mo5740getSizeYbymL2g() >> 32);
        float mo5740getSizeYbymL2g2 = (int) (layoutCoordinates.mo5740getSizeYbymL2g() & 4294967295L);
        sharedElement.setCurrentBounds(RectKt.m4165Recttz77jQw(mo5741localPositionOfR5De75A, Size.m4185constructorimpl((Float.floatToRawIntBits(mo5740getSizeYbymL2g) << 32) | (Float.floatToRawIntBits(mo5740getSizeYbymL2g2) & 4294967295L))));
    }
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        if (layer != null) {
            ...
            DrawScope.m4933recordJVtK1S4$default(contentDrawScope2, layer, 0L, new Function1<DrawScope, Unit>() { // from class: androidx.compose.animation.SharedBoundsNode$draw$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
