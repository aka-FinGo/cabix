...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            Placeable mo5732measureBRTryo0 = list.get(i3).mo5732measureBRTryo0(j);
            i = Math.max(i, mo5732measureBRTryo0.getWidth());
            i2 = Math.max(i2, mo5732measureBRTryo0.getHeight());
            arrayList.add(mo5732measureBRTryo0);
        }
        final ArrayList arrayList2 = arrayList;
        if (measureScope.isLookingAhead()) {
            this.hasLookaheadOccurred = true;
            this.scope.getTargetSize$animation_release().setValue(IntSize.m7152boximpl(IntSize.m7155constructorimpl((i2 & 4294967295L) | (i << 32))));
