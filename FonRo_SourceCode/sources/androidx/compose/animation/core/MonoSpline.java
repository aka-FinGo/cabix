        ...
        while (i4 < i3) {
            ...
            if (time < f2) {
                ...
                while (i2 < length2) {
                    ...
                    v.set$animation_core_release(i2, MonoSplineKt.hermiteInterpolate(f3, f4, f5, f6, fArr4[i4][i2], fArr4[i5][i2]));
                    i2++;
                }
                return;
            }
    ...
    public final void getSlope(float time, AnimationVector v, int index) {
        ...
        while (i4 < i3) {
            ...
            if (time <= f) {
                ...
                float f4 = (time - f2) / f3;
                while (i2 < length2) {
                    v.set$animation_core_release(i2, MonoSplineKt.hermiteDifferential(f3, f4, fArr2[i4][i2], fArr2[i5][i2], fArr3[i4][i2], fArr3[i5][i2]) / f3);
                    i2++;
                }
                return;
            }
