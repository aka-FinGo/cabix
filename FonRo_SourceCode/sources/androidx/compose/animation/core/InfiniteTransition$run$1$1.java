...
public final class InfiniteTransition$run$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:11:0x0083, code lost:
        ...
        if (kotlinx.coroutines.flow.FlowKt.first(androidx.compose.runtime.SnapshotStateKt.snapshotFlow(new androidx.compose.animation.core.InfiniteTransition$run$1$1.AnonymousClass2()), new androidx.compose.animation.core.InfiniteTransition$run$1$1.AnonymousClass3(null), r7) == r0) goto L18;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0059, code lost:
        ...
        if (androidx.compose.animation.core.InfiniteAnimationPolicyKt.withInfiniteAnimationFrameNanos(new androidx.compose.animation.core.InfiniteTransition$run$1$1.AnonymousClass1(), r7) == r0) goto L18;
     */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:11:0x0083 -> B:6:0x0041). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:9:0x0061 -> B:6:0x0041). Please report as a decompilation issue!!! */
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    /*
