...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public final KeyframeEntity<T> m476usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m475setArcModeRur9ykg$animation_core_release(i);
            return keyframeEntity;
        }
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.INSTANCE.m472getArcLinear9TMq4() : i, null);
        }
        ...
        public final void m475setArcModeRur9ykg$animation_core_release(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual(keyframeEntity.getEasing(), getEasing()) && ArcMode.m466equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }

        public int hashCode() {
            T value$animation_core_release = getValue$animation_core_release();
            return ((((value$animation_core_release != null ? value$animation_core_release.hashCode() : 0) * 31) + ArcMode.m467hashCodeimpl(this.arcMode)) * 31) + getEasing().hashCode();
        }
    }
}
