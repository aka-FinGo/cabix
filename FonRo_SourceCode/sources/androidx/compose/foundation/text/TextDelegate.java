...
public final class TextDelegate {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i, int i2, boolean z, int i3, Density density, FontFamily.Resolver resolver, List list, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i4 & 4) != 0 ? Integer.MAX_VALUE : i, (i4 & 8) != 0 ? 1 : i2, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? TextOverflow.INSTANCE.m6924getClipgIe3tQ8() : i3, density, resolver, (i4 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
    ...
    private final MultiParagraph m1450layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int m6944getMinWidthimpl = Constraints.m6944getMinWidthimpl(constraints);
        int m6942getMaxWidthimpl = ((this.softWrap || TextOverflow.m6915equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6925getEllipsisgIe3tQ8())) && Constraints.m6938getHasBoundedWidthimpl(constraints)) ? Constraints.m6942getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i = (this.softWrap || !TextOverflow.m6915equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6925getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (m6944getMinWidthimpl != m6942getMaxWidthimpl) {
            m6942getMaxWidthimpl = RangesKt.coerceIn(getMaxIntrinsicWidth(), m6944getMinWidthimpl, m6942getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.INSTANCE.m6951fitPrioritizingWidthZbe2FdA(0, m6942getMaxWidthimpl, 0, Constraints.m6941getMaxHeightimpl(constraints)), i, this.overflow, (DefaultConstructorMarker) null);
    }

    /* renamed from: layout-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1449layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1452layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U, reason: not valid java name */
    public final TextLayoutResult m1452layoutNN6EwU(long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResult) {
        if (prevResult != null && TextLayoutHelperKt.m1485canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m6404copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m6956constrain4WqzIAM(constraints, IntSize.m7155constructorimpl((TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()) & 4294967295L) | (TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()) << 32))));
        }
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), m1450layoutTextK40F9xA(constraints, layoutDirection), ConstraintsKt.m6956constrain4WqzIAM(constraints, IntSize.m7155constructorimpl((TextDelegateKt.ceilToIntPx(r13.getHeight()) & 4294967295L) | (TextDelegateKt.ceilToIntPx(r13.getWidth()) << 32))), null);
    }
