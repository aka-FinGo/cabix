...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
            ...
            final Function2<Selectable, Selectable, Integer> function2 = new Function2<Selectable, Selectable, Integer>() { // from class: androidx.compose.foundation.text.selection.SelectionRegistrarImpl$sort$1
                ...
                public final Integer invoke(Selectable selectable, Selectable selectable2) {
                    ...
                    if (layoutCoordinates != null) {
                        m4141getZeroF1C5BW0 = LayoutCoordinates.this.mo5741localPositionOfR5De75A(layoutCoordinates, Offset.INSTANCE.m4141getZeroF1C5BW0());
                    } else {
                        m4141getZeroF1C5BW0 = Offset.INSTANCE.m4141getZeroF1C5BW0();
                    }
                    if (layoutCoordinates2 != null) {
                        m4141getZeroF1C5BW02 = LayoutCoordinates.this.mo5741localPositionOfR5De75A(layoutCoordinates2, Offset.INSTANCE.m4141getZeroF1C5BW0());
                    } else {
                        m4141getZeroF1C5BW02 = Offset.INSTANCE.m4141getZeroF1C5BW0();
                    }
                    int i = (int) (m4141getZeroF1C5BW0 & 4294967295L);
                    int i2 = (int) (4294967295L & m4141getZeroF1C5BW02);
                    if (Float.intBitsToFloat(i) == Float.intBitsToFloat(i2)) {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Float.intBitsToFloat((int) (m4141getZeroF1C5BW0 >> 32))), Float.valueOf(Float.intBitsToFloat((int) (m4141getZeroF1C5BW02 >> 32))));
                    } else {
                        compareValues = ComparisonsKt.compareValues(Float.valueOf(Float.intBitsToFloat(i)), Float.valueOf(Float.intBitsToFloat(i2)));
                    }
    ...
    public void mo1817notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long startPosition, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4114boximpl(startPosition), adjustment);
        }
    }
    ...
    public boolean mo1816notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long newPosition, long previousPosition, boolean isStartHandle, SelectionAdjustment adjustment, boolean isInTouchMode) {
        ...
        if (function6 != null) {
            return function6.invoke(Boolean.valueOf(isInTouchMode), layoutCoordinates, Offset.m4114boximpl(newPosition), Offset.m4114boximpl(previousPosition), Boolean.valueOf(isStartHandle), adjustment).booleanValue();
        }
        return true;
    }
