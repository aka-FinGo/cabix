...
public final class SelectionManagerKt {
    ...
    public static final Rect getSelectedRegionRect(List<? extends Pair<? extends Selectable, Selection>> list, LayoutCoordinates layoutCoordinates) {
        ...
        while (i < size) {
            ...
            if (offset != offset2 && (layoutCoordinates2 = component1.getLayoutCoordinates()) != null) {
                ...
                long m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(left2) << 32) | (Float.floatToRawIntBits(top2) & 4294967295L));
                long m4117constructorimpl2 = Offset.m4117constructorimpl((Float.floatToRawIntBits(bottom2) & 4294967295L) | (Float.floatToRawIntBits(right2) << 32));
                long mo5741localPositionOfR5De75A = layoutCoordinates.mo5741localPositionOfR5De75A(layoutCoordinates2, m4117constructorimpl);
                long mo5741localPositionOfR5De75A2 = layoutCoordinates.mo5741localPositionOfR5De75A(layoutCoordinates2, m4117constructorimpl2);
                left = Math.min(left, Float.intBitsToFloat((int) (mo5741localPositionOfR5De75A >> 32)));
                top = Math.min(top, Float.intBitsToFloat((int) (mo5741localPositionOfR5De75A & 4294967295L)));
                right = Math.max(right, Float.intBitsToFloat((int) (mo5741localPositionOfR5De75A2 >> 32)));
                bottom = Math.max(bottom, Float.intBitsToFloat((int) (mo5741localPositionOfR5De75A2 & 4294967295L)));
            }
            i++;
            list2 = list;
            c = 0;
    ...
    public static final long m1806calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager selectionManager, long j) {
        ...
        if (i == 1) {
            return m1808getMagnifierCenterJVtK1S4(selectionManager, j, selection.getStart());
        }
        if (i == 2) {
            return m1808getMagnifierCenterJVtK1S4(selectionManager, j, selection.getEnd());
        }
        if (i == 3) {
    ...
    private static final long m1808getMagnifierCenterJVtK1S4(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null && (offset = anchorInfo.getOffset()) <= anchorSelectable$foundation_release.getLastVisibleOffset()) {
            Offset m1795getCurrentDragPosition_m7T9E = selectionManager.m1795getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(m1795getCurrentDragPosition_m7T9E);
            float intBitsToFloat = Float.intBitsToFloat((int) (layoutCoordinates.mo5741localPositionOfR5De75A(containerLayoutCoordinates, m1795getCurrentDragPosition_m7T9E.m4135unboximpl()) >> 32));
            long mo1758getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo1758getRangeOfLineContainingjx7JFs(offset);
            if (TextRange.m6429getCollapsedimpl(mo1758getRangeOfLineContainingjx7JFs)) {
                coerceIn = anchorSelectable$foundation_release.getLineLeft(offset);
            } else {
                float lineLeft = anchorSelectable$foundation_release.getLineLeft(TextRange.m6435getStartimpl(mo1758getRangeOfLineContainingjx7JFs));
                float lineRight = anchorSelectable$foundation_release.getLineRight(TextRange.m6430getEndimpl(mo1758getRangeOfLineContainingjx7JFs) - 1);
                coerceIn = RangesKt.coerceIn(intBitsToFloat, Math.min(lineLeft, lineRight), Math.max(lineLeft, lineRight));
            }
            if (coerceIn == -1.0f) {
                return Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
            }
            if (!IntSize.m7158equalsimpl0(j, IntSize.INSTANCE.m7165getZeroYbymL2g()) && Math.abs(intBitsToFloat - coerceIn) > ((int) (j >> 32)) / 2) {
                return Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
            }
            if (anchorSelectable$foundation_release.getCenterYForOffset(offset) == -1.0f) {
                return Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo5741localPositionOfR5De75A(layoutCoordinates, Offset.m4117constructorimpl((Float.floatToRawIntBits(coerceIn) << 32) | (4294967295L & Float.floatToRawIntBits(r9))));
        }
        return Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
    }
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m4163Rect0a9Yr6o(layoutCoordinates.mo5749windowToLocalMKHz9U(boundsInWindow.m4160getTopLeftF1C5BW0()), layoutCoordinates.mo5749windowToLocalMKHz9U(boundsInWindow.m4154getBottomRightF1C5BW0()));
    }

    /* renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m1807containsInclusiveUv8p0NA(Rect rect, long j) {
        float left = rect.getLeft();
        float right = rect.getRight();
