...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m6698copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }

    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        if (!TextRange.m6429getCollapsedimpl(getSelection())) {
            return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m6433getMinimpl(getSelection()), TextRange.m6433getMinimpl(getSelection()))});
        }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r9, int r10) {
        ...
        L1b:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m6430getEndimpl(r3)
            ...
            float r2 = r2 * r10
            float r0 = r0 + r2
            androidx.compose.ui.text.input.OffsetMapping r8 = r8.getOffsetMapping()
            ...
            long r2 = r6 & r4
            long r0 = r0 | r2
            long r0 = androidx.compose.ui.geometry.Offset.m4117constructorimpl(r0)
            int r9 = r9.m6405getOffsetForPositionk4lQ0M(r0)
