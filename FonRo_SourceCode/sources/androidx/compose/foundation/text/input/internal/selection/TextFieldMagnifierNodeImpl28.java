...
public final class TextFieldMagnifierNodeImpl28 extends TextFieldMagnifierNode implements CompositionLocalConsumerModifierNode {
    ...
    public TextFieldMagnifierNodeImpl28(TransformedTextFieldState transformedTextFieldState, TextFieldSelectionState textFieldSelectionState, TextLayoutState textLayoutState, boolean z) {
        ...
        this.animatable = new Animatable<>(Offset.m4114boximpl(TextFieldMagnifierKt.m1665calculateSelectionMagnifierCenterAndroidhUlJWOE(this.textFieldState, this.textFieldSelectionState, this.textLayoutState, m1668getMagnifierSizeYbymL2g())), SelectionMagnifierKt.getUnspecifiedSafeOffsetVectorConverter(), Offset.m4114boximpl(SelectionMagnifierKt.getOffsetDisplacementThreshold()), null, 8, null);
        this.magnifierNode = (MagnifierNode) delegate(new MagnifierNode(new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.input.internal.selection.TextFieldMagnifierNodeImpl28$magnifierNode$1
            ...
            public /* bridge */ /* synthetic */ Offset invoke(Density density) {
                return Offset.m4114boximpl(m1670invoketuRUvjQ(density));
            }
            ...
            public final long m1670invoketuRUvjQ(Density density) {
                ...
                return ((Offset) animatable.getValue()).m4135unboximpl();
            }
            ...
            public /* bridge */ /* synthetic */ Unit invoke(DpSize dpSize) {
                m1671invokeEaSLcWc(dpSize.getPackedValue());
            ...
            public final void m1671invokeEaSLcWc(long j) {
                ...
                textFieldMagnifierNodeImpl28.m1669setMagnifierSizeozmzZPI(IntSize.m7155constructorimpl((r0.mo694roundToPx0680j_4(DpSize.m7085getHeightD9Ej5fM(j)) & 4294967295L) | (((Density) CompositionLocalConsumerModifierNodeKt.currentValueOf(textFieldMagnifierNodeImpl28, CompositionLocalsKt.getLocalDensity())).mo694roundToPx0680j_4(DpSize.m7087getWidthD9Ej5fM(j)) << 32)));
            }
    ...
    public final long m1668getMagnifierSizeYbymL2g() {
        return ((IntSize) this.magnifierSize.getValue()).m7164unboximpl();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setMagnifierSize-ozmzZPI, reason: not valid java name */
    public final void m1669setMagnifierSizeozmzZPI(long j) {
        this.magnifierSize.setValue(IntSize.m7152boximpl(j));
    }
