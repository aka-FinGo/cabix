...
public final class TextUndoOperation {
    ...
    private static final Saver<TextUndoOperation, Object> Saver = new Saver<TextUndoOperation, Object>() { // from class: androidx.compose.foundation.text.input.internal.undo.TextUndoOperation$Companion$Saver$1
        ...
        public Object save(SaverScope saverScope, TextUndoOperation textUndoOperation) {
            return CollectionsKt.listOf(Integer.valueOf(textUndoOperation.getIndex()), textUndoOperation.getPreText(), textUndoOperation.getPostText(), Integer.valueOf(TextRange.m6435getStartimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m6430getEndimpl(textUndoOperation.getPreSelection())), Integer.valueOf(TextRange.m6435getStartimpl(textUndoOperation.getPostSelection())), Integer.valueOf(TextRange.m6430getEndimpl(textUndoOperation.getPostSelection())), Long.valueOf(textUndoOperation.getTimeInMillis()));
        }
    ...
    public final TextDeleteType getDeletionType() {
        if (this.textEditType == TextEditType.Delete && TextRange.m6429getCollapsedimpl(this.postSelection)) {
            boolean m6429getCollapsedimpl = TextRange.m6429getCollapsedimpl(this.preSelection);
            long j = this.preSelection;
            if (m6429getCollapsedimpl) {
                if (TextRange.m6435getStartimpl(j) > TextRange.m6435getStartimpl(this.postSelection)) {
                    return TextDeleteType.Start;
                }
                return TextDeleteType.End;
            }
            if (TextRange.m6435getStartimpl(j) == TextRange.m6435getStartimpl(this.postSelection) && TextRange.m6435getStartimpl(this.preSelection) == this.index) {
