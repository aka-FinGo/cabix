...
public final class LegacyCursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.localToScreen.invoke(Matrix.m4612boximpl(this.matrix));
        ...
        Matrix.m4635translateimpl(fArr, f, -rect2.getTop(), 0.0f);
