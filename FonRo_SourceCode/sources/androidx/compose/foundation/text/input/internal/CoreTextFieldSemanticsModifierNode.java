...
public final class CoreTextFieldSemanticsModifierNode extends DelegatingNode implements SemanticsModifierNode {
    ...
    public void applySemantics(final SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m6219setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, this.value.getSelection());
            ...
            SemanticsPropertiesKt.insertTextAtCursor$default(semanticsPropertyReceiver, null, new Function1<AnnotatedString, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$applySemantics$4
                ...
                public final Boolean invoke(AnnotatedString annotatedString) {
                    ...
                    if (unit == null) {
                        ...
                        coreTextFieldSemanticsModifierNode2.getState().getOnValueChange().invoke(new TextFieldValue(StringsKt.replaceRange((CharSequence) coreTextFieldSemanticsModifierNode2.getValue().getText(), TextRange.m6435getStartimpl(coreTextFieldSemanticsModifierNode2.getValue().getSelection()), TextRange.m6430getEndimpl(coreTextFieldSemanticsModifierNode2.getValue().getSelection()), (CharSequence) annotatedString).toString(), TextRangeKt.TextRange(TextRange.m6435getStartimpl(coreTextFieldSemanticsModifierNode2.getValue().getSelection()) + annotatedString.length()), (TextRange) null, 4, (DefaultConstructorMarker) null));
                    }
                    return true;
                }
            }, 1, null);
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$applySemantics$5
            ...
            public final Boolean invoke(int i, int i2, boolean z2) {
                ...
                boolean z3 = false;
                if (CoreTextFieldSemanticsModifierNode.this.getEnabled() && (i != TextRange.m6435getStartimpl(CoreTextFieldSemanticsModifierNode.this.getValue().getSelection()) || i2 != TextRange.m6430getEndimpl(CoreTextFieldSemanticsModifierNode.this.getValue().getSelection()))) {
        ...
        SemanticsPropertiesKt.m6215onImeAction9UiTYpY$default(semanticsPropertyReceiver, this.imeOptions.getImeAction(), null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.CoreTextFieldSemanticsModifierNode$applySemantics$6
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Boolean invoke() {
                CoreTextFieldSemanticsModifierNode.this.getState().getOnImeActionPerformed().invoke(ImeAction.m6618boximpl(CoreTextFieldSemanticsModifierNode.this.getImeOptions().getImeAction()));
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m6429getCollapsedimpl(this.value.getSelection()) && !this.isPassword) {
    ...
    public final void updateNodeSemantics(TransformedText transformedText, TextFieldValue value, LegacyTextFieldState state, boolean readOnly, boolean enabled, boolean isPassword, OffsetMapping offsetMapping, TextFieldSelectionManager manager, ImeOptions imeOptions, FocusRequester focusRequester) {
        ...
        this.imeOptions = imeOptions;
        this.focusRequester = focusRequester;
        if (enabled != z || z4 != z2 || !Intrinsics.areEqual(imeOptions, imeOptions2) || isPassword != z3 || !TextRange.m6429getCollapsedimpl(value.getSelection())) {
