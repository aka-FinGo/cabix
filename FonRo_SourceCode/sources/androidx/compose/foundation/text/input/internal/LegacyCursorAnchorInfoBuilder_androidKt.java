...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        int m6433getMinimpl = TextRange.m6433getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(m6433getMinimpl, TextRange.m6432getMaximpl(textFieldValue.getSelection()));
        if (z) {
            setInsertionMarker(builder, m6433getMinimpl, offsetMapping, textLayoutResult, rect);
        }
        if (z2) {
            ...
            int m6432getMaximpl = composition2 != null ? TextRange.m6432getMaximpl(composition2.getPackedValue()) : -1;
            if (m6433getMinimpl2 >= 0 && m6433getMinimpl2 < m6432getMaximpl) {
                builder.setComposingText(m6433getMinimpl2, textFieldValue.getText().subSequence(m6433getMinimpl2, m6432getMaximpl));
                addCharacterBounds(builder, m6433getMinimpl2, m6432getMaximpl, offsetMapping, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, androidx.compose.ui.text.input.OffsetMapping r20, androidx.compose.ui.text.TextLayoutResult r21, androidx.compose.ui.geometry.Rect r22) {
        /*
            ...
            r5 = 0
            r7.m6285fillBoundingBoxes8ffj60Q(r8, r6, r5)
            r11 = r2
        L23:
            if (r11 >= r0) goto L88
