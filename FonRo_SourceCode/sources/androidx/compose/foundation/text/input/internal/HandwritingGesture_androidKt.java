...
public final class HandwritingGesture_androidKt {
    ...
    public static final long m1567adjustHandwritingDeleteGestureRange72CqOWE(long j, CharSequence charSequence) {
        int m6435getStartimpl = TextRange.m6435getStartimpl(j);
        int m6430getEndimpl = TextRange.m6430getEndimpl(j);
        int codePointBefore = m6435getStartimpl > 0 ? Character.codePointBefore(charSequence, m6435getStartimpl) : 10;
        int codePointAt = m6430getEndimpl < charSequence.length() ? Character.codePointAt(charSequence, m6430getEndimpl) : 10;
        if (isWhitespaceExceptNewline(codePointBefore) && (isWhitespace(codePointAt) || isPunctuation(codePointAt))) {
            do {
                m6435getStartimpl -= Character.charCount(codePointBefore);
                if (m6435getStartimpl == 0) {
                    break;
                }
                codePointBefore = Character.codePointBefore(charSequence, m6435getStartimpl);
            } while (isWhitespaceExceptNewline(codePointBefore));
            return TextRangeKt.TextRange(m6435getStartimpl, m6430getEndimpl);
        }
        ...
        do {
            m6430getEndimpl += Character.charCount(codePointAt);
            if (m6430getEndimpl == charSequence.length()) {
                break;
            }
            codePointAt = Character.codePointAt(charSequence, m6430getEndimpl);
    ...
    public static final long toOffset(PointF pointF) {
        float f = pointF.x;
        float f2 = pointF.y;
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1576getRangeForScreenRectOH9lIzo(TextLayoutState textLayoutState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        return m1574getRangeForScreenRectO048IG0(layoutResult != null ? layoutResult.getMultiParagraph() : null, rect, textLayoutState.getTextLayoutNodeCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1578getRangeForScreenRectsO048IG0(TextLayoutState textLayoutState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1576getRangeForScreenRectOH9lIzo = m1576getRangeForScreenRectOH9lIzo(textLayoutState, rect, i, textInclusionStrategy);
        if (TextRange.m6429getCollapsedimpl(m1576getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        long m1576getRangeForScreenRectOH9lIzo2 = m1576getRangeForScreenRectOH9lIzo(textLayoutState, rect2, i, textInclusionStrategy);
        return TextRange.m6429getCollapsedimpl(m1576getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m6440getZerod9O1mEE() : m1568enclosurepWDy79M(m1576getRangeForScreenRectOH9lIzo, m1576getRangeForScreenRectOH9lIzo2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRect-OH9lIzo, reason: not valid java name */
    public static final long m1575getRangeForScreenRectOH9lIzo(LegacyTextFieldState legacyTextFieldState, Rect rect, int i, TextInclusionStrategy textInclusionStrategy) {
        TextLayoutResult value;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        return m1574getRangeForScreenRectO048IG0((layoutResult == null || (value = layoutResult.getValue()) == null) ? null : value.getMultiParagraph(), rect, legacyTextFieldState.getLayoutCoordinates(), i, textInclusionStrategy);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForScreenRects-O048IG0, reason: not valid java name */
    public static final long m1577getRangeForScreenRectsO048IG0(LegacyTextFieldState legacyTextFieldState, Rect rect, Rect rect2, int i, TextInclusionStrategy textInclusionStrategy) {
        long m1575getRangeForScreenRectOH9lIzo = m1575getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect, i, textInclusionStrategy);
        if (TextRange.m6429getCollapsedimpl(m1575getRangeForScreenRectOH9lIzo)) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        long m1575getRangeForScreenRectOH9lIzo2 = m1575getRangeForScreenRectOH9lIzo(legacyTextFieldState, rect2, i, textInclusionStrategy);
        return TextRange.m6429getCollapsedimpl(m1575getRangeForScreenRectOH9lIzo2) ? TextRange.INSTANCE.m6440getZerod9O1mEE() : m1568enclosurepWDy79M(m1575getRangeForScreenRectOH9lIzo, m1575getRangeForScreenRectOH9lIzo2);
    }
    ...
    public static final int m1571getOffsetForHandwritingGestured4ec7I(TextLayoutState textLayoutState, long j, ViewConfiguration viewConfiguration) {
        MultiParagraph multiParagraph;
        TextLayoutResult layoutResult = textLayoutState.getLayoutResult();
        if (layoutResult == null || (multiParagraph = layoutResult.getMultiParagraph()) == null) {
            return -1;
        }
        return m1572getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, textLayoutState.getTextLayoutNodeCoordinates(), viewConfiguration);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getOffsetForHandwritingGesture-d-4ec7I, reason: not valid java name */
    public static final int m1570getOffsetForHandwritingGestured4ec7I(LegacyTextFieldState legacyTextFieldState, long j, ViewConfiguration viewConfiguration) {
        TextLayoutResult value;
        MultiParagraph multiParagraph;
        TextLayoutResultProxy layoutResult = legacyTextFieldState.getLayoutResult();
        ...
        return m1572getOffsetForHandwritingGestureubNVwUQ(multiParagraph, j, legacyTextFieldState.getLayoutCoordinates(), viewConfiguration);
    }
    ...
    private static final long m1574getRangeForScreenRectO048IG0(MultiParagraph multiParagraph, Rect rect, LayoutCoordinates layoutCoordinates, int i, TextInclusionStrategy textInclusionStrategy) {
        if (multiParagraph == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        return multiParagraph.m6287getRangeForRect86BmAI(rect.m4162translatek4lQ0M(layoutCoordinates.mo5746screenToLocalMKHz9U(Offset.INSTANCE.m4141getZeroF1C5BW0())), i, textInclusionStrategy);
    }

    /* renamed from: getOffsetForHandwritingGesture-ubNVwUQ, reason: not valid java name */
    private static final int m1572getOffsetForHandwritingGestureubNVwUQ(MultiParagraph multiParagraph, long j, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        long mo5746screenToLocalMKHz9U;
        int m1569getLineForHandwritingGestured4ec7I;
        if (layoutCoordinates == null || (m1569getLineForHandwritingGestured4ec7I = m1569getLineForHandwritingGestured4ec7I(multiParagraph, (mo5746screenToLocalMKHz9U = layoutCoordinates.mo5746screenToLocalMKHz9U(j)), viewConfiguration)) == -1) {
            return -1;
        }
        return multiParagraph.m6286getOffsetForPositionk4lQ0M(Offset.m4119copydBAh8RU$default(mo5746screenToLocalMKHz9U, 0.0f, (multiParagraph.getLineTop(m1569getLineForHandwritingGestured4ec7I) + multiParagraph.getLineBottom(m1569getLineForHandwritingGestured4ec7I)) / 2.0f, 1, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getRangeForRemoveSpaceGesture-5iVPX68, reason: not valid java name */
    public static final long m1573getRangeForRemoveSpaceGesture5iVPX68(TextLayoutResult textLayoutResult, long j, long j2, LayoutCoordinates layoutCoordinates, ViewConfiguration viewConfiguration) {
        if (textLayoutResult == null || layoutCoordinates == null) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        long mo5746screenToLocalMKHz9U = layoutCoordinates.mo5746screenToLocalMKHz9U(j);
        long mo5746screenToLocalMKHz9U2 = layoutCoordinates.mo5746screenToLocalMKHz9U(j2);
        int m1569getLineForHandwritingGestured4ec7I = m1569getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo5746screenToLocalMKHz9U, viewConfiguration);
        int m1569getLineForHandwritingGestured4ec7I2 = m1569getLineForHandwritingGestured4ec7I(textLayoutResult.getMultiParagraph(), mo5746screenToLocalMKHz9U2, viewConfiguration);
        if (m1569getLineForHandwritingGestured4ec7I != -1) {
            if (m1569getLineForHandwritingGestured4ec7I2 != -1) {
                m1569getLineForHandwritingGestured4ec7I = Math.min(m1569getLineForHandwritingGestured4ec7I, m1569getLineForHandwritingGestured4ec7I2);
            }
            m1569getLineForHandwritingGestured4ec7I2 = m1569getLineForHandwritingGestured4ec7I;
        } else if (m1569getLineForHandwritingGestured4ec7I2 == -1) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        float lineTop = (textLayoutResult.getLineTop(m1569getLineForHandwritingGestured4ec7I2) + textLayoutResult.getLineBottom(m1569getLineForHandwritingGestured4ec7I2)) / 2.0f;
        int i = (int) (mo5746screenToLocalMKHz9U >> 32);
        int i2 = (int) (mo5746screenToLocalMKHz9U2 >> 32);
        return textLayoutResult.getMultiParagraph().m6287getRangeForRect86BmAI(new Rect(Math.min(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop - 0.1f, Math.max(Float.intBitsToFloat(i), Float.intBitsToFloat(i2)), lineTop + 0.1f), TextGranularity.INSTANCE.m6397getCharacterDRrd7Zo(), TextInclusionStrategy.INSTANCE.getAnyOverlap());
    }

    /* renamed from: getLineForHandwritingGesture-d-4ec7I, reason: not valid java name */
    private static final int m1569getLineForHandwritingGestured4ec7I(MultiParagraph multiParagraph, long j, ViewConfiguration viewConfiguration) {
    ...
    private static final long m1568enclosurepWDy79M(long j, long j2) {
        return TextRangeKt.TextRange(Math.min(TextRange.m6435getStartimpl(j), TextRange.m6435getStartimpl(j)), Math.max(TextRange.m6430getEndimpl(j2), TextRange.m6430getEndimpl(j2)));
    }
}
