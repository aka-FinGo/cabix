...
public final class DefaultImeEditCommandScope implements ImeEditCommandScope {
    ...
    public long mo1540mapFromTransformedGEjPoXI(long range) {
        return this.transformedTextFieldState.m1636mapFromTransformedGEjPoXI(range);
    }

    @Override // androidx.compose.foundation.text.input.internal.ImeEditCommandScope
    /* renamed from: mapToTransformed-GEjPoXI */
    public long mo1541mapToTransformedGEjPoXI(long range) {
        return this.transformedTextFieldState.m1638mapToTransformedGEjPoXI(range);
    }
