    ...
    public static final Modifier cursor(Modifier modifier, final LegacyTextFieldState legacyTextFieldState, final TextFieldValue textFieldValue, final OffsetMapping offsetMapping, final Brush brush, boolean z) {
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i) {
                ...
                ComposerKt.sourceInformationMarkerEnd(composer);
                if (((WindowInfo) consume2).isWindowFocused() && legacyTextFieldState.getHasFocus() && TextRange.m6429getCollapsedimpl(textFieldValue.getSelection()) && z2) {
                    ...
                    TextRange m6423boximpl = TextRange.m6423boximpl(textFieldValue.getSelection());
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer);
                    EffectsKt.LaunchedEffect(annotatedString, m6423boximpl, (Function2) rememberedValue2, composer, 0);
                    ...
                    if (changedInstance2 || rememberedValue3 == Composer.INSTANCE.getEmpty()) {
                        rememberedValue3 = (Function1) new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1$2$1
                            ...
                            public final void invoke2(ContentDrawScope contentDrawScope) {
                                ...
                                int originalToTransformed = offsetMapping2.originalToTransformed(TextRange.m6435getStartimpl(textFieldValue2.getSelection()));
                                ...
                                float coerceAtLeast = RangesKt.coerceAtLeast((float) Math.floor(contentDrawScope.mo700toPx0680j_4(TextFieldCursor_androidKt.getDefaultCursorThickness())), 1.0f);
                                float f = coerceAtLeast / 2.0f;
                                float coerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost(rect.getLeft() + f, Float.intBitsToFloat((int) (contentDrawScope.mo4935getSizeNHjbRc() >> 32)) - f), f);
                                if (((int) coerceAtLeast) % 2 == 1) {
                                    rint = ((float) Math.floor(coerceAtLeast2)) + 0.5f;
                                } else {
                                    rint = (float) Math.rint(coerceAtLeast2);
                                }
                                DrawScope.m4920drawLine1RTmtNc$default(contentDrawScope, brush3, Offset.m4117constructorimpl((Float.floatToRawIntBits(rint) << 32) | (Float.floatToRawIntBits(rect.getTop()) & 4294967295L)), Offset.m4117constructorimpl((Float.floatToRawIntBits(rect.getBottom()) & 4294967295L) | (Float.floatToRawIntBits(rint) << 32)), coerceAtLeast, 0, null, cursorAlpha, null, 0, 432, null);
                            }
                        };
