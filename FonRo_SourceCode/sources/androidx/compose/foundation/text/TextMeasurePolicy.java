    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (invoke != null) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                Pair pair = rect != null ? new Pair(((Measurable) arrayList3.get(i2)).mo5732measureBRTryo0(ConstraintsKt.Constraints$default(0, (int) Math.floor(rect.getRight() - rect.getLeft()), 0, (int) Math.floor(rect.getBottom() - rect.getTop()), 5, null)), IntOffset.m7108boximpl(IntOffset.m7111constructorimpl((Math.round(rect.getTop()) & 4294967295L) | (Math.round(rect.getLeft()) << 32)))) : null;
                if (pair != null) {
                    arrayList4.add(pair);
                }
            }
        ...
        return MeasureScope.layout$default(measureScope, Constraints.m6942getMaxWidthimpl(j), Constraints.m6941getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.TextMeasurePolicy$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (list3 != null) {
                    ...
                    for (int i4 = 0; i4 < size4; i4++) {
                        ...
                        Placeable.PlacementScope.m5796place70tqf50$default(placementScope, pair2.component1(), pair2.component2().m7126unboximpl(), 0.0f, 2, null);
                    }
                }
                ...
                if (list4 != null) {
                    ...
                    for (int i5 = 0; i5 < size5; i5++) {
                        ...
                        Placeable.PlacementScope.m5796place70tqf50$default(placementScope, component1, component2 != null ? component2.invoke().m7126unboximpl() : IntOffset.INSTANCE.m7128getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
