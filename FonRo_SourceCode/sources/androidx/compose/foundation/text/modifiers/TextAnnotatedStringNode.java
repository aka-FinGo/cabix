...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public final MultiParagraphLayoutCache getLayoutCache() {
        ...
        if (multiParagraphLayoutCache == null) {
            MultiParagraphLayoutCache multiParagraphLayoutCache2 = new MultiParagraphLayoutCache(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, this.autoSize, null);
            this._layoutCache = multiParagraphLayoutCache2;
            multiParagraphLayoutCache = multiParagraphLayoutCache2;
        }
    ...
    public final boolean m1750updateLayoutRelatedArgsy0kMQk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow, TextAutoSize autoSize) {
        ...
        if (!TextOverflow.m6915equalsimpl0(this.overflow, overflow)) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m1733updateJ2qo7bo(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders, this.autoSize);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(AnnotatedString updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1733updateJ2qo7bo(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, CollectionsKt.emptyList(), this.autoSize);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
                ...
                */
                public final java.lang.Boolean invoke(java.util.List<androidx.compose.ui.text.TextLayoutResult> r38) {
                    ...
                    L31:
                        ...
                        r33 = 0
                        r34 = 0
                        androidx.compose.ui.text.TextStyle r5 = androidx.compose.ui.text.TextStyle.m6455mergedA7vx0o$default(r5, r6, r8, r10, r11, r12, r13, r14, r15, r17, r18, r19, r20, r22, r23, r24, r25, r26, r27, r29, r30, r31, r32, r33, r34, r35, r36)
                        ...
                        r7 = 0
                        r4 = 0
                        androidx.compose.ui.text.TextLayoutResult r0 = androidx.compose.ui.text.TextLayoutResult.m6403copyO0kMr_c$default(r2, r3, r4, r6, r7)
                        if (r0 == 0) goto Lb8
                        r1 = r38
                        r1.add(r0)
                        goto Lb9
    ...
    public final MeasureResult m1749measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        return mo384measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean m1732layoutWithConstraintsK40F9xA = layoutCache.m1732layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (m1732layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(Constraints.INSTANCE.m6951fitPrioritizingWidthZbe2FdA((int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() >> 32), (int) (textLayoutResult.getSize() & 4294967295L), (int) (textLayoutResult.getSize() & 4294967295L)));
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (getIsAttached()) {
            ...
            boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m6915equalsimpl0(this.overflow, TextOverflow.INSTANCE.m6928getVisiblegIe3tQ8());
            if (z) {
                Rect m4165Recttz77jQw = RectKt.m4165Recttz77jQw(Offset.INSTANCE.m4141getZeroF1C5BW0(), Size.m4185constructorimpl((Float.floatToRawIntBits((int) (textLayoutResult.getSize() >> 32)) << 32) | (Float.floatToRawIntBits((int) (textLayoutResult.getSize() & 4294967295L)) & 4294967295L)));
                canvas.save();
                Canvas.m4357clipRectmtrdDE$default(canvas, m4165Recttz77jQw, 0, 2, null);
            }
            try {
                ...
                if (brush != null) {
                    MultiParagraph.m6284painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
                } else {
                    ColorProducer colorProducer = this.overrideColor;
                    long mo2165invoke0d7_KjU = colorProducer != null ? colorProducer.mo2165invoke0d7_KjU() : Color.INSTANCE.m4420getUnspecified0d7_KjU();
                    if (mo2165invoke0d7_KjU == 16) {
                        if (this.style.m6465getColor0d7_KjU() != 16) {
                            mo2165invoke0d7_KjU = this.style.m6465getColor0d7_KjU();
                        } else {
                            mo2165invoke0d7_KjU = Color.INSTANCE.m4410getBlack0d7_KjU();
                        }
                    }
                    multiParagraph.m6289paintLG529CI(canvas, (r14 & 2) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : mo2165invoke0d7_KjU, (r14 & 4) != 0 ? null : shadow2, (r14 & 8) != 0 ? null : textDecoration2, (r14 & 16) == 0 ? drawStyle2 : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m4937getDefaultBlendMode0nO6VwU() : 0);
                }
                TextSubstitutionValue textSubstitutionValue = this.textSubstitution;
