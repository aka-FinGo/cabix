...
final class DefaultPagerNestedScrollConnection implements NestedScrollConnection {
    ...
    public final long m1288consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        if (orientation == Orientation.Vertical) {
            return Velocity.m7223copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m7223copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPreScroll-OzD1aCk */
    public long mo1127onPreScrollOzD1aCk(long available, int source) {
        if (NestedScrollSource.m5488equalsimpl0(source, NestedScrollSource.INSTANCE.m5500getUserInputWNlRxjI()) && Math.abs(this.state.getCurrentPageOffsetFraction()) > 1.0E-6d) {
            ...
            return Offset.m4118copydBAh8RU(available, intBitsToFloat, f);
        }
    ...
    public long mo821onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (NestedScrollSource.m5488equalsimpl0(source, NestedScrollSource.INSTANCE.m5499getSideEffectWNlRxjI()) && m1287mainAxisk4lQ0M(available) != 0.0f) {
    ...
    public Object mo820onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m7218boximpl(m1288consumeOnOrientationQWom1Mo(j2, this.orientation));
    }

    /* renamed from: mainAxis-k-4lQ0M, reason: not valid java name */
    private final float m1287mainAxisk4lQ0M(long j) {
