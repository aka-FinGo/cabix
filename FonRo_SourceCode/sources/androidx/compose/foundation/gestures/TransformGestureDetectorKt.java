...
public final class TransformGestureDetectorKt {
    ...
    public static final float calculateRotation(PointerEvent pointerEvent) {
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            ...
            if (pointerInputChange2.getPressed() && pointerInputChange2.getPreviousPressed()) {
                ...
                long m4129minusMKHz9U = Offset.m4129minusMKHz9U(pointerInputChange2.getPreviousPosition(), calculateCentroid2);
                long m4129minusMKHz9U2 = Offset.m4129minusMKHz9U(position, calculateCentroid);
                float m849anglek4lQ0M = m849anglek4lQ0M(m4129minusMKHz9U2) - m849anglek4lQ0M(m4129minusMKHz9U);
                float m4123getDistanceimpl = Offset.m4123getDistanceimpl(Offset.m4130plusMKHz9U(m4129minusMKHz9U2, m4129minusMKHz9U)) / 2.0f;
                if (m849anglek4lQ0M > 180.0f) {
                    m849anglek4lQ0M -= 360.0f;
                } else if (m849anglek4lQ0M < -180.0f) {
                    m849anglek4lQ0M += 360.0f;
                }
                f2 += m849anglek4lQ0M * m4123getDistanceimpl;
                f += m4123getDistanceimpl;
            }
        }
        if (f == 0.0f) {
            return 0.0f;
    ...
    public static final long calculatePan(PointerEvent pointerEvent) {
        long calculateCentroid = calculateCentroid(pointerEvent, true);
        if (Offset.m4122equalsimpl0(calculateCentroid, Offset.INSTANCE.m4140getUnspecifiedF1C5BW0())) {
            return Offset.INSTANCE.m4141getZeroF1C5BW0();
        }
        return Offset.m4129minusMKHz9U(calculateCentroid, calculateCentroid(pointerEvent, false));
    }
    ...
    public static final float calculateCentroidSize(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                f += Offset.m4123getDistanceimpl(Offset.m4129minusMKHz9U(z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition(), calculateCentroid));
                i++;
            }
        }
        return f / i;
    ...
    public static final long calculateCentroid(PointerEvent pointerEvent, boolean z) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            PointerInputChange pointerInputChange = changes.get(i2);
            if (pointerInputChange.getPressed() && pointerInputChange.getPreviousPressed()) {
                m4141getZeroF1C5BW0 = Offset.m4130plusMKHz9U(m4141getZeroF1C5BW0, z ? pointerInputChange.getPosition() : pointerInputChange.getPreviousPosition());
                i++;
            }
        }
        if (i == 0) {
        ...
        return Offset.m4120divtuRUvjQ(m4141getZeroF1C5BW0, i);
    }

    /* renamed from: angle-k-4lQ0M, reason: not valid java name */
    private static final float m849anglek4lQ0M(long j) {
