...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/foundation/gestures/DragScope;"}, k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        if (i == 0) {
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableNode$drag$2.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    long m782reverseIfNeededMKHz9U;
                    Orientation orientation;
                    float m775toFloat3MmeM6k;
                    DragScope dragScope2 = DragScope.this;
                    m782reverseIfNeededMKHz9U = draggableNode.m782reverseIfNeededMKHz9U(dragDelta.getDelta());
                    orientation = draggableNode.orientation;
                    m775toFloat3MmeM6k = DraggableKt.m775toFloat3MmeM6k(m782reverseIfNeededMKHz9U, orientation);
                    dragScope2.dragBy(m775toFloat3MmeM6k);
                }
            };
            this.label = 1;
