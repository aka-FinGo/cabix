...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/foundation/draganddrop/DragAndDropStartDetectorScope;"}, k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        if (i == 0) {
            ...
            if (TapGestureDetectorKt.detectTapGestures$default(dragAndDropStartDetectorScope, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceDefaults$DefaultStartDetector$1.1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m687invokek4lQ0M(offset.m4135unboximpl());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m687invokek4lQ0M(long j) {
                    DragAndDropStartDetectorScope.this.mo692requestDragAndDropTransferk4lQ0M(j);
                }
