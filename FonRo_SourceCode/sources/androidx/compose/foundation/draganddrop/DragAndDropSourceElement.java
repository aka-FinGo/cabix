...
final /* data */ class DragAndDropSourceElement extends ModifierNodeElement<DragAndDropSourceNode> {
    ...
    public final DragAndDropSourceElement copy(Function1<? super DrawScope, Unit> drawDragDecoration, Function2<? super DragAndDropStartDetectorScope, ? super Continuation<? super Unit>, ? extends Object> detectDragStart, Function1<? super Offset, DragAndDropTransferData> transferData) {
        return new DragAndDropSourceElement(drawDragDecoration, detectDragStart, transferData);
    }
