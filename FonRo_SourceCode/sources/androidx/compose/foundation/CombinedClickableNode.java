...
public final class CombinedClickableNode extends AbstractClickableNode implements CompositionLocalConsumerModifierNode {
    ...
    /* compiled from: Clickable.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0007\b\u0007\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u001a\u0010\u0005\u001a\u00020\u0006X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0007\u0010\b\"\u0004\b\t\u0010\nR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\f¨\u0006\r"}, d2 = {"Landroidx/compose/foundation/CombinedClickableNode$DoubleKeyClickState;", "", "job", "Lkotlinx/coroutines/Job;", "(Lkotlinx/coroutines/Job;)V", "doubleTapMinTimeMillisElapsed", "", "getDoubleTapMinTimeMillisElapsed", "()Z", "setDoubleTapMinTimeMillisElapsed", "(Z)V", "getJob", "()Lkotlinx/coroutines/Job;", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public Object clickPointerInput(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object detectTapGestures = TapGestureDetectorKt.detectTapGestures(pointerInputScope, (!getEnabled() || this.onDoubleClick == null) ? null : new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.CombinedClickableNode$clickPointerInput$2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m608invokek4lQ0M(offset.m4135unboximpl());
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m609invokek4lQ0M(offset.m4135unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m609invokek4lQ0M(long j) {
                Function0 function0;
                ...
                if (CombinedClickableNode.this.getHapticFeedbackEnabled()) {
                    ((HapticFeedback) CompositionLocalConsumerModifierNodeKt.currentValueOf(CombinedClickableNode.this, CompositionLocalsKt.getLocalHapticFeedback())).mo5106performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m5118getLongPress5zf0vsI());
                }
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m611invokek4lQ0M(offset.m4135unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m611invokek4lQ0M(long j) {
    ...
    public final void m607updatenSzSaCc(Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick, Function0<Unit> onDoubleClick, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role) {
        boolean z;
        ...
        m530updateCommonQzZPfjk(interactionSource, indicationNodeFactory, enabled, onClickLabel, role, onClick);
        if (z2) {
    ...
    protected boolean mo525onClickKeyDownEventZmokQxo(KeyEvent event) {
        boolean z;
        Job launch$default;
        long m5463getKeyZmokQxo = KeyEvent_androidKt.m5463getKeyZmokQxo(event);
        if (this.onLongClick == null || this.longKeyPressJobs.get(m5463getKeyZmokQxo) != null) {
            z = false;
        } else {
            ...
            mutableLongObjectMap.set(m5463getKeyZmokQxo, launch$default);
            z = true;
        }
        DoubleKeyClickState doubleKeyClickState = this.doubleKeyClickStates.get(m5463getKeyZmokQxo);
        if (doubleKeyClickState != null) {
            if (doubleKeyClickState.getJob().isActive()) {
                ...
                if (!doubleKeyClickState.getDoubleTapMinTimeMillisElapsed()) {
                    getOnClick().invoke();
                    this.doubleKeyClickStates.remove(m5463getKeyZmokQxo);
                    return z;
                }
            } else {
                this.doubleKeyClickStates.remove(m5463getKeyZmokQxo);
    ...
    protected boolean mo526onClickKeyUpEventZmokQxo(KeyEvent event) {
        Function0<Unit> function0;
        Job launch$default;
        long m5463getKeyZmokQxo = KeyEvent_androidKt.m5463getKeyZmokQxo(event);
        boolean z = false;
        if (this.longKeyPressJobs.get(m5463getKeyZmokQxo) != null) {
            Job job = this.longKeyPressJobs.get(m5463getKeyZmokQxo);
            if (job != null) {
                if (job.isActive()) {
            ...
            this.longKeyPressJobs.remove(m5463getKeyZmokQxo);
        }
        if (this.onDoubleClick != null) {
            if (this.doubleKeyClickStates.get(m5463getKeyZmokQxo) != null) {
                ...
                launch$default = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), null, null, new CombinedClickableNode$onClickKeyUpEvent$2(this, m5463getKeyZmokQxo, null), 3, null);
                mutableLongObjectMap.set(m5463getKeyZmokQxo, new DoubleKeyClickState(launch$default));
            }
        } else if (!z) {
            getOnClick().invoke();
        }
