...
public final class FocusableNode extends DelegatingNode implements SemanticsModifierNode, GlobalPositionAwareModifierNode, CompositionLocalConsumerModifierNode, ObserverModifierNode, TraversableNode {
    ...
    public /* synthetic */ FocusableNode(MutableInteractionSource mutableInteractionSource, int i, Function1 function1, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(mutableInteractionSource, (i2 & 2) != 0 ? Focusability.INSTANCE.m4061getAlwaysLCbbffg() : i, (i2 & 4) != 0 ? null : function1, null);
    }
    ...
    private FocusableNode(MutableInteractionSource mutableInteractionSource, int i, Function1<? super Boolean, Unit> function1) {
        ...
        this.focusTargetNode = (FocusTargetModifierNode) delegate(FocusTargetModifierNodeKt.m4042FocusTargetModifierNodePYyLHbc(i, new FocusableNode$focusTargetNode$1(this)));
    }
    ...
    /* compiled from: Focusable.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, d2 = {"Landroidx/compose/foundation/FocusableNode$TraverseKey;", "", "()V", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        Function0<Boolean> function0 = this.requestFocus;
        if (function0 == null) {
            function0 = new Function0<Boolean>() { // from class: androidx.compose.foundation.FocusableNode$applySemantics$1
                ...
                public final Boolean invoke() {
                    ...
                    return Boolean.valueOf(FocusTargetModifierNode.m4038requestFocus3ESFkO8$default(focusTargetModifierNode, 0, 1, null));
                }
            };
            this.requestFocus = function0;
        }
        SemanticsPropertiesKt.requestFocus$default(semanticsPropertyReceiver, null, function0, 1, null);
    }
