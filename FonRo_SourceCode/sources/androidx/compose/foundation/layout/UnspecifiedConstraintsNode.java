...
final class UnspecifiedConstraintsNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ UnspecifiedConstraintsNode(float f, float f2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : f, (i & 2) != 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : f2, null);
    }
    ...
    public final void m1118setMinWidth0680j_4(float f) {
        this.minWidth = f;
    }
    ...
    public final void m1117setMinHeight0680j_4(float f) {
        this.minHeight = f;
    }
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (!Float.isNaN(this.minWidth) && Constraints.m6944getMinWidthimpl(j) == 0) {
            int i = measureScope.mo694roundToPx0680j_4(this.minWidth);
            m6944getMinWidthimpl = Constraints.m6942getMaxWidthimpl(j);
            if (i < 0) {
                i = 0;
            }
            if (i <= m6944getMinWidthimpl) {
                m6944getMinWidthimpl = i;
            }
        } else {
            m6944getMinWidthimpl = Constraints.m6944getMinWidthimpl(j);
        }
        int m6942getMaxWidthimpl = Constraints.m6942getMaxWidthimpl(j);
        if (!Float.isNaN(this.minHeight) && Constraints.m6943getMinHeightimpl(j) == 0) {
            int i2 = measureScope.mo694roundToPx0680j_4(this.minHeight);
            m6943getMinHeightimpl = Constraints.m6941getMaxHeightimpl(j);
            int i3 = i2 >= 0 ? i2 : 0;
            if (i3 <= m6943getMinHeightimpl) {
                m6943getMinHeightimpl = i3;
            }
        } else {
            m6943getMinHeightimpl = Constraints.m6943getMinHeightimpl(j);
        }
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(ConstraintsKt.Constraints(m6944getMinWidthimpl, m6942getMaxWidthimpl, m6943getMinHeightimpl, Constraints.m6941getMaxHeightimpl(j)));
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.UnspecifiedConstraintsNode$measure$1
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minWidth) ? intrinsicMeasureScope.mo694roundToPx0680j_4(this.minWidth) : 0;
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i) {
        ...
        int i2 = !Float.isNaN(this.minHeight) ? intrinsicMeasureScope.mo694roundToPx0680j_4(this.minHeight) : 0;
