...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1012setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: setY-0680j_4, reason: not valid java name */
    public final void m1013setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public final void m1014updateMdfbLM(float x, float y, boolean rtlAware) {
        if (!Dp.m6994equalsimpl0(this.x, x) || !Dp.m6994equalsimpl0(this.y, y) || this.rtlAware != rtlAware) {
    ...
    public MeasureResult mo384measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeable, measureScope.mo694roundToPx0680j_4(OffsetNode.this.getX()), measureScope.mo694roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeable, measureScope.mo694roundToPx0680j_4(OffsetNode.this.getX()), measureScope.mo694roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
