...
public final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public final void requestAnimationController() {
        ...
        if (windowInsetsController != null) {
            windowInsetsController.controlWindowInsetsAnimation(this.windowInsets.getType(), -1L, null, this.cancellationSignal, ComponentDialog$$ExternalSyntheticApiModelOutline0.m2m((Object) this));
        }
    }
    ...
    public long mo1127onPreScrollOzD1aCk(long available, int source) {
        return m1125scroll8S9VItk(available, this.sideCalculator.hideMotion(Float.intBitsToFloat((int) (available >> 32)), Float.intBitsToFloat((int) (4294967295L & available))));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo821onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m1125scroll8S9VItk(available, this.sideCalculator.showMotion(Float.intBitsToFloat((int) (available >> 32)), Float.intBitsToFloat((int) (4294967295L & available))));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m1125scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo1077consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo1126onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m1124flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m7227getXimpl(j), Velocity.m7228getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo820onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m1124flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m7227getXimpl(j2), Velocity.m7228getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m1124flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instructions count: 409
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m1124flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
