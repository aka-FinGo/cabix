...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                long m7126unboximpl = OffsetPxNode.this.getOffset().invoke(measureScope).m7126unboximpl();
                boolean rtlAware = OffsetPxNode.this.getRtlAware();
                Placeable placeable = mo5732measureBRTryo0;
                if (rtlAware) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(placementScope, placeable, IntOffset.m7117getXimpl(m7126unboximpl), IntOffset.m7118getYimpl(m7126unboximpl), 0.0f, (Function1) null, 12, (Object) null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(placementScope, placeable, IntOffset.m7117getXimpl(m7126unboximpl), IntOffset.m7118getYimpl(m7126unboximpl), 0.0f, (Function1) null, 12, (Object) null);
                }
            }
        }, 4, null);
    }
