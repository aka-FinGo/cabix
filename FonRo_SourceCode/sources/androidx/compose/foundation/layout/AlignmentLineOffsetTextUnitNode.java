...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m919setBeforeR2X_6o(long j) {
        this.before = j;
    }
    ...
    public final void m918setAfterR2X_6o(long j) {
        this.after = j;
    }
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        MeasureResult m899alignmentLineOffsetMeasuretjqqzMA;
        m899alignmentLineOffsetMeasuretjqqzMA = AlignmentLineKt.m899alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, TextUnit.m7181getRawTypeimpl(this.before) == 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : measureScope.mo695toDpGaN1DYA(this.before), TextUnit.m7181getRawTypeimpl(this.after) == 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : measureScope.mo695toDpGaN1DYA(this.after), measurable, j);
        return m899alignmentLineOffsetMeasuretjqqzMA;
    }
}
