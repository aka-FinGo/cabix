...
public interface FlowLineMeasurePolicy extends RowColumnMeasurePolicy {
    ...
    default long mo962createConstraintsxF2OJ5Q(int mainAxisMin, int crossAxisMin, int mainAxisMax, int crossAxisMax, boolean isPrioritizing) {
        if (isHorizontal()) {
        ...
        return MeasureScope.layout$default(measureScope, i2, i, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLineMeasurePolicy$placeHelper$1$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i4 < endIndex) {
                    ...
                    if (isHorizontal) {
                        int i5 = iArr2[i4 - startIndex];
                        placementScope2 = placementScope;
                        Placeable.PlacementScope.place$default(placementScope2, placeable, i5, crossAxisPosition, 0.0f, 4, null);
                    } else {
                        int i6 = iArr2[i4 - startIndex];
                        placementScope2 = placementScope;
                        Placeable.PlacementScope.place$default(placementScope2, placeable, crossAxisPosition, i6, 0.0f, 4, null);
                    }
                    i4++;
