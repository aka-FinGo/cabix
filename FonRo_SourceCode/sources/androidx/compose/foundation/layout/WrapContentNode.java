...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m6944getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m6942getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m6943getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m6941getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int coerceIn = RangesKt.coerceIn(mo5732measureBRTryo0.getWidth(), Constraints.m6944getMinWidthimpl(j), Constraints.m6942getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo5732measureBRTryo0.getHeight(), Constraints.m6943getMinHeightimpl(j), Constraints.m6941getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5796place70tqf50$default(placementScope, mo5732measureBRTryo0, WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m7152boximpl(IntSize.m7155constructorimpl(((coerceIn2 - mo5732measureBRTryo0.getHeight()) & 4294967295L) | ((coerceIn - mo5732measureBRTryo0.getWidth()) << 32))), measureScope.getLayoutDirection()).m7126unboximpl(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
