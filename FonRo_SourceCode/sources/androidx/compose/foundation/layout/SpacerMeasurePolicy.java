...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m6940getHasFixedWidthimpl(j) ? Constraints.m6942getMaxWidthimpl(j) : 0, Constraints.m6939getHasFixedHeightimpl(j) ? Constraints.m6941getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
