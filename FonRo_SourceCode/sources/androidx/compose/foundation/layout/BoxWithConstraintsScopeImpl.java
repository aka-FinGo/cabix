...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m959copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m961copy0kLqBqw(density, j);
    }
    ...
    public final BoxWithConstraintsScopeImpl m961copy0kLqBqw(Density density, long constraints) {
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m6935equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m6945hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m6947toStringimpl(this.constraints)) + ')';
    }
    ...
    public float mo958getMinWidthD9Ej5fM() {
        return this.density.mo697toDpu2uoSUM(Constraints.m6944getMinWidthimpl(mo954getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxWidth-D9Ej5fM */
    public float mo956getMaxWidthD9Ej5fM() {
        return Constraints.m6938getHasBoundedWidthimpl(mo954getConstraintsmsEJaDk()) ? this.density.mo697toDpu2uoSUM(Constraints.m6942getMaxWidthimpl(mo954getConstraintsmsEJaDk())) : Dp.INSTANCE.m7008getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMinHeight-D9Ej5fM */
    public float mo957getMinHeightD9Ej5fM() {
        return this.density.mo697toDpu2uoSUM(Constraints.m6943getMinHeightimpl(mo954getConstraintsmsEJaDk()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* renamed from: getMaxHeight-D9Ej5fM */
    public float mo955getMaxHeightD9Ej5fM() {
        return Constraints.m6937getHasBoundedHeightimpl(mo954getConstraintsmsEJaDk()) ? this.density.mo697toDpu2uoSUM(Constraints.m6941getMaxHeightimpl(mo954getConstraintsmsEJaDk())) : Dp.INSTANCE.m7008getInfinityD9Ej5fM();
    }
}
