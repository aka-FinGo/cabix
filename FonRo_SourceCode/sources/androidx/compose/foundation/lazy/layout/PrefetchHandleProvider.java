...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1239schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final PrefetchRequest m1238createNestedPrefetchRequestVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    public final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        private HandleAndRequestImpl(int i, long j, PrefetchMetrics prefetchMetrics) {
            ...
            this.startTime = TimeSource.Monotonic.INSTANCE.m9401markNowz9LOYto();
        }
        ...
        private final void updateElapsedAndAvailableTime() {
            ...
            long m9297getInWholeNanosecondsimpl = Duration.m9297getInWholeNanosecondsimpl(TimeSource.Monotonic.ValueTimeMark.m9412minus6eNON_k(m9401markNowz9LOYto, this.startTime));
            this.elapsedTimeNanos = m9297getInWholeNanosecondsimpl;
            this.availableTimeNanos -= m9297getInWholeNanosecondsimpl;
            this.startTime = m9401markNowz9LOYto;
        }
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isCanceled) {
                ...
                if (i >= 0 && i < itemCount) {
                    ...
                    if (!this.isMeasured && !Constraints.m6946isZeroimpl(this.constraints)) {
                        if (!shouldExecute(this.availableTimeNanos, this.prefetchMetrics.getMeasureTimeNanos(contentType))) {
                            return true;
                        }
                        Trace.beginSection("compose:lazy:prefetch:measure");
                        try {
                            m1240performMeasureBRTryo0(this.constraints);
        ...
        private final void m1240performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            if (precomposedSlotHandle != null) {
                ...
                for (int i = 0; i < placeablesCount; i++) {
                    precomposedSlotHandle.mo5758premeasure0kLqBqw(i, constraints);
                }
                return;
            }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m6947toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
