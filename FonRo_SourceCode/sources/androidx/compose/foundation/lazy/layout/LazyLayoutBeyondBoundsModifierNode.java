...
public final class LazyLayoutBeyondBoundsModifierNode extends Modifier.Node implements ModifierLocalModifierNode, BeyondBoundsLayout, LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierNode$measure$1
    ...
    public <T> T mo1205layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        ...
        boolean m1203isForward4vf7U8o = m1203isForward4vf7U8o(direction);
        LazyLayoutBeyondBoundsState lazyLayoutBeyondBoundsState = this.state;
        if (m1203isForward4vf7U8o) {
        ...
        T t = null;
        int i = 0;
        while (t == null && m1202hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction) && i < coerceAtMost) {
            T t2 = (T) m1201addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            t = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierNode$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    boolean m1202hasMoreContentFR3nfPY;
                    m1202hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierNode.this.m1202hasMoreContentFR3nfPY(objectRef.element, direction);
                    return m1202hasMoreContentFR3nfPY;
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1203isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5720getBeforehoxUOeE())) {
            return false;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5719getAfterhoxUOeE())) {
            return true;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5718getAbovehoxUOeE())) {
            return this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5721getBelowhoxUOeE())) {
            return !this.reverseLayout;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5722getLefthoxUOeE())) {
        ...
        if (!BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5723getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1201addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
        int start = currentInterval.getStart();
        int end = currentInterval.getEnd();
        if (m1203isForward4vf7U8o(direction)) {
            end++;
        } else {
            start--;
        }
    ...
    public final boolean m1202hasMoreContentFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval interval, int i) {
        if (m1204isOppositeToOrientation4vf7U8o(i)) {
            return false;
        }
        return m1203isForward4vf7U8o(i) ? interval.getEnd() < this.state.getItemCount() - 1 : interval.getStart() > 0;
    }

    /* renamed from: isOppositeToOrientation-4vf7U8o, reason: not valid java name */
    private final boolean m1204isOppositeToOrientation4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5718getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5721getBelowhoxUOeE())) {
            return this.orientation == Orientation.Horizontal;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5722getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5723getRighthoxUOeE())) {
            return this.orientation == Orientation.Vertical;
        }
        if (BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5720getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m5714equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m5719getAfterhoxUOeE())) {
            return false;
        }
        LazyLayoutBeyondBoundsModifierLocalKt.access$unsupportedDirection();
        throw new KotlinNothingValueException();
