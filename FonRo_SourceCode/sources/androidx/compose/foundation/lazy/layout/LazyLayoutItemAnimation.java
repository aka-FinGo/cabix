...
public final class LazyLayoutItemAnimation {
    ...
    private static final long NotInitialized = IntOffset.m7111constructorimpl(9223372034707292159L);
    ...
    public LazyLayoutItemAnimation(CoroutineScope coroutineScope, GraphicsContext graphicsContext, Function0<Unit> function0) {
        ...
        this.rawOffset = j;
        this.finalOffset = IntOffset.INSTANCE.m7128getZeronOccac();
        this.layer = graphicsContext != null ? graphicsContext.createGraphicsLayer() : null;
        String str = null;
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m7108boximpl(IntOffset.INSTANCE.m7128getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, str, 12, null);
        ...
        mutableStateOf$default5 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m7108boximpl(IntOffset.INSTANCE.m7128getZeronOccac()), null, 2, null);
    ...
    public final void m1215setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }
    ...
    public final void m1213setFinalOffsetgyyYBs(long j) {
        this.finalOffset = j;
    }
    ...
    public final void m1207setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m7108boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m1211getPlacementDeltanOccac() {
        return ((IntOffset) this.placementDelta.getValue()).m7126unboximpl();
    }
    ...
    public final void m1214setLookaheadOffsetgyyYBs(long j) {
        this.lookaheadOffset = j;
    }

    /* renamed from: animatePlacementDelta-ar5cAso, reason: not valid java name */
    public final void m1208animatePlacementDeltaar5cAso(long delta, boolean isMovingAway) {
        FiniteAnimationSpec<IntOffset> finiteAnimationSpec = this.placementSpec;
        if (finiteAnimationSpec == null) {
            return;
        }
        long m7120minusqkQi6aY = IntOffset.m7120minusqkQi6aY(m1211getPlacementDeltanOccac(), delta);
        m1207setPlacementDeltagyyYBs(m7120minusqkQi6aY);
        setPlacementAnimationInProgress(true);
        this.isRunningMovingAwayAnimation = isMovingAway;
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new LazyLayoutItemAnimation$animatePlacementDelta$1(this, finiteAnimationSpec, m7120minusqkQi6aY, null), 3, null);
    }
    ...
    public final void release() {
        ...
        m1207setPlacementDeltagyyYBs(IntOffset.INSTANCE.m7128getZeronOccac());
    ...
    /* compiled from: LazyLayoutItemAnimation.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0019\u0010\u0003\u001a\u00020\u0004ø\u0001\u0000ø\u0001\u0001¢\u0006\n\n\u0002\u0010\u0007\u001a\u0004\b\u0005\u0010\u0006\u0082\u0002\u000b\n\u0005\b¡\u001e0\u0001\n\u0002\b!¨\u0006\b"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation$Companion;", "", "()V", "NotInitialized", "Landroidx/compose/ui/unit/IntOffset;", "getNotInitialized-nOcc-ac", "()J", "J", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    public static final class Companion {
        ...
        public final long m1216getNotInitializednOccac() {
