...
final class GridSlotCache implements LazyGridSlotsProvider {
    ...
    public LazyGridSlots mo1178invoke0kLqBqw(Density density, long constraints) {
        ...
        LazyGridSlots invoke = this.calculation.invoke(density, Constraints.m6929boximpl(constraints));
