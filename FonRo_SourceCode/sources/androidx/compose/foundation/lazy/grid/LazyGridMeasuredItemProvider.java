...
public abstract class LazyGridMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyGridMeasuredItem> {
    ...
    public abstract LazyGridMeasuredItem mo1191createItemO3s9Psw(int index, Object key, Object contentType, int crossAxisSize, int mainAxisSpacing, List<? extends Placeable> placeables, long constraints, int lane, int span);
    ...
    public LazyGridMeasuredItem mo1165getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1196getAndMeasurem8Kt_7k(index, constraints, lane, span, this.defaultMainAxisSpacing);
    }

    /* renamed from: getAndMeasure-m8Kt_7k, reason: not valid java name */
    public final LazyGridMeasuredItem m1196getAndMeasurem8Kt_7k(int index, long constraints, int lane, int span, int mainAxisSpacing) {
        ...
        List<Placeable> mo1223measure0kLqBqw = this.measureScope.mo1223measure0kLqBqw(index, constraints);
        if (Constraints.m6940getHasFixedWidthimpl(constraints)) {
            m6943getMinHeightimpl = Constraints.m6944getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m6939getHasFixedHeightimpl(constraints)) {
        ...
        return mo1191createItemO3s9Psw(index, key, contentType, m6943getMinHeightimpl, mainAxisSpacing, mo1223measure0kLqBqw, constraints, lane, span);
    }
