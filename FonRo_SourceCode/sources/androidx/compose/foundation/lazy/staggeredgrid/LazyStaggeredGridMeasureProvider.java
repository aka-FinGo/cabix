...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem mo1264createItempitSLOA(int index, int lane, int span, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private final long m1270childConstraintsJhjzzOo(int slot, int span) {
        int i;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m6954fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m6953fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1271getAndMeasurejy6DScQ(int index, long span) {
        ...
        long m1270childConstraintsJhjzzOo = m1270childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return mo1264createItempitSLOA(index, coerceAtMost, coerceAtMost2, key, contentType, this.measureScope.mo1223measure0kLqBqw(index, m1270childConstraintsJhjzzOo), m1270childConstraintsJhjzzOo);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasuredItemProvider
    /* renamed from: getAndMeasure--hBUhpc, reason: avoid collision after fix types in other method */
    public LazyStaggeredGridMeasuredItem mo1165getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return mo1264createItempitSLOA(index, lane, span, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo1223measure0kLqBqw(index, constraints), constraints);
    }
