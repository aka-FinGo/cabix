...
public final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        int m6944getMinWidthimpl = round != Integer.MAX_VALUE ? round : Constraints.m6944getMinWidthimpl(j);
        int m6943getMinHeightimpl = round2 != Integer.MAX_VALUE ? round2 : Constraints.m6943getMinHeightimpl(j);
        if (round == Integer.MAX_VALUE) {
            round = Constraints.m6942getMaxWidthimpl(j);
        }
        if (round2 == Integer.MAX_VALUE) {
            round2 = Constraints.m6941getMaxHeightimpl(j);
        }
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(ConstraintsKt.Constraints(m6944getMinWidthimpl, round, m6943getMinHeightimpl, round2));
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
