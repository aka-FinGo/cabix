...
public final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m607updatenSzSaCc(this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick, this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m6196hashCodeimpl = (((hashCode3 + (role != null ? Role.m6196hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode4 = (m6196hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
