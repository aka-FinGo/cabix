...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    public final void performRestore() {
        ...
        if (consumeRestoredStateForKey != null) {
            SavedStateWriter.m7554putAllimpl(m7550constructorimpl, consumeRestoredStateForKey);
        }
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        performRestore();
        Bundle bundle = this.restoredState;
        if (bundle == null || !SavedStateReader.m7465containsimpl(SavedStateReader.m7464constructorimpl(bundle), key)) {
            return null;
        }
        Bundle m7526getSavedStateOrNullimpl = SavedStateReader.m7526getSavedStateOrNullimpl(SavedStateReader.m7464constructorimpl(bundle), key);
        if (m7526getSavedStateOrNullimpl == null) {
            Map emptyMap = MapsKt.emptyMap();
            if (emptyMap.isEmpty()) {
                pairArr = new Pair[0];
            } else {
            ...
            m7526getSavedStateOrNullimpl = BundleKt.bundleOf((Pair[]) Arrays.copyOf(pairArr, pairArr.length));
            SavedStateWriter.m7550constructorimpl(m7526getSavedStateOrNullimpl);
        }
        ...
        return m7526getSavedStateOrNullimpl;
    }
    ...
    public Bundle saveState() {
        ...
        for (Map.Entry<String, SavedStateHandle> entry2 : getViewModel().getHandles().entrySet()) {
            ...
            if (!SavedStateReader.m7542isEmptyimpl(SavedStateReader.m7464constructorimpl(saveState))) {
                SavedStateWriter.m7577putSavedStateimpl(m7550constructorimpl, key, saveState);
            }
        }
        this.restored = false;
        return bundleOf;
