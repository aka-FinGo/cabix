...
public class AnimationHandler {
    ...
    private final Runnable mRunnable = new Runnable() { // from class: androidx.dynamicanimation.animation.AnimationHandler$$ExternalSyntheticLambda1
        @Override // java.lang.Runnable
        public final void run() {
            AnimationHandler.this.m7385x83fff5a8();
        }
    };
    ...
    public /* synthetic */ void m7385x83fff5a8() {
    ...
    public class DurationScaleChangeListener33 implements DurationScaleChangeListener {
        ...
        public boolean register() {
            ...
            ValueAnimator.DurationScaleChangeListener durationScaleChangeListener = new ValueAnimator.DurationScaleChangeListener() { // from class: androidx.dynamicanimation.animation.AnimationHandler$DurationScaleChangeListener33$$ExternalSyntheticLambda2
                @Override // android.animation.ValueAnimator.DurationScaleChangeListener
                public final void onChanged(float f) {
                    AnimationHandler.DurationScaleChangeListener33.this.m7386xb804c881(f);
                }
            };
        ...
        public /* synthetic */ void m7386xb804c881(float f) {
