...
public final class CharSequenceListSerializer implements KSerializer<List<? extends CharSequence>> {
    ...
    public void serialize(Encoder encoder, List<? extends CharSequence> value) {
        ...
        SavedStateWriter.m7562putCharSequenceListimpl(SavedStateWriter.m7550constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public List<CharSequence> deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7484getCharSequenceListimpl(SavedStateReader.m7464constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
