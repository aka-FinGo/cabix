...
public final class SavedStateRegistryImpl {
    ...
    public final Bundle consumeRestoredStateForKey(String key) {
        ...
        Bundle m7521getSavedStateimpl = SavedStateReader.m7465containsimpl(m7464constructorimpl, key) ? SavedStateReader.m7521getSavedStateimpl(m7464constructorimpl, key) : null;
        SavedStateWriter.m7586removeimpl(SavedStateWriter.m7550constructorimpl(bundle), key);
        if (SavedStateReader.m7542isEmptyimpl(SavedStateReader.m7464constructorimpl(bundle))) {
            this.restoredState = null;
        }
        return m7521getSavedStateimpl;
    }
    ...
    public final void performRestore$savedstate_release(Bundle savedState) {
        ...
        Bundle bundle = null;
        if (savedState != null) {
            Bundle m7464constructorimpl = SavedStateReader.m7464constructorimpl(savedState);
            if (SavedStateReader.m7465containsimpl(m7464constructorimpl, SAVED_COMPONENTS_KEY)) {
                bundle = SavedStateReader.m7521getSavedStateimpl(m7464constructorimpl, SAVED_COMPONENTS_KEY);
            }
        }
    ...
    public final void performSave$savedstate_release(Bundle outBundle) {
        ...
        synchronized (this.lock) {
            for (Map.Entry entry2 : this.keyToProviders.entrySet()) {
                SavedStateWriter.m7577putSavedStateimpl(m7550constructorimpl, (String) entry2.getKey(), ((SavedStateRegistry.SavedStateProvider) entry2.getValue()).saveState());
            }
            Unit unit = Unit.INSTANCE;
        }
        if (SavedStateReader.m7542isEmptyimpl(SavedStateReader.m7464constructorimpl(bundleOf))) {
            return;
        }
        SavedStateWriter.m7577putSavedStateimpl(SavedStateWriter.m7550constructorimpl(outBundle), SAVED_COMPONENTS_KEY, bundleOf);
    }
}
