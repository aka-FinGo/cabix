...
public class Processor implements ForegroundProcessor {
    ...
    public boolean startWork(StartStopToken startStopToken, WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return Processor.this.m7596lambda$startWork$0$androidxworkimplProcessor(arrayList, workSpecId);
            }
        });
        if (workSpec == null) {
        ...
        synchronized (this.mLock) {
            ...
            launch.addListener(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    Processor.this.m7597lambda$startWork$1$androidxworkimplProcessor(launch, build);
                }
    ...
    public /* synthetic */ WorkSpec m7596lambda$startWork$0$androidxworkimplProcessor(ArrayList arrayList, String str) throws Exception {
    ...
    public /* synthetic */ void m7597lambda$startWork$1$androidxworkimplProcessor(ListenableFuture listenableFuture, WorkerWrapper workerWrapper) {
        boolean z;
        try {
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Processor.this.m7595lambda$runOnExecuted$2$androidxworkimplProcessor(id, needsReschedule);
            }
        });
    }
    ...
    public /* synthetic */ void m7595lambda$runOnExecuted$2$androidxworkimplProcessor(WorkGenerationalId workGenerationalId, boolean z) {
        synchronized (this.mLock) {
            Iterator<ExecutionListener> it = this.mOuterListeners.iterator();
            while (it.hasNext()) {
