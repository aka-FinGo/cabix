            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i = 0; i < historicalProcessExitReasons.size(); i++) {
                        ApplicationExitInfo m7666m = ContentUriFetcher$$ExternalSyntheticApiModelOutline0.m7666m(historicalProcessExitReasons.get(i));
                        reason = m7666m.getReason();
                        if (reason == 10) {
                            timestamp = m7666m.getTimestamp();
