...
@DebugMetadata(c = "uz.FonRo.pos.ui.catalog.GlobalCatalogScreenKt$GlobalCatalogScreen$4$1$1$4$1$1$1$1", f = "GlobalCatalogScreen.kt", i = {}, l = {299}, m = "invokeSuspend", n = {}, nl = {-1}, s = {}, v = 2)
/* loaded from: classes7.dex */
public final class GlobalCatalogScreenKt$GlobalCatalogScreen$4$1$1$4$1$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GlobalCatalogScreenKt$GlobalCatalogScreen$4$1$1$4$1$1$1$1(this.$loading$delegate, this.$error$delegate, this.$items$delegate, this.$total$delegate, this.$lang$delegate, this.$categoryId$delegate, this.$search$delegate, this.$categories$delegate, this.$importedIds$delegate, this.$didLoad$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GlobalCatalogScreenKt$GlobalCatalogScreen$4$1$1$4$1$1$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
