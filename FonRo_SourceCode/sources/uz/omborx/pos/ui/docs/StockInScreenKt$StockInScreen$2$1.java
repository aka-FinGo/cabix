...
@DebugMetadata(c = "uz.FonRo.pos.ui.docs.StockInScreenKt$StockInScreen$2$1", f = "StockInScreen.kt", i = {0, 0, 1, 1}, l = {310, 311}, m = "invokeSuspend", n = {"$this$LaunchedEffect", "$this$invokeSuspend_u24lambda_u240", "$this$LaunchedEffect", "$this$invokeSuspend_u24lambda_u241"}, nl = {310, 311}, s = {"L$0", "L$1", "L$0", "L$1"}, v = 2)
/* loaded from: classes7.dex */
final class StockInScreenKt$StockInScreen$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public StockInScreenKt$StockInScreen$2$1(Repo repo, Continuation<? super StockInScreenKt$StockInScreen$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        StockInScreenKt$StockInScreen$2$1 stockInScreenKt$StockInScreen$2$1 = new StockInScreenKt$StockInScreen$2$1(this.$repo, continuation);
        stockInScreenKt$StockInScreen$2$1.L$0 = obj;
        return stockInScreenKt$StockInScreen$2$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StockInScreenKt$StockInScreen$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r8) {
        ...
        L7d:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: uz.FonRo.pos.ui.docs.StockInScreenKt$StockInScreen$2$1.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
