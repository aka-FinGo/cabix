...
@DebugMetadata(c = "uz.FonRo.pos.ui.docs.StockInScreenKt$StockInPaywall$refresh$1", f = "StockInScreen.kt", i = {}, l = {1497}, m = "invokeSuspend", n = {}, nl = {1498}, s = {}, v = 2)
/* loaded from: classes7.dex */
public final class StockInScreenKt$StockInPaywall$refresh$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public StockInScreenKt$StockInPaywall$refresh$1(FonRoApp FonRoApp, MutableState<Boolean> mutableState, Continuation<? super StockInScreenKt$StockInPaywall$refresh$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StockInScreenKt$StockInPaywall$refresh$1(this.$app, this.$busy$delegate, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((StockInScreenKt$StockInPaywall$refresh$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            try {
                StockInScreenKt.StockInPaywall$lambda$2(this.$busy$delegate, false);
