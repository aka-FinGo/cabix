...
public final /* data */ class WriteOffItem {
    ...
    public static /* synthetic */ WriteOffItem copy$default(WriteOffItem writeOffItem, long j, String str, double d, String str2, double d2, double d3, int i, Object obj) {
        if ((i & 1) != 0) {
            j = writeOffItem.productId;
        }
        long j2 = j;
        if ((i & 2) != 0) {
            str = writeOffItem.productName;
        }
        return writeOffItem.copy(j2, str, (i & 4) != 0 ? writeOffItem.quantity : d, (i & 8) != 0 ? writeOffItem.productUnit : str2, (i & 16) != 0 ? writeOffItem.purchasePrice : d2, (i & 32) != 0 ? writeOffItem.amount : d3);
    }
    ...
    public final WriteOffItem copy(long productId, String productName, double quantity, String productUnit, double purchasePrice, double amount) {
        return new WriteOffItem(productId, productName, quantity, productUnit, purchasePrice, amount);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof WriteOffItem)) {
            return false;
        }
        WriteOffItem writeOffItem = (WriteOffItem) other;
        return this.productId == writeOffItem.productId && Intrinsics.areEqual(this.productName, writeOffItem.productName) && Double.compare(this.quantity, writeOffItem.quantity) == 0 && Intrinsics.areEqual(this.productUnit, writeOffItem.productUnit) && Double.compare(this.purchasePrice, writeOffItem.purchasePrice) == 0 && Double.compare(this.amount, writeOffItem.amount) == 0;
    }
    ...
    public String toString() {
        return "WriteOffItem(productId=" + this.productId + ", productName=" + this.productName + ", quantity=" + this.quantity + ", productUnit=" + this.productUnit + ", purchasePrice=" + this.purchasePrice + ", amount=" + this.amount + ")";
    }

    /* compiled from: Sync.kt */
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Luz/FonRo/pos/data/model/WriteOffItem$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Luz/FonRo/pos/data/model/WriteOffItem;", "app"}, k = 1, mv = {2, 4, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes5.dex */
    public static final class Companion {
        ...
        public final KSerializer<WriteOffItem> serializer() {
            return WriteOffItem$$serializer.INSTANCE;
        }
    }

    public /* synthetic */ WriteOffItem(int i, long j, String str, double d, String str2, double d2, double d3, SerializationConstructorMarker serializationConstructorMarker) {
    ...
    public WriteOffItem(long j, String str, double d, String str2, double d2, double d3) {
        this.productId = j;
        this.productName = str;
        this.quantity = d;
        this.productUnit = str2;
    ...
    @JvmStatic
    public static final /* synthetic */ void write$Self$app(WriteOffItem self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public /* synthetic */ WriteOffItem(long j, String str, double d, String str2, double d2, double d3, int i, DefaultConstructorMarker defaultConstructorMarker) {
