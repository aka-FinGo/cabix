...
@DebugMetadata(c = "uz.FonRo.pos.data.repo.AuthRepository$login$2", f = "AuthRepository.kt", i = {}, l = {31}, m = "invokeSuspend", n = {}, nl = {32}, s = {}, v = 2)
/* loaded from: classes5.dex */
public final class AuthRepository$login$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Session>, Object> {
    ...
    public AuthRepository$login$2(AuthRepository authRepository, String str, String str2, Continuation<? super AuthRepository$login$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AuthRepository$login$2(this.this$0, this.$email, this.$password, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.L$0 = apiClient2;
            this.label = 1;
            Object login = api.login(new LoginBody(this.$email, this.$password), this);
