...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m8043boximpl(ULong.m8049constructorimpl(getMostSignificantBits())), ULong.m8043boximpl(ULong.m8049constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m9425toUByteArrayTcUX1vc() {
        return UByteArray.m7946constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        if (j != other.mostSignificantBits) {
            compare2 = Long.compare(ULong.m8049constructorimpl(j) ^ Long.MIN_VALUE, ULong.m8049constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE);
            return compare2;
        }
        compare = Long.compare(ULong.m8049constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m8049constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m9427fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m9426fromUByteArrayGBYM_sE(byte[] ubyteArray) {
