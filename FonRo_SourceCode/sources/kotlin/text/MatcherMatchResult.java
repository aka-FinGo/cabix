...
public final class MatcherMatchResult implements MatchResult {
    ...
    public List<String> getGroupValues() {
        AbstractList<String> abstractList = this.groupValues_;
        if (abstractList == null) {
            abstractList = new AbstractList<String>() { // from class: kotlin.text.MatcherMatchResult$groupValues$1
            ...
            this.groupValues_ = abstractList;
        }
        Intrinsics.checkNotNull(abstractList);
        return abstractList;
    }
