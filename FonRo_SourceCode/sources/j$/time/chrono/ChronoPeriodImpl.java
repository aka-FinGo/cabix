...
final class ChronoPeriodImpl implements TemporalAmount, Serializable {
    private static final List SUPPORTED_UNITS = Period.AnonymousClass0.m(ChronoUnit.YEARS, ChronoUnit.MONTHS, ChronoUnit.DAYS);
    ...
    public Temporal addTo(Temporal temporal) {
        ...
        if (this.months == 0) {
            ...
            int i2 = this.years;
            if (monthRange > 0) {
                temporal = temporal.plus((i2 * monthRange) + this.months, ChronoUnit.MONTHS);
            } else {
                if (i2 != 0) {
    ...
    private void validateChrono(TemporalAccessor temporalAccessor) {
        ...
        ZoneId.AnonymousClass4.m("Chronology mismatch, expected: ", this.chrono.getId(), ", actual: ", chronology.getId());
    }
