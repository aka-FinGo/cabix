...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    ...
    /* renamed from: j$.time.chrono.HijrahChronology$0 */
    /* loaded from: classes3.dex */
    ...
    public HijrahDate dateYearDay(int i, int i2) {
        ...
        if (i2 > of.lengthOfYear()) {
            Month.AnonymousClass0.m("Invalid dayOfYear: ", i2);
            return null;
        }
    ...
    public HijrahEra eraOf(int i) {
        ...
        Year.AnonymousClass3.m("invalid Hijrah era");
        return null;
    }

    @Override // j$.time.chrono.Chronology
    public List eras() {
        return Duration$DurationUnits$0.m(HijrahEra.values());
    }
    ...
    void checkValidMonth(int i) {
        if (i < 1 || i > 12) {
            Month.AnonymousClass0.m("Invalid Hijrah month: ", i);
        }
    }
    ...
    public int[] getHijrahDateInfo(int i) {
        ...
        if (i < this.minEpochDay || i >= this.maxEpochDay) {
            Year.AnonymousClass3.m("Hijrah date out of range");
            return null;
        }
    ...
    public long getEpochDay(int i, int i2, int i3) {
        ...
        if (i3 < 1 || i3 > getMonthLength(i, i2)) {
            Month.AnonymousClass0.m("Invalid Hijrah day of month: ", i3);
            return 0L;
        }
    ...
    private int[] createEpochMonths(int i, int i2, int i3, Map map) {
        ...
        for (int i6 = i2; i6 <= i3; i6++) {
            ...
            while (i7 < 12) {
                ...
                iArr[i5] = i;
                if (i8 < 29 || i8 > 32) {
                    AnonymousClass0.m("Invalid month length in year: ", i2);
                    return null;
                }
                i += i8;
