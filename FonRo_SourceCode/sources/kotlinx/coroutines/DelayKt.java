...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo9503scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m9429delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9430toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9430toDelayMillisLRDsOJo(long j) {
        boolean m9311isPositiveimpl = Duration.m9311isPositiveimpl(j);
        if (m9311isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m9295getInWholeMillisecondsimpl(Duration.m9313plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m9311isPositiveimpl) {
