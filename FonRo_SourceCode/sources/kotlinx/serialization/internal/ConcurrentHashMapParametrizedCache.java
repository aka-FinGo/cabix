...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo9515getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object putIfAbsent2 = concurrentHashMap2.putIfAbsent(arrayList2, m7869boximpl);
            obj = putIfAbsent2 == null ? m7869boximpl : putIfAbsent2;
        }
