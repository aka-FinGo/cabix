...
public class HeartBeatInfoStorage {
    ...
    public synchronized void deleteAllHeartBeats() {
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda3
            ...
            public final Object invoke(Object obj) {
                return HeartBeatInfoStorage.this.m7843xe97e9b5a((MutablePreferences) obj);
            }
        });
    }
    ...
    public /* synthetic */ Unit m7843xe97e9b5a(MutablePreferences mutablePreferences) {
        Set m7942m;
        long j = 0;
        for (Map.Entry<Preferences.Key<?>, Object> entry : mutablePreferences.asMap().entrySet()) {
            if (entry.getValue() instanceof Set) {
                ...
                if (set.contains(formattedDate)) {
                    m7942m = UByte$$ExternalSyntheticBackport0.m7942m(new Object[]{formattedDate});
                    mutablePreferences.set(key, m7942m);
                    j++;
                } else {
    ...
    public synchronized void postHeartBeatCleanUp() {
        ...
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda4
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return HeartBeatInfoStorage.this.m7844x44e9f764(formattedDate, (MutablePreferences) obj);
            }
        });
    }
    ...
    public /* synthetic */ Unit m7844x44e9f764(String str, MutablePreferences mutablePreferences) {
    ...
    public synchronized void storeHeartBeat(long j, final String str) {
        ...
        this.firebaseDataStore.editSync(new Function1() { // from class: com.google.firebase.heartbeatinfo.HeartBeatInfoStorage$$ExternalSyntheticLambda2
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return HeartBeatInfoStorage.this.m7845x76ccc570(formattedDate, str, stringSetKey, (MutablePreferences) obj);
            }
        });
    }
    ...
    public /* synthetic */ Unit m7845x76ccc570(String str, String str2, Preferences.Key key, MutablePreferences mutablePreferences) {
    ...
    private long cleanUpStoredHeartBeats(MutablePreferences mutablePreferences) {
        ...
        hashSet2.remove(str);
        mutablePreferences.set(PreferencesKeys.stringSetKey(str2), hashSet2);
        long j = longValue - 1;
        mutablePreferences.set(HEART_BEAT_COUNT_TAG, Long.valueOf(j));
        return j;
    }
