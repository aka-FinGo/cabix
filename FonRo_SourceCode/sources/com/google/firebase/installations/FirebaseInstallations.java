...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda2
            ...
            public final void run() {
                FirebaseInstallations.this.m7847xc18eb11d();
            }
        });
    ...
    public /* synthetic */ void m7847xc18eb11d() {
        m7848x7147f7aa(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m7848x7147f7aa(z);
            }
        });
    ...
    public final void m7848x7147f7aa(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m7846x5a306a82(z);
            }
        });
    }
    ...
    */
    public void m7846x5a306a82(boolean r3) {
        /*
            r2 = this;
        ...
        L26:
            ...
            r2.checkAndUpdateFidListeners(r0, r3)
        ...
        L5f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m7846x5a306a82(boolean):void");
    }

    private boolean shouldNotifyFidListener(PersistedInstallationEntry persistedInstallationEntry, PersistedInstallationEntry persistedInstallationEntry2) {
        if (!persistedInstallationEntry2.isRegistered() || TextUtils.isEmpty(persistedInstallationEntry2.getFirebaseInstallationId())) {
            return false;
        }
        if (TextUtils.equals(persistedInstallationEntry.getFirebaseInstallationId(), persistedInstallationEntry2.getFirebaseInstallationId())) {
            return !persistedInstallationEntry.isRegistered();
        }
        return true;
    }

    private synchronized void checkAndUpdateFidListeners(PersistedInstallationEntry persistedInstallationEntry, PersistedInstallationEntry persistedInstallationEntry2) {
        if (shouldNotifyFidListener(persistedInstallationEntry, persistedInstallationEntry2)) {
