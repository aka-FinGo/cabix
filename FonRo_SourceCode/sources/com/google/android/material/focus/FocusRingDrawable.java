...
public class FocusRingDrawable extends DrawableWrapper {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (theme != null) {
            obtainAttributes = theme.obtainStyledAttributes(attributeSet, com.google.android.material.R.styleable.FocusRingDrawable, 0, 0);
        } else {
            obtainAttributes = resources.obtainAttributes(attributeSet, com.google.android.material.R.styleable.FocusRingDrawable);
        }
    ...
    private void updateStateFromTypedArrayWithoutThemeAttrsOrDefaults(TypedArray typedArray) {
        this.state.ringEnabledAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsEnabled);
        if (this.state.ringEnabledAttr == Integer.MIN_VALUE && typedArray.hasValue(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsEnabled)) {
            this.state.ringEnabled = typedArray.getBoolean(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsEnabled, this.state.ringEnabled);
            this.state.ringEnabledInflated = true;
        }
        this.state.ringOuterColorAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeColor);
        if (this.state.ringOuterColorAttr == Integer.MIN_VALUE) {
            this.state.ringOuterColor = typedArray.getColor(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeColor, Integer.MIN_VALUE);
        }
        this.state.ringInnerColorAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeColor);
        if (this.state.ringInnerColorAttr == Integer.MIN_VALUE) {
            this.state.ringInnerColor = typedArray.getColor(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeColor, Integer.MIN_VALUE);
        }
        this.state.ringOuterStrokeWidthAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeWidth);
        if (this.state.ringOuterStrokeWidthAttr == Integer.MIN_VALUE) {
            this.state.ringOuterStrokeWidth = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeWidth, Float.NaN);
        }
        this.state.ringInnerStrokeWidthAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeWidth);
        if (this.state.ringInnerStrokeWidthAttr == Integer.MIN_VALUE) {
            this.state.ringInnerStrokeWidth = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeWidth, Float.NaN);
        }
        this.state.ringInnerStrokeWidthAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeWidth);
        if (this.state.ringInnerStrokeWidthAttr == Integer.MIN_VALUE) {
            this.state.ringInnerStrokeWidth = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeWidth, Float.NaN);
        }
        this.state.ringRadiusAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsRadius);
        if (this.state.ringRadiusAttr == Integer.MIN_VALUE) {
            this.state.ringRadius = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsRadius, Float.NaN);
        }
        this.state.ringInsetAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInset);
        if (this.state.ringInsetAttr == Integer.MIN_VALUE) {
            this.state.ringInset = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInset, Float.NaN);
        }
        this.state.ringInnerInsetAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeInset);
        if (this.state.ringInnerInsetAttr == Integer.MIN_VALUE) {
            this.state.ringInnerInset = typedArray.getDimension(com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeInset, Float.NaN);
        }
        this.state.ringShapeAppearanceAttr = getValueDataIfAttr(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsShapeAppearance);
        this.state.ringShapeAppearanceResId = getResIdIfReference(typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsShapeAppearance);
    }
    ...
    private void updateStateFromTypedArrayWithThemeAttrsAndDefaults(TypedArray typedArray, Resources.Theme theme) {
        ...
        if (this.state.ringEnabled) {
            ...
            focusRingState.ringOuterColor = maybeResolveColor(focusRingState.ringOuterColor, theme, this.state.ringOuterColorAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeColor, ViewCompat.MEASURED_STATE_MASK);
            FocusRingState focusRingState2 = this.state;
            focusRingState2.ringInnerColor = maybeResolveColor(focusRingState2.ringInnerColor, theme, this.state.ringInnerColorAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeColor, -1);
            FocusRingState focusRingState3 = this.state;
            focusRingState3.ringOuterStrokeWidth = maybeResolveDimension(focusRingState3.ringOuterStrokeWidth, theme, this.state.ringOuterStrokeWidthAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsOuterStrokeWidth, com.google.android.material.R.dimen.mtrl_focus_ring_outer_stroke_width);
            FocusRingState focusRingState4 = this.state;
            focusRingState4.ringInnerStrokeWidth = maybeResolveDimension(focusRingState4.ringInnerStrokeWidth, theme, this.state.ringInnerStrokeWidthAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeWidth, com.google.android.material.R.dimen.mtrl_focus_ring_inner_stroke_width);
            FocusRingState focusRingState5 = this.state;
            focusRingState5.ringRadius = maybeResolveDimension(focusRingState5.ringRadius, theme, this.state.ringRadiusAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsRadius, 0);
            FocusRingState focusRingState6 = this.state;
            focusRingState6.ringInset = maybeResolveDimension(focusRingState6.ringInset, theme, this.state.ringInsetAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInset, 0);
            if (Float.isNaN(this.state.ringInset)) {
                this.state.ringInset = 0.0f;
            }
            FocusRingState focusRingState7 = this.state;
            focusRingState7.ringInnerInset = maybeResolveDimension(focusRingState7.ringInnerInset, theme, this.state.ringInnerInsetAttr, typedArray, com.google.android.material.R.styleable.FocusRingDrawable_focusRingsInnerStrokeInset, com.google.android.material.R.dimen.mtrl_focus_ring_inner_stroke_inset);
            ...
            if (focusRingState8.ringShapeAppearanceAttr == Integer.MIN_VALUE) {
                i = com.google.android.material.R.attr.focusRingsShapeAppearance;
            } else {
    ...
    private void init(Resources.Theme theme) {
        TypedArray obtainStyledAttributes = theme.obtainStyledAttributes(com.google.android.material.R.styleable.FocusRingDrawable);
