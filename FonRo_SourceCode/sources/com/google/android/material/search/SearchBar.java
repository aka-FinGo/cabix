...
public class SearchBar extends Toolbar {
    ...
    */
    ...
    private ActionMenuView findOrGetMenuView() {
        ...
        ActionMenuView actionMenuView2 = ToolbarUtils.getActionMenuView(this);
        this.menuView = actionMenuView2;
        return actionMenuView2;
    }

    private ImageButton findOrGetNavView() {
        ImageButton imageButton = this.navIconButton;
        if (imageButton != null) {
            return imageButton;
        }
        ImageButton navigationIconButton = ToolbarUtils.getNavigationIconButton(this);
        this.navIconButton = navigationIconButton;
    ...
    public /* synthetic */ void m7762x9ebe9dc4() {
