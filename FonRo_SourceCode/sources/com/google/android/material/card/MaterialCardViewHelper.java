...
public class MaterialCardViewHelper {
    ...
    public void animateCheckedIcon(boolean z) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                MaterialCardViewHelper.this.m7699xa4d79c2b(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m7699xa4d79c2b(ValueAnimator valueAnimator) {
    ...
    private Drawable getClickableForeground() {
        ...
        LayerDrawable layerDrawable2 = new LayerDrawable(new Drawable[]{this.rippleDrawable, this.foregroundContentDrawable, this.checkedIcon});
        FocusRingDrawable.layer(this.materialCardView.getContext(), layerDrawable2, this.foregroundShapeDrawable);
        layerDrawable2.setId(2, com.google.android.material.R.id.mtrl_card_checked_layer_id);
        this.clickableForegroundDrawable = layerDrawable2;
