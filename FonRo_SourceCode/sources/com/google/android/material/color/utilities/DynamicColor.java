    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function != null) {
            ...
            if ((doubleValue2 - doubleValue) * d2 < delta) {
                double d5 = delta * d2;
                doubleValue2 = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, doubleValue + d5);
                if ((doubleValue2 - doubleValue) * d2 < delta) {
                    doubleValue = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, doubleValue2 - d5);
                }
            }
