...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setAction(CharSequence charSequence, final View.OnClickListener onClickListener) {
        ...
        actionView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                Snackbar.this.m7791lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(onClickListener, view);
            }
        });
        return this;
    }
    ...
    public /* synthetic */ void m7791lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
    ...
    public Snackbar setCloseIconVisible(boolean z) {
        ...
        closeViewOrThrow.setOnClickListener(z ? new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Snackbar.this.m7792x429a879c(view);
            }
        } : null);
    ...
    public /* synthetic */ void m7792x429a879c(View view) {
        dismiss();
    }
    ...
    public Snackbar setCloseIconDrawable(Drawable drawable) {
        getCloseViewOrThrow().m7695x11712a47(drawable);
        return this;
    }
    ...
    public int getDuration() {
        ...
        if (i >= 29) {
            recommendedTimeoutMillis = this.accessibilityManager.getRecommendedTimeoutMillis(duration, (z ? 4 : 0) | 3);
