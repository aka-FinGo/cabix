...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(Canvas canvas, Matrix matrix, RectF rectF, int i, float f, float f2) {
        ...
        if (z) {
            ...
            iArr2[0] = 0;
            iArr2[1] = this.shadowEndColor;
            iArr2[2] = this.shadowMiddleColor;
            iArr2[3] = this.shadowStartColor;
            iArr = iArr2;
            f3 = f;
        } else {
            path.rewind();
            ...
            float f4 = -i;
            rectF.inset(f4, f4);
            int[] iArr3 = cornerColors;
            iArr3[0] = 0;
            iArr3[1] = this.shadowStartColor;
            iArr3[2] = this.shadowMiddleColor;
            iArr3[3] = this.shadowEndColor;
            iArr = iArr3;
        }
        ...
        this.cornerShadowPaint.setShader(new RadialGradient(rectF.centerX(), rectF.centerY(), width, iArr, fArr, Shader.TileMode.CLAMP));
        canvas.save();
        canvas.concat(matrix);
