...
final class zzafg implements zzafp {
    ...
    public final int zzc(Object obj) {
        int hashCode = ((zzadu) obj).zzc.hashCode();
        return this.zzc ? (hashCode * 53) + ((zzadr) obj).zzb.zza.hashCode() : hashCode;
    }
    ...
    public final int zze(Object obj) {
        int zzh = ((zzadu) obj).zzc.zzh();
        return this.zzc ? zzh + ((zzadr) obj).zzb.zzg() : zzh;
    }

    @Override // com.google.android.gms.internal.measurement.zzafp
    public final void zzf(Object obj, zzago zzagoVar) throws IOException {
        Iterator zzc = ((zzadr) obj).zzb.zzc();
        while (zzc.hasNext()) {
