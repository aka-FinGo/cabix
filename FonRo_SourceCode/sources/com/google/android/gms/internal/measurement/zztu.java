...
public final class zztu {
    ...
    public final zztu zzc(zzuw zzuwVar) {
        ...
        Preconditions.checkArgument(!hashMap.containsKey("singleproc"), "There is already a factory registered for the ID %s", "singleproc");
        hashMap.put("singleproc", zzuwVar);
        return this;
    }
