...
public final class zzvb extends zztf {
    ...
    public final ListenableFuture zza(final IOException iOException, zztg zztgVar) {
        ...
        return Futures.catchingAsync(zztgVar.zza(Futures.immediateFuture(this.zza)), IOException.class, new AsyncFunction() { // from class: com.google.android.gms.internal.measurement.zzva
