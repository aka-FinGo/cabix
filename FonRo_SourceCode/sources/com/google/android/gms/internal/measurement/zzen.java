...
public final class zzen extends zzeo {
    ...
    final void zza() throws RemoteException {
        long j;
        Long l = this.zza;
        long longValue = l == null ? this.zzi : l.longValue();
        Long l2 = this.zzb;
        if (l2 == null) {
            j = this.zzj;
        } else {
        ...
        ((zzcp) Preconditions.checkNotNull(this.zzh.zzS())).logEventWithElapsedTime(this.zzc, this.zzd, this.zze, this.zzf, this.zzg, longValue, j);
    }
}
