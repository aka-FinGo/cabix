...
public final class zzaeq extends zzace implements RandomAccess, zzaee, zzafk {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzaeqVar.zzc, 0, jArr, this.zzd, zzaeqVar.zzd);
            this.zzd = i3;
            this.modCount++;
            return true;
        }
