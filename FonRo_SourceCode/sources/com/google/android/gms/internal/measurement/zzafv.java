...
public class zzafv extends AbstractMap {
    private Object[] zza;
    private int zzb;
    private boolean zzd;
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int compareTo = comparable.compareTo(((zzafs) this.zza[i2]).zza());
            if (compareTo > 0) {
                return -(i + 1);
            }
            if (compareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int compareTo2 = comparable.compareTo(((zzafs) this.zza[i4]).zza());
            if (compareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public final Object get(Object obj) {
        ...
        if (zzm >= 0) {
            return ((zzafs) this.zza[zzm]).getValue();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int zzm = zzm(comparable);
        if (zzm >= 0) {
            return ((zzafs) this.zza[zzm]).setValue(obj);
        }
        zzh();
        Object[] objArr = this.zza;
        if (objArr == null) {
        ...
        if (this.zzb == 16) {
            zzafs zzafsVar = (zzafs) objArr[15];
            this.zzb = 15;
