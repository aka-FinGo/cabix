...
public final class zzod {
    ...
    public final Bundle zzb() {
        int zzf;
        Map map = this.zza;
        if (DiskLruCache.VERSION.equals(map.get("gdprApplies")) && DiskLruCache.VERSION.equals(map.get("EnableAdvertiserConsentMode"))) {
            String str = "denied";
            if (map.get("Version") == null) {
                if (DiskLruCache.VERSION.equals(map.get("GoogleConsent")) && (zzf = zzf()) >= 0) {
            ...
            if (zzf() >= 0) {
                ...
                bundle2.putString(zzjk.AD_STORAGE.zze, true != Objects.equals(map.get("AuthorizePurpose1"), DiskLruCache.VERSION) ? "denied" : "granted");
                bundle2.putString(zzjk.AD_PERSONALIZATION.zze, (Objects.equals(map.get("AuthorizePurpose3"), DiskLruCache.VERSION) && Objects.equals(map.get("AuthorizePurpose4"), DiskLruCache.VERSION)) ? "granted" : "denied");
                if (zzf() >= 4) {
                    String str4 = zzjk.AD_USER_DATA.zze;
                    if (Objects.equals(map.get("AuthorizePurpose1"), DiskLruCache.VERSION) && Objects.equals(map.get("AuthorizePurpose7"), DiskLruCache.VERSION)) {
                        str = "granted";
                    }
    ...
    public final String zzd(zzod zzodVar) {
        ...
        String str2 = (isEmpty || ((String) map.get("Version")) != null) ? "0" : DiskLruCache.VERSION;
        Bundle zzb = zzb();
    ...
    public final String zze() {
        ...
        Map map = this.zza;
        int i2 = true != DiskLruCache.VERSION.equals(map.get("gdprApplies")) ? 0 : 2;
        int i3 = i2 | 4;
        if (DiskLruCache.VERSION.equals(map.get("EnableAdvertiserConsentMode"))) {
            i3 = i2 | 12;
        }
