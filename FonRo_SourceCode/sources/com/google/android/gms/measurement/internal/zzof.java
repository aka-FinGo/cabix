...
public final class zzof {
    ...
    public static final Map zzd(ImmutableMap immutableMap, ImmutableMap immutableMap2, ImmutableSet immutableSet, char[] cArr, int i, int i2, int i3, int i4, int i5, String str, String str2, String str3, boolean z, boolean z2, boolean z3) {
        ...
        ImmutableMap.Builder put = ImmutableMap.builder().put("Version", "2").put("VendorConsent", true != z ? "0" : DiskLruCache.VERSION).put("VendorLegitimateInterest", true != z2 ? "0" : DiskLruCache.VERSION).put("gdprApplies", i3 != 1 ? "0" : DiskLruCache.VERSION).put("EnableAdvertiserConsentMode", i2 != 1 ? "0" : DiskLruCache.VERSION).put("PolicyVersion", String.valueOf(i4)).put("CmpSdkID", String.valueOf(i)).put("PurposeOneTreatment", i5 != 1 ? "0" : DiskLruCache.VERSION).put("PublisherCC", str);
        if (zzabxVar != null) {
            zza2 = zzabxVar.zza();
        } else {
