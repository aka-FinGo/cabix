                    ...
                    try {
                        if (this.count == 0 || (entry = getEntry(k, i)) == null) {
                            ...
                            if (valueReference.isLoading()) {
                                V waitForLoadingValue = segment.waitForLoadingValue(entry, k2, valueReference);
                                segment.postReadCleanup();
                                return waitForLoadingValue;
                            }
                        }
                        V lockedGetOrLoad = segment.lockedGetOrLoad(k2, i2, cacheLoader2);
                        segment.postReadCleanup();
                        ...
                        if (referenceEntry.getValueReference().isActive()) {
                            ...
                            try {
                                if (key != null && v != null) {
                                    ...
                                    r5 = this;
                                    r5.enqueueNotification(key, referenceEntry.getHash(), v, referenceEntry.getValueReference().getWeight(), removalCause);
                                }
                                r5.enqueueNotification(key, referenceEntry.getHash(), v, referenceEntry.getValueReference().getWeight(), removalCause);
                            } catch (Throwable th) {
                                th = th;
        ...
        boolean reclaimKey(ReferenceEntry<K, V> referenceEntry, int i) {
            ...
            while (referenceEntry3 != null) {
                if (referenceEntry3 != referenceEntry) {
                    ...
                    this.modCount++;
                    segment = this;
                    ReferenceEntry<K, V> removeValueFromChain = segment.removeValueFromChain(referenceEntry2, referenceEntry3, referenceEntry3.getKey(), i, referenceEntry3.getValueReference().get(), referenceEntry3.getValueReference(), RemovalCause.COLLECTED);
        ...
        boolean reclaimValue(K k, int i, ValueReference<K, V> valueReference) {
            ...
            while (referenceEntry2 != null) {
                ...
                if (referenceEntry2.getHash() == i && key != null && this.map.keyEquivalence.equivalent(k, key)) {
                    ...
                    this.modCount++;
                    segment = this;
                    ReferenceEntry<K, V> removeValueFromChain = segment.removeValueFromChain(referenceEntry, referenceEntry2, key, i, valueReference.get(), valueReference, RemovalCause.COLLECTED);
    ...
    */
    java.util.Map<K, V> loadAll(java.util.Set<? extends K> r7, com.google.common.cache.CacheLoader<? super K, V> r8) throws java.util.concurrent.ExecutionException {
        /*
            ...
            r1 = 1
            r2 = 0
            java.util.Map r7 = r8.loadAll(r7)     // Catch: java.lang.Throwable -> La8 java.lang.Error -> Lab java.lang.Exception -> Lb2 java.lang.RuntimeException -> Lb9 java.lang.InterruptedException -> Lc0 com.google.common.cache.CacheLoader.UnsupportedLoadingOperationException -> Lce
            if (r7 == 0) goto L78
            r0.stop()
        ...
        Lab:
            r7 = move-exception
            com.google.common.util.concurrent.ExecutionError r8 = new com.google.common.util.concurrent.ExecutionError     // Catch: java.lang.Throwable -> La8
            r8.<init>(r7)     // Catch: java.lang.Throwable -> La8
            throw r8     // Catch: java.lang.Throwable -> La8
        Lb2:
            r7 = move-exception
            java.util.concurrent.ExecutionException r8 = new java.util.concurrent.ExecutionException     // Catch: java.lang.Throwable -> La8
            r8.<init>(r7)     // Catch: java.lang.Throwable -> La8
            throw r8     // Catch: java.lang.Throwable -> La8
        Lb9:
            r7 = move-exception
            com.google.common.util.concurrent.UncheckedExecutionException r8 = new com.google.common.util.concurrent.UncheckedExecutionException     // Catch: java.lang.Throwable -> La8
            r8.<init>(r7)     // Catch: java.lang.Throwable -> La8
            throw r8     // Catch: java.lang.Throwable -> La8
        Lc0:
            r7 = move-exception
            java.lang.Thread r8 = java.lang.Thread.currentThread()     // Catch: java.lang.Throwable -> La8
            r8.interrupt()     // Catch: java.lang.Throwable -> La8
            java.util.concurrent.ExecutionException r8 = new java.util.concurrent.ExecutionException     // Catch: java.lang.Throwable -> La8
            r8.<init>(r7)     // Catch: java.lang.Throwable -> La8
            throw r8     // Catch: java.lang.Throwable -> La8
        Lce:
