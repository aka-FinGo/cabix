    ...
    public static class SynchronizedMultiset<E> extends SynchronizedCollection<E> implements Multiset<E> {
        ...
        public Set<E> elementSet() {
            ...
            synchronized (this.mutex) {
                set = this.elementSet;
                if (set == null) {
                    set = Synchronized.typePreservingSet(delegate().elementSet(), this.mutex);
                    this.elementSet = set;
                }
            }
            return set;
        ...
        public Set<Multiset.Entry<E>> entrySet() {
            ...
            synchronized (this.mutex) {
                set = this.entrySet;
                if (set == null) {
                    set = Synchronized.typePreservingSet(delegate().entrySet(), this.mutex);
                    this.entrySet = set;
                }
            }
            return set;
    ...
    public static class SynchronizedMultimap<K, V> extends SynchronizedObject implements Multimap<K, V> {
        ...
        public Set<K> keySet() {
            ...
            synchronized (this.mutex) {
                set = this.keySet;
                if (set == null) {
                    set = Synchronized.typePreservingSet(delegate().keySet(), this.mutex);
                    this.keySet = set;
                }
            }
            return set;
        ...
        public Collection<Map.Entry<K, V>> entries() {
            ...
            synchronized (this.mutex) {
                ...
                if (collection == null) {
                    collection = Synchronized.typePreservingCollection(delegate().entries(), this.mutex);
        ...
        public Multiset<K> keys() {
            ...
            synchronized (this.mutex) {
                multiset = this.keys;
                if (multiset == null) {
                    multiset = Synchronized.multiset(delegate().keys(), this.mutex);
                    this.keys = multiset;
                }
            }
            return multiset;
    ...
    public static class SynchronizedSetMultimap<K, V> extends SynchronizedMultimap<K, V> implements SetMultimap<K, V> {
        ...
        public Set<Map.Entry<K, V>> entries() {
            ...
            synchronized (this.mutex) {
                set = this.entrySet;
                if (set == null) {
                    set = Synchronized.set(delegate().entries(), this.mutex);
                    this.entrySet = set;
                }
            }
            return set;
    ...
    public static class SynchronizedMap<K, V> extends SynchronizedObject implements Map<K, V> {
        ...
        public Set<Map.Entry<K, V>> entrySet() {
            ...
            synchronized (this.mutex) {
                set = this.entrySet;
                if (set == null) {
                    set = Synchronized.set(delegate().entrySet(), this.mutex);
                    this.entrySet = set;
                }
            }
            return set;
        ...
        public Set<K> keySet() {
            ...
            synchronized (this.mutex) {
                set = this.keySet;
                if (set == null) {
                    set = Synchronized.set(delegate().keySet(), this.mutex);
                    this.keySet = set;
                }
            }
            return set;
    ...
    static class SynchronizedBiMap<K, V> extends SynchronizedMap<K, V> implements BiMap<K, V>, Serializable {
        ...
        public Set<V> values() {
            ...
            synchronized (this.mutex) {
                set = this.valueSet;
                if (set == null) {
                    set = Synchronized.set(delegate().values(), this.mutex);
                    this.valueSet = set;
                }
            }
            return set;
