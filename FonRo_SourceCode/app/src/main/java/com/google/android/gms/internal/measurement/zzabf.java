...
public enum zzabf {
    ...
    static {
        ...
        for (zzabf zzabfVar : values()) {
            if (hashMap.put(Character.valueOf(zzabfVar.zzG), zzabfVar) != null) {
                String valueOf = String.valueOf(zzabfVar);
                String.valueOf(valueOf);
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(valueOf)));
            }
        }
