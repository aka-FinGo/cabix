...
public abstract class NavigationBarItemView extends FrameLayout implements NavigationBarMenuItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        linearLayout.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.google.android.material.navigation.NavigationBarItemView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnLayoutChangeListener
            public final void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                NavigationBarItemView.this.m7756xe6e25373(view, i, i2, i3, i4, i5, i6, i7, i8);
            }
        });
    }
    ...
    public /* synthetic */ void m7756xe6e25373(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        boolean z;
