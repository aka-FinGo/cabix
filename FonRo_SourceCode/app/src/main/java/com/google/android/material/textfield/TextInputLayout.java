    ...
    */
    ...
    public void onGlobalLayout() {
        ...
        if (updateEditTextHeightBasedOnIcon || updateDummyDrawables) {
            this.editText.post(new Runnable() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    TextInputLayout.this.m7809xa47602b9();
                }
            });
        }
    }
    ...
    public /* synthetic */ void m7809xa47602b9() {
    ...
    private Drawable getOrCreateOutlinedDropDownMenuBackground() {
        ...
        MaterialShapeDrawable dropDownMaterialShapeDrawable = getDropDownMaterialShapeDrawable(true);
        this.outlinedDropDownMenuBackground = dropDownMaterialShapeDrawable;
        return dropDownMaterialShapeDrawable;
    }
            ...
            try {
                f = StaticLayoutBuilderCompat.obtain(this.placeholderText, textPaint, i).setIsRtl(getLayoutDirection() == 1).setIncludePad(true).setLineSpacing(this.placeholderTextView.getLineSpacingExtra(), this.placeholderTextView.getLineSpacingMultiplier()).setStaticLayoutBuilderConfigurer(new StaticLayoutBuilderConfigurer() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda9
                    ...
                    public final void configure(StaticLayout.Builder builder) {
                        TextInputLayout.this.m7810xd6b8ec95(builder);
                    }
    ...
    public /* synthetic */ void m7810xd6b8ec95(StaticLayout.Builder builder) {
    ...
    public static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (!TextUtils.isEmpty(helperText) && this.layout.indicatorViewController.helperTextShouldBeShown()) {
                if (TextUtils.isEmpty(charSequence)) {
                    charSequence = helperText.toString();
                } else {
                    charSequence = charSequence + ", " + ((Object) helperText);
                }
            }
