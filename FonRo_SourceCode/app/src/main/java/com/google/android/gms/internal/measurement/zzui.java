    ...
    public final ListenableFuture zzb(final AsyncFunction asyncFunction, final Executor executor, zzuu zzuuVar) {
        ...
        synchronized (this.zzh) {
            ...
            if (listenableFuture == null) {
                listenableFuture = Futures.nonCancellationPropagating(this.zzi.submitAsync(zzxa.zzb(new AsyncCallable() { // from class: com.google.android.gms.internal.measurement.zzub
