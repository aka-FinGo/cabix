...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public final MotionSpec getCurrentMotionSpec() {
        ...
        if (motionSpec2 == null) {
            motionSpec2 = MotionSpec.createFromResource(this.context, getDefaultMotionSpecResource());
            this.defaultMotionSpec = motionSpec2;
        }
        return (MotionSpec) Preconditions.checkNotNull(motionSpec2);
    }
