...
public final class zzt extends zzai {
    ...
    public zzt(zzr zzrVar) {
        ...
        this.zza = zzrVar;
        this.zze.put(Routes.LOG, new zzs(this, false, true));
        this.zze.put(NotificationCompat.GROUP_KEY_SILENT, new zzp(this, NotificationCompat.GROUP_KEY_SILENT));
        ((zzai) this.zze.get(NotificationCompat.GROUP_KEY_SILENT)).zzm(Routes.LOG, new zzs(this, true, true));
        this.zze.put("unmonitored", new zzq(this, "unmonitored"));
        ((zzai) this.zze.get("unmonitored")).zzm(Routes.LOG, new zzs(this, false, false));
    }
