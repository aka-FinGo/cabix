...
public final class zzhh extends zzjf {
    ...
    public final SharedPreferences zze() {
        zzg();
        zzw();
        SharedPreferences sharedPreferences = this.zzw;
        ...
        SharedPreferences sharedPreferences2 = zzicVar.zzaZ().getSharedPreferences(concat, 0);
        this.zzw = sharedPreferences2;
