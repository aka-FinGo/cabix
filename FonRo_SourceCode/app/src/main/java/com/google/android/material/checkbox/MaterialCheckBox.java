...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", "drawable", BuildConfig.API_CLIENT);
    ...
    */
    public MaterialCheckBox(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        Lc3:
            int r8 = com.google.android.material.R.styleable.MaterialCheckBox_rippleColor
            boolean r8 = r9.hasValue(r8)
            if (r8 == 0) goto Ld4
            int r8 = com.google.android.material.R.styleable.MaterialCheckBox_rippleColor
            android.content.res.ColorStateList r8 = com.google.android.material.resources.MaterialResources.getColorStateList(r0, r9, r8)
            r7.setRippleColor(r8)
        Ld4:
            r9.recycle()
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26 && (m3011m = Listener$$ExternalSyntheticApiModelOutline0.m3011m(getContext().getSystemService(Listener$$ExternalSyntheticApiModelOutline0.m3024m()))) != null) {
                m3011m.notifyValueChanged(this);
            }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        ...
        this.materialThemeColorsTintList = colorStateList2;
