...
public final class zzrf {
    ...
    public zzrf(Context context, final Supplier supplier, Supplier supplier2, Supplier supplier3) {
        ...
        this.zzh = Suppliers.memoize(new Supplier() { // from class: com.google.android.gms.internal.measurement.zzqy
            @Override // com.google.common.base.Supplier
            public final /* synthetic */ Object get() {
                return ((ListeningScheduledExecutorService) Preconditions.checkNotNull((ListeningScheduledExecutorService) Supplier.this.get())).schedule((Callable) zzrd.zza, WorkRequest.MIN_BACKOFF_MILLIS, TimeUnit.MILLISECONDS);
            }
        });
    }
    ...
    public final ListenableFuture zza() {
        if (!zzky.zzb(this.zzc)) {
            long zze = zzg().zze();
            TimeUnit timeUnit = TimeUnit.HOURS;
            if (zze + 86400000 < System.currentTimeMillis()) {
