...
public final class zzpp extends zzjf {
    ...
    */
    final int zzF(java.lang.String r13, java.lang.String r14, java.lang.String r15, java.lang.Object r16, android.os.Bundle r17, java.util.List r18, boolean r19, boolean r20) {
        /*
    ...
    public final MeasurementManagerFutures zzV() {
        ...
        MeasurementManagerFutures from = MeasurementManagerFutures.from(this.zzu.zzaZ());
        this.zzg = from;
        return from;
    }
    ...
    final boolean zzY() {
        ...
        if (this.zzh == null) {
            ...
            try {
                num = zzV.getMeasurementApiStatusAsync().get(WorkRequest.MIN_BACKOFF_MILLIS, TimeUnit.MILLISECONDS);
    ...
    public final int zzak() {
        ...
        if (num == null) {
            num = Integer.valueOf(GoogleApiAvailabilityLight.getInstance().getApkVersion(this.zzu.zzaZ()) / 1000);
            this.zzi = num;
        }
        return num.intValue();
    }
