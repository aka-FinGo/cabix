...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final TelemetryLoggingClient zaH() {
        ...
        TelemetryLoggingClient client = TelemetryLogging.getClient(this.zai);
        this.zah = client;
        return client;
    }
    ...
    public static GoogleApiManager zak(Context context) {
        ...
        synchronized (zac) {
            googleApiManager = zad;
            if (googleApiManager == null) {
                GoogleApiManager googleApiManager2 = new GoogleApiManager(context.getApplicationContext(), GmsClientSupervisor.getOrStartHandlerThread().getLooper(), GoogleApiAvailability.getInstance());
                zad = googleApiManager2;
