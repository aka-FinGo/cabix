...
public abstract class zzacs extends zzacv {
    ...
    public final String zzl() throws IOException {
        ...
        if (zzv > 0) {
            ...
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                String str = new String(this.zze, i2, zzv, StandardCharsets.UTF_8);
                this.zzh += zzv;
                return str;
            }
        }
    ...
    public final String zzm() throws IOException {
        ...
        if (zzv > 0) {
            ...
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                String zzd = zzagl.zzd(this.zze, i2, zzv);
                this.zzh += zzv;
                return zzd;
            }
        }
    ...
    public final zzacr zzn() throws IOException {
        ...
        if (zzv > 0) {
            ...
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                zzacr zzk = zzacr.zzk(this.zze, i2, zzv, false);
                this.zzh += zzv;
                return zzk;
            }
        }
        ...
        return zzacr.zzl(zzJ(zzv), false);
    }
