    ...
    private void setupWithViewPager(ViewPager viewPager, boolean z, boolean z2) {
        ...
        if (viewPager != null) {
            ...
            if (tabLayoutOnPageChangeListener2 == null) {
                tabLayoutOnPageChangeListener2 = new TabLayoutOnPageChangeListener(this);
                this.pageChangeListener = tabLayoutOnPageChangeListener2;
            }
            ...
            if (adapterChangeListener2 == null) {
                adapterChangeListener2 = new AdapterChangeListener();
