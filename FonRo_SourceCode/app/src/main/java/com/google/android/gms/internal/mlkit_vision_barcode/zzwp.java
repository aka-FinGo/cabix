...
public final class zzwp {
    ...
    private final boolean zzk(zzrc zzrcVar, long j, long j2) {
        if (this.zzk.get(zzrcVar) == null) {
            return true;
        }
        long longValue = j - ((Long) this.zzk.get(zzrcVar)).longValue();
        TimeUnit timeUnit = TimeUnit.SECONDS;
        return longValue > WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS;
    }
