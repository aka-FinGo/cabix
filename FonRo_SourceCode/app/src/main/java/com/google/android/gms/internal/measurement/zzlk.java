...
public final class zzlk {
    ...
    public static void zza(Context context) {
        ...
        if (context2 != null) {
            PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(zzc, null, context2);
        }
    }
        ...
        try {
            ...
            synchronized (zzb) {
                if (zzd != null) {
                    ...
                    zzlkVar = (zzlk) absent.or(new Supplier() { // from class: com.google.android.gms.internal.measurement.zzll
                        @Override // com.google.common.base.Supplier
                        public final /* synthetic */ Object get() {
                            int i = zzlk.zza;
