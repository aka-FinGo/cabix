...
public final class zzagu implements zzagt {
    ...
    public final long zzG() {
        return ((Long) zza.zzb(33, "measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS).get()).longValue();
    }
    ...
    public final long zzI() {
        return ((Long) zza.zzb(36, "measurement.service_client.idle_disconnect_millis", CoroutineLiveDataKt.DEFAULT_TIMEOUT).get()).longValue();
    }
    ...
    public final long zzR() {
        return ((Long) zza.zzb(47, "measurement.sgtm.upload.max_queued_batches", CoroutineLiveDataKt.DEFAULT_TIMEOUT).get()).longValue();
    }
    ...
    public final long zzU() {
        return ((Long) zza.zzb(50, "measurement.sgtm.upload.min_delay_after_startup", CoroutineLiveDataKt.DEFAULT_TIMEOUT).get()).longValue();
    }
    ...
    @Override // com.google.android.gms.internal.measurement.zzagt
    public final long zza() {
        return ((Long) zza.zzb(0, "measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS).get()).longValue();
    }
    ...
    public final long zzam() {
        return ((Long) zza.zzb(68, "measurement.upload.max_conversions_per_day", WorkRequest.MIN_BACKOFF_MILLIS).get()).longValue();
    }
