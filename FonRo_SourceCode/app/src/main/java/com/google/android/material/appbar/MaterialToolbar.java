...
public class MaterialToolbar extends Toolbar {
    ...
    */
    public MaterialToolbar(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        ...
        L5f:
            r8.recycle()
            com.google.android.material.shape.ShapeAppearanceModel$Builder r7 = com.google.android.material.shape.ShapeAppearanceModel.builder(r0, r1, r3, r4)
            com.google.android.material.shape.ShapeAppearanceModel r7 = r7.build()
            r6.initBackground(r0, r7)
            return
        */
