        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ContentUriFetcher$$ExternalSyntheticApiModelOutline0.m$2();
                        ResourcesLoader m7668m = ContentUriFetcher$$ExternalSyntheticApiModelOutline0.m7668m();
                        loadFromTable = ResourcesProvider.loadFromTable(dup, null);
                        m7668m.addProvider(loadFromTable);
                        if (dup != null) {
                            dup.close();
                        }
