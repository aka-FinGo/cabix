        ...
        switch (hashCode) {
            ...
            case 109526418:
                if (str.equals("slice")) {
                    ...
                    double max2 = zzi2 < AudioStats.AUDIO_AMPLITUDE_NONE ? Math.max(zzi2 + zzh6, AudioStats.AUDIO_AMPLITUDE_NONE) : Math.min(zzi2, zzh6);
                    if (list.size() == 2) {
                        double zzi3 = zzh.zzi(zzgVar.zza((zzao) list.get(1)).zzd().doubleValue());
                        zzh6 = zzi3 < AudioStats.AUDIO_AMPLITUDE_NONE ? Math.max(zzh6 + zzi3, AudioStats.AUDIO_AMPLITUDE_NONE) : Math.min(zzh6, zzi3);
                    }
            ...
            case 1943291465:
                if (str.equals("indexOf")) {
                    ...
                    if (list.size() > 1) {
                        ...
                        d2 = zzi4 < AudioStats.AUDIO_AMPLITUDE_NONE ? zzaeVar.zzh() + zzi4 : zzi4;
                    }
                    Iterator zzg6 = zzaeVar.zzg();
                    while (zzg6.hasNext()) {
                        int intValue2 = ((Integer) zzg6.next()).intValue();
                        double d3 = intValue2;
                        if (d3 >= d2 && zzh.zzf(zzaeVar.zzl(intValue2), zzaoVar2)) {
