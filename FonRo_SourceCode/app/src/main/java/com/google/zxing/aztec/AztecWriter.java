...
public final class AztecWriter implements Writer {
    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        int i3 = 0;
        if (map != null) {
            r9 = map.containsKey(EncodeHintType.CHARACTER_SET) ? Charset.forName(map.get(EncodeHintType.CHARACTER_SET).toString()) : null;
        ...
        return encode(str, barcodeFormat, i, i2, r9, r0, i3);
    }
