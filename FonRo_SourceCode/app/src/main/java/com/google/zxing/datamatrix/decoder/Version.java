...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        Version version22 = new Version(22, MenuKt.InTransitionDuration, MenuKt.InTransitionDuration, 18, 18, new ECBlocks(i10, new ECB(i13, 175)));
