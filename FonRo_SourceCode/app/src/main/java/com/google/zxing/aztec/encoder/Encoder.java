            ...
            for (int i26 = 0; i26 < i25; i26++) {
                ...
                while (i28 < i18) {
                    ...
                    if (generateCheckWords.get(i24 + i27 + i28)) {
                        int i30 = i23 * 2;
                        i7 = i18;
                        bitMatrix.set(iArr[i30 + i28], iArr[i30 + i26]);
                    } else {
                        i7 = i18;
                    }
                    if (generateCheckWords.get((i25 * 2) + i24 + i27 + i28)) {
                        int i31 = i23 * 2;
                        bitMatrix.set(iArr[i31 + i26], iArr[((i17 - 1) - i31) - i28]);
                    }
                    if (generateCheckWords.get((i25 * 4) + i24 + i27 + i28)) {
                        int i32 = (i17 - 1) - (i23 * 2);
                        bitMatrix.set(iArr[i32 - i28], iArr[i32 - i26]);
                    }
                    if (generateCheckWords.get((i25 * 6) + i24 + i27 + i28)) {
                        int i33 = i23 * 2;
                        bitMatrix.set(iArr[((i17 - 1) - i33) - i26], iArr[i33 + i28]);
                    }
                    i28++;
                    i18 = i7;
                    i9 = i29;
