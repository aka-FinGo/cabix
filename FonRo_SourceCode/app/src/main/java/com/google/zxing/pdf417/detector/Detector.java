...
public final class Detector {
    ...
    private static BitMatrix applyRotation(BitMatrix bitMatrix, int i) {
        ...
        BitMatrix m7850clone = bitMatrix.m7850clone();
        m7850clone.rotate(i);
        return m7850clone;
    }
    ...
    */
    ...
    private static ResultPoint[] findVertices(BitMatrix bitMatrix, int i, int i2) {
        ...
        if (resultPoint != null) {
            ...
            r5 = resultPointArr[5] != null ? (int) Math.max((((int) r8.getY()) - y) * 0.5f, 10.0f) : 10;
            i3 = y;
            i4 = x;
        }
        copyToResult(resultPointArr, findRowsWithPattern(bitMatrix, height, width, i3, i4, r5, STOP_PATTERN), INDEXES_STOP_PATTERN);
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int i5, int[] iArr) {
        ...
        while (true) {
            ...
            int[] findGuardPattern2 = findGuardPattern(bitMatrix, i4, i7, i2, iArr2, iArr3);
            if (findGuardPattern2 != null) {
                int[] iArr4 = findGuardPattern2;
                while (true) {
                    i6 = i7;
                    if (i6 <= 0 || (findGuardPattern = findGuardPattern(bitMatrix, i4, i6 - 1, i2, iArr, iArr3)) == null) {
                        break;
                    }
        ...
        if (z) {
            ...
            int i10 = 0;
            while (i9 < i) {
                int[] findGuardPattern3 = findGuardPattern(bitMatrix, iArr5[0], i9, i2, iArr, iArr3);
