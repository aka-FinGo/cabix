...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m9473trySendImplMj0NB7M = conflatedBufferedChannel.m9473trySendImplMj0NB7M(e, true);
        if (m9473trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m9458exceptionOrNullimpl(m9473trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m9473trySendImplMj0NB7M = conflatedBufferedChannel.m9473trySendImplMj0NB7M(e, true);
        if (!(m9473trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo9440trySendJP2dKIU(E element) {
        return m9473trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m9473trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m9472trySendDropLatestMj0NB7M(element, isSendOp) : m9448trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m9472trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo9440trySendJP2dKIU = super.mo9440trySendJP2dKIU(element);
        if (ChannelResult.m9464isSuccessimpl(mo9440trySendJP2dKIU) || ChannelResult.m9462isClosedimpl(mo9440trySendJP2dKIU)) {
            return mo9440trySendJP2dKIU;
        }
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo9440trySendJP2dKIU = mo9440trySendJP2dKIU(element);
        if (!(mo9440trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo9440trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m9458exceptionOrNullimpl(mo9440trySendJP2dKIU);
