    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (value == symbol2) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference2, value, symbol4)) {
                    Result.Companion companion = Result.INSTANCE;
                    ((CancellableContinuationImpl) value).resumeWith(Result.m7870constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
