...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m9479debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m9430toDelayMillisLRDsOJo(j));
    }
    ...
    public static final long debounce$lambda$2$FlowKt__DelayKt(Function1 function1, Object obj) {
        return DelayKt.m9430toDelayMillisLRDsOJo(((Duration) function1.invoke(obj)).getRawValue());
    }
    ...
    public static final <T> Flow<T> m9480sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m9430toDelayMillisLRDsOJo(j));
    }

    /* renamed from: timeout-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m9481timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m9482timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt, reason: not valid java name */
    private static final <T> Flow<T> m9482timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
