...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m7870constructorimpl = Result.m7870constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m7870constructorimpl = Result.m7870constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            m7870constructorimpl = Result.m7870constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m7876isFailureimpl(m7870constructorimpl) ? null : m7870constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m7870constructorimpl = Result.m7870constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m7870constructorimpl = Result.m7870constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m7876isFailureimpl(m7870constructorimpl)) {
            m7870constructorimpl = valueOf;
        }
        return ((Number) m7870constructorimpl).intValue();
    }
