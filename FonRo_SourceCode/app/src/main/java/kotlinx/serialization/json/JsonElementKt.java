...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m9554JsonPrimitive7apg3OU(byte b) {
        return m9555JsonPrimitiveVKZWuLQ(ULong.m8049constructorimpl(b & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m9557JsonPrimitivexj2QHRw(short s) {
        return m9555JsonPrimitiveVKZWuLQ(ULong.m8049constructorimpl(s & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m9556JsonPrimitiveWZ4Q5Ns(int i) {
        return m9555JsonPrimitiveVKZWuLQ(ULong.m8049constructorimpl(i & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m9555JsonPrimitiveVKZWuLQ(long j) {
        String m;
