...
public final class RealConnectionPool {
    ...
    */
    public final boolean callAcquirePooledConnection(okhttp3.Address r3, okhttp3.internal.connection.RealCall r4, java.util.List<okhttp3.Route> r5, boolean r6) {
        /*
            r2 = this;
        ...
        L10:
            ...
            monitor-enter(r0)
            if (r6 == 0) goto L2a
            boolean r1 = r0.isMultiplexed$okhttp()     // Catch: java.lang.Throwable -> L3a
            if (r1 == 0) goto L36
        L2a:
            boolean r1 = r0.isEligible$okhttp(r3, r5)     // Catch: java.lang.Throwable -> L3a
            if (r1 == 0) goto L36
            r4.acquireConnectionNoEvents(r0)     // Catch: java.lang.Throwable -> L3a
            monitor-exit(r0)
            r2 = 1
            return r2
        L36:
