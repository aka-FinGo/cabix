...
public final class Response implements Closeable {
    ...
    public final CacheControl m9677deprecated_cacheControl() {
        return cacheControl();
    }
