...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    public static ZoneOffsetTransitionRule readExternal(DataInput dataInput) {
        ...
        ZoneOffset ofTotalSeconds = ZoneOffset.ofTotalSeconds(i4 == 255 ? dataInput.readInt() : (i4 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) * 900);
        return of(of, i, of2, ofSecondOfDay, i3 == 24, timeDefinition, ofTotalSeconds, i5 == 3 ? ZoneOffset.ofTotalSeconds(dataInput.readInt()) : ZoneOffset.ofTotalSeconds(ofTotalSeconds.getTotalSeconds() + (i5 * 1800)), ZoneOffset.ofTotalSeconds(i6 == 3 ? dataInput.readInt() : ofTotalSeconds.getTotalSeconds() + (i6 * 1800)));
    }
