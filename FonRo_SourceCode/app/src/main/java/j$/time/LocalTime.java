...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
    ...
    public static LocalTime from(TemporalAccessor temporalAccessor) {
        ...
        ZoneId.AnonymousClass4.m("Unable to obtain LocalTime from TemporalAccessor: ", temporalAccessor, " of type ", temporalAccessor.getClass().getName());
        return null;
    }
    ...
    public LocalTime plus(long j, TemporalUnit temporalUnit) {
        if (temporalUnit instanceof ChronoUnit) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
                ...
                case 3:
                    return plusNanos((j % 86400000) * AnimationKt.MillisToNanos);
                case 4:
    ...
    public int compareTo(LocalTime localTime) {
        ...
        return (compare == 0 && (compare = Integer.compare(this.minute, localTime.minute)) == 0 && (compare = Integer.compare(this.second, localTime.second)) == 0) ? Integer.compare(this.nano, localTime.nano) : compare;
    }
