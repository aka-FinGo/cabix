...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    private void initializeDrawableForDisplay(Drawable drawable) {
        ...
        if (blockInvalidateCallback == null) {
            blockInvalidateCallback = new BlockInvalidateCallback();
            this.mBlockInvalidateCallback = blockInvalidateCallback;
        }
        drawable.setCallback(blockInvalidateCallback.wrap(drawable.getCallback()));
        try {
