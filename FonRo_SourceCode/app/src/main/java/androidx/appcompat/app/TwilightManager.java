...
class TwilightManager {
    ...
    public static TwilightManager getInstance(Context context) {
        ...
        TwilightManager twilightManager2 = new TwilightManager(applicationContext, (LocationManager) applicationContext.getSystemService(FirebaseAnalytics.Param.LOCATION));
        sInstance = twilightManager2;
        return twilightManager2;
    }
