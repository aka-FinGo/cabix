...
public abstract class AppCompatDelegate {
    ...
    public static class SerialExecutor implements Executor {
            ...
            synchronized (this.mLock) {
                this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.AppCompatDelegate$SerialExecutor$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        AppCompatDelegate.SerialExecutor.this.m25x45c145d(runnable);
                    }
                });
        ...
        public /* synthetic */ void m25x45c145d(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
    ...
    public static void syncRequestedAndStoredLocales(final Context context) {
        if (isAutoStorageOptedIn(context)) {
            ...
            synchronized (sAppLocalesStorageSyncLock) {
                LocaleListCompat localeListCompat = sRequestedAppLocales;
                if (localeListCompat == null) {
                    LocaleListCompat localeListCompat2 = sStoredAppLocales;
                    if (localeListCompat2 == null) {
                        localeListCompat2 = LocaleListCompat.forLanguageTags(AppLocalesStorageHelper.readLocales(context));
                    ...
                    LocaleListCompat localeListCompat3 = sRequestedAppLocales;
                    sStoredAppLocales = localeListCompat3;
                    AppLocalesStorageHelper.persistLocales(context, localeListCompat3.toLanguageTags());
                }
            }
        }
    }
