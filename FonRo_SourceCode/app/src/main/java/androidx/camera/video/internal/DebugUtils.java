...
public final class DebugUtils {
    ...
    private static String formatInterval(long j) {
        ...
        long millis = (j - TimeUnit.HOURS.toMillis(j2)) / DurationKt.MILLIS_IN_MINUTE;
        TimeUnit timeUnit3 = TimeUnit.MILLISECONDS;
        long millis2 = ((j - TimeUnit.HOURS.toMillis(j2)) - TimeUnit.MINUTES.toMillis(millis)) / 1000;
        return String.format(Locale.US, "%02d:%02d:%02d.%03d", Long.valueOf(j2), Long.valueOf(millis), Long.valueOf(millis2), Long.valueOf(((j - TimeUnit.HOURS.toMillis(j2)) - TimeUnit.MINUTES.toMillis(millis)) - TimeUnit.SECONDS.toMillis(millis2)));
    }
