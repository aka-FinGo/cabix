...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        if (surfaceProcessorNode != null) {
            OutConfig of = OutConfig.of(surfaceEdge2);
            final SurfaceEdge surfaceEdge3 = (SurfaceEdge) Objects.requireNonNull(videoCapture.mNode.transform(SurfaceProcessorNode.In.of(videoCapture.mCameraEdge, Collections.singletonList(of))).get(of));
            Runnable runnable2 = new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m253lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge3, cameraInternal, videoCaptureConfig, resolveTimebase);
                }
            };
            videoCapture = this;
            videoCaptureConfig2 = videoCaptureConfig;
            surfaceEdge3.addOnInvalidatedListener(runnable2);
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m254lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
            }, CameraXExecutors.mainThreadExecutor());
        } else {
            videoCaptureConfig2 = videoCaptureConfig;
            SurfaceRequest createSurfaceRequest = surfaceEdge2.createSurfaceRequest(cameraInternal);
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda3
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                VideoCapture.this.m255lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    public /* synthetic */ void m254lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    public /* synthetic */ void m255lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onAppEdgeInvalidated, reason: merged with bridge method [inline-methods] */
    public void m253lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda6
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return VideoCapture.this.m256xc7537f7(builder, completer);
            }
        });
    ...
    public /* synthetic */ Object m256xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.AnonymousClass2.this.m257lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }
        ...
        public /* synthetic */ void m257lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
        ...
        if (!list.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (!map.containsValue(next) && (findNearestHigherSupportedEncoderProfilesFor = videoCapabilities.findNearestHigherSupportedEncoderProfilesFor(next, dynamicRange)) != null) {
                    ...
                    VideoEncoderInfo findLargestSupportedSizeVideoEncoderInfo = findLargestSupportedSizeVideoEncoderInfo(videoCaptureConfig.getVideoEncoderInfoFinder(), findNearestHigherSupportedEncoderProfilesFor, dynamicRange2, mediaSpec2, next, (Range) Objects.requireNonNull(videoCaptureConfig.getTargetFrameRate(Defaults.DEFAULT_FPS_RANGE)));
