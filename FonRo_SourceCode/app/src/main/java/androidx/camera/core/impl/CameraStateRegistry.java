...
public final class CameraStateRegistry implements CameraCoordinator.ConcurrentCameraModeListener {
    ...
    */
    public boolean tryOpenCaptureSession(java.lang.String r5, java.lang.String r6) {
        ...
        L1c:
            if (r6 == 0) goto L23
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r4 = r4.getCameraRegistration(r6)     // Catch: java.lang.Throwable -> L5b
            goto L24
        L23:
            r4 = r1
        L24:
            if (r4 == 0) goto L2a
            androidx.camera.core.impl.CameraInternal$State r1 = r4.getState()     // Catch: java.lang.Throwable -> L5b
        L2a:
            androidx.camera.core.impl.CameraInternal$State r4 = androidx.camera.core.impl.CameraInternal.State.OPEN     // Catch: java.lang.Throwable -> L5b
            boolean r4 = r4.equals(r5)     // Catch: java.lang.Throwable -> L5b
            r6 = 0
            if (r4 != 0) goto L3e
            androidx.camera.core.impl.CameraInternal$State r4 = androidx.camera.core.impl.CameraInternal.State.CONFIGURED     // Catch: java.lang.Throwable -> L5b
            boolean r4 = r4.equals(r5)     // Catch: java.lang.Throwable -> L5b
            if (r4 == 0) goto L3c
            goto L3e
        L3c:
        ...
        L3e:
            r4 = r3
        L3f:
            androidx.camera.core.impl.CameraInternal$State r5 = androidx.camera.core.impl.CameraInternal.State.OPEN     // Catch: java.lang.Throwable -> L5b
            boolean r5 = r5.equals(r1)     // Catch: java.lang.Throwable -> L5b
            if (r5 != 0) goto L52
            androidx.camera.core.impl.CameraInternal$State r5 = androidx.camera.core.impl.CameraInternal.State.CONFIGURED     // Catch: java.lang.Throwable -> L5b
            boolean r5 = r5.equals(r1)     // Catch: java.lang.Throwable -> L5b
            if (r5 == 0) goto L50
            goto L52
        L50:
    ...
    */
    public void markCameraState(androidx.camera.core.Camera r6, androidx.camera.core.impl.CameraInternal.State r7, boolean r8) {
        /*
            ...
            monitor-enter(r0)
            int r1 = r5.mAvailableCameras     // Catch: java.lang.Throwable -> Lbc
            ...
            if (r7 != r2) goto Le
            androidx.camera.core.impl.CameraInternal$State r2 = r5.unregisterCamera(r6)     // Catch: java.lang.Throwable -> Lbc
            goto L12
        Le:
            androidx.camera.core.impl.CameraInternal$State r2 = r5.updateAndVerifyState(r6, r7)     // Catch: java.lang.Throwable -> Lbc
        L12:
            if (r2 != r7) goto L16
            monitor-exit(r0)     // Catch: java.lang.Throwable -> Lbc
            return
        L16:
            androidx.camera.core.concurrent.CameraCoordinator r2 = r5.mCameraCoordinator     // Catch: java.lang.Throwable -> Lbc
            ...
            if (r7 != r2) goto L3b
            androidx.camera.core.CameraInfo r2 = r6.getCameraInfo()     // Catch: java.lang.Throwable -> Lbc
            ...
            androidx.camera.core.concurrent.CameraCoordinator r3 = r5.mCameraCoordinator     // Catch: java.lang.Throwable -> Lbc
            java.lang.String r2 = r3.getPairedConcurrentCameraId(r2)     // Catch: java.lang.Throwable -> Lbc
            if (r2 == 0) goto L3b
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r2 = r5.getCameraRegistration(r2)     // Catch: java.lang.Throwable -> Lbc
            goto L3c
        L3b:
            r2 = r4
        L3c:
            ...
            java.util.Map<androidx.camera.core.Camera, androidx.camera.core.impl.CameraStateRegistry$CameraRegistration> r5 = r5.mCameraStates     // Catch: java.lang.Throwable -> Lbc
            java.util.Set r5 = r5.entrySet()     // Catch: java.lang.Throwable -> Lbc
            java.util.Iterator r5 = r5.iterator()     // Catch: java.lang.Throwable -> Lbc
        L52:
            boolean r7 = r5.hasNext()     // Catch: java.lang.Throwable -> Lbc
            if (r7 == 0) goto L94
            java.lang.Object r7 = r5.next()     // Catch: java.lang.Throwable -> Lbc
            java.util.Map$Entry r7 = (java.util.Map.Entry) r7     // Catch: java.lang.Throwable -> Lbc
            java.lang.Object r1 = r7.getValue()     // Catch: java.lang.Throwable -> Lbc
            ...
            androidx.camera.core.impl.CameraInternal$State r1 = r1.getState()     // Catch: java.lang.Throwable -> Lbc
            androidx.camera.core.impl.CameraInternal$State r3 = androidx.camera.core.impl.CameraInternal.State.PENDING_OPEN     // Catch: java.lang.Throwable -> Lbc
            if (r1 != r3) goto L52
            java.lang.Object r1 = r7.getKey()     // Catch: java.lang.Throwable -> Lbc
            androidx.camera.core.Camera r1 = (androidx.camera.core.Camera) r1     // Catch: java.lang.Throwable -> Lbc
            java.lang.Object r7 = r7.getValue()     // Catch: java.lang.Throwable -> Lbc
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r7 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r7     // Catch: java.lang.Throwable -> Lbc
            r4.put(r1, r7)     // Catch: java.lang.Throwable -> Lbc
            goto L52
        L7c:
            ...
            if (r7 != r1) goto L94
            int r7 = r5.mAvailableCameras     // Catch: java.lang.Throwable -> Lbc
            if (r7 <= 0) goto L94
            java.util.HashMap r4 = new java.util.HashMap     // Catch: java.lang.Throwable -> Lbc
            r4.<init>()     // Catch: java.lang.Throwable -> Lbc
            java.util.Map<androidx.camera.core.Camera, androidx.camera.core.impl.CameraStateRegistry$CameraRegistration> r5 = r5.mCameraStates     // Catch: java.lang.Throwable -> Lbc
            java.lang.Object r5 = r5.get(r6)     // Catch: java.lang.Throwable -> Lbc
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r5 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r5     // Catch: java.lang.Throwable -> Lbc
            r4.put(r6, r5)     // Catch: java.lang.Throwable -> Lbc
        L94:
            if (r4 == 0) goto L9b
            if (r8 != 0) goto L9b
            r4.remove(r6)     // Catch: java.lang.Throwable -> Lbc
        L9b:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> Lbc
            if (r4 == 0) goto Lb6
        ...
        La6:
            ...
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r6 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r6
            r6.notifyOnOpenAvailableListener()
            goto La6
        Lb6:
            if (r2 == 0) goto Lbb
