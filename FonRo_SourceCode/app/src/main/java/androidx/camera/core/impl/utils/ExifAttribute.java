...
final class ExifAttribute {
    ...
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x014c: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:109:0x014c */
    /* JADX WARN: Removed duplicated region for block: B:112:0x014f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Type inference failed for: r11v15, types: [int[]] */
    /* JADX WARN: Type inference failed for: r11v17, types: [long[]] */
    /* JADX WARN: Type inference failed for: r11v19, types: [androidx.camera.core.impl.utils.LongRational[]] */
