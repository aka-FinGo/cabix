...
public class ExifData {
    ...
    public static final class Builder {
        ...
        public Builder setExposureTimeNanos(long j) {
            ...
            return setAttribute(ExifInterface.TAG_EXPOSURE_TIME, String.valueOf(j / 1.0E9d));
        }
        ...
        private void setAttributeInternal(String str, String str2, List<Map<String, ExifAttribute>> list) {
            ...
            int i4 = 2;
            int i5 = 1;
            if (str4 != null && ExifData.sTagSetForCompatibility.contains(str3)) {
                if (str3.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                    ...
                    try {
                        ...
                        Logger.w(ExifData.TAG, "Invalid value for " + str3 + " : " + str4, e);
                        return;
                    }
                }
            }
            ...
            while (i7 < ExifData.EXIF_TAGS.length) {
                ExifTag exifTag = sExifTagMapsForWriting.get(i7).get(str3);
                if (exifTag != null) {
                    if (str4 == null) {
                        list.get(i7).remove(str3);
                    } else {
                        ...
                        switch (i3) {
                            case 1:
                                i = i6;
                                i2 = i5;
                                list.get(i7).put(str3, ExifAttribute.createByte(str4));
                                continue;
                            case 2:
                            case 7:
                                i = i6;
                                i2 = i5;
                                list.get(i7).put(str3, ExifAttribute.createString(str4));
                                continue;
                            case 3:
                                i = i6;
                                i2 = i5;
                                ...
                                list.get(i7).put(str3, ExifAttribute.createUShort(iArr, this.mByteOrder));
                                continue;
                            case 4:
                                i = i6;
                                i2 = i5;
                                ...
                                list.get(i7).put(str3, ExifAttribute.createULong(jArr, this.mByteOrder));
                                continue;
                            case 5:
                                i = i6;
                                i2 = i5;
                                ...
                                while (i10 < split3.length) {
                                    ...
                                    int i11 = i10;
                                    longRationalArr[i11] = new LongRational((long) Double.parseDouble(split4[i]), (long) Double.parseDouble(split4[i2]));
                                    i10 = i11 + 1;
                                }
                                list.get(i7).put(str3, ExifAttribute.createURational(longRationalArr, this.mByteOrder));
                                continue;
                            case 9:
                                i = i6;
                                i2 = i5;
                                ...
                                list.get(i7).put(str3, ExifAttribute.createSLong(iArr2, this.mByteOrder));
                                continue;
                            case 10:
                                ...
                                while (i13 < split6.length) {
                                    String[] split7 = split6[i13].split(str5, -1);
                                    longRationalArr2[i13] = new LongRational((long) Double.parseDouble(split7[i6]), (long) Double.parseDouble(split7[i5]));
                                    i13++;
                                    i6 = i6;
                                    i5 = i5;
                                    str5 = str5;
                                ...
                                i = i6;
                                i2 = i5;
                                list.get(i7).put(str3, ExifAttribute.createSRational(longRationalArr2, this.mByteOrder));
                                continue;
                            case 12:
                                ...
                                list.get(i7).put(str3, ExifAttribute.createDouble(dArr, this.mByteOrder));
                                break;
                        }
                    }
                }
