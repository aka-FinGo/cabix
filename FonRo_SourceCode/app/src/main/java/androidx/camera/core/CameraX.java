...
public final class CameraX {
    ...
    CameraX(Context context, CameraXConfig.Provider provider, Function<Context, QuirkSettings> function) {
        ...
        if (provider != null) {
            cameraXConfig = provider.getCameraXConfig();
            ...
            cameraXConfig = configProvider.getCameraXConfig();
            this.mCameraXConfig = cameraXConfig;
        }
        updateQuirkSettings(context, cameraXConfig.getQuirkSettings(), function);
        ...
        Integer num = (Integer) cameraXConfig.retrieveOption(CameraXConfig.OPTION_MIN_LOGGING_LEVEL, null);
        this.mMinLogLevel = num;
        increaseMinLogLevelReference(num);
        this.mRetryPolicy = new RetryPolicy.Builder(cameraXConfig.getCameraProviderInitRetryPolicy()).build();
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final int i, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
            ...
            public final void run() {
                CameraX.this.m148lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(context, executor, i, completer, j);
            }
        });
    }
    ...
    public /* synthetic */ void m148lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(Context context, final Executor executor, final int i, final CallbackToFutureAdapter.Completer completer, final long j) {
        ...
        try {
            ...
            if (onRetryDecisionRequested.shouldRetry() && i < Integer.MAX_VALUE) {
                ...
                HandlerCompat.postDelayed(this.mSchedulerHandler, new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        CameraX.this.m147lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(executor, j, i, applicationContext, completer);
                    }
    ...
    public /* synthetic */ void m147lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(Executor executor, long j, int i, Context context, CallbackToFutureAdapter.Completer completer) {
