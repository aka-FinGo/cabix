...
public class ChainingListenableFuture<I, O> extends FutureChain<O> implements Runnable {
    ...
    /* JADX WARN: Type inference failed for: r4v0, types: [androidx.camera.core.impl.utils.futures.ChainingListenableFuture<I, O>, androidx.camera.core.impl.utils.futures.ChainingListenableFuture] */
            ...
            try {
                try {
                    try {
                        ...
                        chainingListenableFuture.mFunction = null;
                        chainingListenableFuture.mInputFuture = null;
                        chainingListenableFuture.mOutputCreated.countDown();
                        return;
