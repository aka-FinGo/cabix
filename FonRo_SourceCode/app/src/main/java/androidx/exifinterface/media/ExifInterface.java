...
public class ExifInterface {
    ...
    public static class ExifAttribute {
        ...
        /* JADX WARN: Not initialized variable reg: 3, insn: 0x0150: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:109:0x0150 */
        /* JADX WARN: Removed duplicated region for block: B:112:0x0153 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /* JADX WARN: Type inference failed for: r11v16, types: [int[]] */
        /* JADX WARN: Type inference failed for: r11v18, types: [long[]] */
        /* JADX WARN: Type inference failed for: r11v20, types: [androidx.exifinterface.media.ExifInterface$Rational[]] */
        ...
        /* JADX WARN: Type inference failed for: r11v28, types: [double[]] */
                ...
                if (str4 == null) {
                    ...
                    switch (i) {
                        case 1:
                            i2 = i6;
                            i3 = i5;
                            this.mAttributes[i7].put(str3, ExifAttribute.createByte(str4));
                            continue;
                        case 2:
                        case 7:
                            i2 = i6;
                            i3 = i5;
                            this.mAttributes[i7].put(str3, ExifAttribute.createString(str4));
                            continue;
                        case 3:
                            i2 = i6;
                            i3 = i5;
                        ...
                        case 5:
                            ...
                            while (i10 < split3.length) {
                                ...
                                int i11 = i10;
                                rationalArr[i11] = new Rational((long) Double.parseDouble(split4[i2]), (long) Double.parseDouble(split4[i3]));
                                i10 = i11 + 1;
                            }
                        ...
                        case 9:
                            ...
                            for (int i12 = i2; i12 < split5.length; i12++) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:59:0x00e9 A[Catch: all -> 0x0111, Exception -> 0x0115, TryCatch #18 {Exception -> 0x0115, all -> 0x0111, blocks: (B:57:0x00e5, B:59:0x00e9, B:60:0x00ff, B:64:0x00f8), top: B:56:0x00e5 }] */
    /* JADX WARN: Removed duplicated region for block: B:64:0x00f8 A[Catch: all -> 0x0111, Exception -> 0x0115, TryCatch #18 {Exception -> 0x0115, all -> 0x0111, blocks: (B:57:0x00e5, B:59:0x00e9, B:60:0x00ff, B:64:0x00f8), top: B:56:0x00e5 }] */
    ...
    */
    public byte[] getThumbnailBytes() {
        ...
        L8:
            ...
            return r1
        Ld:
            android.content.res.AssetManager$AssetInputStream r1 = r8.mAssetInputStream     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            if (r1 == 0) goto L2c
        ...
        L29:
            ...
            goto L83
        L2c:
            java.lang.String r1 = r8.mFilename     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            if (r1 == 0) goto L38
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            java.lang.String r3 = r8.mFilename     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            r1.<init>(r3)     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            goto L1a
        L38:
            java.io.FileDescriptor r1 = r8.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            java.io.FileDescriptor r1 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r1)     // Catch: java.lang.Throwable -> L7d java.lang.Exception -> L80
            int r3 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L79
            r4 = 0
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r4, r3)     // Catch: java.lang.Throwable -> L76 java.lang.Exception -> L79
        ...
        L4d:
            if (r1 == 0) goto L70
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r4 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            r4.<init>(r1)     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            int r5 = r8.mThumbnailOffset     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            int r6 = r8.mOffsetToExifData     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            int r5 = r5 + r6
            r4.skipFully(r5)     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            int r5 = r8.mThumbnailLength     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            byte[] r5 = new byte[r5]     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            r4.readFully(r5)     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            r8.mThumbnailBytes = r5     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto L6d
        ...
        L6e:
            ...
            goto L83
        L70:
            java.io.FileNotFoundException r8 = new java.io.FileNotFoundException     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            r8.<init>()     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
            throw r8     // Catch: java.lang.Exception -> L6e java.lang.Throwable -> L91
        L76:
            r8 = move-exception
            r3 = r1
            goto L93
        ...
        L83:
            ...
            android.util.Log.d(r0, r4, r8)     // Catch: java.lang.Throwable -> L91
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
            if (r3 == 0) goto L90
            androidx.exifinterface.media.ExifInterfaceUtils.closeFileDescriptor(r3)
        L90:
    ...
    public Bitmap getThumbnailBitmap() {
        ...
        int i = this.mThumbnailCompression;
        if (i == 6 || i == 7) {
            return BitmapFactory.decodeByteArray(bArr, 0, this.mThumbnailLength);
        }
        if (i == 1) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                int i3 = i2 * 3;
                iArr[i2] = (bArr2[i3] << Ascii.DLE) + (bArr2[i3 + 1] << 8) + bArr2[i3 + 2];
            }
    ...
    public void setGpsInfo(Location location) {
        ...
        setAttribute(TAG_GPS_SPEED, new Rational((speed * 3600.0f) / 1000.0f).toString());
    ...
    public void setAltitude(double d) {
        String str = d >= AudioStats.AUDIO_AMPLITUDE_NONE ? "0" : DiskLruCache.VERSION;
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x0166 A[LOOP:0: B:9:0x0034->B:33:0x0166, LOOP_END] */
