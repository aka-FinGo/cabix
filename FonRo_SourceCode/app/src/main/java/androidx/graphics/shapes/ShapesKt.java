...
public final class ShapesKt {
    ...
    private static final float[] pillStarVerticesFromNumVerts(int i, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        float f11 = coerceAtLeast2 / 2.0f;
        float twoPi = Utils.getTwoPi() * min * Utils.interpolate(f3, 1.0f, f4);
        float f12 = (2.0f * coerceAtLeast2) + (2.0f * coerceAtLeast) + twoPi;
        float f13 = twoPi / 4.0f;
        float f14 = f10 + f13;
        float f15 = f14 + coerceAtLeast2;
        float f16 = f15 + f13;
        float f17 = f16 + coerceAtLeast;
        float f18 = f17 + f13;
        float f19 = f18 + coerceAtLeast2;
        float f20 = f19 + f13;
        ...
        long m328constructorimpl2 = FloatFloatPair.m328constructorimpl(f11, f10);
        float f23 = -f11;
        long m328constructorimpl3 = FloatFloatPair.m328constructorimpl(f23, f10);
        float f24 = -f10;
        long m328constructorimpl4 = FloatFloatPair.m328constructorimpl(f23, f24);
        long m328constructorimpl5 = FloatFloatPair.m328constructorimpl(f11, f24);
        float f25 = f10;
        int i3 = 0;
        float f26 = 0.0f;
        boolean z = false;
        ...
        while (i3 < i2) {
            ...
            while (true) {
                ...
                if (f27 >= f28) {
                    ...
                    float f30 = z ? min * f3 : min;
                    switch (i4) {
                        case 0:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = FloatFloatPair.m328constructorimpl(f30, f29 * f9);
                            break;
                        case 1:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = PointKt.m7415plusybeJwSQ(Utils.m7431radialToCartesianL6JJ3z0$default(f30, (f29 * Utils.getFloatPi()) / 2.0f, 0L, 4, null), m328constructorimpl2);
                            break;
                        case 2:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = FloatFloatPair.m328constructorimpl(f11 - (f29 * coerceAtLeast2), f30);
                            break;
                        case 3:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = PointKt.m7415plusybeJwSQ(Utils.m7431radialToCartesianL6JJ3z0$default(f30, (Utils.getFloatPi() / 2.0f) + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m328constructorimpl3);
                            break;
                        case 4:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = FloatFloatPair.m328constructorimpl(-f30, f9 - (f29 * coerceAtLeast));
                            break;
                        case 5:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = PointKt.m7415plusybeJwSQ(Utils.m7431radialToCartesianL6JJ3z0$default(f30, Utils.getFloatPi() + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m328constructorimpl4);
                            break;
                        case 6:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = FloatFloatPair.m328constructorimpl(f8 + (f29 * coerceAtLeast2), -f30);
                            break;
                        case 7:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = PointKt.m7415plusybeJwSQ(Utils.m7431radialToCartesianL6JJ3z0$default(f30, (Utils.getFloatPi() * 1.5f) + ((f29 * Utils.getFloatPi()) / 2.0f), 0L, 4, null), m328constructorimpl5);
                            break;
                        default:
                            f8 = f23;
                            f9 = f10;
                            m328constructorimpl = FloatFloatPair.m328constructorimpl(f30, f24 + (f29 * f9));
                            break;
                    }
                    int i7 = i5 + 1;
                    fArr2[i5] = PointKt.m7411getXDnnuFBc(m328constructorimpl) + f6;
                    i5 += 2;
                    fArr2[i7] = PointKt.m7412getYDnnuFBc(m328constructorimpl) + f7;
                    f22 += f21;
                    z = !z;
                    i3++;
                    f23 = f8;
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long m7431radialToCartesianL6JJ3z0$default = Utils.m7431radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2.0f * i3, 0L, 4, null);
            fArr[i2] = PointKt.m7411getXDnnuFBc(m7431radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m7412getYDnnuFBc(m7431radialToCartesianL6JJ3z0$default) + f4;
            long m7431radialToCartesianL6JJ3z0$default2 = Utils.m7431radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m7411getXDnnuFBc(m7431radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m7412getYDnnuFBc(m7431radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
