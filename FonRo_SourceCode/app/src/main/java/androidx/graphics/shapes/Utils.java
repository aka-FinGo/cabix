...
public final class Utils {
    ...
    private static final long Zero = FloatFloatPair.m328constructorimpl(0.0f, 0.0f);
    ...
    public static final long directionVector(float f, float f2) {
        ...
        return FloatFloatPair.m328constructorimpl(f / distance, f2 / distance);
    }

    public static final long directionVector(float f) {
        double d = f;
        return FloatFloatPair.m328constructorimpl((float) Math.cos(d), (float) Math.sin(d));
    }
    ...
    public static /* synthetic */ long m7431radialToCartesianL6JJ3z0$default(float f, float f2, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = Zero;
        }
        return m7430radialToCartesianL6JJ3z0(f, f2, j);
    }

    /* renamed from: radialToCartesian-L6JJ3z0, reason: not valid java name */
    public static final long m7430radialToCartesianL6JJ3z0(float f, float f2, long j) {
        return PointKt.m7415plusybeJwSQ(PointKt.m7417timesso9K2fw(directionVector(f2), f), j);
    }

    /* renamed from: rotate90-DnnuFBc, reason: not valid java name */
    public static final long m7432rotate90DnnuFBc(long j) {
        return FloatFloatPair.m328constructorimpl(-PointKt.m7412getYDnnuFBc(j), PointKt.m7411getXDnnuFBc(j));
    }
