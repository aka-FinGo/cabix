    ...
    public static final class Companion {
        ...
        public final MeasuredPolygon measurePolygon$graphics_shapes_release(Measurer measurer, RoundedPolygon polygon) {
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ...
                createListBuilder.add(new ProgressableFeature((mutableFloatList.get(intValue) + mutableFloatList.get(intValue + 1)) / 2.0f, (Feature) ((Pair) arrayList3.get(i4)).getFirst()));
            }
