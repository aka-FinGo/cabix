...
public final class MutableCubic extends Cubic {
    ...
    private final void transformOnePoint(PointTransformer f, int ix) {
        int i = ix + 1;
        long mo7420transformXgqJiTY = f.mo7420transformXgqJiTY(getPoints()[ix], getPoints()[i]);
        getPoints()[ix] = Float.intBitsToFloat((int) (mo7420transformXgqJiTY >> 32));
        getPoints()[i] = Float.intBitsToFloat((int) (4294967295L & mo7420transformXgqJiTY));
    }
