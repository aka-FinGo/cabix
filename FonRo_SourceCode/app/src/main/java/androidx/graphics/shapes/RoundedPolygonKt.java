...
public final class RoundedPolygonKt {
    ...
    public static final RoundedPolygon RoundedPolygon(float[] vertices, CornerRounding rounding, List<CornerRounding> list, float f, float f2) {
        ...
        while (i4 < length) {
            ...
            int i7 = (i6 % length) * 2;
            int i8 = i4 * 2;
            arrayList2.add(new RoundedCorner(FloatFloatPair.m328constructorimpl(vertices[i5], vertices[i5 + 1]), FloatFloatPair.m328constructorimpl(vertices[i8], vertices[i8 + 1]), FloatFloatPair.m328constructorimpl(vertices[i7], vertices[i7 + 1]), cornerRounding2, null));
            i4 = i6;
        }
        ...
        while (i3 < length) {
            ...
            int i15 = i14 % length;
            int i16 = i3 * 2;
            long m328constructorimpl = FloatFloatPair.m328constructorimpl(vertices[i16], vertices[i16 + i2]);
            int i17 = (((i3 + length) - i2) % length) * i;
            long m328constructorimpl2 = FloatFloatPair.m328constructorimpl(vertices[i17], vertices[i17 + i2]);
            int i18 = i15 * 2;
            arrayList5.add(new Feature.Corner((List) arrayList.get(i3), m328constructorimpl, ((RoundedCorner) arrayList2.get(i3)).getCenter(), PointKt.m7402clockwiseybeJwSQ(PointKt.m7414minusybeJwSQ(m328constructorimpl, m328constructorimpl2), PointKt.m7414minusybeJwSQ(FloatFloatPair.m328constructorimpl(vertices[i18], vertices[i18 + i2]), m328constructorimpl)), null));
        ...
        if (f == Float.MIN_VALUE || f2 == Float.MIN_VALUE) {
            ...
            calculateCenter = FloatFloatPair.m328constructorimpl(f, f2);
        }
    ...
    private static final long calculateCenter(float[] fArr) {
        ...
        return FloatFloatPair.m328constructorimpl((f / fArr.length) / 2.0f, (f2 / fArr.length) / 2.0f);
    }
    ...
    private static final float[] verticesFromNumVerts(int i, float f, float f2, float f3) {
        ...
        while (i2 < i) {
            float f4 = f;
            long m7415plusybeJwSQ = PointKt.m7415plusybeJwSQ(Utils.m7431radialToCartesianL6JJ3z0$default(f4, (Utils.getFloatPi() / i) * 2.0f * i2, 0L, 4, null), FloatFloatPair.m328constructorimpl(f2, f3));
            int i4 = i3 + 1;
            fArr[i3] = PointKt.m7411getXDnnuFBc(m7415plusybeJwSQ);
            i3 += 2;
            fArr[i4] = PointKt.m7412getYDnnuFBc(m7415plusybeJwSQ);
            i2++;
            f = f4;
        }
        return fArr;
