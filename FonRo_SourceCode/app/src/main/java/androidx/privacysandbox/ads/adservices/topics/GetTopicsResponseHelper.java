...
public final class GetTopicsResponseHelper {
    ...
    public final GetTopicsResponse convertResponse$ads_adservices_release(android.adservices.topics.GetTopicsResponse response) {
        ...
        while (it.hasNext()) {
            android.adservices.topics.Topic m7663m = ContentUriFetcher$$ExternalSyntheticApiModelOutline0.m7663m(it.next());
            taxonomyVersion = m7663m.getTaxonomyVersion();
            modelVersion = m7663m.getModelVersion();
            topicId = m7663m.getTopicId();
    ...
    public final GetTopicsResponse convertResponseWithEncryptedTopics$ads_adservices_release(android.adservices.topics.GetTopicsResponse response) {
        ...
        while (it2.hasNext()) {
            android.adservices.topics.EncryptedTopic m = ContentUriFetcher$$ExternalSyntheticApiModelOutline0.m(it2.next());
