        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, Drawable.Callback callback, Resources resources) {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (vectorDrawableCompat2 != null) {
                    Drawable.ConstantState constantState = vectorDrawableCompat2.getConstantState();
                    if (resources != null) {
                        vectorDrawableCompat = (VectorDrawableCompat) constantState.newDrawable(resources);
                        this.mVectorDrawable = vectorDrawableCompat;
                    } else {
                        vectorDrawableCompat = (VectorDrawableCompat) constantState.newDrawable();
                        this.mVectorDrawable = vectorDrawableCompat;
                    }
                    VectorDrawableCompat vectorDrawableCompat3 = (VectorDrawableCompat) vectorDrawableCompat.mutate();
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if (animator instanceof ObjectAnimator) {
            ...
            if ("fillColor".equals(propertyName) || "strokeColor".equals(propertyName)) {
                android.animation.ArgbEvaluator argbEvaluator = this.mArgbEvaluator;
