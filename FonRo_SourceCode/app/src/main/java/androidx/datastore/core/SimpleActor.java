...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object m9459getOrNullimpl = ChannelResult.m9459getOrNullimpl(((SimpleActor) this).messageQueue.mo9447tryReceivePtdJZtk());
                        if (m9459getOrNullimpl != null) {
                            onUndeliveredElement.invoke(m9459getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo9440trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable m9458exceptionOrNullimpl = ChannelResult.m9458exceptionOrNullimpl(obj);
            if (m9458exceptionOrNullimpl != null) {
                throw m9458exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m9464isSuccessimpl(obj)) {
