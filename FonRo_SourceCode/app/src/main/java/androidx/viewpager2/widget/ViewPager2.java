...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            viewPager2 = this;
            viewPager2.saveAttributeDataForStyleable(context, R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        } else {
            viewPager2 = this;
        }
        try {
            viewPager2.setOrientation(obtainStyledAttributes.getInt(R.styleable.ViewPager2_android_orientation, 0));
        } finally {
