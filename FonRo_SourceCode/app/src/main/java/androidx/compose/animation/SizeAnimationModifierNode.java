...
public final class SizeAnimationModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m440copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m442copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m442copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m7158equalsimpl0(this.startSize, animData.startSize);
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m7161hashCodeimpl(this.startSize);
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m7163toStringimpl(this.startSize)) + ')';
        }
        ...
        public final long m443getStartSizeYbymL2g() {
            return this.startSize;
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m444setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }
    }
    ...
    public MeasureResult mo384measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        long m6956constrain4WqzIAM;
        if (measureScope.isLookingAhead()) {
            m437setLookaheadConstraintsBRTryo0(j);
            mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(j);
        } else {
            mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(m438targetConstraintsZezNO4M(j));
        }
        final Placeable placeable = mo5732measureBRTryo0;
        final long m7155constructorimpl = IntSize.m7155constructorimpl((placeable.getWidth() << 32) | (placeable.getHeight() & 4294967295L));
        if (measureScope.isLookingAhead()) {
            this.lookaheadSize = m7155constructorimpl;
            m6956constrain4WqzIAM = m7155constructorimpl;
        } else {
            m6956constrain4WqzIAM = ConstraintsKt.m6956constrain4WqzIAM(j, m439animateTomzRDjE0(AnimationModifierKt.m388isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : m7155constructorimpl));
        }
        final int i = (int) (m6956constrain4WqzIAM >> 32);
        final int i2 = (int) (m6956constrain4WqzIAM & 4294967295L);
        return MeasureScope.layout$default(measureScope, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifierNode$measure$2
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5796place70tqf50$default(placementScope, placeable, SizeAnimationModifierNode.this.getAlignment().mo3942alignKFBX0sM(m7155constructorimpl, IntSize.m7155constructorimpl((i << 32) | (i2 & 4294967295L)), measureScope.getLayoutDirection()), 0.0f, 2, null);
            }
        }, 4, null);
    }

    /* renamed from: animateTo-mzRDjE0, reason: not valid java name */
    public final long m439animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            boolean z = (IntSize.m7158equalsimpl0(targetSize, animData.getAnim().getValue().m7164unboximpl()) || animData.getAnim().isRunning()) ? false : true;
            if (!IntSize.m7158equalsimpl0(targetSize, animData.getAnim().getTargetValue().m7164unboximpl()) || z) {
                animData.m444setStartSizeozmzZPI(animData.getAnim().getValue().m7164unboximpl());
            ...
            animData = new AnimData(new Animatable(IntSize.m7152boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m7152boximpl(IntSize.m7155constructorimpl(InlineClassHelperKt.Uint64Low32)), null, 8, null), targetSize, null);
        }
        setAnimData(animData);
        return animData.getAnim().getValue().m7164unboximpl();
    }
}
