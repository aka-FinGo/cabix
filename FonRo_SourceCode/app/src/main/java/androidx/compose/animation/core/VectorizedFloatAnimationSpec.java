...
public final class VectorizedFloatAnimationSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        if (v2 == null) {
            v2 = (V) AnimationVectorsKt.newInstance(initialValue);
            this.valueVector = v2;
        }
        if (v2 == null) {
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        if (v2 == null) {
            v2 = (V) AnimationVectorsKt.newInstance(initialVelocity);
    ...
    public long getDurationNanos(V initialValue, V targetValue, V initialVelocity) {
        ...
        for (int i = 0; i < size; i++) {
            j = Math.max(j, this.anims.get(i).getDurationNanos(initialValue.get$animation_core_release(i), targetValue.get$animation_core_release(i), initialVelocity.get$animation_core_release(i)));
        }
        return j;
    }
}
