...
public final class VisibilityThresholdsKt {
    ...
    public static final long getVisibilityThreshold(DpOffset.Companion companion) {
        ...
        return DpOffset.m7045constructorimpl((Float.floatToRawIntBits(visibilityThreshold) << 32) | (Float.floatToRawIntBits(visibilityThreshold2) & 4294967295L));
    }
    ...
    public static final long getVisibilityThreshold(IntOffset.Companion companion) {
        return IntOffset.m7111constructorimpl(InlineClassHelperKt.Uint64Low32);
    }

    public static final long getVisibilityThreshold(Offset.Companion companion) {
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(0.5f) << 32) | (Float.floatToRawIntBits(0.5f) & 4294967295L));
    }

    public static final float getVisibilityThreshold(Dp.Companion companion) {
        return Dp.m6989constructorimpl(0.1f);
    }

    public static final long getVisibilityThreshold(Size.Companion companion) {
        return Size.m4185constructorimpl((Float.floatToRawIntBits(0.5f) << 32) | (Float.floatToRawIntBits(0.5f) & 4294967295L));
    }

    public static final long getVisibilityThreshold(IntSize.Companion companion) {
        return IntSize.m7155constructorimpl(InlineClassHelperKt.Uint64Low32);
    }
}
