    ...
    public MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                ...
                placeableArr[i] = mo5732measureBRTryo0;
                m7165getZeroYbymL2g = m7155constructorimpl;
            }
            i++;
        }
        ...
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo5732measureBRTryo0(j);
            }
        }
        if (measureScope.isLookingAhead()) {
            width = (int) (m7165getZeroYbymL2g >> 32);
        } else {
            if (size == 0) {
                placeable2 = null;
            } else {
        ...
        if (measureScope.isLookingAhead()) {
            height = (int) (m7165getZeroYbymL2g & 4294967295L);
        } else {
            if (size != 0) {
        ...
        if (!measureScope.isLookingAhead()) {
            this.rootScope.m381setMeasuredSizeozmzZPI$animation_release(IntSize.m7155constructorimpl((width << 32) | (height & 4294967295L)));
        }
        return MeasureScope.layout$default(measureScope, width, height, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long mo3942alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo3942alignKFBX0sM(IntSize.m7155constructorimpl((placeable5.getWidth() << 32) | (placeable5.getHeight() & 4294967295L)), IntSize.m7155constructorimpl((i3 << 32) | (i4 & 4294967295L)), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(placementScope, placeable5, IntOffset.m7117getXimpl(mo3942alignKFBX0sM), IntOffset.m7118getYimpl(mo3942alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
