...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m4165Recttz77jQw(sharedElementInternalState.m429calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m430getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m428onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset m4114boximpl = rect != null ? Offset.m4114boximpl(rect.m4160getTopLeftF1C5BW0()) : null;
            if (m4114boximpl == null ? false : Offset.m4122equalsimpl0(m4114boximpl.m4135unboximpl(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size m4182boximpl = rect2 != null ? Size.m4182boximpl(rect2.m4158getSizeNHjbRc()) : null;
                if (m4182boximpl == null ? false : Size.m4190equalsimpl0(m4182boximpl.m4199unboximpl(), lookaheadSize)) {
                    return;
                }
            }
            Rect m4165Recttz77jQw = RectKt.m4165Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(m4165Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, m4165Recttz77jQw);
            }
        }
    }
