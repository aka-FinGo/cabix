...
final class EnterExitTransitionModifierNode extends LayoutModifierNodeWithPassThroughIntrinsics {
    ...
    private final void m416setLookaheadConstraintsBRTryo0(long j) {
    ...
    public final long m417sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        if (i != 1) {
            if (i == 2) {
                ...
                if (changeSize != null && (size = changeSize.getSize()) != null) {
                    return size.invoke(IntSize.m7152boximpl(fullSize)).m7164unboximpl();
                }
            } else {
                if (i != 3) {
                ...
                if (changeSize2 != null && (size2 = changeSize2.getSize()) != null) {
                    return size2.invoke(IntSize.m7152boximpl(fullSize)).m7164unboximpl();
                }
            }
        }
        return fullSize;
    ...
    public final long m419targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        if (this.currentAlignment != null && getAlignment() != null && !Intrinsics.areEqual(this.currentAlignment, getAlignment())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m7128getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m7128getZeronOccac();
            }
            ...
            if (changeSize != null) {
                long m7164unboximpl = changeSize.getSize().invoke(IntSize.m7152boximpl(fullSize)).m7164unboximpl();
                Alignment alignment = getAlignment();
                Intrinsics.checkNotNull(alignment);
                long mo3942alignKFBX0sM = alignment.mo3942alignKFBX0sM(fullSize, m7164unboximpl, LayoutDirection.Ltr);
                Alignment alignment2 = this.currentAlignment;
                Intrinsics.checkNotNull(alignment2);
                return IntOffset.m7120minusqkQi6aY(mo3942alignKFBX0sM, alignment2.mo3942alignKFBX0sM(fullSize, m7164unboximpl, LayoutDirection.Ltr));
            }
            return IntOffset.INSTANCE.m7128getZeronOccac();
        }
        return IntOffset.INSTANCE.m7128getZeronOccac();
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            long m7155constructorimpl = IntSize.m7155constructorimpl((mo5732measureBRTryo0.getWidth() << 32) | (mo5732measureBRTryo0.getHeight() & 4294967295L));
            this.lookaheadSize = m7155constructorimpl;
            m416setLookaheadConstraintsBRTryo0(j);
            return MeasureScope.layout$default(measureScope, (int) (m7155constructorimpl >> 32), (int) (m7155constructorimpl & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
        ...
        if (this.isEnabled.invoke().booleanValue()) {
            ...
            final Placeable mo5732measureBRTryo02 = measurable.mo5732measureBRTryo0(j);
            long m7155constructorimpl2 = IntSize.m7155constructorimpl((mo5732measureBRTryo02.getWidth() << 32) | (mo5732measureBRTryo02.getHeight() & 4294967295L));
            final long j2 = AnimationModifierKt.m388isValidozmzZPI(this.lookaheadSize) ? this.lookaheadSize : m7155constructorimpl2;
            ...
            State<IntSize> animate3 = deferredAnimation != null ? deferredAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$animSize$1
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                    return IntSize.m7152boximpl(m420invokeYEO4UFw(enterExitState));
                }

                /* renamed from: invoke-YEO4UFw, reason: not valid java name */
                public final long m420invokeYEO4UFw(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m417sizeByStateUzc_VyU(enterExitState, j2);
                }
            }) : null;
            if (animate3 != null) {
                m7155constructorimpl2 = animate3.getValue().m7164unboximpl();
            }
            long m6956constrain4WqzIAM = ConstraintsKt.m6956constrain4WqzIAM(j, m7155constructorimpl2);
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation2 = this.offsetAnimation;
            long m7128getZeronOccac = (deferredAnimation2 == null || (animate2 = deferredAnimation2.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$offsetDelta$1
                @Override // kotlin.jvm.functions.Function1
                public final FiniteAnimationSpec<IntOffset> invoke(Transition.Segment<EnterExitState> segment) {
                    SpringSpec springSpec;
                    springSpec = EnterExitTransitionKt.DefaultOffsetAnimationSpec;
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7108boximpl(m421invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m421invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m419targetOffsetByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7128getZeronOccac() : animate2.getValue().m7126unboximpl();
            Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> deferredAnimation3 = this.slideAnimation;
            long m7128getZeronOccac2 = (deferredAnimation3 == null || (animate = deferredAnimation3.animate(this.slideSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$slideOffset$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                    return IntOffset.m7108boximpl(m422invokeBjo55l4(enterExitState));
                }

                /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                public final long m422invokeBjo55l4(EnterExitState enterExitState) {
                    return EnterExitTransitionModifierNode.this.m418slideTargetValueByStateoFUgxo0(enterExitState, j2);
                }
            })) == null) ? IntOffset.INSTANCE.m7128getZeronOccac() : animate.getValue().m7126unboximpl();
            Alignment alignment2 = this.currentAlignment;
            final long m7121plusqkQi6aY = IntOffset.m7121plusqkQi6aY(alignment2 != null ? alignment2.mo3942alignKFBX0sM(j2, m6956constrain4WqzIAM, LayoutDirection.Ltr) : IntOffset.INSTANCE.m7128getZeronOccac(), m7128getZeronOccac2);
            final long j3 = m7128getZeronOccac;
            return MeasureScope.layout$default(measureScope, (int) (m6956constrain4WqzIAM >> 32), (int) (m6956constrain4WqzIAM & 4294967295L), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$2
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                ...
                /* renamed from: invoke, reason: avoid collision after fix types in other method */
                public final void invoke2(Placeable.PlacementScope placementScope) {
                    placementScope.placeWithLayer(Placeable.this, IntOffset.m7117getXimpl(j3) + IntOffset.m7117getXimpl(m7121plusqkQi6aY), IntOffset.m7118getYimpl(j3) + IntOffset.m7118getYimpl(m7121plusqkQi6aY), 0.0f, init);
                }
            }, 4, null);
        }
        final Placeable mo5732measureBRTryo03 = measurable.mo5732measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo03.getWidth(), mo5732measureBRTryo03.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.EnterExitTransitionModifierNode$measure$3$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public final long m418slideTargetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Function1<IntSize, IntOffset> slideOffset;
        Function1<IntSize, IntOffset> slideOffset2;
        Slide slide = this.enter.getData().getSlide();
        long m7128getZeronOccac = (slide == null || (slideOffset2 = slide.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7128getZeronOccac() : slideOffset2.invoke(IntSize.m7152boximpl(fullSize)).m7126unboximpl();
        Slide slide2 = this.exit.getData().getSlide();
        long m7128getZeronOccac2 = (slide2 == null || (slideOffset = slide2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m7128getZeronOccac() : slideOffset.invoke(IntSize.m7152boximpl(fullSize)).m7126unboximpl();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m7128getZeronOccac();
        }
