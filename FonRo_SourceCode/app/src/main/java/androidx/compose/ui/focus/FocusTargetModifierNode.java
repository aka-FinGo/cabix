...
public interface FocusTargetModifierNode extends DelegatableNode {
    ...
    int mo4039getFocusabilityLCbbffg();
    ...
    boolean mo4040requestFocus3ESFkO8(int focusDirection);

    /* renamed from: setFocusability-josRg5g, reason: not valid java name */
    void mo4041setFocusabilityjosRg5g(int i);

    /* renamed from: requestFocus-3ESFkO8$default, reason: not valid java name */
    static /* synthetic */ boolean m4038requestFocus3ESFkO8$default(FocusTargetModifierNode focusTargetModifierNode, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        return focusTargetModifierNode.mo4040requestFocus3ESFkO8(i);
    }
}
