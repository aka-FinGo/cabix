...
public final class BulletSpan_androidKt {
    ...
    public static final void setDrawStyle(Paint paint, DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            ...
            paint.setStrokeCap(DrawStyleSpan_androidKt.m6741toAndroidCapBeK7IIE(stroke.getCap()));
            paint.setStrokeJoin(DrawStyleSpan_androidKt.m6742toAndroidJoinWw9F2mQ(stroke.getJoin()));
    ...
    public static final void draw(Outline outline, Canvas canvas, Paint paint, float f, float f2, int i) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            float intBitsToFloat = Float.intBitsToFloat((int) (rounded.getRoundRect().m4175getTopLeftCornerRadiuskKHJgLs() >> 32));
    ...
    public static final void m6740setBrushAndDrawyzxVdVo(Paint paint, Brush brush, float f, long j, Function0<Unit> function0) {
        Integer num = null;
        if (brush == null) {
            if (!Float.isNaN(f)) {
        ...
        if (brush instanceof SolidColor) {
            ...
            paint.setColor(ColorKt.m4438toArgb8_81llA(((SolidColor) brush).getValue()));
            function0.invoke();
        ...
        if (brush instanceof ShaderBrush) {
            ...
            paint.setShader(((ShaderBrush) brush).mo4353createShaderuvyYCjk(j));
            function0.invoke();
