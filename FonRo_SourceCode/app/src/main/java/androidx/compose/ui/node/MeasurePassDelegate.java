...
public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            ...
            outerCoordinator.mo5732measureBRTryo0(j);
        }
    };
    ...
    private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m7128getZeronOccac();
    private final Function0<Unit> placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.MeasurePassDelegate$placeOuterCoordinatorBlock$1
        ...
        public final void invoke2() {
            ...
            if (graphicsLayer != null) {
                ...
                placementScope2.m5811placeWithLayeraW9wM(outerCoordinator, j3, graphicsLayer, f3);
                return;
            }
            if (function1 == null) {
                ...
                placementScope2.m5802place70tqf50(outerCoordinator2, j2, f2);
                return;
            }
            ...
            placementScope2.m5810placeWithLayeraW9wM(outerCoordinator3, j, f, function1);
        }
    };
    ...
    public final Constraints m5947getLastConstraintsDWUhwKw() {
        if (this.measuredOnce) {
            return Constraints.m6929boximpl(getMeasurementConstraints());
        }
        return null;
    }
    ...
    public final void m5949performMeasureBRTryo0$ui_release(long constraints) {
    ...
    public Placeable mo5732measureBRTryo0(long constraints) {
        ...
        if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(getLayoutNode())) {
            ...
            lookaheadPassDelegate.mo5732measureBRTryo0(constraints);
        }
        trackMeasurementByParent(getLayoutNode());
        m5950remeasureBRTryo0(constraints);
        return this;
    }

    /* renamed from: remeasure-BRTryo0, reason: not valid java name */
    public final boolean m5950remeasureBRTryo0(long constraints) {
        ...
        if (getLayoutNode().getMeasurePending$ui_release() || !Constraints.m6935equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long mo5740getSizeYbymL2g = getOuterCoordinator().mo5740getSizeYbymL2g();
            m5795setMeasurementConstraintsBRTryo0(constraints);
            m5949performMeasureBRTryo0$ui_release(constraints);
            if (IntSize.m7158equalsimpl0(getOuterCoordinator().mo5740getSizeYbymL2g(), mo5740getSizeYbymL2g) && getOuterCoordinator().getWidth() == getWidth() && getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m5794setMeasuredSizeozmzZPI(IntSize.m7155constructorimpl((getOuterCoordinator().getHeight() & 4294967295L) | (getOuterCoordinator().getWidth() << 32)));
            return z;
        }
    ...
    public void mo5733placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m5946placeSelfMLgxB_4(position, zIndex, layerBlock, null);
    }
    ...
    public void mo5793placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
        m5946placeSelfMLgxB_4(position, zIndex, null, layer);
    }
    ...
    private final void m5946placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        Placeable.PlacementScope placementScope;
        this.isPlacedByParent = true;
        if (!IntOffset.m7116equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
        ...
        if (lookaheadPassDelegate != null && lookaheadPassDelegate.getNeedsToBePlacedInApproach()) {
            ...
            Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate2, IntOffset.m7117getXimpl(position), IntOffset.m7118getYimpl(position), 0.0f, 4, null);
        }
        ...
        m5945placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
    }

    /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
    private final void m5945placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
        if (getLayoutNode().getIsDeactivated()) {
        ...
        Owner requireOwner = LayoutNodeKt.requireOwner(getLayoutNode());
        requireOwner.getRectManager().m6223onLayoutPositionChanged70tqf50(getLayoutNode(), position, z);
        if (!this.layoutPending && getIsPlaced()) {
            getOuterCoordinator().m5984placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
    ...
    public final void replace() {
        ...
        try {
            ...
            try {
                measurePassDelegate.m5945placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
                if (isPlaced && !measurePassDelegate.onNodePlacedCalled && (parent$ui_release = measurePassDelegate.getLayoutNode().getParent$ui_release()) != null) {
                    LayoutNode.requestRelayout$ui_release$default(parent$ui_release, false, 1, null);
                }
    ...
    private final void onBeforeLayoutChildren() {
        ...
        for (int i = 0; i < size; i++) {
            LayoutNode layoutNode = layoutNodeArr[i];
            if (layoutNode.getMeasurePending$ui_release() && layoutNode.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m5905remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null)) {
                LayoutNode.requestRemeasure$ui_release$default(getLayoutNode(), false, false, false, 7, null);
            }
        }
    }
