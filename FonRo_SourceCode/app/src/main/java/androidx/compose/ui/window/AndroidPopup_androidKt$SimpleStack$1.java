...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (size == 1) {
            ...
            return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1.2
                {
                    super(1);
                }
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            ...
            i = Math.max(i, mo5732measureBRTryo02.getWidth());
            i2 = Math.max(i2, mo5732measureBRTryo02.getHeight());
