...
public final class Stroke extends DrawStyle {
    ...
    public static final class Companion {
        ...
        public final int m5006getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m5007getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4733equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4743equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4734hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4744hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return hashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m4735toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m4745toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
