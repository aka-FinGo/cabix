...
public final class RelativeLayoutBounds {
    ...
    public final long m6229getPositionInRootnOccac() {
        return IntOffset.m7111constructorimpl(this.topLeft);
    }

    /* renamed from: getPositionInWindow-nOcc-ac, reason: not valid java name */
    public final long m6231getPositionInWindownOccac() {
        int m7117getXimpl = IntOffset.m7117getXimpl(this.screenOffset) - IntOffset.m7117getXimpl(this.windowOffset);
        int m7118getYimpl = IntOffset.m7118getYimpl(this.screenOffset) - IntOffset.m7118getYimpl(this.windowOffset);
        long j = this.topLeft;
        return IntOffset.m7111constructorimpl(((((int) (j >> 32)) + m7117getXimpl) << 32) | ((((int) j) + m7118getYimpl) & 4294967295L));
    }

    /* renamed from: getPositionInScreen-nOcc-ac, reason: not valid java name */
    public final long m6230getPositionInScreennOccac() {
        int m7117getXimpl = IntOffset.m7117getXimpl(this.screenOffset);
        int m7118getYimpl = IntOffset.m7118getYimpl(this.screenOffset);
        long j = this.topLeft;
        return IntOffset.m7111constructorimpl(((((int) (j >> 32)) + m7117getXimpl) << 32) | ((((int) j) + m7118getYimpl) & 4294967295L));
    }
    ...
    public final IntRect getBoundsInWindow() {
        ...
        if (fArr != null) {
            return IntRectKt.roundToIntRect(Matrix.m4621mapimpl(fArr, new Rect(i, i2, i3, i4)));
        }
        int m7117getXimpl = IntOffset.m7117getXimpl(this.screenOffset) - IntOffset.m7117getXimpl(this.windowOffset);
        int m7118getYimpl = IntOffset.m7118getYimpl(this.screenOffset) - IntOffset.m7118getYimpl(this.windowOffset);
        return new IntRect(i + m7117getXimpl, i2 + m7118getYimpl, i3 + m7117getXimpl, i4 + m7118getYimpl);
    }
    ...
    public final IntRect getBoundsInScreen() {
        if (this.viewToWindowMatrix != null) {
            ...
            return new IntRect(boundsInWindow.getLeft() + IntOffset.m7117getXimpl(j), boundsInWindow.getTop() + IntOffset.m7118getYimpl(j), boundsInWindow.getRight() + IntOffset.m7117getXimpl(j), boundsInWindow.getBottom() + IntOffset.m7118getYimpl(j));
        }
        ...
        int m7117getXimpl = IntOffset.m7117getXimpl(this.screenOffset);
        int m7118getYimpl = IntOffset.m7118getYimpl(this.screenOffset);
        return new IntRect(i + m7117getXimpl, ((int) j2) + m7118getYimpl, i2 + m7117getXimpl, i3 + m7118getYimpl);
    }
