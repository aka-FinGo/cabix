...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m4472getAutoNrFUSI();
    ...
    public void mo6129setCompositingStrategyaDBOjCE(int i) {
        ...
        } else if (CompositingStrategy.m4468equalsimpl0(i, CompositingStrategy.INSTANCE.m4473getModulateAlphaNrFUSI())) {
