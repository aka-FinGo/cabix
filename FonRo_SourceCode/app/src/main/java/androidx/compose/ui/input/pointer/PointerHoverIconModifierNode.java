...
public final class PointerHoverIconModifierNode extends HoverIconModifierNode {
    ...
    public boolean mo5534isRelevantPointerTypeuerMTgs(int pointerType) {
        return (PointerType.m5678equalsimpl0(pointerType, PointerType.INSTANCE.m5684getStylusT8wyACA()) || PointerType.m5678equalsimpl0(pointerType, PointerType.INSTANCE.m5682getEraserT8wyACA())) ? false : true;
    }
