...
public final class AutofillCallback extends AutofillManager$AutofillCallback {
    ...
    public final void register(AndroidAutofill autofill) {
        autofill.getAutofillManager().registerCallback(Listener$$ExternalSyntheticApiModelOutline0.m3010m((Object) this));
    }

    public final void unregister(AndroidAutofill autofill) {
        autofill.getAutofillManager().unregisterCallback(Listener$$ExternalSyntheticApiModelOutline0.m3010m((Object) this));
    }
}
