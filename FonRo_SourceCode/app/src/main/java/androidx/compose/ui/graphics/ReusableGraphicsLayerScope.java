...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.INSTANCE.m4472getAutoNrFUSI();
    private long size = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
    ...
    public void mo4573setAmbientShadowColor8_81llA(long j) {
        if (Color.m4385equalsimpl0(this.ambientShadowColor, j)) {
            return;
        }
    ...
    public void mo4575setSpotShadowColor8_81llA(long j) {
        if (Color.m4385equalsimpl0(this.spotShadowColor, j)) {
            return;
        }
    ...
    public void mo4576setTransformOrigin__ExYCQ(long j) {
        if (TransformOrigin.m4769equalsimpl0(this.transformOrigin, j)) {
            return;
        }
    ...
    public void mo4574setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m4468equalsimpl0(this.compositingStrategy, i)) {
            return;
        }
    ...
    public void m4696setSizeuvyYCjk(long j) {
        this.size = j;
    }
    ...
    public final void reset() {
        ...
        mo4573setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo4575setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo4576setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m4775getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo4574setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m4472getAutoNrFUSI());
        m4696setSizeuvyYCjk(Size.INSTANCE.m4202getUnspecifiedNHjbRc());
        this.outline = null;
        this.mutatedFields = 0;
    }

    public final void updateOutline$ui_release() {
        this.outline = getShape().mo614createOutlinePq9zytI(getSize(), this.layoutDirection, this.graphicsDensity);
    }
}
