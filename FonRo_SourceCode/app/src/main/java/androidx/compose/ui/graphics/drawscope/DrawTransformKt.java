...
public final class DrawTransformKt {
    ...
    public static /* synthetic */ void m5001rotateRad0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo4860getCenterF1C5BW0();
        }
        drawTransform.mo4862rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: rotateRad-0AR0LA0, reason: not valid java name */
    public static final void m5000rotateRad0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo4862rotateUv8p0NA(DegreesKt.degrees(f), j);
    }

    /* renamed from: scale-0AR0LA0, reason: not valid java name */
    public static final void m5002scale0AR0LA0(DrawTransform drawTransform, float f, long j) {
        drawTransform.mo4863scale0AR0LA0(f, f, j);
    }

    /* renamed from: scale-0AR0LA0$default, reason: not valid java name */
    public static /* synthetic */ void m5003scale0AR0LA0$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawTransform.mo4860getCenterF1C5BW0();
        }
        drawTransform.mo4863scale0AR0LA0(f, f, j);
