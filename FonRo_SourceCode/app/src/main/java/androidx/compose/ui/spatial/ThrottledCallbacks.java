...
public final class ThrottledCallbacks {
    ...
    private long windowOffset = IntOffset.INSTANCE.m7128getZeronOccac();
    private long screenOffset = IntOffset.INSTANCE.m7128getZeronOccac();
    ...
    public final class Entry implements DelegatableNode.RegistrationHandle {
        ...
        public final void m6241fire9b9wPM(long topLeft, long bottomRight, long windowOffset, long screenOffset, float[] viewToWindowMatrix) {
            RelativeLayoutBounds m6242rectInfoForQMZNJw = ThrottledCallbacksKt.m6242rectInfoForQMZNJw(this.node, topLeft, bottomRight, windowOffset, screenOffset, viewToWindowMatrix);
            if (m6242rectInfoForQMZNJw == null) {
                return;
            }
            this.callback.invoke(m6242rectInfoForQMZNJw);
        }
    }
    ...
    public final void m6239setWindowOffsetgyyYBs(long j) {
        this.windowOffset = j;
    }
    ...
    public final void m6237setScreenOffsetgyyYBs(long j) {
        this.screenOffset = j;
    }
    ...
    public final void m6238setViewToWindowMatrixQ8lPUPs(float[] fArr) {
        this.viewToWindowMatrix = fArr;
    }

    /* renamed from: updateOffsets-bT0EZQs, reason: not valid java name */
    public final boolean m6240updateOffsetsbT0EZQs(long screen, long window, float[] matrix) {
        boolean z;
        if (IntOffset.m7116equalsimpl0(window, this.windowOffset)) {
            z = false;
        } else {
            this.windowOffset = window;
            z = true;
        }
        if (!IntOffset.m7116equalsimpl0(screen, this.screenOffset)) {
                ...
                while (i3 < i2) {
                    if ((j4 & 255) < 128) {
                        ...
                        while (entry != null) {
                            int i4 = i3;
                            Entry entry2 = entry;
                            throttledCallbacks.m6233fireWY9HvpM(entry2, j, j2, fArr, currentMillis);
    ...
    public final void fireGlobalChangeEntries(long currentMillis) {
        ...
        if (entry != null) {
            for (Entry entry2 = entry; entry2 != null; entry2 = entry2.getNext()) {
                ...
                entry2.setBottomRight(((IntOffset.m7117getXimpl(offsetFromRoot) + ((int) (lastSize >> 32))) << 32) | ((IntOffset.m7118getYimpl(offsetFromRoot) + ((int) (lastSize & 4294967295L))) & 4294967295L));
                m6233fireWY9HvpM(entry2, j, j2, fArr, currentMillis);
            }
        }
    }
    ...
    public final void triggerDebounced(long currentMillis) {
                    ...
                    while (i4 < i3) {
                        if ((j6 & 255) < 128) {
                            ...
                            while (entry != null) {
                                int i5 = i2;
                                Entry entry2 = entry;
                                j2 = m6232debounceEntryb8qMvQI(entry2, j3, j4, fArr, currentMillis, j2);
                                i4 = i4;
                                entry = entry2.getNext();
                                i2 = i5;
                            }
        ...
        if (entry3 != null) {
            long j7 = j2;
            while (entry3 != null) {
                j7 = m6232debounceEntryb8qMvQI(entry3, j3, j4, fArr, currentMillis, j7);
    ...
    private final void fireWithUpdatedRect(Entry entry, long topLeft, long bottomRight, long currentMillis) {
        ...
        if (z2 && z) {
            ...
            entry.m6241fire9b9wPM(topLeft, bottomRight, this.windowOffset, this.screenOffset, this.viewToWindowMatrix);
        } else {
            if (z3) {
                return;
            }
    ...
    private final void m6233fireWY9HvpM(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis) {
        boolean z = currentMillis - entry.getLastInvokeMillis() > entry.getThrottleMillis();
        boolean z2 = entry.getDebounceMillis() == 0;
        entry.setLastUninvokedFireMillis(currentMillis);
        if (z && z2) {
            entry.setLastInvokeMillis(currentMillis);
            entry.m6241fire9b9wPM(entry.getTopLeft(), entry.getBottomRight(), windowOffset, screenOffset, viewToWindowMatrix);
        }
        if (z2) {
            return;
        }
    ...
    private final long m6232debounceEntryb8qMvQI(Entry entry, long windowOffset, long screenOffset, float[] viewToWindowMatrix, long currentMillis, long minDeadline) {
