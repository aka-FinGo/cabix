...
public final /* data */ class ParagraphInfo {
    ...
    public final Rect toGlobal(Rect rect) {
        float f = this.top;
        return rect.m4162translatek4lQ0M(Offset.m4117constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
    }
    ...
    public final Path toGlobal(Path path) {
        float f = this.top;
        path.mo4261translatek4lQ0M(Offset.m4117constructorimpl((Float.floatToRawIntBits(0.0f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L)));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m6299toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m6300toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m6300toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m6428equalsimpl0(j, TextRange.INSTANCE.m6440getZerod9O1mEE())) {
            return TextRange.INSTANCE.m6440getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m6435getStartimpl(j)), toGlobalIndex(TextRange.m6430getEndimpl(j)));
    }

    /* renamed from: toLocal-MK-Hz9U, reason: not valid java name */
    public final long m6301toLocalMKHz9U(long j) {
