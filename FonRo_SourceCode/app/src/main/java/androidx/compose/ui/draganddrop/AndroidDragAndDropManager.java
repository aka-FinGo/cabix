...
public final class AndroidDragAndDropManager implements View.OnDragListener, DragAndDropManager {
    ...
    public void mo3961requestDragAndDropTransferUv8p0NA(DragAndDropNode node, long offset) {
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        node.m3967startDragAndDropTransferd4ec7I(new DragAndDropStartTransferScope() { // from class: androidx.compose.ui.draganddrop.AndroidDragAndDropManager$requestDragAndDropTransfer$dragAndDropSourceScope$1
            ...
            public boolean mo3962startDragAndDropTransfer12SF9DM(DragAndDropTransferData transferData, long decorationSize, Function1<? super DrawScope, Unit> drawDragDecoration) {
                Function3 function3;
                Ref.BooleanRef booleanRef2 = Ref.BooleanRef.this;
                function3 = this.startDrag;
                booleanRef2.element = ((Boolean) function3.invoke(transferData, Size.m4182boximpl(decorationSize), drawDragDecoration)).booleanValue();
