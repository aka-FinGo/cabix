...
public final class PointerIdArray {
    ...
    public final long m5700get_I2yYro(int index) {
        return PointerId.m5587constructorimpl(this.internalArray[index]);
    }

    /* renamed from: remove-0FcD4WY, reason: not valid java name */
    public final boolean m5701remove0FcD4WY(long pointerId) {
    ...
    public final boolean m5698add0FcD4WY(long pointerId) {
    ...
    public final void m5702setDmW0f2w(int index, long pointerId) {
        set(index, pointerId);
    }
    ...
    public final boolean m5699contains0FcD4WY(long pointerId) {
