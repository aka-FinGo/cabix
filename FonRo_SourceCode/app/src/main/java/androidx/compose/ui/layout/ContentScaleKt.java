...
public final class ContentScaleKt {
    ...
    public static final float m5730computeFillMinDimensioniLBOSCw(long j, long j2) {
    ...
    private static final float m5731computeFillWidthiLBOSCw(long j, long j2) {
        return Float.intBitsToFloat((int) (j2 >> 32)) / Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: computeFillHeight-iLBOSCw, reason: not valid java name */
    private static final float m5728computeFillHeightiLBOSCw(long j, long j2) {
