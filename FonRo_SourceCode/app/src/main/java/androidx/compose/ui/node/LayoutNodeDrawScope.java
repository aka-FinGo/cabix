...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void mo4832drawArcillE91I(Brush brush, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4832drawArcillE91I(brush, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4833drawArcyD3GUKo(long color, float startAngle, float sweepAngle, boolean useCenter, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4833drawArcyD3GUKo(color, startAngle, sweepAngle, useCenter, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4834drawCircleV9BoPsw(Brush brush, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4834drawCircleV9BoPsw(brush, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4835drawCircleVaOC9Bg(long color, float radius, long center, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4835drawCircleVaOC9Bg(color, radius, center, alpha, style, colorFilter, blendMode);
    }
    ...
    public /* synthetic */ void mo4836drawImage9jGpkUE(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4836drawImage9jGpkUE(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4837drawImageAZ2fEMs(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode, int filterQuality) {
        this.canvasDrawScope.mo4837drawImageAZ2fEMs(image, srcOffset, srcSize, dstOffset, dstSize, alpha, style, colorFilter, blendMode, filterQuality);
    }
    ...
    public void mo4838drawImagegbVJVH8(ImageBitmap image, long topLeft, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4838drawImagegbVJVH8(image, topLeft, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4839drawLine1RTmtNc(Brush brush, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4839drawLine1RTmtNc(brush, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4840drawLineNGM6Ib0(long color, long start, long end, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4840drawLineNGM6Ib0(color, start, end, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4841drawOvalAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4841drawOvalAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4842drawOvalnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4842drawOvalnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4843drawPathGBMwjPU(Path path, Brush brush, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4843drawPathGBMwjPU(path, brush, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4844drawPathLG529CI(Path path, long color, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4844drawPathLG529CI(path, color, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4845drawPointsF8ZwMP8(List<Offset> points, int pointMode, long color, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4845drawPointsF8ZwMP8(points, pointMode, color, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4846drawPointsGsft0Ws(List<Offset> points, int pointMode, Brush brush, float strokeWidth, int cap, PathEffect pathEffect, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4846drawPointsGsft0Ws(points, pointMode, brush, strokeWidth, cap, pathEffect, alpha, colorFilter, blendMode);
    }
    ...
    public void mo4847drawRectAsUm42w(Brush brush, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4847drawRectAsUm42w(brush, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4848drawRectnJ9OG0(long color, long topLeft, long size, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4848drawRectnJ9OG0(color, topLeft, size, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4849drawRoundRectZuiqVtQ(Brush brush, long topLeft, long size, long cornerRadius, float alpha, DrawStyle style, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4849drawRoundRectZuiqVtQ(brush, topLeft, size, cornerRadius, alpha, style, colorFilter, blendMode);
    }
    ...
    public void mo4850drawRoundRectuAw5IA(long color, long topLeft, long size, long cornerRadius, DrawStyle style, float alpha, ColorFilter colorFilter, int blendMode) {
        this.canvasDrawScope.mo4850drawRoundRectuAw5IA(color, topLeft, size, cornerRadius, style, alpha, colorFilter, blendMode);
    }

    @Override // androidx.compose.ui.graphics.drawscope.DrawScope
    /* renamed from: getCenter-F1C5BW0 */
    public long mo4934getCenterF1C5BW0() {
        return this.canvasDrawScope.mo4934getCenterF1C5BW0();
    }
    ...
    public long mo4935getSizeNHjbRc() {
        return this.canvasDrawScope.mo4935getSizeNHjbRc();
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx--R2X_6o */
    public int mo693roundToPxR2X_6o(long j) {
        return this.canvasDrawScope.mo693roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo694roundToPx0680j_4(float f) {
        return this.canvasDrawScope.mo694roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toDp-GaN1DYA */
    public float mo695toDpGaN1DYA(long j) {
        return this.canvasDrawScope.mo695toDpGaN1DYA(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo696toDpu2uoSUM(float f) {
        return this.canvasDrawScope.mo696toDpu2uoSUM(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo697toDpu2uoSUM(int i) {
        return this.canvasDrawScope.mo697toDpu2uoSUM(i);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo698toDpSizekrfVVM(long j) {
        return this.canvasDrawScope.mo698toDpSizekrfVVM(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo699toPxR2X_6o(long j) {
        return this.canvasDrawScope.mo699toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo700toPx0680j_4(float f) {
        return this.canvasDrawScope.mo700toPx0680j_4(f);
    }
    ...
    public long mo701toSizeXkaWNTQ(long j) {
        return this.canvasDrawScope.mo701toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.ui.unit.FontScaling
    /* renamed from: toSp-0xMU5do */
    public long mo702toSp0xMU5do(float f) {
        return this.canvasDrawScope.mo702toSp0xMU5do(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo703toSpkPz2Gy4(float f) {
        return this.canvasDrawScope.mo703toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo704toSpkPz2Gy4(int i) {
        return this.canvasDrawScope.mo704toSpkPz2Gy4(i);
    }
    ...
    public void drawContent() {
        ...
        if (drawModifierNode != null) {
            ...
            if (nextDrawNode == 0) {
                NodeCoordinator m5854requireCoordinator64DMado = DelegatableNodeKt.m5854requireCoordinator64DMado(drawModifierNode2, NodeKind.m5994constructorimpl(4));
                if (m5854requireCoordinator64DMado.getTail() == drawModifierNode.getNode()) {
                    m5854requireCoordinator64DMado = m5854requireCoordinator64DMado.getWrapped();
                    Intrinsics.checkNotNull(m5854requireCoordinator64DMado);
                }
                m5854requireCoordinator64DMado.performDraw(canvas, getDrawContext().getGraphicsLayer());
                return;
            }
            ...
            while (nextDrawNode != 0) {
                ...
                } else if ((nextDrawNode.getKindSet() & m5994constructorimpl) != 0 && (nextDrawNode instanceof DelegatingNode)) {
    ...
    public void mo4936recordJVtK1S4(GraphicsLayer graphicsLayer, long j, final Function1<? super DrawScope, Unit> function1) {
        final DrawModifierNode drawModifierNode = this.drawNode;
        graphicsLayer.m5029recordmLhObY(this, getLayoutDirection(), j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.node.LayoutNodeDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                try {
                    ...
                    long mo4856getSizeNHjbRc2 = layoutNodeDrawScope.getDrawContext().mo4856getSizeNHjbRc();
                    ...
                    try {
                        ...
                        r2.setCanvas(canvas);
                        r2.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
                        ...
                        try {
                            ...
                            drawContext.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc2);
    ...
    public final void performDraw(DrawModifierNode drawModifierNode, Canvas canvas, GraphicsLayer graphicsLayer) {
        NodeCoordinator m5854requireCoordinator64DMado = DelegatableNodeKt.m5854requireCoordinator64DMado(drawModifierNode, NodeKind.m5994constructorimpl(4));
        m5854requireCoordinator64DMado.getLayoutNode().getMDrawScope$ui_release().m5923drawDirecteZhPAX0$ui_release(canvas, IntSizeKt.m7172toSizeozmzZPI(m5854requireCoordinator64DMado.mo5740getSizeYbymL2g()), m5854requireCoordinator64DMado, drawModifierNode, graphicsLayer);
    }

    /* renamed from: drawDirect-eZhPAX0$ui_release, reason: not valid java name */
    public final void m5923drawDirecteZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, DrawModifierNode drawNode, GraphicsLayer layer) {
        DrawModifierNode drawModifierNode = this.drawNode;
        ...
        long mo4856getSizeNHjbRc = canvasDrawScope.getDrawContext().mo4856getSizeNHjbRc();
        ...
        drawContext.mo4857setSizeuvyYCjk(size);
        ...
        try {
            ...
            drawContext2.setLayoutDirection(layoutDirection2);
            drawContext2.setCanvas(canvas2);
            drawContext2.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
            ...
            drawContext3.mo4857setSizeuvyYCjk(mo4856getSizeNHjbRc);
    ...
    public final void m5922draweZhPAX0$ui_release(Canvas canvas, long size, NodeCoordinator coordinator, Modifier.Node drawNode, GraphicsLayer layer) {
        int m5994constructorimpl = NodeKind.m5994constructorimpl(4);
        DelegatingNode delegatingNode = drawNode;
        MutableVector mutableVector = null;
        while (delegatingNode != 0) {
            if (delegatingNode instanceof DrawModifierNode) {
                m5923drawDirecteZhPAX0$ui_release(canvas, size, coordinator, delegatingNode, layer);
