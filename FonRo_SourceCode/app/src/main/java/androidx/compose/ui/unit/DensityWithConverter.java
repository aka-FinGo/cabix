...
public final /* data */ class DensityWithConverter implements Density {
    ...
    public float mo695toDpGaN1DYA(long j) {
        ...
        return Dp.m6989constructorimpl(this.converter.convertSpToDp(TextUnit.m7183getValueimpl(j)));
    }
}
