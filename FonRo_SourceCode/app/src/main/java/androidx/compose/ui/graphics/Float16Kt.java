...
public final class Float16Kt {
    ...
    public static final short m4530minAoSsdG0(short s, short s2) {
        if (Float16.m4502isNaNimpl(s) || Float16.m4502isNaNimpl(s2)) {
            return Float16.Companion.m4524getNaNslo4al4();
        }
        return Float16.m4489compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4529maxAoSsdG0(short s, short s2) {
        if (Float16.m4502isNaNimpl(s) || Float16.m4502isNaNimpl(s2)) {
            return Float16.Companion.m4524getNaNslo4al4();
        }
        return Float16.m4489compareTo41bOqos(s, s2) >= 0 ? s : s2;
