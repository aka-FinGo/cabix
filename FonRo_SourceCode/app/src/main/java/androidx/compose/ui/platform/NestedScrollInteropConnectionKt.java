...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final int m6171toViewTypeGyEprt8(int i) {
        return !NestedScrollSource.m5488equalsimpl0(i, NestedScrollSource.INSTANCE.m5500getUserInputWNlRxjI()) ? 1 : 0;
    }
    ...
    public static final long m6170toOffsetUv8p0NA(int[] iArr, long j) {
        float coerceAtLeast;
        ...
        return Offset.m4117constructorimpl((Float.floatToRawIntBits(coerceAtLeast) << 32) | (Float.floatToRawIntBits(coerceAtLeast2) & 4294967295L));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: getScrollAxes-k-4lQ0M, reason: not valid java name */
    public static final int m6169getScrollAxesk4lQ0M(long j) {
