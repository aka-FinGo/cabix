...
public abstract class AlignmentLines {
    ...
    protected abstract long mo5839calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        long m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
        while (true) {
            m4117constructorimpl = mo5839calculatePositionInParentR5De75A(initialCoordinator, m4117constructorimpl);
            ...
            if (getAlignmentLinesMap(initialCoordinator).containsKey(alignmentLine)) {
                ...
                m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(positionFor) << 32) | (Float.floatToRawIntBits(positionFor) & 4294967295L));
            }
        }
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            intBitsToFloat = Float.intBitsToFloat((int) (m4117constructorimpl & 4294967295L));
        } else {
            intBitsToFloat = Float.intBitsToFloat((int) (m4117constructorimpl >> 32));
        }
