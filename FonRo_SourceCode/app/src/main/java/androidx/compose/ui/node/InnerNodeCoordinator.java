...
public final class InnerNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateImpl extends LookaheadDelegate {
        ...
        public Placeable mo5732measureBRTryo0(long constraints) {
            ...
            LookaheadDelegate.m5928access$setMeasurementConstraintsBRTryo0(lookaheadDelegateImpl, constraints);
            ...
            LookaheadDelegate.access$set_measureResult(lookaheadDelegateImpl, getLayoutNode().getMeasurePolicy().mo356measure3p2s80s(this, getLayoutNode().getChildLookaheadMeasurables$ui_release(), constraints));
    ...
    public Placeable mo5732measureBRTryo0(long constraints) {
        if (getForceMeasureWithLookaheadConstraints()) {
            ...
            constraints = lookaheadDelegate.m5930getConstraintsmsEJaDk$ui_release();
        }
        ...
        setMeasureResult$ui_release(getLayoutNode().getMeasurePolicy().mo356measure3p2s80s(this, getLayoutNode().getChildMeasurables$ui_release(), constraints));
        onMeasured();
        return this;
    }
    ...
    public void mo5898hitTestChildqzLsGqo(NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        ...
        if (hitTestSource.shouldHitTestChildren(getLayoutNode())) {
            if (!m5988withinLayerBoundsk4lQ0M(pointerPosition)) {
                if (PointerType.m5678equalsimpl0(pointerType, PointerType.INSTANCE.m5685getTouchT8wyACA()) && (Float.floatToRawIntBits(m5976distanceInMinimumTouchTargettz77jQw(pointerPosition, m5979getMinimumTouchTargetSizeNHjbRc())) & Integer.MAX_VALUE) < 2139095040) {
                    isInLayer = false;
                }
            }
            z = true;
        ...
        if (z) {
            ...
            while (size >= 0) {
                ...
                if (layoutNode.isPlaced()) {
                    ...
                    hitTestSource2.mo5989childHitTestqzLsGqo(layoutNode, pointerPosition, hitTestResult, pointerType, isInLayer);
    ...
    /* compiled from: InnerNodeCoordinator.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/node/InnerNodeCoordinator$Companion;", "", "()V", "innerBoundsPaint", "Landroidx/compose/ui/graphics/Paint;", "getInnerBoundsPaint", "()Landroidx/compose/ui/graphics/Paint;", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    static {
        ...
        Paint.mo4245setColor8_81llA(Color.INSTANCE.m4418getRed0d7_KjU());
