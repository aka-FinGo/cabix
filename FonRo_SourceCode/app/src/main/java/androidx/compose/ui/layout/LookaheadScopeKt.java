...
public final class LookaheadScopeKt {
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if (startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            Updater.m3812initimpl(m3808constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m3815setimpl(m3808constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
    ...
    public static final long m5761localLookaheadPositionOfFgt4K4Q(LookaheadScope lookaheadScope, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
        ...
        if (lookaheadCoordinates instanceof LookaheadLayoutCoordinates) {
            return lookaheadCoordinates.mo5742localPositionOfS_NoaFU(lookaheadCoordinates2, j, z);
        }
        if (!(lookaheadCoordinates2 instanceof LookaheadLayoutCoordinates)) {
            return lookaheadCoordinates.mo5742localPositionOfS_NoaFU(lookaheadCoordinates, j, z);
        }
        return Offset.m4117constructorimpl(lookaheadCoordinates2.mo5742localPositionOfS_NoaFU(lookaheadCoordinates, j, z) ^ (-9223372034707292160L));
    }
}
