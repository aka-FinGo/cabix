...
public final class GraphicsLayer {
    ...
    private long roundRectOutlineTopLeft = Offset.INSTANCE.m4141getZeroF1C5BW0();
    private long roundRectOutlineSize = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
    ...
    public GraphicsLayer(GraphicsLayerImpl graphicsLayerImpl, LayerManager layerManager) {
        ...
        this.topLeft = IntOffset.INSTANCE.m7128getZeronOccac();
        this.size = IntSize.INSTANCE.m7165getZeroYbymL2g();
        this.pivotOffset = Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
    }
    ...
    public final int m5024getCompositingStrategyke2Ky5w() {
        return this.impl.getCompositingStrategy();
    }

    /* renamed from: setCompositingStrategy-Wpw9cng, reason: not valid java name */
    public final void m5032setCompositingStrategyWpw9cng(int i) {
        if (CompositingStrategy.m5011equalsimpl0(this.impl.getCompositingStrategy(), i)) {
            return;
        }
        this.impl.mo5045setCompositingStrategyWpw9cng(i);
    }
    ...
    public final void m5037setTopLeftgyyYBs(long j) {
        if (IntOffset.m7116equalsimpl0(this.topLeft, j)) {
            return;
        }
        this.topLeft = j;
        m5018setPositionVbeCjmY(j, this.size);
    }
    ...
    private final void m5021setSizeozmzZPI(long j) {
        if (IntSize.m7158equalsimpl0(this.size, j)) {
            return;
        }
        this.size = j;
        m5018setPositionVbeCjmY(this.topLeft, j);
    ...
    public final int m5023getBlendMode0nO6VwU() {
        return this.impl.getBlendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m5031setBlendModes9anfk8(int i) {
        if (BlendMode.m4295equalsimpl0(this.impl.getBlendMode(), i)) {
            return;
        }
        this.impl.mo5044setBlendModes9anfk8(i);
    }
    ...
    public final void m5033setPivotOffsetk4lQ0M(long j) {
        if (Offset.m4122equalsimpl0(this.pivotOffset, j)) {
            return;
        }
        this.pivotOffset = j;
        this.impl.mo5047setPivotOffsetk4lQ0M(j);
    }
    ...
    public static /* synthetic */ void m5020setRoundRectOutlineTNW_H78$default(GraphicsLayer graphicsLayer, long j, long j2, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Offset.INSTANCE.m4141getZeroF1C5BW0();
        }
        long j3 = j;
        if ((i & 2) != 0) {
            j2 = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
        }
        long j4 = j2;
        if ((i & 4) != 0) {
            f = 0.0f;
        }
        graphicsLayer.m5035setRoundRectOutlineTNW_H78(j3, j4, f);
    }
    ...
    public static /* synthetic */ void m5019setRectOutlinetz77jQw$default(GraphicsLayer graphicsLayer, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Offset.INSTANCE.m4141getZeroF1C5BW0();
        }
        if ((i & 2) != 0) {
        ...
        graphicsLayer.m5034setRectOutlinetz77jQw(j, j2);
    }
    ...
    private final void m5018setPositionVbeCjmY(long topLeft, long size) {
        this.impl.mo5048setPositionH0pRuoY(IntOffset.m7117getXimpl(topLeft), IntOffset.m7118getYimpl(topLeft), size);
    }

    /* renamed from: record-mL-hObY, reason: not valid java name */
    public final void m5029recordmLhObY(Density density, LayoutDirection layoutDirection, long size, Function1<? super DrawScope, Unit> block) {
        m5021setSizeozmzZPI(size);
    ...
    private final void transformCanvas(Canvas androidCanvas) {
        Canvas canvas;
        float m7117getXimpl = IntOffset.m7117getXimpl(this.topLeft);
        float m7118getYimpl = IntOffset.m7118getYimpl(this.topLeft);
        float m7117getXimpl2 = IntOffset.m7117getXimpl(this.topLeft) + ((int) (this.size >> 32));
        float m7118getYimpl2 = IntOffset.m7118getYimpl(this.topLeft) + ((int) (this.size & 4294967295L));
        float alpha = getAlpha();
        ColorFilter colorFilter = getColorFilter();
        int m5023getBlendMode0nO6VwU = m5023getBlendMode0nO6VwU();
        if (alpha < 1.0f || !BlendMode.m4295equalsimpl0(m5023getBlendMode0nO6VwU, BlendMode.INSTANCE.m4326getSrcOver0nO6VwU()) || colorFilter != null || CompositingStrategy.m5011equalsimpl0(m5024getCompositingStrategyke2Ky5w(), CompositingStrategy.INSTANCE.m5017getOffscreenke2Ky5w())) {
            ...
            paint.mo4244setBlendModes9anfk8(m5023getBlendMode0nO6VwU);
            paint.setColorFilter(colorFilter);
            canvas = androidCanvas;
            canvas.saveLayer(m7117getXimpl, m7118getYimpl, m7117getXimpl2, m7118getYimpl2, paint.getInternalPaint());
        } else {
            androidCanvas.save();
            canvas = androidCanvas;
        }
    ...
    public final void draw$ui_graphics_release(androidx.compose.ui.graphics.Canvas canvas, GraphicsLayer parentLayer) {
        ...
        if (z4) {
            ...
            if (outline instanceof Outline.Rectangle) {
                androidx.compose.ui.graphics.Canvas.m4357clipRectmtrdDE$default(canvas, outline.getRect(), 0, 2, null);
                ...
                androidx.compose.ui.graphics.Canvas.m4355clipPathmtrdDE$default(canvas, path, 0, 2, null);
            } else if (outline instanceof Outline.Generic) {
                androidx.compose.ui.graphics.Canvas.m4355clipPathmtrdDE$default(canvas, ((Outline.Generic) outline).getPath(), 0, 2, null);
            }
        }
        if (parentLayer != null) {
        ...
        if (AndroidCanvas_androidKt.getNativeCanvas(canvas).isHardwareAccelerated() || this.impl.getSupportsSoftwareRendering()) {
            ...
            long m7172toSizeozmzZPI = IntSizeKt.m7172toSizeozmzZPI(this.size);
            ...
            long mo4856getSizeNHjbRc = canvasDrawScope2.getDrawContext().mo4856getSizeNHjbRc();
            z = z3;
            ...
            drawContext.mo4857setSizeuvyYCjk(m7172toSizeozmzZPI);
    ...
    private final void configureOutlineAndClip() {
        if (this.outlineDirty) {
            ...
            if (!this.clip && getShadowElevation() <= 0.0f) {
                ...
                this.impl.mo5046setOutlineO0kMr_c(null, IntSize.INSTANCE.m7165getZeroYbymL2g());
            } else {
                ...
                if (path != null) {
                    ...
                    if (path instanceof AndroidPath) {
                        ...
                        this.impl.mo5046setOutlineO0kMr_c(outline, IntSize.m7155constructorimpl((4294967295L & Math.round(obtainPathBounds.height())) | (Math.round(obtainPathBounds.width()) << 32)));
                    ...
                    this.impl.setClip(this.clip);
                    Size.INSTANCE.m4203getZeroNHjbRc();
                    ...
                    long j3 = j2 == InlineClassHelperKt.UnspecifiedPackedFloats ? m7172toSizeozmzZPI : j2;
                    int i = (int) (j >> 32);
                    ...
                    this.impl.mo5046setOutlineO0kMr_c(obtainAndroidOutline, IntSizeKt.m7168roundToIntSizeuvyYCjk(j3));
                }
            }
        }
    ...
    private final <T> T resolveOutlinePosition(Function2<? super Offset, ? super Size, ? extends T> block) {
        ...
        if (j2 != InlineClassHelperKt.UnspecifiedPackedFloats) {
            m7172toSizeozmzZPI = j2;
        }
        return block.invoke(Offset.m4114boximpl(j), Size.m4182boximpl(m7172toSizeozmzZPI));
    }
    ...
    public final androidx.compose.ui.graphics.Outline getOutline() {
        ...
        float intBitsToFloat3 = Float.intBitsToFloat((int) (m7172toSizeozmzZPI >> 32)) + intBitsToFloat;
        float intBitsToFloat4 = intBitsToFloat2 + Float.intBitsToFloat((int) (m7172toSizeozmzZPI & 4294967295L));
        if (this.roundRectCornerRadius <= 0.0f) {
            ...
            rectangle = new Outline.Rounded(RoundRectKt.m4179RoundRectgG7oq9Y(intBitsToFloat, intBitsToFloat2, intBitsToFloat3, intBitsToFloat4, CornerRadius.m4079constructorimpl((Float.floatToRawIntBits(r0) << 32) | (4294967295L & Float.floatToRawIntBits(r0)))));
        }
    ...
    private final void resetOutlineParams() {
        ...
        this.roundRectOutlineSize = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
        this.roundRectOutlineTopLeft = Offset.INSTANCE.m4141getZeroF1C5BW0();
    ...
    public final void m5035setRoundRectOutlineTNW_H78(long topLeft, long size, float cornerRadius) {
        if (Offset.m4122equalsimpl0(this.roundRectOutlineTopLeft, topLeft) && Size.m4190equalsimpl0(this.roundRectOutlineSize, size) && this.roundRectCornerRadius == cornerRadius && this.outlinePath == null) {
            return;
        }
        resetOutlineParams();
    ...
    public final void m5034setRectOutlinetz77jQw(long topLeft, long size) {
        m5035setRoundRectOutlineTNW_H78(topLeft, size, 0.0f);
    }

    /* renamed from: getAmbientShadowColor-0d7_KjU, reason: not valid java name */
    public final long m5022getAmbientShadowColor0d7_KjU() {
        return this.impl.getAmbientShadowColor();
    }

    /* renamed from: setAmbientShadowColor-8_81llA, reason: not valid java name */
    public final void m5030setAmbientShadowColor8_81llA(long j) {
        if (Color.m4385equalsimpl0(j, this.impl.getAmbientShadowColor())) {
            return;
        }
        this.impl.mo5043setAmbientShadowColor8_81llA(j);
    }

    /* renamed from: getSpotShadowColor-0d7_KjU, reason: not valid java name */
    public final long m5027getSpotShadowColor0d7_KjU() {
        return this.impl.getSpotShadowColor();
    }

    /* renamed from: setSpotShadowColor-8_81llA, reason: not valid java name */
    public final void m5036setSpotShadowColor8_81llA(long j) {
        if (Color.m4385equalsimpl0(j, this.impl.getSpotShadowColor())) {
            return;
        }
        this.impl.mo5049setSpotShadowColor8_81llA(j);
    }
    ...
    */
    public final java.lang.Object toImageBitmap(kotlin.coroutines.Continuation<? super androidx.compose.ui.graphics.ImageBitmap> r5) {
        ...
        L40:
            ...
            androidx.compose.ui.graphics.ImageBitmap r4 = androidx.compose.ui.graphics.AndroidImageBitmap_androidKt.asImageBitmap(r5)
            return r4
        */
