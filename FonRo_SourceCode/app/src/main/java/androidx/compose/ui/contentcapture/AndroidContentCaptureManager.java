...
public final class AndroidContentCaptureManager implements ContentCaptureManager, DefaultLifecycleObserver, View.OnAttachStateChangeListener {
    ...
    /* compiled from: AndroidContentCaptureManager.android.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0082\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager$TranslateStatus;", "", "(Ljava/lang/String;I)V", "SHOW_ORIGINAL", "SHOW_TRANSLATED", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:24:0x0092 -> B:11:0x0034). Please report as a decompilation issue!!! */
    /*
    ...
    */
    ...
    private final ViewStructureCompat toViewStructure(SemanticsNode semanticsNode, int i) {
        ...
        String m6175toLegacyClassNameV4PA4sw;
        ...
        if (role != null && (m6175toLegacyClassNameV4PA4sw = SemanticsUtils_androidKt.m6175toLegacyClassNameV4PA4sw(role.getValue())) != null) {
            newVirtualViewStructure.setClassName(m6175toLegacyClassNameV4PA4sw);
        }
        TextLayoutResult textLayoutResult = SemanticsUtils_androidKt.getTextLayoutResult(unmergedConfig);
        if (textLayoutResult != null) {
            TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
            newVirtualViewStructure.setTextStyle(TextUnit.m7183getValueimpl(layoutInput.getStyle().m6466getFontSizeXSAIIZE()) * layoutInput.getDensity().getDensity() * layoutInput.getDensity().getFontScale(), 0, 0, 0);
        }
    ...
    private static final class ViewTranslationHelperMethods {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public final void doTranslation(androidx.compose.ui.contentcapture.AndroidContentCaptureManager r7, android.util.LongSparseArray<android.view.translation.ViewTranslationResponse> r8) {
            /*
                r6 = this;
                int r6 = r8.size()
                r0 = 0
            L5:
                ...
                android.view.translation.ViewTranslationResponse r3 = androidx.compose.material3.internal.Listener$$ExternalSyntheticApiModelOutline0.m3022m(r3)
                if (r3 == 0) goto L61
                java.lang.String r4 = "android:text"
                android.view.translation.TranslationResponseValue r3 = androidx.compose.material3.internal.Listener$$ExternalSyntheticApiModelOutline0.m(r3, r4)
                if (r3 == 0) goto L61
                java.lang.CharSequence r3 = androidx.compose.material3.internal.Listener$$ExternalSyntheticApiModelOutline0.m(r3)
                if (r3 == 0) goto L61
                androidx.collection.IntObjectMap r4 = r7.getCurrentSemanticsNodes$ui_release()
                int r1 = (int) r1
        ...
        public final void onCreateVirtualViewTranslationRequests(AndroidContentCaptureManager contentCaptureManager, long[] virtualIds, int[] supportedFormats, Consumer<ViewTranslationRequest> requestsCollector) {
            ...
            for (long j : virtualIds) {
                ...
                if (semanticsNodeWithAdjustedBounds != null && (semanticsNode = semanticsNodeWithAdjustedBounds.getSemanticsNode()) != null) {
                    Listener$$ExternalSyntheticApiModelOutline0.m3025m();
                    autofillId = contentCaptureManager.getView().getAutofillId();
                    ViewTranslationRequest.Builder m = Listener$$ExternalSyntheticApiModelOutline0.m(autofillId, semanticsNode.getId());
