...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m5097rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long m4420getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j;
        int m4324getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m4324getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m5098rememberVectorPaintervIP8VLU = m5098rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m4420getUnspecified0d7_KjU, m4324getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m5098rememberVectorPaintervIP8VLU;
    }
    ...
    */
    ...
    private static final long m5095obtainSizePxVpY3zN4(Density density, float f, float f2) {
        float mo700toPx0680j_4 = density.mo700toPx0680j_4(f);
        float mo700toPx0680j_42 = density.mo700toPx0680j_4(f2);
    ...
    private static final long m5096obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
        ...
        return Size.m4185constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f2) & 4294967295L));
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m5094createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m4428tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m5093configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            str = RootGroupName;
        }
        return m5092configureVectorPainterT4PVSW8(vectorPainter, j, j2, str, colorFilter, (i & 16) != 0 ? false : z);
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m5092configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m5090setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m5091setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long m5095obtainSizePxVpY3zN4 = m5095obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m5092configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), m5095obtainSizePxVpY3zN4, m5096obtainViewportSizePq9zytI(m5095obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m5094createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m5076setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m5077setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m5078setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
