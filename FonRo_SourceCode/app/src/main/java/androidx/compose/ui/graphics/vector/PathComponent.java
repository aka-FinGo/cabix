...
public final class PathComponent extends VNode {
    ...
    public final void m5076setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo4259setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m5077setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m5078setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int mo4257getFillTypeRgk1Os = this.renderPath.mo4257getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo4259setFillTypeoQ8Xj4U(mo4257getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m4924drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m4924drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
