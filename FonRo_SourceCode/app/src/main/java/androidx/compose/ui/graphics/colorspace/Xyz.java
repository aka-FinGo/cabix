...
public final class Xyz extends ColorSpace {
    ...
    public Xyz(String str, int i) {
        super(str, ColorModel.INSTANCE.m4799getXyzxdoWZVw(), i, null);
    }
