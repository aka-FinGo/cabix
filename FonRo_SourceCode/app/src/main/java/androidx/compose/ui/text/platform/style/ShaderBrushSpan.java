...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(ShaderBrush shaderBrush, float f) {
        ...
        this.alpha = f;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4182boximpl(Size.INSTANCE.m4202getUnspecifiedNHjbRc()), null, 2, null);
        ...
        this.shaderState = SnapshotStateKt.derivedStateOf(new Function0<Shader>() { // from class: androidx.compose.ui.text.platform.style.ShaderBrushSpan$shaderState$1
            ...
            public final Shader invoke() {
                if (ShaderBrushSpan.this.m6743getSizeNHjbRc() == InlineClassHelperKt.UnspecifiedPackedFloats || Size.m4196isEmptyimpl(ShaderBrushSpan.this.m6743getSizeNHjbRc())) {
                    return null;
                }
                return ShaderBrushSpan.this.getShaderBrush().mo4353createShaderuvyYCjk(ShaderBrushSpan.this.m6743getSizeNHjbRc());
            }
        });
    }
    ...
    public final long m6743getSizeNHjbRc() {
        return ((Size) this.size.getValue()).m4199unboximpl();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m6744setSizeuvyYCjk(long j) {
