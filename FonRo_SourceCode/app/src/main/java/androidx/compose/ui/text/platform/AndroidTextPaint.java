...
public final class AndroidTextPaint extends TextPaint {
    ...
    public static /* synthetic */ void m6716getBrushSizeVsRJwc0$ui_text_release$annotations() {
    }
    ...
    public AndroidTextPaint(int i, float f) {
        ...
        this.backingBlendMode = DrawScope.INSTANCE.m4937getDefaultBlendMode0nO6VwU();
    ...
    public final void m6722setBrushSizeiaC8Vc4$ui_text_release(Size size) {
        this.brushSize = size;
    }
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Float.intBitsToFloat((int) (this.shadow.getOffset() >> 32)), Float.intBitsToFloat((int) (this.shadow.getOffset() & 4294967295L)), ColorKt.m4438toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m6723setColor8_81llA(long color) {
        Color color2 = this.lastColor;
        if ((color2 == null ? false : Color.m4385equalsimpl0(color2.m4394unboximpl(), color)) || color == 16) {
            return;
        }
        this.lastColor = Color.m4374boximpl(color);
        setColor(ColorKt.m4438toArgb8_81llA(color));
        clearShader();
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m6717setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m6721setBrush12SF9DM(brush, j, f);
    }

    /* JADX WARN: Code restructure failed: missing block: B:16:0x0032, code lost:
    
        if ((r0 == null ? false : androidx.compose.ui.geometry.Size.m4190equalsimpl0(r0.m4199unboximpl(), r4)) == false) goto L18;
     */
    ...
    */
    public final void m6721setBrush12SF9DM(final androidx.compose.ui.graphics.Brush r3, final long r4, float r6) {
        /*
            r2 = this;
            if (r3 != 0) goto L6
            r2.clearShader()
        ...
        L6:
            ...
            long r3 = r3.getValue()
            long r3 = androidx.compose.ui.text.style.TextDrawStyleKt.m6893modulateDxMtmZc(r3, r6)
            r2.m6723setColor8_81llA(r3)
            return
        L18:
            ...
            goto L32
        L2a:
            long r0 = r0.m4199unboximpl()
            boolean r0 = androidx.compose.ui.geometry.Size.m4190equalsimpl0(r0, r4)
        L32:
            if (r0 != 0) goto L52
        L34:
            ...
            if (r0 == 0) goto L52
            r2.brush = r3
            androidx.compose.ui.geometry.Size r0 = androidx.compose.ui.geometry.Size.m4182boximpl(r4)
            r2.brushSize = r0
        ...
        L63:
            ...
            androidx.compose.ui.text.platform.AndroidTextPaint_androidKt.setAlpha(r2, r6)
        L6d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.platform.AndroidTextPaint.m6721setBrush12SF9DM(androidx.compose.ui.graphics.Brush, long, float):void");
    }
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (drawStyle instanceof Stroke) {
            getComposePaint().mo4249setStylek9PVt8s(PaintingStyle.INSTANCE.m4652getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            getComposePaint().setStrokeWidth(stroke.getWidth());
            getComposePaint().setStrokeMiterLimit(stroke.getMiter());
            getComposePaint().mo4248setStrokeJoinWw9F2mQ(stroke.getJoin());
            getComposePaint().mo4247setStrokeCapBeK7IIE(stroke.getCap());
    ...
    public final void m6720setBlendModes9anfk8(int i) {
        if (BlendMode.m4295equalsimpl0(i, this.backingBlendMode)) {
            return;
        }
        getComposePaint().mo4244setBlendModes9anfk8(i);
