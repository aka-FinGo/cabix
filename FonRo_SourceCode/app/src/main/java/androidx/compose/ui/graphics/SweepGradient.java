...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo4353createShaderuvyYCjk(long size) {
        ...
        if ((9223372034707292159L & j) == androidx.compose.ui.geometry.InlineClassHelperKt.UnspecifiedPackedFloats) {
            m4117constructorimpl = SizeKt.m4204getCenteruvyYCjk(size);
        } else {
            ...
            m4117constructorimpl = Offset.m4117constructorimpl((Float.floatToRawIntBits(Float.intBitsToFloat((int) (size & 4294967295L))) & 4294967295L) | (Float.floatToRawIntBits(intBitsToFloat) << 32));
        }
        return ShaderKt.m4703SweepGradientShader9KIMszo(m4117constructorimpl, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m4122equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m4127hashCodeimpl = ((Offset.m4127hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m4127hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
