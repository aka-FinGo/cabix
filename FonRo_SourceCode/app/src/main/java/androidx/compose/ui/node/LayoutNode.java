...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, SemanticsInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m5917measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m5917measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo5916getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m7097getZeroMYxV2XQ();
        }
    };
    ...
    public LayoutNode(boolean z, int i) {
        ...
        this.isVirtual = z;
        this.semanticsId = i;
        this.offsetFromRoot = IntOffset.INSTANCE.m7127getMaxnOccac();
        this.lastSize = IntSize.INSTANCE.m7165getZeroYbymL2g();
        this.outerToInnerOffset = IntOffset.INSTANCE.m7127getMaxnOccac();
    ...
    public final void m5914setOffsetFromRootgyyYBs$ui_release(long j) {
    ...
    public final void m5913setLastSizeozmzZPI$ui_release(long j) {
        this.lastSize = j;
    }
    ...
    public final void m5915setOuterToInnerOffsetgyyYBs$ui_release(long j) {
    ...
    public final void insertAt$ui_release(int r3, LayoutNode instance) {
        ...
        this._foldedChildren.add(r3, instance);
    ...
    public final void removeAt$ui_release(int r4, int count) {
        if (!(count >= 0)) {
    ...
    public final void move$ui_release(int r5, int r6, int count) {
        if (r5 == r6) {
            return;
        }
        for (int i = 0; i < count; i++) {
            this._foldedChildren.add(r5 > r6 ? r6 + i : (r6 + count) - 2, this._foldedChildren.removeAt(r5 > r6 ? r5 + i : r5));
        }
        onZSortedChildrenInvalidated$ui_release();
        invalidateUnfoldedVirtualChildren();
        invalidateMeasurements$ui_release();
    ...
    public SemanticsConfiguration getSemanticsConfiguration() {
        if (!isAttached() || getIsDeactivated() || !this.nodes.m5955hasH91voCI$ui_release(NodeKind.m5994constructorimpl(8))) {
            return null;
        }
    ...
    private final SemanticsConfiguration calculateSemanticsConfiguration() {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$calculateSemanticsConfiguration$1
            ...
            public final void invoke2() {
                ...
                int m5994constructorimpl = NodeKind.m5994constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & m5994constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & m5994constructorimpl) != 0) {
    ...
    */
    ...
    public final void detach$ui_release() {
        ...
        if (!ComposeUiFlags.isSemanticAutofillEnabled && this.nodes.m5955hasH91voCI$ui_release(NodeKind.m5994constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long m5978getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m5978getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m6940getHasFixedWidthimpl(m5978getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m6939getHasFixedHeightimpl(m5978getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5918maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5919maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5920minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m5921minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        /* renamed from: minIntrinsicWidth */
        public Void m5921minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight */
        public Void m5920minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth */
        public Void m5919maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicHeight */
        public Void m5918maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public void setViewConfiguration(ViewConfiguration viewConfiguration) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & m5994constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m5994constructorimpl) != 0) {
                ...
                if ((head.getAggregateChildKindSet() & m5994constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int m5994constructorimpl = NodeKind.m5994constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & m5994constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m5994constructorimpl) != 0) {
                    DelegatingNode delegatingNode = head;
    ...
    private final void applyModifier(Modifier modifier) {
        ...
        if (this.lookaheadRoot == null && this.nodes.m5955hasH91voCI$ui_release(NodeKind.m5994constructorimpl(512))) {
    ...
    public static /* synthetic */ void m5902hitTest6fMxITs$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = PointerType.INSTANCE.m5686getUnknownT8wyACA();
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            z = true;
        }
        layoutNode.m5909hitTest6fMxITs$ui_release(j, hitTestResult, i3, z);
    }

    /* renamed from: hitTest-6fMxITs$ui_release */
    public final void m5909hitTest6fMxITs$ui_release(long pointerPosition, HitTestResult hitTestResult, int pointerType, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5981hitTestqzLsGqo(NodeCoordinator.INSTANCE.getPointerInputSource(), NodeCoordinator.m5963fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitTestResult, pointerType, isInLayer);
    }

    /* renamed from: hitTestSemantics-6fMxITs$ui_release$default */
    public static /* synthetic */ void m5903hitTestSemantics6fMxITs$ui_release$default(LayoutNode layoutNode, long j, HitTestResult hitTestResult, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = PointerType.INSTANCE.m5685getTouchT8wyACA();
        }
        int i3 = i;
        if ((i2 & 8) != 0) {
            z = true;
        }
        layoutNode.m5910hitTestSemantics6fMxITs$ui_release(j, hitTestResult, i3, z);
    }

    /* renamed from: hitTestSemantics-6fMxITs$ui_release */
    public final void m5910hitTestSemantics6fMxITs$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, int pointerType, boolean isInLayer) {
        getOuterCoordinator$ui_release().m5981hitTestqzLsGqo(NodeCoordinator.INSTANCE.getSemanticsSource(), NodeCoordinator.m5963fromParentPosition8S9VItk$default(getOuterCoordinator$ui_release(), pointerPosition, false, 2, null), hitSemanticsEntities, PointerType.INSTANCE.m5685getTouchT8wyACA(), isInLayer);
    }
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int m5994constructorimpl = NodeKind.m5994constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & m5994constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m5994constructorimpl) != 0) {
                    DelegatingNode delegatingNode = head;
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m5854requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m5994constructorimpl(256)));
                        } else if ((delegatingNode.getKindSet() & m5994constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                            Modifier.Node delegate = delegatingNode.getDelegate();
                            int i = 0;
                            delegatingNode = delegatingNode;
    ...
    public static /* synthetic */ boolean m5904lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5925getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m5911lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release */
    public final boolean m5911lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m5939remeasureBRTryo0(constraints.getValue());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default */
    public static /* synthetic */ boolean m5905remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m5924getLastConstraintsDWUhwKw();
        }
        return layoutNode.m5912remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release */
    public final boolean m5912remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m5950remeasureBRTryo0(constraints.getValue());
    }
                ...
                if ((head.getKindSet() & m5994constructorimpl) != 0) {
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m5854requireCoordinator64DMado((LayoutModifierNode) delegatingNode, NodeKind.m5994constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNode.getKindSet() & m5994constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints m5924getLastConstraintsDWUhwKw = layoutNode.layoutDelegate.m5924getLastConstraintsDWUhwKw();
        Owner owner = layoutNode.owner;
        if (m5924getLastConstraintsDWUhwKw != null) {
            if (owner != null) {
                owner.mo6055measureAndLayout0kLqBqw(layoutNode, m5924getLastConstraintsDWUhwKw.getValue());
            }
        } else if (owner != null) {
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node headNode = innerCoordinator$ui_release.headNode(m6003getIncludeSelfInTraversalH91voCI); headNode != null && (headNode.getAggregateChildKindSet() & m5994constructorimpl) != 0; headNode = headNode.getChild()) {
    ...
    public final void forEachCoordinator$ui_release(Function1<? super LayoutModifierNodeCoordinator, Unit> block) {
        ...
        for (NodeCoordinator outerCoordinator$ui_release = getOuterCoordinator$ui_release(); outerCoordinator$ui_release != innerCoordinator$ui_release; outerCoordinator$ui_release = outerCoordinator$ui_release.getWrapped()) {
            ...
            block.invoke((LayoutModifierNodeCoordinator) outerCoordinator$ui_release);
        }
    }
    ...
    /* compiled from: LayoutNode.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0080\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, d2 = {"Landroidx/compose/ui/node/LayoutNode$LayoutState;", "", "(Ljava/lang/String;I)V", "Measuring", "LookaheadMeasuring", "LayingOut", "LookaheadLayingOut", "Idle", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
    ...
    /* compiled from: LayoutNode.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0080\u0081\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, d2 = {"Landroidx/compose/ui/node/LayoutNode$UsageByParent;", "", "(Ljava/lang/String;I)V", "InMeasureBlock", "InLayoutBlock", "NotUsed", "ui_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes4.dex */
