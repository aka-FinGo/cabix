...
public final class RecalculateWindowInsetsModifierNode extends Modifier.Node implements ModifierLocalModifierNode, LayoutModifierNode, GlobalPositionAwareModifierNode {
    ...
    public RecalculateWindowInsetsModifierNode() {
        ...
        this.oldPosition = IntOffset.INSTANCE.m7128getZeronOccac();
    ...
    public final void m1075setOldPositiongyyYBs(long j) {
        this.oldPosition = j;
    }
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, final Measurable measurable, long j) {
        if (!Constraints.m6940getHasFixedWidthimpl(j) || !Constraints.m6939getHasFixedHeightimpl(j)) {
            ...
            return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RecalculateWindowInsetsModifierNode$measure$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
        ...
        return MeasureScope.layout$default(measureScope, m6942getMaxWidthimpl, m6941getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.RecalculateWindowInsetsModifierNode$measure$2
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (coordinates != null) {
                    RecalculateWindowInsetsModifierNode.this.m1075setOldPositiongyyYBs(IntOffsetKt.m7134roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(coordinates)));
                }
                if (coordinates == null) {
                    ...
                    long mo5740getSizeYbymL2g = coordinates.mo5740getSizeYbymL2g();
                    long mo5743localToRootMKHz9U = coordinates.mo5743localToRootMKHz9U(Offset.m4117constructorimpl((Float.floatToRawIntBits((int) (mo5740getSizeYbymL2g & 4294967295L)) & 4294967295L) | (Float.floatToRawIntBits((int) (mo5740getSizeYbymL2g >> 32)) << 32)));
                    long mo5740getSizeYbymL2g2 = LayoutCoordinatesKt.findRootCoordinates(coordinates).mo5740getSizeYbymL2g();
                    ...
                    int round3 = ((int) (mo5740getSizeYbymL2g2 >> 32)) - Math.round(Float.intBitsToFloat((int) (mo5743localToRootMKHz9U >> 32)));
                    int round4 = ((int) (mo5740getSizeYbymL2g2 & 4294967295L)) - Math.round(Float.intBitsToFloat((int) (mo5743localToRootMKHz9U & 4294967295L)));
                ...
                Placeable.PlacementScope.place$default(placementScope, measurable.mo5732measureBRTryo0(Constraints.INSTANCE.m6952fixedJhjzzOo(m6942getMaxWidthimpl, m6941getMaxHeightimpl)), 0, 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public void onGloballyPositioned(LayoutCoordinates coordinates) {
        long m7134roundk4lQ0M = IntOffsetKt.m7134roundk4lQ0M(LayoutCoordinatesKt.positionInRoot(coordinates));
        boolean m7116equalsimpl0 = IntOffset.m7116equalsimpl0(this.oldPosition, m7134roundk4lQ0M);
        this.oldPosition = m7134roundk4lQ0M;
        if (m7116equalsimpl0) {
            return;
        }
