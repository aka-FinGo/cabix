...
final class HandwritingDetectorNode extends DelegatingNode implements PointerInputModifierNode {
    ...
    public long mo1498getTouchBoundsExpansionRZrCHBk() {
        return this.pointerInputNode.mo1498getTouchBoundsExpansionRZrCHBk();
    }
}
