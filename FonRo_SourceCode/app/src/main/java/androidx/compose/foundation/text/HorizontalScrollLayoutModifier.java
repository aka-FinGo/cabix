...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo969measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        if (measurable.maxIntrinsicWidth(Constraints.m6941getMaxHeightimpl(j)) < Constraints.m6942getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = j;
            j = Constraints.m6932copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(j);
        final int min = Math.min(mo5732measureBRTryo0.getWidth(), Constraints.m6942getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, min, mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.access$getCursorRectInScroller(measureScope2, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo5732measureBRTryo0.getWidth()), min, mo5732measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, mo5732measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
