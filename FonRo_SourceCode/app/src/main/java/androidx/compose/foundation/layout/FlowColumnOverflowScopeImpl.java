...
public final class FlowColumnOverflowScopeImpl implements FlowColumnScope, FlowColumnOverflowScope {
    ...
    private final Lazy totalItemCount = FlowLayoutOverflowKt.lazyInt$default(null, new Function0<Integer>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflowScopeImpl$totalItemCount$2
        ...
        public final Integer invoke() {
            ...
            return Integer.valueOf(flowLayoutOverflowState.getItemCount());
        }
    }, 1, null);
    ...
    public FlowColumnOverflowScopeImpl(FlowLayoutOverflowState flowLayoutOverflowState) {
        ...
        this.shownItemCount = FlowLayoutOverflowKt.lazyInt(flowLayoutOverflowState.getShownItemLazyErrorMessage(), new Function0<Integer>() { // from class: androidx.compose.foundation.layout.FlowColumnOverflowScopeImpl$shownItemCount$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Integer invoke() {
                ...
                return Integer.valueOf(flowLayoutOverflowState2.getItemShown());
            }
        });
    }
