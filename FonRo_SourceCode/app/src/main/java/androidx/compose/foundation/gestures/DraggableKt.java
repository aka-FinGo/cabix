...
public final class DraggableKt {
    ...
    public static final float m775toFloat3MmeM6k(long j, Orientation orientation) {
        return Float.intBitsToFloat((int) (orientation == Orientation.Vertical ? j & 4294967295L : j >> 32));
    }

    /* renamed from: toFloat-sF-c-tU */
    public static final float m776toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7228getYimpl(j) : Velocity.m7227getXimpl(j);
    }

    /* renamed from: toValidVelocity-TH1AsA0 */
    public static final long m777toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m7227getXimpl(j)) ? 0.0f : Velocity.m7227getXimpl(j), Float.isNaN(Velocity.m7228getYimpl(j)) ? 0.0f : Velocity.m7228getYimpl(j));
    }
}
