...
public final /* data */ class BoxMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo356measure3p2s80s(final MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        ...
        if (list.isEmpty()) {
            return MeasureScope.layout$default(measureScope, Constraints.m6944getMinWidthimpl(j), Constraints.m6943getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$1
        ...
        long m6930constructorimpl = this.propagateMinConstraints ? j : Constraints.m6930constructorimpl(j & ConstraintsKt.MaxDimensionsAndFocusMask);
        if (list.size() == 1) {
            final Measurable measurable = list.get(0);
            matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
            if (!matchesParentSize3) {
                mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(m6930constructorimpl);
                m6944getMinWidthimpl = Math.max(Constraints.m6944getMinWidthimpl(j), mo5732measureBRTryo0.getWidth());
                m6943getMinHeightimpl = Math.max(Constraints.m6943getMinHeightimpl(j), mo5732measureBRTryo0.getHeight());
            } else {
                m6944getMinWidthimpl = Constraints.m6944getMinWidthimpl(j);
                m6943getMinHeightimpl = Constraints.m6943getMinHeightimpl(j);
                mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(Constraints.INSTANCE.m6952fixedJhjzzOo(Constraints.m6944getMinWidthimpl(j), Constraints.m6943getMinHeightimpl(j)));
            }
            final int i = m6944getMinWidthimpl;
            final int i2 = m6943getMinHeightimpl;
        ...
        intRef.element = Constraints.m6944getMinWidthimpl(j);
        final Ref.IntRef intRef2 = new Ref.IntRef();
        intRef2.element = Constraints.m6943getMinHeightimpl(j);
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (matchesParentSize2) {
                ...
                Placeable mo5732measureBRTryo02 = measurable2.mo5732measureBRTryo0(m6930constructorimpl);
                placeableArr[i3] = mo5732measureBRTryo02;
                intRef.element = Math.max(intRef.element, mo5732measureBRTryo02.getWidth());
                intRef2.element = Math.max(intRef2.element, mo5732measureBRTryo02.getHeight());
            }
        }
        if (z) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                ...
                if (matchesParentSize) {
                    placeableArr[i4] = measurable3.mo5732measureBRTryo0(Constraints);
                }
            }
        }
        return MeasureScope.layout$default(measureScope, intRef.element, intRef2.element, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxMeasurePolicy$measure$5
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                while (i5 < length) {
                    ...
                    Measurable measurable4 = list3.get(i6);
