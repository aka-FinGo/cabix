...
final class GlowEdgeEffectCompat extends EdgeEffect {
    ...
    public GlowEdgeEffectCompat(Context context) {
        super(context);
        this.oppositeReleaseDeltaThreshold = AndroidDensity_androidKt.Density(context).mo700toPx0680j_4(Dp.m6989constructorimpl(1.0f));
    }
