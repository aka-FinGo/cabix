...
public final class RoundedCornerShape extends CornerBasedShape {
    ...
    public Outline mo1325createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Rect m4215toRectuvyYCjk = SizeKt.m4215toRectuvyYCjk(size);
        float f = layoutDirection == LayoutDirection.Ltr ? topStart : topEnd;
        long m4079constructorimpl = CornerRadius.m4079constructorimpl((Float.floatToRawIntBits(f) << 32) | (Float.floatToRawIntBits(f) & 4294967295L));
        float f2 = layoutDirection == LayoutDirection.Ltr ? topEnd : topStart;
        long m4079constructorimpl2 = CornerRadius.m4079constructorimpl((Float.floatToRawIntBits(f2) & 4294967295L) | (Float.floatToRawIntBits(f2) << 32));
        float f3 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        long m4079constructorimpl3 = CornerRadius.m4079constructorimpl((Float.floatToRawIntBits(f3) << 32) | (Float.floatToRawIntBits(f3) & 4294967295L));
        float f4 = layoutDirection == LayoutDirection.Ltr ? bottomStart : bottomEnd;
        return new Outline.Rounded(RoundRectKt.m4177RoundRectZAM2FJo(m4215toRectuvyYCjk, m4079constructorimpl, m4079constructorimpl2, m4079constructorimpl3, CornerRadius.m4079constructorimpl((4294967295L & Float.floatToRawIntBits(f4)) | (Float.floatToRawIntBits(f4) << 32))));
    }
