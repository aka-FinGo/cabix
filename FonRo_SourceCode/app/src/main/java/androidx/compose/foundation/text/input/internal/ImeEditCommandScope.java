...
public interface ImeEditCommandScope {
    ...
    long mo1540mapFromTransformedGEjPoXI(long range);

    /* renamed from: mapToTransformed-GEjPoXI */
    long mo1541mapToTransformedGEjPoXI(long range);
}
