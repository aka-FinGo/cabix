...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode, ObserverModifierNode {
    ...
    public final void m560setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private BackgroundNode(long j, Brush brush, float f, Shape shape) {
        ...
        this.alpha = f;
        this.shape = shape;
        this.lastSize = Size.INSTANCE.m4202getUnspecifiedNHjbRc();
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m4385equalsimpl0(this.color, Color.INSTANCE.m4420getUnspecified0d7_KjU())) {
            DrawScope.m4929drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.m4928drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }
    ...
    private final void drawOutline(ContentDrawScope contentDrawScope) {
        ...
        if (!Color.m4385equalsimpl0(this.color, Color.INSTANCE.m4420getUnspecified0d7_KjU())) {
            OutlineKt.m4643drawOutlinewDX37Ww$default(contentDrawScope, outline, this.color, 0.0f, null, null, 0, 60, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m4641drawOutlinehn5TExg$default(contentDrawScope, outline, brush, this.alpha, null, null, 0, 56, null);
        }
    }

    private final Outline getOutline(final ContentDrawScope contentDrawScope) {
        Outline outline;
        if (Size.m4190equalsimpl0(contentDrawScope.mo4935getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            ...
            ObserverModifierNodeKt.observeReads(this, new Function0<Unit>() { // from class: androidx.compose.foundation.BackgroundNode$getOutline$1
                ...
                public final void invoke2() {
                    ...
                    backgroundNode.tmpOutline = backgroundNode.getShape().mo614createOutlinePq9zytI(contentDrawScope.mo4935getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
                }
            });
        ...
        this.lastSize = contentDrawScope.mo4935getSizeNHjbRc();
