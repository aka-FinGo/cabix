...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing marqueeSpacing, float f) {
        ...
        mutableStateOf$default3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m630boximpl(i2), null, 2, null);
    ...
    public final int m644getAnimationModeZbEOnfQ() {
    ...
    public final void m645setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m630boximpl(i));
    }
    ...
    public final void m646updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        setSpacing(spacing);
        m645setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m6994equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        setContainerWidth(ConstraintsKt.m6959constrainWidthK40F9xA(j, mo5732measureBRTryo0.getWidth()));
        setContentWidth(mo5732measureBRTryo0.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
    ...
    public void draw(final ContentDrawScope contentDrawScope) {
        ...
        boolean z = direction != 1.0f ? animatable.getValue().floatValue() < ((float) getContainerWidth()) : animatable.getValue().floatValue() < ((float) getContentWidth());
        float direction2 = getDirection();
        Animatable<Float, AnimationVector1D> animatable2 = this.offset;
        boolean z2 = direction2 != 1.0f ? animatable2.getValue().floatValue() > ((float) getSpacingPx()) : animatable2.getValue().floatValue() > ((float) ((getContentWidth() + getSpacingPx()) - getContainerWidth()));
        ...
        float f = spacingPx;
        float intBitsToFloat = Float.intBitsToFloat((int) (contentDrawScope.mo4935getSizeNHjbRc() & 4294967295L));
        GraphicsLayer graphicsLayer = this.marqueeLayer;
        if (graphicsLayer != null) {
            contentDrawScope.mo4936recordJVtK1S4(graphicsLayer, IntSize.m7155constructorimpl((getContentWidth() << 32) | (MathKt.roundToInt(intBitsToFloat) & 4294967295L)), new Function1<DrawScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$draw$1$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(1);
                }
        ...
        float intBitsToFloat2 = Float.intBitsToFloat((int) (4294967295L & contentDrawScope2.mo4935getSizeNHjbRc()));
        ...
        try {
            drawContext.getTransform().mo4859clipRectN_I0leg(floatValue, 0.0f, containerWidth, intBitsToFloat2, m4373getIntersectrtfAjoo);
