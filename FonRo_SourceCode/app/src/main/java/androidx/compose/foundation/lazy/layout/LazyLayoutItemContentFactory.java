                ...
                public final void invoke(Composer composer, int i) {
                    ...
                    if (composer.shouldExecute((i & 3) != 2, i & 1)) {
                        ...
                        if (i2 != -1) {
                            ...
                            composer2 = composer;
                            LazyLayoutItemContentFactoryKt.m1221access$SkippableItemJVlU9Rs(invoke, StableValue.m1242constructorimpl(saveableStateHolder), i2, StableValue.m1242constructorimpl(this.getKey()), composer2, 0);
