...
public final class Draggable2DNode extends DragGestureNode {
    ...
    public void mo718onDragStartedk4lQ0M(long startedPosition) {
        this.onDragStarted.invoke(Offset.m4114boximpl(startedPosition));
    }

    @Override // androidx.compose.foundation.gestures.DragGestureNode
    /* renamed from: onDragStopped-TH1AsA0 */
    public void mo719onDragStoppedTH1AsA0(long velocity) {
        this.onDragStopped.invoke(Velocity.m7218boximpl(velocity));
    }
    ...
    private final long m771reverseIfNeededMKHz9U(long j) {
        return this.reverseDirection ? Offset.m4117constructorimpl(j ^ (-9223372034707292160L)) : j;
    }
}
