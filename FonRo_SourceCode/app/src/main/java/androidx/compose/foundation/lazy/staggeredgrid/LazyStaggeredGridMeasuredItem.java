...
public final class LazyStaggeredGridMeasuredItem implements LazyStaggeredGridItemInfo, LazyLayoutMeasuredItem {
    ...
    public final void position(int mainAxis, int crossAxis, int mainAxisLayoutSize) {
        ...
        if (getIsVertical()) {
            m7111constructorimpl = IntOffset.m7111constructorimpl((crossAxis << 32) | (4294967295L & mainAxis));
        } else {
            m7111constructorimpl = IntOffset.m7111constructorimpl((crossAxis & 4294967295L) | (mainAxis << 32));
        }
    ...
    public final int getMainAxisOffset() {
        return !getIsVertical() ? IntOffset.m7117getXimpl(getOffset()) : IntOffset.m7118getYimpl(getOffset());
    }
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (animation != null) {
                if (isLookingAhead) {
                    ...
                    if ((m1273getMainAxisgyyYBs(offset) <= height && m1273getMainAxisgyyYBs(m7121plusqkQi6aY) <= height) || (m1273getMainAxisgyyYBs(offset) >= i2 && m1273getMainAxisgyyYBs(m7121plusqkQi6aY) >= i2)) {
            ...
            if (context.getReverseLayout()) {
                if (getIsVertical()) {
                    m7117getXimpl = IntOffset.m7117getXimpl(offset);
                } else {
                    m7117getXimpl = (this.mainAxisLayoutSize - IntOffset.m7117getXimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                if (!getIsVertical()) {
                    m7118getYimpl = IntOffset.m7118getYimpl(offset);
                } else {
                    m7118getYimpl = (this.mainAxisLayoutSize - IntOffset.m7118getYimpl(offset)) - (getIsVertical() ? placeable.getHeight() : placeable.getWidth());
                }
                offset = IntOffset.m7111constructorimpl((m7118getYimpl & 4294967295L) | (m7117getXimpl << 32));
            }
            long m7121plusqkQi6aY2 = IntOffset.m7121plusqkQi6aY(offset, context.getContentOffset());
            if (!isLookingAhead && animation != null) {
                animation.m1213setFinalOffsetgyyYBs(m7121plusqkQi6aY2);
            }
            if (graphicsLayer != null) {
                Placeable.PlacementScope.m5799placeRelativeWithLayeraW9wM$default(scope, placeable, m7121plusqkQi6aY2, graphicsLayer, 0.0f, 4, (Object) null);
            } else {
                Placeable.PlacementScope.m5798placeRelativeWithLayeraW9wM$default(scope, placeable, m7121plusqkQi6aY2, 0.0f, (Function1) null, 6, (Object) null);
            }
        }
    }
    ...
    private final int m1273getMainAxisgyyYBs(long j) {
    ...
    private final long m1272copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
