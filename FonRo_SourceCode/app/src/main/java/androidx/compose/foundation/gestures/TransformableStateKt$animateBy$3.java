...
public final class TransformableStateKt$animateBy$3 extends SuspendLambda implements Function2<TransformScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(AnimationState$default, animationData3, delegatingAnimationSpec, false, new Function1<AnimationScope<AnimationData, AnimationVector4D>, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableStateKt$animateBy$3.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(AnimationScope<AnimationData, AnimationVector4D> animationScope) {
                    ...
                    transformScope.mo736transformByd4ec7I(zoom, Offset.m4129minusMKHz9U(animationScope.getValue().m726getOffsetF1C5BW0(), objectRef.element.m726getOffsetF1C5BW0()), animationScope.getValue().getDegrees() - objectRef.element.getDegrees());
