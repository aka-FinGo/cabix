...
@Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Landroidx/compose/foundation/gestures/Drag2DScope;"}, k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
            ...
            Function1<DragEvent.DragDelta, Unit> function1 = new Function1<DragEvent.DragDelta, Unit>() { // from class: androidx.compose.foundation.gestures.Draggable2DNode$drag$2.1
                ...
                public final void invoke2(DragEvent.DragDelta dragDelta) {
                    ...
                    if (draggable2DNode2.reverseDirection) {
                        delta = Offset.m4117constructorimpl((-9223372034707292160L) ^ delta);
                    }
                    drag2DScope2.mo735dragByk4lQ0M(delta);
                }
            };
            this.label = 1;
