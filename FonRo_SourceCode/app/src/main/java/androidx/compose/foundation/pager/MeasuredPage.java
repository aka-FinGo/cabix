...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        while (i < size) {
            ...
            long m1291getOffsetBjo55l4 = m1291getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int m7117getXimpl = this.isVertical ? IntOffset.m7117getXimpl(m1291getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m7117getXimpl(m1291getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m7118getYimpl = (this.mainAxisLayoutSize - IntOffset.m7118getYimpl(m1291getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m7118getYimpl = IntOffset.m7118getYimpl(m1291getOffsetBjo55l4);
                }
                m1291getOffsetBjo55l4 = IntOffset.m7111constructorimpl((m7117getXimpl << 32) | (m7118getYimpl & 4294967295L));
            }
            long m7121plusqkQi6aY = IntOffset.m7121plusqkQi6aY(m1291getOffsetBjo55l4, this.visualOffset);
            if (this.isVertical) {
                placementScope = scope;
                Placeable.PlacementScope.m5800placeWithLayeraW9wM$default(placementScope, placeable, m7121plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            } else {
                placementScope = scope;
                Placeable.PlacementScope.m5798placeRelativeWithLayeraW9wM$default(placementScope, placeable, m7121plusqkQi6aY, 0.0f, (Function1) null, 6, (Object) null);
            }
            i++;
    ...
    private final long m1291getOffsetBjo55l4(int index) {
    ...
    private final long m1290copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        return IntOffset.m7111constructorimpl(((this.isVertical ? IntOffset.m7117getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m7117getXimpl(j))).intValue()) << 32) | ((this.isVertical ? function1.invoke(Integer.valueOf(IntOffset.m7118getYimpl(j))).intValue() : IntOffset.m7118getYimpl(j)) & 4294967295L));
    }
}
