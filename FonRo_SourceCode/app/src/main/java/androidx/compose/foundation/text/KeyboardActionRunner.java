...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m1377runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> function1;
        Unit unit = null;
        if (ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6635getDoneeUduSuo())) {
            ...
            if (!(ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6634getDefaulteUduSuo()) ? true : ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6638getNoneeUduSuo()))) {
        ...
        if (unit == null) {
            mo1376defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo1376defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6637getNexteUduSuo())) {
            getFocusManager().mo4022moveFocus3ESFkO8(FocusDirection.INSTANCE.m4017getNextdhqQ8s());
            return;
        }
        if (ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6639getPreviouseUduSuo())) {
            getFocusManager().mo4022moveFocus3ESFkO8(FocusDirection.INSTANCE.m4018getPreviousdhqQ8s());
            return;
        }
        if (!ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6635getDoneeUduSuo())) {
            if (ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6636getGoeUduSuo()) ? true : ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6640getSearcheUduSuo()) ? true : ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6641getSendeUduSuo()) ? true : ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6634getDefaulteUduSuo())) {
                return;
            }
            ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6638getNoneeUduSuo());
        } else {
