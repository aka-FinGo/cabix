...
public class ClickableNode extends AbstractClickableNode {
    ...
    protected final boolean mo525onClickKeyDownEventZmokQxo(KeyEvent event) {
        return false;
    }
    ...
    static /* synthetic */ Object clickPointerInput$suspendImpl(final ClickableNode clickableNode, PointerInputScope pointerInputScope, Continuation<? super Unit> continuation) {
        Object detectTapAndPress = TapGestureDetectorKt.detectTapAndPress(pointerInputScope, new ClickableNode$clickPointerInput$2(clickableNode, null), new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.ClickableNode$clickPointerInput$3
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m606invokek4lQ0M(offset.m4135unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m606invokek4lQ0M(long j) {
    ...
    public final void m604updateQzZPfjk(MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
    ...
    protected final boolean mo526onClickKeyUpEventZmokQxo(KeyEvent event) {
        getOnClick().invoke();
        return true;
    }
}
