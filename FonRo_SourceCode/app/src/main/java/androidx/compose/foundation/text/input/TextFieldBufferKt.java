...
public final class TextFieldBufferKt {
    ...
    */
    public static final long m1510adjustTextRangevJH6DeI(long r2, int r4, int r5, int r6) {
        /*
            int r0 = androidx.compose.ui.text.TextRange.m6433getMinimpl(r2)
            int r1 = androidx.compose.ui.text.TextRange.m6432getMaximpl(r2)
            if (r1 >= r4) goto Lb
            return r2
        Lb:
            if (r0 > r4) goto L14
        ...
        L2a:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.TextFieldBufferKt.m1510adjustTextRangevJH6DeI(long, int, int, int):long");
    }
    ...
    public static final void selectAll(TextFieldBuffer textFieldBuffer) {
        textFieldBuffer.m1506setSelection5zctL8(TextRangeKt.TextRange(0, textFieldBuffer.getLength()));
    }
    ...
    public static final void forEachChange(TextFieldBuffer.ChangeList changeList, Function2<? super TextRange, ? super TextRange, Unit> function2) {
        for (int i = 0; i < changeList.getChangeCount(); i++) {
            function2.invoke(TextRange.m6423boximpl(changeList.mo1509getRangejx7JFs(i)), TextRange.m6423boximpl(changeList.mo1508getOriginalRangejx7JFs(i)));
        }
    }
    ...
    public static final void forEachChangeReversed(TextFieldBuffer.ChangeList changeList, Function2<? super TextRange, ? super TextRange, Unit> function2) {
        for (int changeCount = changeList.getChangeCount() - 1; changeCount >= 0; changeCount--) {
            function2.invoke(TextRange.m6423boximpl(changeList.mo1509getRangejx7JFs(changeCount)), TextRange.m6423boximpl(changeList.mo1508getOriginalRangejx7JFs(changeCount)));
        }
    }
    ...
    public static final void setSelectionCoerced(TextFieldBuffer textFieldBuffer, int i, int i2) {
        textFieldBuffer.m1506setSelection5zctL8(TextRangeKt.TextRange(RangesKt.coerceIn(i, 0, textFieldBuffer.getLength()), RangesKt.coerceIn(i2, 0, textFieldBuffer.getLength())));
    }
}
