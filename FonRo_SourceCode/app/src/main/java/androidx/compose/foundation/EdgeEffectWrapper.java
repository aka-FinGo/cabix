...
final class EdgeEffectWrapper {
    ...
    private final EdgeEffect createEdgeEffect(Orientation orientation) {
        ...
        if (!IntSize.m7158equalsimpl0(this.size, IntSize.INSTANCE.m7165getZeroYbymL2g())) {
    ...
    public final void m612updateSizeozmzZPI(long size) {
        this.size = size;
        EdgeEffect edgeEffect = this.topEffect;
        if (edgeEffect != null) {
