...
public final class LazyStaggeredGridScrollScopeKt$LazyLayoutScrollScope$1 implements LazyLayoutScrollScope, ScrollScope {
    ...
    public int calculateDistanceTo(int targetIndex, int targetOffset) {
        ...
        if (lazyStaggeredGridItemInfo2 == null) {
            ...
            m7117getXimpl = (visibleItemsAverageSize * ((targetIndex / laneCount$foundation_release) - (getFirstVisibleItemIndex() / laneCount$foundation_release))) - getFirstVisibleItemScrollOffset();
        } else if (layoutInfo.getOrientation() == Orientation.Vertical) {
            m7117getXimpl = IntOffset.m7118getYimpl(lazyStaggeredGridItemInfo2.getOffset());
        } else {
            m7117getXimpl = IntOffset.m7117getXimpl(lazyStaggeredGridItemInfo2.getOffset());
        }
        return m7117getXimpl + targetOffset;
    }
}
