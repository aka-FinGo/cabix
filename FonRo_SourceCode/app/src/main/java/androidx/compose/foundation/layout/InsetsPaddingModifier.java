...
public final class InsetsPaddingModifier implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo969measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(ConstraintsKt.m6961offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m6959constrainWidthK40F9xA(j, mo5732measureBRTryo0.getWidth() + right), ConstraintsKt.m6958constrainHeightK40F9xA(j, mo5732measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
