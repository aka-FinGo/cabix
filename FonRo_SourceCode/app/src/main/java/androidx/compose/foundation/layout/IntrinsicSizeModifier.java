...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        if (getEnforceIncoming()) {
            mo1002calculateContentConstraintsl58MMJ0 = ConstraintsKt.m6957constrainN9IONVI(j, mo1002calculateContentConstraintsl58MMJ0);
        }
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(mo1002calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measureScope, mo5732measureBRTryo0.getWidth(), mo5732measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5797placeRelative70tqf50$default(placementScope, Placeable.this, IntOffset.INSTANCE.m7128getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
