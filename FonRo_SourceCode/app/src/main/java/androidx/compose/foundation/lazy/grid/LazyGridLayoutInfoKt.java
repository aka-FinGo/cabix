...
@Metadata(d1 = {"\u0000\f\n\u0000\n\u0002\u0010\b\n\u0002\u0018\u0002\n\u0000\u001a\f\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u0000¨\u0006\u0003"}, d2 = {"visibleLinesAverageMainAxisSize", "", "Landroidx/compose/foundation/lazy/grid/LazyGridLayoutInfo;", "foundation_release"}, k = 2, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
        ...
        while (i < visibleItemsInfo.size()) {
            ...
            if (visibleLinesAverageMainAxisSize$lineOf == -1) {
                ...
                while (i < visibleItemsInfo.size() && visibleLinesAverageMainAxisSize$lineOf(z, lazyGridLayoutInfo, i) == visibleLinesAverageMainAxisSize$lineOf) {
                    if (z) {
                        mo1189getSizeYbymL2g = visibleItemsInfo.get(i).mo1189getSizeYbymL2g() & 4294967295L;
                    } else {
                        mo1189getSizeYbymL2g = visibleItemsInfo.get(i).mo1189getSizeYbymL2g() >> 32;
                    }
                    i4 = Math.max(i4, (int) mo1189getSizeYbymL2g);
                    i++;
                }
                i2 += i4;
                i3++;
