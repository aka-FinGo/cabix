...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m4614constructorimpl$default(null, 1, null);
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    Matrix.m4623resetimpl(this.matrix);
                    textLayoutNodeCoordinates.mo5748transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m4236setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1550buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m4162translatek4lQ0M(textLayoutNodeCoordinates.mo5741localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m4141getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m4162translatek4lQ0M(textLayoutNodeCoordinates.mo5741localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m4141getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
