...
public final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m913setBefore0680j_4(this.before);
        node.m912setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetDpElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m6994equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m6994equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m6995hashCodeimpl(this.before)) * 31) + Dp.m6995hashCodeimpl(this.after);
    }
}
