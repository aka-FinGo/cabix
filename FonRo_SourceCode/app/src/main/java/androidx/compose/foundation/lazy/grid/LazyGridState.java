...
public final class LazyGridState implements ScrollableState {
            ...
            public List<LazyLayoutPrefetchState.PrefetchHandle> scheduleLinePrefetch(int lineIndex) {
                ...
                try {
                    ...
                    if (lazyGridMeasureResult != null) {
                        List<Pair<Integer, Constraints>> invoke = lazyGridMeasureResult.getPrefetchInfoRetriever().invoke(Integer.valueOf(lineIndex));
                        int size = invoke.size();
                        for (int i3 = 0; i3 < size; i3++) {
                            Pair<Integer, Constraints> pair = invoke.get(i3);
                            arrayList.add(lazyGridState.getPrefetchState().m1226schedulePrefetch0kLqBqw(pair.getFirst().intValue(), pair.getSecond().getValue()));
                        }
    ...
    public final MutableState<Unit> m1199getPlacementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    public final MutableState<Unit> m1198getMeasurementScopeInvalidatorzYiylxw$foundation_release() {
    ...
    */
    ...
    /* compiled from: LazyGridState.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001f\u0010\b\u001a\f\u0012\u0004\u0012\u00020\u0005\u0012\u0002\b\u00030\u00042\u0006\u0010\t\u001a\u00020\nH\u0001¢\u0006\u0002\b\u000bR\u001b\u0010\u0003\u001a\f\u0012\u0004\u0012\u00020\u0005\u0012\u0002\b\u00030\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\f"}, d2 = {"Landroidx/compose/foundation/lazy/grid/LazyGridState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/lazy/grid/LazyGridState;", "getSaver", "()Landroidx/compose/runtime/saveable/Saver;", "saver", "prefetchStrategy", "Landroidx/compose/foundation/lazy/grid/LazyGridPrefetchStrategy;", "saver$foundation_release", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
