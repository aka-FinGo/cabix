...
public final class SecureTextFieldController {
    ...
    public final void scheduleHide() {
        if (ChannelResult.m9463isFailureimpl(this.resetTimerSignal.mo9440trySendJP2dKIU(Unit.INSTANCE))) {
