...
public final class ScrollingLogic$doFlingAnimation$2 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        float m831toFloatTH1AsA0;
        Ref.LongRef longRef;
        long j;
        ScrollingLogic scrollingLogic2;
        long m832updateQWom1Mo;
        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m838toFloatk4lQ0M(nestedScrollScope.mo793scrollByWithOverscrollOzD1aCk(scrollingLogic4.m836reverseIfNeededMKHz9U(scrollingLogic4.m839toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m5499getSideEffectWNlRxjI())));
                }
            };
            ...
            m831toFloatTH1AsA0 = scrollingLogic.m831toFloatTH1AsA0(j2);
            float reverseIfNeeded = scrollingLogic.reverseIfNeeded(m831toFloatTH1AsA0);
        ...
        m832updateQWom1Mo = scrollingLogic.m832updateQWom1Mo(j, scrollingLogic2.reverseIfNeeded(((Number) obj).floatValue()));
        longRef.element = m832updateQWom1Mo;
