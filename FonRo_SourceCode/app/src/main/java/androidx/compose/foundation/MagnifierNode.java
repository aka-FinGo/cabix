...
public final class MagnifierNode extends Modifier.Node implements GlobalPositionAwareModifierNode, DrawModifierNode, SemanticsModifierNode, ObserverModifierNode {
    ...
    public /* synthetic */ MagnifierNode(Function1 function1, Function1 function12, Function1 function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(function1, (i & 2) != 0 ? null : function12, (i & 4) != 0 ? null : function13, (i & 8) != 0 ? Float.NaN : f, (i & 16) != 0 ? false : z, (i & 32) != 0 ? DpSize.INSTANCE.m7096getUnspecifiedMYxV2XQ() : j, (i & 64) != 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : f2, (i & 128) != 0 ? Dp.INSTANCE.m7009getUnspecifiedD9Ej5fM() : f3, (i & 256) != 0 ? true : z2, (i & 512) != 0 ? PlatformMagnifierFactory.INSTANCE.getForCurrentPlatform() : platformMagnifierFactory, null);
    }
    ...
    public final void m622setSizeEaSLcWc(long j) {
        this.size = j;
    }
    ...
    public final void m620setCornerRadius0680j_4(float f) {
        this.cornerRadius = f;
    }
    ...
    public final void m621setElevation0680j_4(float f) {
        this.elevation = f;
    }
    ...
    private MagnifierNode(Function1<? super Density, Offset> function1, Function1<? super Density, Offset> function12, Function1<? super DpSize, Unit> function13, float f, boolean z, long j, float f2, float f3, boolean z2, PlatformMagnifierFactory platformMagnifierFactory) {
        ...
        this.sourceCenterInRoot = Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
    }
    ...
    private final long m616getAnchorPositionInRootF1C5BW0() {
        State<Offset> state = this.anchorPositionInRootState;
        if (state == null) {
            state = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode$anchorPositionInRoot$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m4114boximpl(m624invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m624invokeF1C5BW0() {
                    LayoutCoordinates layoutCoordinates;
                    layoutCoordinates = MagnifierNode.this.getLayoutCoordinates();
                    return layoutCoordinates != null ? LayoutCoordinatesKt.positionInRoot(layoutCoordinates) : Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
                }
            });
            this.anchorPositionInRootState = state;
        }
        return state != null ? state.getValue().m4135unboximpl() : Offset.INSTANCE.m4140getUnspecifiedF1C5BW0();
    }

    /* renamed from: update-5F03MCQ, reason: not valid java name */
    public final void m623update5F03MCQ(Function1<? super Density, Offset> sourceCenter, Function1<? super Density, Offset> magnifierCenter, float zoom, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Function1<? super DpSize, Unit> onSizeChanged, PlatformMagnifierFactory platformMagnifierFactory) {
        float f = this.zoom;
        long j = this.size;
        ...
        if (this.magnifier != null && ((!Magnifier_androidKt.equalsIncludingNaN(zoom, f) && !platformMagnifierFactory.getCanUpdateZoom()) || !DpSize.m7084equalsimpl0(size, j) || !Dp.m6994equalsimpl0(cornerRadius, f2) || !Dp.m6994equalsimpl0(elevation, f3) || useTextDefault != z || clippingEnabled != z2 || !Intrinsics.areEqual(platformMagnifierFactory, platformMagnifierFactory2) || !Intrinsics.areEqual(requireView, view) || !Intrinsics.areEqual(requireDensity, density))) {
            recreateMagnifier();
        }
        updateMagnifier();
    }
    ...
    private final void recreateMagnifier() {
        ...
        this.magnifier = this.platformMagnifierFactory.mo650createnHHXs2Y(view2, this.useTextDefault, this.size, this.cornerRadius, this.elevation, this.clippingEnabled, density2, this.zoom);
    ...
    */
    public final void updateMagnifier() {
        ...
        Ld:
            ...
            if (r5 == 0) goto L85
            long r5 = r9.m616getAnchorPositionInRootF1C5BW0()
            long r5 = r5 & r3
            int r5 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
            if (r5 == 0) goto L85
            long r5 = r9.m616getAnchorPositionInRootF1C5BW0()
            long r1 = androidx.compose.ui.geometry.Offset.m4130plusMKHz9U(r5, r1)
            ...
            long r0 = r0.m4135unboximpl()
            androidx.compose.ui.geometry.Offset r0 = androidx.compose.ui.geometry.Offset.m4114boximpl(r0)
            long r1 = r0.m4135unboximpl()
            long r1 = r1 & r3
        ...
        L59:
            if (r0 == 0) goto L68
            long r0 = r0.m4135unboximpl()
            long r2 = r9.m616getAnchorPositionInRootF1C5BW0()
            long r0 = androidx.compose.ui.geometry.Offset.m4130plusMKHz9U(r2, r0)
            goto L6e
        L68:
            androidx.compose.ui.geometry.Offset$Companion r0 = androidx.compose.ui.geometry.Offset.INSTANCE
            long r0 = r0.m4140getUnspecifiedF1C5BW0()
        L6e:
            r5 = r0
        ...
        L76:
            ...
            float r7 = r9.zoom
            r2.mo649updateWko1d7g(r3, r5, r7)
        L81:
    ...
    private final void updateSizeIfNecessary() {
        Density density;
        PlatformMagnifier platformMagnifier = this.magnifier;
        if (platformMagnifier == null || (density = this.density) == null || IntSize.m7157equalsimpl(platformMagnifier.mo648getSizeYbymL2g(), this.previousSize)) {
            return;
        }
        Function1<? super DpSize, Unit> function1 = this.onSizeChanged;
        if (function1 != null) {
            function1.invoke(DpSize.m7075boximpl(density.mo698toDpSizekrfVVM(IntSizeKt.m7172toSizeozmzZPI(platformMagnifier.mo648getSizeYbymL2g()))));
        }
        this.previousSize = IntSize.m7152boximpl(platformMagnifier.mo648getSizeYbymL2g());
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (channel != null) {
            ChannelResult.m9454boximpl(channel.mo9440trySendJP2dKIU(Unit.INSTANCE));
        }
    }
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(Magnifier_androidKt.getMagnifierPositionInRoot(), new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierNode$applySemantics$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ Offset invoke() {
                return Offset.m4114boximpl(m625invokeF1C5BW0());
            }

            /* renamed from: invoke-F1C5BW0, reason: not valid java name */
            public final long m625invokeF1C5BW0() {
                long j;
