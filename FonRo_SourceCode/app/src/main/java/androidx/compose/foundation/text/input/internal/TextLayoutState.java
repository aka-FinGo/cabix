...
public final class TextLayoutState {
    ...
    public TextLayoutState() {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m6987boximpl(Dp.m6989constructorimpl(0.0f)), null, 2, null);
    ...
    public final float m1622getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m7003unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1626setMinHeightForSingleLineField0680j_4(float f) {
    ...
    public final TextLayoutResult m1625layoutWithNewMeasureInputshBUhpc(Density density, LayoutDirection layoutDirection, FontFamily.Resolver fontFamilyResolver, long constraints) {
        TextLayoutResult m1614layoutWithNewMeasureInputshBUhpc = this.layoutCache.m1614layoutWithNewMeasureInputshBUhpc(density, layoutDirection, fontFamilyResolver, constraints);
        ...
        return m1614layoutWithNewMeasureInputshBUhpc;
    }

    /* renamed from: getOffsetForPosition-3MmeM6k$default, reason: not valid java name */
    public static /* synthetic */ int m1620getOffsetForPosition3MmeM6k$default(TextLayoutState textLayoutState, long j, boolean z, int i, Object obj) {
        if ((i & 2) != 0) {
            z = true;
        }
        return textLayoutState.m1623getOffsetForPosition3MmeM6k(j, z);
    }

    /* renamed from: getOffsetForPosition-3MmeM6k, reason: not valid java name */
    public final int m1623getOffsetForPosition3MmeM6k(long position, boolean coerceInVisibleBounds) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return -1;
        }
        if (coerceInVisibleBounds) {
            position = m1621coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(position);
        }
        return layoutResult.m6405getOffsetForPositionk4lQ0M(TextLayoutStateKt.m1628fromDecorationToTextLayoutUv8p0NA(this, position));
    }

    /* renamed from: isPositionOnText-k-4lQ0M, reason: not valid java name */
    public final boolean m1624isPositionOnTextk4lQ0M(long offset) {
        TextLayoutResult layoutResult = getLayoutResult();
        if (layoutResult == null) {
            return false;
        }
        long m1628fromDecorationToTextLayoutUv8p0NA = TextLayoutStateKt.m1628fromDecorationToTextLayoutUv8p0NA(this, m1621coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(offset));
        int lineForVerticalPosition = layoutResult.getLineForVerticalPosition(Float.intBitsToFloat((int) (4294967295L & m1628fromDecorationToTextLayoutUv8p0NA)));
        int i = (int) (m1628fromDecorationToTextLayoutUv8p0NA >> 32);
    ...
    */
    public final long m1621coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long r5) {
        /*
            r4 = this;
            androidx.compose.ui.layout.LayoutCoordinates r0 = r4.getTextLayoutNodeCoordinates()
            if (r0 == 0) goto L22
            boolean r1 = r0.isAttached()
            if (r1 == 0) goto L1a
            androidx.compose.ui.layout.LayoutCoordinates r4 = r4.getDecoratorNodeCoordinates()
            r1 = 0
            if (r4 == 0) goto L20
            r2 = 0
            r3 = 2
        ...
        L22:
            ...
            androidx.compose.ui.geometry.Rect r1 = r4.getZero()
        L28:
            long r4 = androidx.compose.foundation.text.input.internal.TextLayoutStateKt.m1627coerceIn3MmeM6k(r5, r1)
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.input.internal.TextLayoutState.m1621coercedInVisibleBoundsOfInputTextMKHz9U$foundation_release(long):long");
    }
}
