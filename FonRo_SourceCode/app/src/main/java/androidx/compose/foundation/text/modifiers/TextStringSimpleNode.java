...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6924getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final ParagraphLayoutCache getLayoutCache() {
        ...
        if (paragraphLayoutCache == null) {
            ParagraphLayoutCache paragraphLayoutCache2 = new ParagraphLayoutCache(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, null);
            this._layoutCache = paragraphLayoutCache2;
            paragraphLayoutCache = paragraphLayoutCache2;
        }
    ...
    public final boolean m1751updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        if (textChanged || layoutChanged) {
            getLayoutCache().m1744updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
        }
        if (getIsAttached()) {
    ...
    public final boolean setSubstitution(String updatedText) {
        ...
        if (textSubstitutionValue != null) {
            ...
            if (layoutCache != null) {
                layoutCache.m1744updateL6sJoHM(updatedText, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
        ...
        if (function1 == null) {
            function1 = new Function1<List<TextLayoutResult>, Boolean>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$applySemantics$1
                ...
                public final Boolean invoke(List<TextLayoutResult> list) {
                    ...
                    TextLayoutResult slowCreateTextLayoutResultOrNull = layoutCache.slowCreateTextLayoutResultOrNull(TextStyle.m6455mergedA7vx0o$default(textStyle, colorProducer != null ? colorProducer.mo2165invoke0d7_KjU() : Color.INSTANCE.m4420getUnspecified0d7_KjU(), 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, 0, 0, null, null, 16777214, null));
    ...
    public MeasureResult mo384measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        boolean m1742layoutWithConstraintsK40F9xA = layoutCacheForMeasure.m1742layoutWithConstraintsK40F9xA(j, measureScope.getLayoutDirection());
        ...
        if (m1742layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo5732measureBRTryo0 = measurable.mo5732measureBRTryo0(Constraints.INSTANCE.m6951fitPrioritizingWidthZbe2FdA(i, i, i2, i2));
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (didOverflow) {
            ...
            canvas.save();
            Canvas.m4356clipRectN_I0leg$default(canvas, 0.0f, 0.0f, layoutSize, layoutSize2, 0, 16, null);
        }
        try {
            ...
            if (brush != null) {
                Paragraph.m6295painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ...
                Paragraph.m6293paintLG529CI$default(paragraph, canvas, mo2165invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
            if (didOverflow) {
                canvas.restore();
            }
