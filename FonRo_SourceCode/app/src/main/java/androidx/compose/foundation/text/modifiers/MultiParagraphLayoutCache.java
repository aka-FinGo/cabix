...
public final class MultiParagraphLayoutCache {
    ...
    public /* synthetic */ MultiParagraphLayoutCache(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, List list, TextAutoSize textAutoSize, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m6924getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : list, (i4 & 256) != 0 ? null : textAutoSize, null);
    }
    ...
    private final TextAutoSizeLayoutScopeImpl getFontSizeSearchScope() {
        ...
        if (textAutoSizeLayoutScopeImpl == null) {
            textAutoSizeLayoutScopeImpl = new TextAutoSizeLayoutScopeImpl();
            this._textAutoSizeLayoutScope = textAutoSizeLayoutScopeImpl;
        }
    ...
    public final boolean m1732layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        long m1731useMinLinesConstrainerOh53vG4 = this.minLines > 1 ? m1731useMinLinesConstrainerOh53vG4(constraints, layoutDirection) : constraints;
        if (!m1729newLayoutWillBeDifferentVKLhPVY(this.layoutCache, m1731useMinLinesConstrainerOh53vG4, layoutDirection)) {
            TextLayoutResult textLayoutResult = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult);
            if (Constraints.m6935equalsimpl0(m1731useMinLinesConstrainerOh53vG4, textLayoutResult.getLayoutInput().getConstraints())) {
                return false;
            }
            TextLayoutResult textLayoutResult2 = this.layoutCache;
            Intrinsics.checkNotNull(textLayoutResult2);
            this.layoutCache = m1730textLayoutResultVKLhPVY(layoutDirection, m1731useMinLinesConstrainerOh53vG4, textLayoutResult2.getMultiParagraph());
            return true;
        }
        if (this.autoSize != null) {
            this.intrinsicsLayoutDirection = layoutDirection;
            long m6466getFontSizeXSAIIZE = this.style.m6466getFontSizeXSAIIZE();
            TextAutoSize textAutoSize = this.autoSize;
            Intrinsics.checkNotNull(textAutoSize);
            long mo1346getFontSizeCi0_558 = textAutoSize.mo1346getFontSizeCi0_558(getFontSizeSearchScope(), constraints, this.text);
            if (TextUnit.m7185isEmimpl(mo1346getFontSizeCi0_558)) {
                mo1346getFontSizeCi0_558 = MultiParagraphLayoutCacheKt.m1736timesNB67dxo(m6466getFontSizeXSAIIZE, mo1346getFontSizeCi0_558);
            }
            long j = mo1346getFontSizeCi0_558;
            TextLayoutResult lastLayoutResult = getFontSizeSearchScope().getLastLayoutResult();
            if (lastLayoutResult != null && TextUnit.m7180equalsimpl0(j, lastLayoutResult.getLayoutInput().getStyle().m6466getFontSizeXSAIIZE()) && TextOverflow.m6915equalsimpl0(lastLayoutResult.getLayoutInput().getOverflow(), this.overflow)) {
                this.layoutCache = lastLayoutResult;
                return true;
            }
            setStyle(TextStyle.m6448copyp1EtxEg$default(this.style, 0L, j, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, null, 0, 0, null, 16777213, null));
        }
        this.layoutCache = m1730textLayoutResultVKLhPVY(layoutDirection, m1731useMinLinesConstrainerOh53vG4, m1728layoutTextK40F9xA(m1731useMinLinesConstrainerOh53vG4, layoutDirection));
        return true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: useMinLinesConstrainer-Oh53vG4, reason: not valid java name */
    public final long m1731useMinLinesConstrainerOh53vG4(long constraints, LayoutDirection layoutDirection) {
    ...
    public final TextLayoutResult m1730textLayoutResultVKLhPVY(LayoutDirection layoutDirection, long finalConstraints, MultiParagraph multiParagraph) {
        ...
        Density density = this.density;
        Intrinsics.checkNotNull(density);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, textStyle, list, i, z, i2, density, layoutDirection, this.fontFamilyResolver, finalConstraints, (DefaultConstructorMarker) null), multiParagraph, ConstraintsKt.m6956constrain4WqzIAM(finalConstraints, IntSize.m7155constructorimpl((TextDelegateKt.ceilToIntPx(multiParagraph.getHeight()) & 4294967295L) | (TextDelegateKt.ceilToIntPx(min) << 32))), null);
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            Constraints = m1731useMinLinesConstrainerOh53vG4(Constraints, layoutDirection);
        }
        int coerceAtLeast = RangesKt.coerceAtLeast(TextDelegateKt.ceilToIntPx(m1728layoutTextK40F9xA(Constraints, layoutDirection).getHeight()), Constraints.m6943getMinHeightimpl(Constraints));
    ...
    public final void m1733updateJ2qo7bo(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines, List<AnnotatedString.Range<Placeholder>> placeholders, TextAutoSize autoSize) {
        this.text = text;
        setStyle(style);
    ...
    public final MultiParagraph m1728layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        MultiParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return new MultiParagraph(layoutDirection2, LayoutUtilsKt.m1719finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1720finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), this.overflow, (DefaultConstructorMarker) null);
    }

    /* renamed from: newLayoutWillBeDifferent-VKLhPVY, reason: not valid java name */
    private final boolean m1729newLayoutWillBeDifferentVKLhPVY(TextLayoutResult textLayoutResult, long j, LayoutDirection layoutDirection) {
        ...
        if (Constraints.m6935equalsimpl0(j, textLayoutResult.getLayoutInput().getConstraints())) {
            return false;
        }
        return Constraints.m6942getMaxWidthimpl(j) != Constraints.m6942getMaxWidthimpl(textLayoutResult.getLayoutInput().getConstraints()) || Constraints.m6944getMinWidthimpl(j) != Constraints.m6944getMinWidthimpl(textLayoutResult.getLayoutInput().getConstraints()) || ((float) Constraints.m6941getMaxHeightimpl(j)) < textLayoutResult.getMultiParagraph().getHeight() || textLayoutResult.getMultiParagraph().getDidExceedMaxLines();
    }
    ...
    public final class TextAutoSizeLayoutScopeImpl implements TextAutoSizeLayoutScope {
        ...
        public TextLayoutResult mo1734performLayout5ZSfY2I(long constraints, AnnotatedString text, long fontSize) {
            long j;
            long j2;
            long m1736timesNB67dxo;
            TextStyle textStyle = MultiParagraphLayoutCache.this.style;
            if (TextUnit.m7185isEmimpl(fontSize)) {
                m1736timesNB67dxo = MultiParagraphLayoutCacheKt.m1736timesNB67dxo(MultiParagraphLayoutCache.this.style.m6466getFontSizeXSAIIZE(), fontSize);
                j = m1736timesNB67dxo;
            } else {
                j = fontSize;
            }
            if (!TextUnit.m7180equalsimpl0(j, MultiParagraphLayoutCache.this.style.m6466getFontSizeXSAIIZE())) {
                MultiParagraphLayoutCache multiParagraphLayoutCache = MultiParagraphLayoutCache.this;
                multiParagraphLayoutCache.setStyle(TextStyle.m6448copyp1EtxEg$default(multiParagraphLayoutCache.style, 0L, j, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, 0, 0, 0L, null, null, null, 0, 0, null, 16777213, null));
            }
            if (MultiParagraphLayoutCache.this.minLines > 1) {
                ...
                j2 = multiParagraphLayoutCache2.m1731useMinLinesConstrainerOh53vG4(constraints, layoutDirection);
            } else {
                j2 = constraints;
            }
            ...
            MultiParagraph m1728layoutTextK40F9xA = multiParagraphLayoutCache3.m1728layoutTextK40F9xA(j2, layoutDirection2);
            ...
            TextLayoutResult m1730textLayoutResultVKLhPVY = multiParagraphLayoutCache4.m1730textLayoutResultVKLhPVY(layoutDirection3, j2, m1728layoutTextK40F9xA);
            this.lastLayoutResult = m1730textLayoutResultVKLhPVY;
            MultiParagraphLayoutCache.this.setStyle(textStyle);
            return m1730textLayoutResultVKLhPVY;
        }
        ...
        public float mo699toPxR2X_6o(long j) {
            if (TextUnit.m7185isEmimpl(j)) {
                if (!TextUnit.m7185isEmimpl(MultiParagraphLayoutCache.this.style.m6466getFontSizeXSAIIZE())) {
                    if (!TextUnit.m7180equalsimpl0(MultiParagraphLayoutCache.this.style.m6466getFontSizeXSAIIZE(), TextUnit.INSTANCE.m7194getUnspecifiedXSAIIZE())) {
                        return mo699toPxR2X_6o(MultiParagraphLayoutCache.this.style.m6466getFontSizeXSAIIZE()) * TextUnit.m7183getValueimpl(j);
                    }
