...
public final class TextFieldDecoratorModifierNode extends DelegatingNode implements DrawModifierNode, PlatformTextInputModifierNode, SemanticsModifierNode, FocusRequesterModifierNode, FocusEventModifierNode, GlobalPositionAwareModifierNode, PointerInputModifierNode, KeyInputModifierNode, CompositionLocalConsumerModifierNode, ModifierLocalModifierNode, ObserverModifierNode, LayoutAwareModifierNode {
    ...
    public TextFieldDecoratorModifierNode(TransformedTextFieldState transformedTextFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation inputTransformation, boolean z, boolean z2, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean z3, MutableInteractionSource mutableInteractionSource, boolean z4, MutableSharedFlow<Unit> mutableSharedFlow) {
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    /*  JADX ERROR: Method code generation error
                        jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x001f: CONSTRUCTOR (r7v1 'function0' kotlin.jvm.functions.Function0<kotlin.Unit>) = 
        ...
        this.dragAndDropNode = (DragAndDropTargetModifierNode) delegate(TextFieldDragAndDropNode_androidKt.textFieldDragAndDropNode$default(new Function0<Set<? extends MediaType>>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$dragAndDropNode$1
            ...
            public final Boolean invoke(ClipEntry clipEntry, ClipMetadata clipMetadata) {
                ...
                if (receiveContentConfiguration != null) {
                    TransferableContent onReceive = receiveContentConfiguration.getReceiveContentListener().onReceive(new TransferableContent(clipEntry, clipMetadata, TransferableContent.Source.INSTANCE.m660getDragAndDropkB6V9T0(), null, 8, null));
            ...
            public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                m1608invokek4lQ0M(offset.m4135unboximpl());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1608invokek4lQ0M(long j) {
                long m1630fromWindowToDecorationUv8p0NA = TextLayoutStateKt.m1630fromWindowToDecorationUv8p0NA(TextFieldDecoratorModifierNode.this.getTextLayoutState(), j);
                int m1620getOffsetForPosition3MmeM6k$default = TextLayoutState.m1620getOffsetForPosition3MmeM6k$default(TextFieldDecoratorModifierNode.this.getTextLayoutState(), m1630fromWindowToDecorationUv8p0NA, false, 2, null);
                if (m1620getOffsetForPosition3MmeM6k$default >= 0) {
                    TextFieldDecoratorModifierNode.this.getTextFieldState().m1640selectCharsIn5zctL8(TextRangeKt.TextRange(m1620getOffsetForPosition3MmeM6k$default));
                }
                TextFieldDecoratorModifierNode.this.getTextFieldSelectionState().m1690updateHandleDraggingUv8p0NA(Handle.Cursor, m1630fromWindowToDecorationUv8p0NA);
            }
        ...
        this.clipboardKeyCommandsHandler = ClipboardKeyCommandsHandler.m1544constructorimpl(new Function1<KeyCommand, Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$clipboardKeyCommandsHandler$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (getAutofillHighlightOn()) {
            DrawScope.m4929drawRectnJ9OG0$default(contentDrawScope, ((Color) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, AutofillHighlightKt.getLocalAutofillHighlightColor())).m4394unboximpl(), 0L, 0L, 0.0f, null, null, 0, WebSocketProtocol.PAYLOAD_SHORT, null);
        }
    }
    ...
    public final void updateNode(TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, InputTransformation filter, boolean enabled, boolean readOnly, KeyboardOptions keyboardOptions, KeyboardActionHandler keyboardActionHandler, boolean singleLine, MutableInteractionSource interactionSource, boolean isPassword, MutableSharedFlow<Unit> stylusHandwritingTrigger) {
        ...
        if (enabled != z2 || z != z3 || !ImeAction.m6621equalsimpl0(keyboardOptions.m1390getImeActionOrDefaulteUduSuo$foundation_release(), keyboardOptions2.m1390getImeActionOrDefaulteUduSuo$foundation_release()) || isPassword != z4) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        SemanticsPropertiesKt.m6219setTextSelectionRangeFDrldGo(semanticsPropertyReceiver, selection);
        if (!this.enabled) {
        ...
        SemanticsPropertiesKt.setSelection$default(semanticsPropertyReceiver, null, new Function3<Integer, Integer, Boolean, Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$applySemantics$5
            ...
            public final Boolean invoke(int i, int i2, boolean z2) {
                ...
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = TextFieldDecoratorModifierNode.this;
                if (z2) {
                    visualText = textFieldDecoratorModifierNode.getTextFieldState().getUntransformedText();
                } else {
                    visualText = textFieldDecoratorModifierNode.getTextFieldState().getVisualText();
                }
                ...
                if (i == TextRange.m6435getStartimpl(selection2) && i2 == TextRange.m6430getEndimpl(selection2)) {
                    return true;
                }
                ...
                if (z2) {
                    textFieldDecoratorModifierNode2.getTextFieldState().m1641selectUntransformedCharsIn5zctL8(TextRange);
                } else {
                    textFieldDecoratorModifierNode2.getTextFieldState().m1640selectCharsIn5zctL8(TextRange);
                }
                return true;
            }
        }, 1, null);
        final int m1390getImeActionOrDefaulteUduSuo$foundation_release = this.keyboardOptions.m1390getImeActionOrDefaulteUduSuo$foundation_release();
        SemanticsPropertiesKt.m6215onImeAction9UiTYpY$default(semanticsPropertyReceiver, m1390getImeActionOrDefaulteUduSuo$foundation_release, null, new Function0<Boolean>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$applySemantics$6
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final Boolean invoke() {
                TextFieldDecoratorModifierNode.this.m1607onImeActionPerformedKlQnJC8(m1390getImeActionOrDefaulteUduSuo$foundation_release);
                return true;
            }
        }, 2, null);
        ...
        if (!TextRange.m6429getCollapsedimpl(selection) && !this.isPassword) {
    ...
    public boolean mo529onPreKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1539onPreKeyEventMyFupTE(event, this.textFieldState, this.textFieldSelectionState, (FocusManager) CompositionLocalConsumerModifierNodeKt.currentValueOf(this, CompositionLocalsKt.getLocalFocusManager()), requireKeyboardController());
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onKeyEvent-ZmokQxo */
    public boolean mo527onKeyEventZmokQxo(KeyEvent event) {
        return this.textFieldKeyEventHandler.mo1538onKeyEventCJ9ybgU(event, this.textFieldState, this.textLayoutState, this.textFieldSelectionState, this.clipboardKeyCommandsHandler, this.enabled && !this.readOnly, this.singleLine, new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onKeyEvent$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final void invoke2() {
                TextFieldDecoratorModifierNode textFieldDecoratorModifierNode = TextFieldDecoratorModifierNode.this;
                textFieldDecoratorModifierNode.m1607onImeActionPerformedKlQnJC8(textFieldDecoratorModifierNode.getKeyboardOptions().m1390getImeActionOrDefaulteUduSuo$foundation_release());
            }
        });
    }
    ...
    public void mo688onRemeasuredozmzZPI(long size) {
        this.dragAndDropNode.mo688onRemeasuredozmzZPI(size);
    }
    ...
    public final void m1607onImeActionPerformedKlQnJC8(final int imeAction) {
        KeyboardActionHandler keyboardActionHandler;
        if (ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6638getNoneeUduSuo()) || ImeAction.m6621equalsimpl0(imeAction, ImeAction.INSTANCE.m6634getDefaulteUduSuo()) || (keyboardActionHandler = this.keyboardActionHandler) == null) {
            this.keyboardActionScope.mo1376defaultKeyboardActionKlQnJC8(imeAction);
            ...
            keyboardActionHandler.onKeyboardAction(new Function0<Unit>() { // from class: androidx.compose.foundation.text.input.internal.TextFieldDecoratorModifierNode$onImeActionPerformed$1
                ...
                public final void invoke2() {
                    ...
                    textFieldDecoratorModifierNode$keyboardActionScope$1.mo1376defaultKeyboardActionKlQnJC8(imeAction);
                }
            });
        }
    }
