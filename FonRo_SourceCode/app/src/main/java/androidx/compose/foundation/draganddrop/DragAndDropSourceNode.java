...
public final class DragAndDropSourceNode extends DelegatingNode implements LayoutAwareModifierNode {
    ...
    private final DragAndDropSourceModifierNode dragAndDropModifierNode = (DragAndDropSourceModifierNode) delegate(DragAndDropNodeKt.DragAndDropSourceModifierNode(new Function2<DragAndDropStartTransferScope, Offset, Unit>() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceNode$dragAndDropModifierNode$1
        ...
        public /* bridge */ /* synthetic */ Unit invoke(DragAndDropStartTransferScope dragAndDropStartTransferScope, Offset offset) {
            m689invokeUv8p0NA(dragAndDropStartTransferScope, offset.m4135unboximpl());
            return Unit.INSTANCE;
        }

        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final void m689invokeUv8p0NA(DragAndDropStartTransferScope dragAndDropStartTransferScope, long j) {
            long j2;
            DragAndDropTransferData invoke = DragAndDropSourceNode.this.getTransferData().invoke(Offset.m4114boximpl(j));
            if (invoke != null) {
                j2 = DragAndDropSourceNode.this.size;
                dragAndDropStartTransferScope.mo3962startDragAndDropTransfer12SF9DM(invoke, IntSizeKt.m7172toSizeozmzZPI(j2), DragAndDropSourceNode.this.getDrawDragDecoration());
            }
        }
    }));
            ...
            this.inputModifierNode = (PointerInputModifierNode) delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new PointerInputEventHandler() { // from class: androidx.compose.foundation.draganddrop.DragAndDropSourceNode$onAttach$1
                ...
                public static final class AnonymousClass1 implements DragAndDropStartDetectorScope, PointerInputScope {
                    ...
                    public long mo690getExtendedTouchPaddingNHjbRc() {
                        return this.$$delegate_0.mo690getExtendedTouchPaddingNHjbRc();
                    }
                    ...
                    public void mo692requestDragAndDropTransferk4lQ0M(long offset) {
                        ...
                        dragAndDropSourceModifierNode.mo3965requestDragAndDropTransferk4lQ0M(offset);
                    }
                }
    ...
    public void mo688onRemeasuredozmzZPI(long size) {
        this.size = size;
        this.dragAndDropModifierNode.mo688onRemeasuredozmzZPI(size);
    }
}
