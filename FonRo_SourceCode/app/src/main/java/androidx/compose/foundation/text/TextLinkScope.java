...
public final class TextLinkScope {
    ...
    public static final TextRangeLayoutMeasureResult textRange$lambda$0(TextLinkScope textLinkScope, AnnotatedString.Range range, TextRangeLayoutMeasureScope textRangeLayoutMeasureScope) {
        ...
        if (textLayoutResult == null) {
            return textRangeLayoutMeasureScope.layout(0, 0, new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$layoutResult$1
                ...
                public /* bridge */ /* synthetic */ IntOffset invoke() {
                    return IntOffset.m7108boximpl(m1496invokenOccac());
                }

                /* renamed from: invoke-nOcc-ac, reason: not valid java name */
                public final long m1496invokenOccac() {
        ...
        if (calculateVisibleLinkRange == null) {
            return textRangeLayoutMeasureScope.layout(0, 0, new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$updatedRange$1
                @Override // kotlin.jvm.functions.Function0
                public /* bridge */ /* synthetic */ IntOffset invoke() {
                    return IntOffset.m7108boximpl(m1497invokenOccac());
                }

                /* renamed from: invoke-nOcc-ac, reason: not valid java name */
                public final long m1497invokenOccac() {
                    return IntOffset.INSTANCE.m7128getZeronOccac();
                }
            });
        }
        ...
        return textRangeLayoutMeasureScope.layout(roundToIntRect.getWidth(), roundToIntRect.getHeight(), new Function0<IntOffset>() { // from class: androidx.compose.foundation.text.TextLinkScope$textRange$1$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public /* bridge */ /* synthetic */ IntOffset invoke() {
                return IntOffset.m7108boximpl(m1495invokenOccac());
            }

            /* renamed from: invoke-nOcc-ac, reason: not valid java name */
            public final long m1495invokenOccac() {
                return IntRect.this.m7146getTopLeftnOccac();
            }
        });
    }
    ...
    public final Shape shapeForRange(AnnotatedString.Range<LinkAnnotation> link) {
        ...
        return pathForRangeInRangeCoordinates != null ? new Shape() { // from class: androidx.compose.foundation.text.TextLinkScope$shapeForRange$1$1
            ...
            public Outline mo614createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        if (startRestartGroup.shouldExecute((i2 & 3) != 2, i2 & 1)) {
            ...
            while (i4 < size) {
                ...
                if (range.getStart() != range.getEnd()) {
                    ...
                    }, i3, null), range), mutableInteractionSource, false, 2, null), PointerIcon.INSTANCE.getHand(), false, 2, null);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                    BoxKt.Box(ClickableKt.m596combinedClickableauXiCPI$default(pointerHoverIcon$default, mutableInteractionSource, null, false, null, null, null, null, null, false, (Function0) rememberedValue2, TypedValues.PositionType.TYPE_CURVE_FIT, null), startRestartGroup, 0);
                    ...
                    if (!isNullOrEmpty) {
                        ...
                        if (rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                            rememberedValue4 = (Function2) new TextLinkScope$LinksComposables$1$3$1(linkStateInteractionSourceObserver, null);
