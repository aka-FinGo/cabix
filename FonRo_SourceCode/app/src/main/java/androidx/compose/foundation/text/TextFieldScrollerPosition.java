...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m6440getZerod9O1mEE();
    ...
    public final void m1481setPreviousSelection5zctL8(long j) {
    ...
    public final int m1479getOffsetToFollow5zctL8(long selection) {
        return TextRange.m6435getStartimpl(selection) != TextRange.m6435getStartimpl(this.previousSelection) ? TextRange.m6435getStartimpl(selection) : TextRange.m6430getEndimpl(selection) != TextRange.m6430getEndimpl(this.previousSelection) ? TextRange.m6430getEndimpl(selection) : TextRange.m6433getMinimpl(selection);
    }
