...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl mo650createnHHXs2Y(View view, boolean useTextDefault, long size, float cornerRadius, float elevation, boolean clippingEnabled, Density density, float initialZoom) {
        if (useTextDefault) {
            return new PlatformMagnifierImpl(new Magnifier(view));
        }
        long mo701toSizeXkaWNTQ = density.mo701toSizeXkaWNTQ(size);
        float mo700toPx0680j_4 = density.mo700toPx0680j_4(cornerRadius);
        float mo700toPx0680j_42 = density.mo700toPx0680j_4(elevation);
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (mo701toSizeXkaWNTQ != InlineClassHelperKt.UnspecifiedPackedFloats) {
            builder.setSize(MathKt.roundToInt(Float.intBitsToFloat((int) (mo701toSizeXkaWNTQ >> 32))), MathKt.roundToInt(Float.intBitsToFloat((int) (mo701toSizeXkaWNTQ & 4294967295L))));
        }
        if (!Float.isNaN(mo700toPx0680j_4)) {
            builder.setCornerRadius(mo700toPx0680j_4);
        }
        if (!Float.isNaN(mo700toPx0680j_42)) {
            builder.setElevation(mo700toPx0680j_42);
        }
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo649updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            if (!Float.isNaN(zoom)) {
