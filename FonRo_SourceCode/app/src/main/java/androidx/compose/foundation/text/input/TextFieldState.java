...
public final class TextFieldState {
    ...
    /* compiled from: TextFieldState.kt */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\bà\u0080\u0001\u0018\u00002\u00020\u0001J \u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\bH&ø\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001¨\u0006\tÀ\u0006\u0001"}, d2 = {"Landroidx/compose/foundation/text/input/TextFieldState$NotifyImeListener;", "", "onChange", "", "oldValue", "Landroidx/compose/foundation/text/input/TextFieldCharSequence;", "newValue", "restartIme", "", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        String str2 = str;
        this.mainBuffer = new TextFieldBuffer(new TextFieldCharSequence(str2, TextRangeKt.m6441coerceIn8ffj60Q(j, 0, str.length()), null, null, null, 28, null), null, null, null, 14, null);
    ...
    */
    ...
    public final long m1514getSelectiond9O1mEE() {
        return getValue$foundation_release().getSelection();
    }

    /* renamed from: getComposition-MzsxiRA */
    public final TextRange m1513getCompositionMzsxiRA() {
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m6438toStringimpl(m1514getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean m6428equalsimpl0 = true ^ TextRange.m6428equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.getSelectionInChars());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        syncMainBufferToTemporaryBuffer$foundation_release(newValue, z, m6428equalsimpl0);
    }
    ...
    public final void editWithNoSideEffects$foundation_release(Function1<? super TextFieldBuffer, Unit> block) {
        getMainBuffer().getChangeTracker$foundation_release().clearChanges();
        block.invoke(getMainBuffer());
        updateValueAndNotifyListeners(getValue$foundation_release(), TextFieldBuffer.m1501toTextFieldCharSequenceI88jaVs$foundation_release$default(getMainBuffer(), 0L, null, null, 7, null), true);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        List m1516finalizeComposingAnnotationsitr0ztk;
        List m1516finalizeComposingAnnotationsitr0ztk2;
        TextFieldCharSequence value$foundation_release = getValue$foundation_release();
        if (this.mainBuffer.getChangeTracker$foundation_release().getChangeCount() == 0 && TextRange.m6428equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.getSelectionInChars())) {
            ...
            m1516finalizeComposingAnnotationsitr0ztk2 = TextFieldStateKt.m1516finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation_release());
            updateValueAndNotifyListeners(value$foundation_release2, new TextFieldCharSequence(textFieldBuffer, selectionInChars, composition, highlight$foundation_release, m1516finalizeComposingAnnotationsitr0ztk2, null), restartImeIfContentChanges);
            return;
        }
        boolean z = false;
        ...
        m1516finalizeComposingAnnotationsitr0ztk = TextFieldStateKt.m1516finalizeComposingAnnotationsitr0ztk(this.mainBuffer.getComposition(), this.mainBuffer.getComposingAnnotations$foundation_release());
        TextFieldCharSequence textFieldCharSequence = new TextFieldCharSequence(textFieldBuffer2, selectionInChars2, composition2, highlight$foundation_release2, m1516finalizeComposingAnnotationsitr0ztk, null);
        ...
        boolean m6428equalsimpl0 = TextRange.m6428equalsimpl0(textFieldBuffer3.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z4 = !m6428equalsimpl0;
        if (!contentEquals || !m6428equalsimpl0) {
            syncMainBufferToTemporaryBuffer$foundation_release(textFieldBuffer3, z3, z4);
        } else {
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1501toTextFieldCharSequenceI88jaVs$foundation_release$default(textFieldBuffer3, 0L, textFieldCharSequence.getComposition(), null, 5, null), restartImeIfContentChanges);
        }
    ...
    public final void syncMainBufferToTemporaryBuffer$foundation_release(TextFieldBuffer temporaryBuffer, boolean textChanged, boolean selectionChanged) {
        TextFieldCharSequence m1501toTextFieldCharSequenceI88jaVs$foundation_release$default = TextFieldBuffer.m1501toTextFieldCharSequenceI88jaVs$foundation_release$default(this.mainBuffer, 0L, null, null, 7, null);
        if (textChanged) {
            ...
            this.mainBuffer.m1506setSelection5zctL8(TextRangeKt.TextRange(TextRange.m6435getStartimpl(temporaryBuffer.getSelectionInChars()), TextRange.m6430getEndimpl(temporaryBuffer.getSelectionInChars())));
        }
        if (textChanged || selectionChanged || !Intrinsics.areEqual(m1501toTextFieldCharSequenceI88jaVs$foundation_release$default.getComposition(), temporaryBuffer.getComposition())) {
            this.mainBuffer.commitComposition$foundation_release();
        }
        updateValueAndNotifyListeners(m1501toTextFieldCharSequenceI88jaVs$foundation_release$default, TextFieldBuffer.m1501toTextFieldCharSequenceI88jaVs$foundation_release$default(this.mainBuffer, 0L, null, null, 7, null), true);
    }

    /* compiled from: TextFieldState.kt */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\bÇ\u0002\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0004J\u0012\u0010\u0005\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0006\u001a\u00020\u0003H\u0016J\u0016\u0010\u0007\u001a\u0004\u0018\u00010\u0003*\u00020\b2\u0006\u0010\u0006\u001a\u00020\u0002H\u0016¨\u0006\t"}, d2 = {"Landroidx/compose/foundation/text/input/TextFieldState$Saver;", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/foundation/text/input/TextFieldState;", "", "()V", "restore", "value", "save", "Landroidx/compose/runtime/saveable/SaverScope;", "foundation_release"}, k = 1, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes.dex */
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m6435getStartimpl(textFieldState.m1514getSelectiond9O1mEE())), Integer.valueOf(TextRange.m6430getEndimpl(textFieldState.m1514getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
