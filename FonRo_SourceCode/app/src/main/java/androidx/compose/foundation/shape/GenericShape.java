...
public final class GenericShape implements Shape {
    ...
    public Outline mo614createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
        ...
        this.builder.invoke(Path, Size.m4182boximpl(size), layoutDirection);
        Path.close();
