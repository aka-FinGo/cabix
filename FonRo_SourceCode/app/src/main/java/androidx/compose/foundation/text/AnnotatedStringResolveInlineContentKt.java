...
public final class AnnotatedStringResolveInlineContentKt {
    ...
    public static final void InlineChildren(final AnnotatedString annotatedString, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> list, Composer composer, final int i) {
        ...
        ComposerKt.sourceInformation(startRestartGroup, "C(InlineChildren)P(1)*69@2648L334:AnnotatedStringResolveInlineContent.kt#423gt5");
        if ((i & 6) == 0) {
        ...
        if (!startRestartGroup.shouldExecute((i2 & 19) != 18, i2 & 1)) {
            ...
            while (i4 < size) {
                ...
                AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 annotatedStringResolveInlineContentKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                    ...
                    public final MeasureResult mo356measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list2, long j) {
                        ArrayList arrayList = new ArrayList(list2.size());
                        int size2 = list2.size();
                        for (int i5 = 0; i5 < size2; i5++) {
                            arrayList.add(list2.get(i5).mo5732measureBRTryo0(j));
                        }
                        final ArrayList arrayList2 = arrayList;
                        return MeasureScope.layout$default(measureScope, Constraints.m6942getMaxWidthimpl(j), Constraints.m6941getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2.1
                ...
                Updater.m3815setimpl(m3808constructorimpl, annotatedStringResolveInlineContentKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                ...
                ComposerKt.sourceInformationMarkerStart(startRestartGroup, 256083996, "C69@2667L42:AnnotatedStringResolveInlineContent.kt#423gt5");
