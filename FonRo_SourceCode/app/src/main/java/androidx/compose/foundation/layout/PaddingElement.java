...
public final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final void m1040setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m1041setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m1039setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m1038setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public void update(PaddingNode node) {
        node.m1060setStart0680j_4(this.start);
        node.m1061setTop0680j_4(this.top);
        node.m1059setEnd0680j_4(this.end);
        node.m1058setBottom0680j_4(this.bottom);
        node.setRtlAware(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((((((Dp.m6995hashCodeimpl(this.start) * 31) + Dp.m6995hashCodeimpl(this.top)) * 31) + Dp.m6995hashCodeimpl(this.end)) * 31) + Dp.m6995hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        PaddingElement paddingElement = other instanceof PaddingElement ? (PaddingElement) other : null;
        return paddingElement != null && Dp.m6994equalsimpl0(this.start, paddingElement.start) && Dp.m6994equalsimpl0(this.top, paddingElement.top) && Dp.m6994equalsimpl0(this.end, paddingElement.end) && Dp.m6994equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m6989constructorimpl(0.0f) : f, (i & 2) != 0 ? Dp.m6989constructorimpl(0.0f) : f2, (i & 4) != 0 ? Dp.m6989constructorimpl(0.0f) : f3, (i & 8) != 0 ? Dp.m6989constructorimpl(0.0f) : f4, z, function1, null);
    }
}
