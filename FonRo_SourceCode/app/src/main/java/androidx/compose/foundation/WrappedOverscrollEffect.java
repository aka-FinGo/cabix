...
final class WrappedOverscrollEffect implements OverscrollEffect {
    ...
    public long mo537applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        if (this.eventHandlingEnabled) {
            return this.innerOverscrollEffect.mo537applyToScrollRhakbz0(delta, source, performScroll);
        }
    ...
    public Object mo536applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        if (this.eventHandlingEnabled) {
            Object mo536applyToFlingBMRW4eQ = this.innerOverscrollEffect.mo536applyToFlingBMRW4eQ(j, function2, continuation);
