...
public final class CursorAnchorInfoBuilder_androidKt {
    ...
    public static /* synthetic */ CursorAnchorInfo m1551buildvxqZcH0$default(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4, int i, Object obj) {
        ...
        return m1550buildvxqZcH0(builder, charSequence, j, textRange, textLayoutResult, matrix, rect, rect2, z, z2, z3, z4);
    }

    /* renamed from: build-vxqZcH0, reason: not valid java name */
    public static final CursorAnchorInfo m1550buildvxqZcH0(CursorAnchorInfo.Builder builder, CharSequence charSequence, long j, TextRange textRange, TextLayoutResult textLayoutResult, Matrix matrix, Rect rect, Rect rect2, boolean z, boolean z2, boolean z3, boolean z4) {
        builder.reset();
        builder.setMatrix(matrix);
        int m6433getMinimpl = TextRange.m6433getMinimpl(j);
        builder.setSelectionRange(m6433getMinimpl, TextRange.m6432getMaximpl(j));
        if (z) {
            setInsertionMarker(builder, m6433getMinimpl, textLayoutResult, rect);
        }
        if (z2) {
            int m6433getMinimpl2 = textRange != null ? TextRange.m6433getMinimpl(textRange.getPackedValue()) : -1;
            int m6432getMaximpl = textRange != null ? TextRange.m6432getMaximpl(textRange.getPackedValue()) : -1;
            if (m6433getMinimpl2 >= 0 && m6433getMinimpl2 < m6432getMaximpl) {
                builder.setComposingText(m6433getMinimpl2, charSequence.subSequence(m6433getMinimpl2, m6432getMaximpl));
                addCharacterBounds(builder, m6433getMinimpl2, m6432getMaximpl, textLayoutResult, rect);
            }
        }
    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(android.view.inputmethod.CursorAnchorInfo.Builder r14, int r15, int r16, androidx.compose.ui.text.TextLayoutResult r17, androidx.compose.ui.geometry.Rect r18) {
        /*
            ...
            r6 = 0
            r3.m6285fillBoundingBoxes8ffj60Q(r4, r2, r6)
            r8 = r15
        L17:
            if (r8 >= r0) goto L76
            int r3 = r8 - r15
