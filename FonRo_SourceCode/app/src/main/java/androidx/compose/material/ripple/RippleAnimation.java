...
public final class RippleAnimation {
    ...
    */
    ...
    public final void m1844draw4WTKRHQ(DrawScope drawScope, long j) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1846getRippleStartRadiusuvyYCjk(drawScope.mo4935getSizeNHjbRc()));
        }
        if (this.origin == null) {
            this.origin = Offset.m4114boximpl(drawScope.mo4934getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m4114boximpl(OffsetKt.Offset(Size.m4194getWidthimpl(drawScope.mo4935getSizeNHjbRc()) / 2.0f, Size.m4191getHeightimpl(drawScope.mo4935getSizeNHjbRc()) / 2.0f));
        }
        ...
        float m4125getXimpl = Offset.m4125getXimpl(offset.m4135unboximpl());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float lerp2 = MathHelpersKt.lerp(m4125getXimpl, Offset.m4125getXimpl(offset2.m4135unboximpl()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float m4126getYimpl = Offset.m4126getYimpl(offset3.m4135unboximpl());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long Offset = OffsetKt.Offset(lerp2, MathHelpersKt.lerp(m4126getYimpl, Offset.m4126getYimpl(offset4.m4135unboximpl()), this.animatedCenterPercent.getValue().floatValue()));
        long m4383copywmQWz5c$default = Color.m4383copywmQWz5c$default(j, Color.m4386getAlphaimpl(j) * floatValue, 0.0f, 0.0f, 0.0f, 14, null);
        if (!this.bounded) {
            DrawScope.m4916drawCircleVaOC9Bg$default(drawScope, m4383copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            return;
        }
        ...
        try {
            drawContext.getTransform().mo4859clipRectN_I0leg(0.0f, 0.0f, m4194getWidthimpl, m4191getHeightimpl, m4373getIntersectrtfAjoo);
            DrawScope.m4916drawCircleVaOC9Bg$default(drawScope, m4383copywmQWz5c$default, lerp, Offset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        } finally {
