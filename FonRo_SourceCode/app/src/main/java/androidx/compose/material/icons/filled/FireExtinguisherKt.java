...
public final class FireExtinguisherKt {
    ...
    public static final ImageVector getFireExtinguisher(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.FireExtinguisher", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
