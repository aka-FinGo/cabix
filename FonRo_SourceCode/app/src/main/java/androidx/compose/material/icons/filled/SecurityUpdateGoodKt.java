...
public final class SecurityUpdateGoodKt {
    ...
    public static final ImageVector getSecurityUpdateGood(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SecurityUpdateGood", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
