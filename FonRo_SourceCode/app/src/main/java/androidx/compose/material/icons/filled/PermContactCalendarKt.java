...
public final class PermContactCalendarKt {
    ...
    public static final ImageVector getPermContactCalendar(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PermContactCalendar", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
