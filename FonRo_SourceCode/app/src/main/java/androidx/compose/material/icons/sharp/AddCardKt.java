...
public final class AddCardKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getAddCard(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r2.horizontalLineToRelative(r9)
            r9 = -1073741824(0xffffffffc0000000, float:-2.0)
            r2.verticalLineToRelative(r9)
            r2.horizontalLineTo(r6)
            r12 = -1061158912(0xffffffffc0c00000, float:-6.0)
            r2.verticalLineToRelative(r12)
            r12 = 1099956224(0x41900000, float:18.0)
            r2.horizontalLineToRelative(r12)
            r2.verticalLineTo(r6)
            ...
            r2.horizontalLineToRelative(r6)
            r2.verticalLineTo(r4)
            r2.close()
            ...
            r2.horizontalLineToRelative(r6)
            r2.verticalLineToRelative(r4)
            r2.horizontalLineToRelative(r7)
            r2.verticalLineToRelative(r6)
