...
public final class PianoKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPiano(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.close()
            r0.moveTo(r6, r6)
            r2 = -1068498944(0xffffffffc0500000, float:-3.25)
            r0.horizontalLineToRelative(r2)
            r0.verticalLineToRelative(r7)
