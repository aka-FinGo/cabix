...
public final class PauseCircleKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPauseCircle(androidx.compose.material.icons.Icons.Outlined r19) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.PauseCircleKt._pauseCircle
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.PauseCircle"
            ...
            r7 = 1083137065(0x408f5c29, float:4.48)
            r8 = 1092616192(0x41200000, float:10.0)
            r12.reflectiveCurveToRelative(r7, r8, r8, r8)
            r7 = -1064346583(0xffffffffc08f5c29, float:-4.48)
            r9 = -1054867456(0xffffffffc1200000, float:-10.0)
            r12.reflectiveCurveToRelative(r8, r7, r8, r9)
            r7 = 1099704566(0x418c28f6, float:17.52)
            r12.reflectiveCurveTo(r7, r4, r0, r4)
            r12.close()
            ...
            r8 = 1080410767(0x4065c28f, float:3.59)
            r9 = -1056964608(0xffffffffc1000000, float:-8.0)
            r12.reflectiveCurveToRelative(r8, r9, r6, r9)
            r12.reflectiveCurveToRelative(r6, r8, r6, r6)
            r8 = 1099122606(0x418347ae, float:16.41)
            r12.reflectiveCurveTo(r8, r7, r0, r7)
            r12.close()
            ...
            androidx.compose.material.icons.outlined.PauseCircleKt._pauseCircle = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
