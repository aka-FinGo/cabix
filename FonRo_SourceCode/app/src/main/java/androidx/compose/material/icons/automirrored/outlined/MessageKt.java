...
public final class MessageKt {
    ...
    public static final ImageVector getMessage(Icons.AutoMirrored.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Outlined.Message", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
