...
public final class FilterHdrKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFilterHdr(androidx.compose.material.icons.Icons.Sharp r19) {
        /*
        ...
        L8:
            ...
            r4 = 1077306982(0x40366666, float:2.85)
            r6 = 1081291571(0x40733333, float:3.8)
            r12.lineToRelative(r4, r6)
            r4 = -1077097267(0xffffffffbfcccccd, float:-1.6)
            r6 = 1067030938(0x3f99999a, float:1.2)
            r12.lineToRelative(r4, r6)
            r17 = 1088421888(0x40e00000, float:7.0)
            r18 = 1092616192(0x41200000, float:10.0)
            r13 = 1092416963(0x411cf5c3, float:9.81)
            r14 = 1096548352(0x415c0000, float:13.75)
