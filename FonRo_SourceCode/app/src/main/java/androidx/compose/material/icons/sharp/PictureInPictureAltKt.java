...
public final class PictureInPictureAltKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getPictureInPictureAlt(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.close()
            r7 = 1100490998(0x419828f6, float:19.02)
            r0.moveTo(r4, r7)
            r0.lineTo(r6, r7)
            r4 = 1084164669(0x409f0a3d, float:4.97)
            r0.lineTo(r6, r4)
            r0.horizontalLineToRelative(r2)
            r2 = 1096862925(0x4160cccd, float:14.05)
            r0.verticalLineToRelative(r2)
            r0.close()
