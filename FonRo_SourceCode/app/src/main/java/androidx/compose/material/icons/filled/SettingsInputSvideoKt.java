...
public final class SettingsInputSvideoKt {
    ...
    public static final ImageVector getSettingsInputSvideo(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.SettingsInputSvideo", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
