...
public final class FolderDeleteKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFolderDelete(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r9 = -1062207488(0xffffffffc0b00000, float:-5.5)
            r0.verticalLineToRelative(r9)
            r0.horizontalLineToRelative(r8)
            r0.verticalLineTo(r6)
            r0.horizontalLineTo(r4)
