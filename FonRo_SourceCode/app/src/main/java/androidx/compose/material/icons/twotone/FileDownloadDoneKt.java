...
public final class FileDownloadDoneKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFileDownloadDone(androidx.compose.material.icons.Icons.TwoTone r19) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.twotone.FileDownloadDoneKt._fileDownloadDone
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "TwoTone.FileDownloadDone"
            ...
            r0.<init>()
            r4 = 1101072957(0x41a10a3d, float:20.13)
            r6 = 1085087416(0x40ad1eb8, float:5.41)
            r0.moveTo(r4, r6)
            r4 = -1078691103(0xffffffffbfb47ae1, float:-1.41)
            r0.lineToRelative(r4, r4)
            r6 = -1055716803(0xffffffffc1130a3d, float:-9.19)
            r7 = 1091766845(0x41130a3d, float:9.19)
            r0.lineToRelative(r6, r7)
            r6 = -1064828928(0xffffffffc0880000, float:-4.25)
            r7 = -1064849900(0xffffffffc087ae14, float:-4.24)
            r0.lineToRelative(r6, r7)
            r6 = 1068792545(0x3fb47ae1, float:1.41)
            r0.lineToRelative(r4, r6)
            r4 = 1085611704(0x40b51eb8, float:5.66)
            r0.lineToRelative(r4, r4)
            r0.close()
            ...
            r2 = r0
            r0 = r18
            androidx.compose.ui.graphics.vector.ImageVector.Builder.m5069addPathoIyEayM$default(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17)
            int r3 = androidx.compose.ui.graphics.vector.VectorKt.getDefaultFillType()
            ...
            androidx.compose.material.icons.twotone.FileDownloadDoneKt._fileDownloadDone = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
