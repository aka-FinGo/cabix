...
public final class ClosedCaptionDisabledKt {
    ...
    public static final ImageVector getClosedCaptionDisabled(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ClosedCaptionDisabled", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
