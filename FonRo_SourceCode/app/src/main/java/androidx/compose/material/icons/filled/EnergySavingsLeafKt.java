...
public final class EnergySavingsLeafKt {
    ...
    public static final ImageVector getEnergySavingsLeaf(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.EnergySavingsLeaf", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
