...
public final class MergeKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getMerge(androidx.compose.material.icons.Icons.Outlined r19) {
        /*
            androidx.compose.ui.graphics.vector.ImageVector r0 = androidx.compose.material.icons.outlined.MergeKt._merge
            if (r0 == 0) goto L8
        ...
        L8:
            ...
            r11 = 96
            r12 = 0
            java.lang.String r2 = "Outlined.Merge"
            ...
            r12.lineTo(r4, r6)
            r4 = 1083871068(0x409a8f5c, float:4.83)
            r7 = -1063612580(0xffffffffc09a8f5c, float:-4.83)
            r12.lineToRelative(r4, r7)
            r17 = 1066779279(0x3f95c28f, float:1.17)
            r18 = -1070260552(0xffffffffc0351eb8, float:-2.83)
            r13 = 1061158912(0x3f400000, float:0.75)
            r14 = -1086324736(0xffffffffbf400000, float:-0.75)
            r15 = 1066779279(0x3f95c28f, float:1.17)
            r16 = -1075671204(0xffffffffbfe28f5c, float:-1.77)
            r12.curveToRelative(r13, r14, r15, r16, r17, r18)
            r4 = -1063046349(0xffffffffc0a33333, float:-5.1)
            r12.verticalLineToRelative(r4)
            r4 = 1091997532(0x41168f5c, float:9.41)
            r7 = 1090948956(0x41068f5c, float:8.41)
            r12.lineTo(r4, r7)
            ...
            r12.verticalLineToRelative(r4)
            r18 = 1077223096(0x40351eb8, float:2.83)
            r13 = 0
            r14 = 1065856532(0x3f87ae14, float:1.06)
            r15 = 1054280253(0x3ed70a3d, float:0.42)
            r16 = 1074077368(0x40051eb8, float:2.08)
            r12.curveToRelative(r13, r14, r15, r16, r17, r18)
            r4 = 1100480512(0x41980000, float:19.0)
            r12.lineTo(r4, r6)
            r4 = 1099741266(0x418cb852, float:17.59)
            r12.lineTo(r4, r2)
            r4 = 1094713344(0x41400000, float:12.0)
            r6 = 1098288988(0x41768f5c, float:15.41)
            r12.lineTo(r4, r6)
            r12.lineTo(r0, r2)
            r12.close()
            ...
            androidx.compose.material.icons.outlined.MergeKt._merge = r0
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)
            return r0
        */
