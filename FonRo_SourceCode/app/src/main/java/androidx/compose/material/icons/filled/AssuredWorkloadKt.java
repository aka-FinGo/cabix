...
public final class AssuredWorkloadKt {
    ...
    public static final ImageVector getAssuredWorkload(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.AssuredWorkload", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
