...
public final class DirectionsRailwayFilledKt {
    ...
    public static final ImageVector getDirectionsRailwayFilled(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.DirectionsRailwayFilled", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
