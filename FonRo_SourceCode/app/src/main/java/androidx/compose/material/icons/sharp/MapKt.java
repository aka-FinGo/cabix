...
public final class MapKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getMap(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.lineTo(r6, r7)
            r8 = 1084269527(0x40a0a3d7, float:5.02)
            r0.lineTo(r7, r8)
            r7 = 1099012506(0x4181999a, float:16.2)
            r0.verticalLineToRelative(r7)
            r7 = -1072357704(0xffffffffc0151eb8, float:-2.33)
            r8 = 1086324736(0x40c00000, float:6.0)
            r0.lineToRelative(r8, r7)
            r7 = 1074161254(0x40066666, float:2.1)
            r0.lineToRelative(r8, r7)
            r7 = -1073657938(0xffffffffc00147ae, float:-2.02)
            r0.lineToRelative(r8, r7)
            r7 = 1101529088(0x41a80000, float:21.0)
            r9 = 1076971438(0x403147ae, float:2.77)
            r0.lineTo(r7, r9)
            r0.lineTo(r2, r4)
            r0.close()
            r4 = 1100422840(0x41971eb8, float:18.89)
            r0.moveTo(r2, r4)
            r2 = -1061158912(0xffffffffc0c00000, float:-6.0)
            r4 = -1073280451(0xffffffffc0070a3d, float:-2.11)
            r0.lineToRelative(r2, r4)
            r2 = 1084458271(0x40a3851f, float:5.11)
            r0.lineTo(r6, r2)
            r2 = 1074203197(0x40070a3d, float:2.11)
            r0.lineToRelative(r8, r2)
            r2 = 1094367314(0x413ab852, float:11.67)
