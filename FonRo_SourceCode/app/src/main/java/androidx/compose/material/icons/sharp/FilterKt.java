...
public final class FilterKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFilter(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1098865705(0x417f5c29, float:15.96)
            r4 = 1092920279(0x4124a3d7, float:10.29)
            r0.moveTo(r2, r4)
