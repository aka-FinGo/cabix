...
public final class ElectricRickshawKt {
    ...
    public static final ImageVector getElectricRickshaw(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.ElectricRickshaw", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
