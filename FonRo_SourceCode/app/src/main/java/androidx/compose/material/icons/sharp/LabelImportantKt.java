...
public final class LabelImportantKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getLabelImportant(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1100475269(0x4197eb85, float:18.99)
            r4 = 1082130432(0x40800000, float:4.0)
            r0.moveTo(r4, r2)
            r2 = 1094755287(0x4140a3d7, float:12.04)
