...
public final class ClosedCaptionOffKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getClosedCaptionOff(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.horizontalLineToRelative(r15)
            r0.verticalLineToRelative(r7)
            r0.horizontalLineToRelative(r8)
            r0.verticalLineToRelative(r2)
            r0.horizontalLineToRelative(r9)
