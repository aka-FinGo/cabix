...
public final class PhotoCameraBackKt {
    ...
    public static final ImageVector getPhotoCameraBack(Icons.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Filled.PhotoCameraBack", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
