...
public final class FormatTextdirectionLToRKt {
    ...
    public static final ImageVector getFormatTextdirectionLToR(Icons.AutoMirrored.Filled filled) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("AutoMirrored.Filled.FormatTextdirectionLToR", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, true, 96, null);
