...
public final class OndemandVideoKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getOndemandVideo(androidx.compose.material.icons.Icons.Sharp r18) {
        /*
        ...
        L8:
            ...
            r0.verticalLineToRelative(r8)
            r8 = 1088400916(0x40dfae14, float:6.99)
            r0.horizontalLineToRelative(r8)
            r0.lineTo(r2, r4)
            r0.close()
