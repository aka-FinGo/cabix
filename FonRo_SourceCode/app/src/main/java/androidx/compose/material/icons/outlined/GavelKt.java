...
public final class GavelKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getGavel(androidx.compose.material.icons.Icons.Outlined r18) {
        /*
        ...
        L8:
            ...
            r0.verticalLineToRelative(r2)
            r0.close()
            r2 = 1084730900(0x40a7ae14, float:5.24)
            r6 = 1090592440(0x41011eb8, float:8.07)
            r0.moveTo(r2, r6)
            r7 = 1077223096(0x40351eb8, float:2.83)
            r8 = -1070260552(0xffffffffc0351eb8, float:-2.83)
            r0.lineToRelative(r7, r8)
            r9 = 1096957297(0x41623d71, float:14.14)
            r0.lineToRelative(r9, r9)
            r0.lineToRelative(r8, r7)
            r0.lineTo(r2, r6)
            r0.close()
            r2 = 1095048888(0x41451eb8, float:12.32)
            r0.moveTo(r2, r4)
            r6 = 1085611704(0x40b51eb8, float:5.66)
            r0.lineToRelative(r6, r6)
            r0.lineToRelative(r8, r7)
            r9 = -1061871944(0xffffffffc0b51eb8, float:-5.66)
            r0.lineToRelative(r9, r9)
            r0.lineTo(r2, r4)
            r0.close()
            r2 = 1081417400(0x40751eb8, float:3.83)
            r9 = 1092070932(0x4117ae14, float:9.48)
            r0.moveTo(r2, r9)
            r0.lineToRelative(r6, r6)
            r0.lineToRelative(r8, r7)
            r2 = 1095038403(0x4144f5c3, float:12.31)
            r0.lineTo(r4, r2)
            r0.lineToRelative(r7, r8)
            r0.close()
