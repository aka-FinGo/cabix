...
public final class FirstPageKt {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: InlineMethods
        ...
        */
    public static final androidx.compose.ui.graphics.vector.ImageVector getFirstPage(androidx.compose.material.icons.Icons.TwoTone r18) {
        /*
        ...
        L8:
            ...
            r0.<init>()
            r2 = 1100171182(0x419347ae, float:18.41)
            r4 = 1099216978(0x4184b852, float:16.59)
            r0.moveTo(r2, r4)
            r2 = 1096621752(0x415d1eb8, float:13.82)
