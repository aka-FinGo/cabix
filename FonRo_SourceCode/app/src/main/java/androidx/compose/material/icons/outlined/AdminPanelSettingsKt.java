...
public final class AdminPanelSettingsKt {
    ...
    public static final ImageVector getAdminPanelSettings(Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AdminPanelSettings", Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
