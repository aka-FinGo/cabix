...
public final class PersistentVectorBuilder<E> extends AbstractMutableList<E> implements PersistentList.Builder<E> {
    ...
    private final void insertIntoTail(Object[] root, int index, E element) {
        ...
        if (tailSize < 32) {
            ArraysKt.copyInto(objArr, makeMutable, index + 1, index, tailSize);
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (size == 0) {
            CommonFunctionsKt.m3921assert(index >= rootSize());
            int i2 = index & 31;
        ...
        if (index >= rootSize()) {
            ...
            if (tailSize2 > tailSize) {
                ...
                Object[] makeMutableShiftingRight = persistentVectorBuilder.makeMutableShiftingRight(objArr4, i3);
                ...
                copyInto = ArraysKt.copyInto(objArr4, persistentVectorBuilder.mutableBuffer(), 0, i4, tailSize);
                int i5 = 32 - i4;
                Object[] makeMutableShiftingRight2 = persistentVectorBuilder.makeMutableShiftingRight(persistentVectorBuilder.tail, i5);
                int i6 = size - 1;
    ...
    private final Object removeFromTailAt(Object[] root, int rootSize, int shift, int index) {
        ...
        CommonFunctionsKt.m3921assert(index < size);
        Object[] objArr = this.tail;
        if (size == 1) {
            Object obj = objArr[0];
    ...
    private final boolean removeAll(Function1<? super E, Boolean> predicate) {
        ...
        if (i == 32) {
            CommonFunctionsKt.m3921assert(!leafBufferIterator.hasNext());
    ...
    private final int removeAllFromTail(Function1<? super E, Boolean> predicate, int tailSize, ObjectRef bufferRef) {
        ...
        if (removeAll == tailSize) {
            CommonFunctionsKt.m3921assert(bufferRef.getValue() == this.tail);
            return tailSize;
        }
