...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3781boximpl(Composer composer) {
    ...
    public static String m3786toStringimpl(Composer composer) {
    ...
    public String toString() {
        return m3786toStringimpl(this.composer);
    }
    ...
    public static final void m3787updateimpl(Composer composer, Function1<? super Updater<T>, Unit> function1) {
        composer.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3807boximpl(Updater.m3808constructorimpl(composer)));
