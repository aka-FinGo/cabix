...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m3807boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m3808constructorimpl(Composer composer) {
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3809equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3810equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m3811hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3816toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m3809equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3811hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3816toStringimpl(this.composer);
    }
    ...
    public static final void m3814setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m3815setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
    ...
    public static final void m3817updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> function2) {
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m3818updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> function2) {
        boolean inserting = composer.getInserting();
    ...
    public static final void m3812initimpl(Composer composer, final Function1<? super T, Unit> function1) {
    ...
    public static final void m3813reconcileimpl(Composer composer, final Function1<? super T, Unit> function1) {
