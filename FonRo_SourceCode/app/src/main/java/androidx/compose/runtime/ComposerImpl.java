...
public final class ComposerImpl implements Composer {
    ...
    private final ArrayList<T> pendingStack = Stack.m3793constructorimpl$default(null, 1, null);
    ...
    public ComposerImpl(Applier<?> applier, CompositionContext compositionContext, SlotTable slotTable, Set<RememberObserver> set, ChangeList changeList, ChangeList changeList2, ControlledComposition controlledComposition) {
        ...
        this.invalidateStack = Stack.m3793constructorimpl$default(null, 1, null);
    ...
    public void startReplaceableGroup(int key) {
        m3748startBaiHCIY(key, null, GroupKind.INSTANCE.m3762getGroupULZAiWs(), null);
    }
    ...
    public void startDefaults() {
        m3748startBaiHCIY(-127, null, GroupKind.INSTANCE.m3762getGroupULZAiWs(), null);
    }
    ...
    public void startMovableGroup(int key, Object dataKey) {
        m3748startBaiHCIY(key, dataKey, GroupKind.INSTANCE.m3762getGroupULZAiWs(), null);
    }
    ...
    private final void abortRoot() {
        cleanUpCompose();
        Stack.m3791clearimpl(this.pendingStack);
    ...
    public final void deactivate$runtime_release() {
        Stack.m3791clearimpl(this.invalidateStack);
    ...
    public void startNode() {
        m3748startBaiHCIY(125, null, GroupKind.INSTANCE.m3763getNodeULZAiWs(), null);
        this.nodeExpected = true;
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m3748startBaiHCIY(125, null, GroupKind.INSTANCE.m3764getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    public void startReusableGroup(int key, Object dataKey) {
        ...
        m3748startBaiHCIY(key, null, GroupKind.INSTANCE.m3762getGroupULZAiWs(), dataKey);
    }
    ...
    public void startProvider(ProvidedValue<?> value) {
        ...
        m3748startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3762getGroupULZAiWs(), currentCompositionLocalScope);
    }
    ...
    public void startProviders(ProvidedValue<?>[] values) {
        ...
        m3748startBaiHCIY(202, ComposerKt.getCompositionLocalMap(), GroupKind.INSTANCE.m3762getGroupULZAiWs(), updateProviderMapGroup);
    }
    ...
    public CompositionContext buildContext() {
        ...
        if (compositionContextHolder == null) {
            ...
            composerImpl = this;
            compositionContextHolder = new CompositionContextHolder(new CompositionContextImpl(compoundKeyHash, z, z2, observerHolder));
    ...
    public final RecomposeScopeImpl getCurrentRecomposeScope$runtime_release() {
        ...
        if (this.childrenComposing == 0 && Stack.m3799isNotEmptyimpl(arrayList)) {
            return (RecomposeScopeImpl) Stack.m3800peekimpl(arrayList);
        }
        return null;
    }
    ...
    */
    private final void m3748startBaiHCIY(int r13, java.lang.Object r14, int r15, java.lang.Object r16) {
        /*
            Method dump skipped, instructions count: 472
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.ComposerImpl.m3748startBaiHCIY(int, java.lang.Object, int, java.lang.Object):void");
    }

    private final void enterGroup(boolean isNode, Pending newPending) {
        Stack.m3803pushimpl(this.pendingStack, this.pending);
    ...
    private final void exitGroup(int expectedNodeCount, boolean inserting) {
        Pending pending = (Pending) Stack.m3802popimpl(this.pendingStack);
    ...
    private final void recomposeToGroupEnd() {
        ...
        while (firstInRange != null) {
            ...
            if (firstInRange.isInvalid()) {
                ...
                Stack.m3803pushimpl(this.invalidateStack, firstInRange.getScope());
                firstInRange.getScope().rereadTrackedInstances();
                Stack.m3802popimpl(this.invalidateStack);
            }
            firstInRange = ComposerKt.firstInRange(this.invalidations, this.reader.getCurrentGroup(), groupSize);
        }
        if (z2) {
    ...
    private final void updateNodeCountOverrides(int group, int newCount) {
        ...
        if (updatedNodeCount != newCount) {
            ...
            int m3796getSizeimpl = Stack.m3796getSizeimpl(this.pendingStack) - 1;
            while (group != -1) {
                int updatedNodeCount2 = updatedNodeCount(group) + i;
                updateNodeCount(group, updatedNodeCount2);
                int i2 = m3796getSizeimpl;
                while (true) {
                    if (-1 < i2) {
                        Pending pending = (Pending) Stack.m3801peekimpl(this.pendingStack, i2);
                        if (pending != null && pending.updateNodeCount(group, updatedNodeCount2)) {
                            m3796getSizeimpl = i2 - 1;
                            break;
                        }
                        i2--;
                    } else {
    ...
    */
    private final void addRecomposeScope() {
        /*
            ...
            androidx.compose.runtime.Stack.m3803pushimpl(r1, r0)
            r4.updateValue(r0)
        ...
        L72:
            ...
            androidx.compose.runtime.Stack.m3803pushimpl(r0, r2)
    ...
    public ScopeUpdateScope endRestartGroup() {
        ...
        RecomposeScopeImpl recomposeScopeImpl2 = Stack.m3799isNotEmptyimpl(this.invalidateStack) ? (RecomposeScopeImpl) Stack.m3802popimpl(this.invalidateStack) : null;
    ...
    */
    public final void invokeMovableContentLambda(final androidx.compose.runtime.MovableContent<java.lang.Object> r13, androidx.compose.runtime.PersistentCompositionLocalMap r14, final java.lang.Object r15, boolean r16) {
        /*
            ...
            r2 = 0
            r12.compoundKeyHash = r0     // Catch: java.lang.Throwable -> La0
            boolean r0 = r12.getInserting()     // Catch: java.lang.Throwable -> La0
            r3 = 0
            r4 = 1
            if (r0 == 0) goto L1d
            androidx.compose.runtime.SlotWriter r0 = r12.writer     // Catch: java.lang.Throwable -> La0
        ...
        L1d:
            ...
            goto L31
        L24:
            androidx.compose.runtime.SlotReader r0 = r12.reader     // Catch: java.lang.Throwable -> La0
            java.lang.Object r0 = r0.getGroupAux()     // Catch: java.lang.Throwable -> La0
            boolean r0 = kotlin.jvm.internal.Intrinsics.areEqual(r0, r14)     // Catch: java.lang.Throwable -> La0
            if (r0 != 0) goto L31
            r3 = r4
        L31:
            if (r3 == 0) goto L36
            r12.recordProviderUpdate(r14)     // Catch: java.lang.Throwable -> La0
        L36:
            ...
            int r5 = r5.m3762getGroupULZAiWs()     // Catch: java.lang.Throwable -> La0
            r6 = 202(0xca, float:2.83E-43)
            r12.m3748startBaiHCIY(r6, r0, r5, r14)     // Catch: java.lang.Throwable -> La0
            r12.providerCache = r2     // Catch: java.lang.Throwable -> La0
            boolean r14 = r12.getInserting()     // Catch: java.lang.Throwable -> La0
            if (r14 == 0) goto L7b
            if (r16 != 0) goto L7b
            r12.writerHasAProvider = r4     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.SlotWriter r14 = r12.writer     // Catch: java.lang.Throwable -> La0
            int r0 = r14.getParent()     // Catch: java.lang.Throwable -> La0
            int r0 = r14.parent(r0)     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.Anchor r8 = r14.anchor(r0)     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.MovableContentStateReference r3 = new androidx.compose.runtime.MovableContentStateReference     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.ControlledComposition r6 = r12.getComposition()     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.SlotTable r7 = r12.insertTable     // Catch: java.lang.Throwable -> La0
            java.util.List r9 = kotlin.collections.CollectionsKt.emptyList()     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.PersistentCompositionLocalMap r10 = r12.currentCompositionLocalScope()     // Catch: java.lang.Throwable -> La0
            r11 = 0
            r4 = r13
            r5 = r15
            r3.<init>(r4, r5, r6, r7, r8, r9, r10, r11)     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.CompositionContext r13 = r12.parentContext     // Catch: java.lang.Throwable -> La0
            r13.insertMovableContent$runtime_release(r3)     // Catch: java.lang.Throwable -> La0
            goto L95
        L7b:
            boolean r0 = r12.providersInvalid     // Catch: java.lang.Throwable -> La0
            r12.providersInvalid = r3     // Catch: java.lang.Throwable -> La0
            r3 = r12
            androidx.compose.runtime.Composer r3 = (androidx.compose.runtime.Composer) r3     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.ComposerImpl$invokeMovableContentLambda$1 r6 = new androidx.compose.runtime.ComposerImpl$invokeMovableContentLambda$1     // Catch: java.lang.Throwable -> La0
            r6.<init>()     // Catch: java.lang.Throwable -> La0
            r13 = 316014703(0x12d6006f, float:1.3505406E-27)
            androidx.compose.runtime.internal.ComposableLambda r13 = androidx.compose.runtime.internal.ComposableLambdaKt.composableLambdaInstance(r13, r4, r6)     // Catch: java.lang.Throwable -> La0
            kotlin.jvm.functions.Function2 r13 = (kotlin.jvm.functions.Function2) r13     // Catch: java.lang.Throwable -> La0
            androidx.compose.runtime.internal.Utils_jvmKt.invokeComposable(r3, r13)     // Catch: java.lang.Throwable -> La0
            r12.providersInvalid = r0     // Catch: java.lang.Throwable -> La0
        L95:
            r12.endGroup()
    ...
    */
    private final <R> R recomposeMovableContent(androidx.compose.runtime.ControlledComposition r7, androidx.compose.runtime.ControlledComposition r8, java.lang.Integer r9, java.util.List<? extends kotlin.Pair<androidx.compose.runtime.RecomposeScopeImpl, ? extends java.lang.Object>> r10, kotlin.jvm.functions.Function0<? extends R> r11) {
        ...
        L11:
            ...
            if (r4 == 0) goto L29
            r6.tryImminentInvalidation$runtime_release(r5, r4)     // Catch: java.lang.Throwable -> L49
            goto L2d
        L29:
            r4 = 0
            r6.tryImminentInvalidation$runtime_release(r5, r4)     // Catch: java.lang.Throwable -> L49
    ...
    public final void m3749composeContentZbOJvo$runtime_release(MutableScatterMap<Object, Object> invalidationsRequested, Function2<? super Composer, ? super Integer, Unit> content, ShouldPauseCallback shouldPause) {
        ...
        try {
            m3747doComposeaFTiNEg(invalidationsRequested, content);
        } finally {
    ...
    public final boolean m3750recomposeaFTiNEg$runtime_release(MutableScatterMap<Object, Object> invalidationsRequested, ShouldPauseCallback shouldPause) {
        if (!this.changes.isEmpty()) {
            ComposerKt.composeImmediateRuntimeError("Expected applyChanges() to have been called");
        }
        if (ScopeMap.m3913getSizeimpl(invalidationsRequested) <= 0 && this.invalidations.isEmpty() && !this.forciblyRecompose) {
            return false;
        }
        this.shouldPauseCallback = shouldPause;
        try {
            m3747doComposeaFTiNEg(invalidationsRequested, null);
            this.shouldPauseCallback = null;
            return this.changes.isNotEmpty();
        } catch (Throwable th) {
            this.shouldPauseCallback = null;
    ...
    public final void m3751updateComposerInvalidationsRY85e9Y(MutableScatterMap<Object, Object> invalidationsRequested) {
    ...
    private final void m3747doComposeaFTiNEg(MutableScatterMap<Object, Object> invalidationsRequested, Function2<? super Composer, ? super Integer, Unit> content) {
        if (this.isComposing) {
        ...
        try {
            ...
            this.providerUpdates = null;
            m3751updateComposerInvalidationsRY85e9Y(invalidationsRequested);
            this.nodeIndex = 0;
            this.isComposing = true;
            try {
                startRoot();
    ...
    private final void finalizeCompose() {
        ...
        if (!Stack.m3798isEmptyimpl(this.pendingStack)) {
    ...
    public final class CompositionContextImpl extends CompositionContext {
        ...
        public ScatterSet<RecomposeScopeImpl> composeInitialPaused$runtime_release(ControlledComposition composition, ShouldPauseCallback shouldPause, Function2<? super Composer, ? super Integer, Unit> content) {
            return ComposerImpl.this.parentContext.composeInitialPaused$runtime_release(composition, shouldPause, content);
        }
        ...
        public ScatterSet<RecomposeScopeImpl> recomposePaused$runtime_release(ControlledComposition composition, ShouldPauseCallback shouldPause, ScatterSet<RecomposeScopeImpl> invalidScopes) {
            return ComposerImpl.this.parentContext.recomposePaused$runtime_release(composition, shouldPause, invalidScopes);
        }
    ...
    public final int stacksSize$runtime_release() {
        return this.entersStack.tos + Stack.m3796getSizeimpl(this.invalidateStack) + this.providersInvalidStack.tos + Stack.m3796getSizeimpl(this.pendingStack) + this.parentStateStack.tos;
    }
        ...
        while (group >= 0) {
            if (group != recomposeGroup) {
                ...
                if (groupCompoundKeyPart == 126665345) {
                    rotateLeft = Integer.rotateLeft(groupCompoundKeyPart, i3);
                } else {
                    i2 = (i2 ^ Integer.rotateLeft(groupCompoundKeyPart, i)) ^ Integer.rotateLeft(this.reader.hasObjectKey(group) ? 0 : rGroupIndexOf(group), i3);
                    i = (i + 6) % 32;
                    i3 = (i3 + 6) % 32;
                    group = this.reader.parent(group);
                }
            } else {
                rotateLeft = Integer.rotateLeft(recomposeKey, i3);
            }
            return rotateLeft ^ i2;
        }
        return i2;
    }
}
