...
public final class PrioritySet {
    ...
    public static final /* synthetic */ PrioritySet m3768boximpl(MutableIntList mutableIntList) {
        return new PrioritySet(mutableIntList);
    }

    /* renamed from: constructor-impl */
    public static MutableIntList m3769constructorimpl(MutableIntList mutableIntList) {
        return mutableIntList;
    }

    /* renamed from: equals-impl */
    public static boolean m3771equalsimpl(MutableIntList mutableIntList, Object obj) {
        return (obj instanceof PrioritySet) && Intrinsics.areEqual(mutableIntList, ((PrioritySet) obj).getList());
    }

    /* renamed from: equals-impl0 */
    public static final boolean m3772equalsimpl0(MutableIntList mutableIntList, MutableIntList mutableIntList2) {
        return Intrinsics.areEqual(mutableIntList, mutableIntList2);
    }

    /* renamed from: hashCode-impl */
    public static int m3773hashCodeimpl(MutableIntList mutableIntList) {
        return mutableIntList.hashCode();
    }

    /* renamed from: toString-impl */
    public static String m3778toStringimpl(MutableIntList mutableIntList) {
        return "PrioritySet(list=" + mutableIntList + ')';
    }

    public boolean equals(Object obj) {
        return m3771equalsimpl(this.list, obj);
    }

    public int hashCode() {
        return m3773hashCodeimpl(this.list);
    }

    public String toString() {
        return m3778toStringimpl(this.list);
    }
    ...
    public static final void m3767addimpl(MutableIntList mutableIntList, int i) {
    ...
    public static final boolean m3774isEmptyimpl(MutableIntList mutableIntList) {
        return mutableIntList._size == 0;
    }

    /* renamed from: isNotEmpty-impl */
    public static final boolean m3775isNotEmptyimpl(MutableIntList mutableIntList) {
        return mutableIntList._size != 0;
    }

    /* renamed from: peek-impl */
    public static final int m3776peekimpl(MutableIntList mutableIntList) {
        return mutableIntList.first();
    }

    /* renamed from: takeMax-impl */
    public static final int m3777takeMaximpl(MutableIntList mutableIntList) {
        int i;
        MutableIntList mutableIntList2 = mutableIntList;
        int i2 = mutableIntList2._size;
    ...
    public static final void m3779validateHeapimpl(MutableIntList mutableIntList) {
    ...
    public static /* synthetic */ MutableIntList m3770constructorimpl$default(MutableIntList mutableIntList, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            mutableIntList = new MutableIntList(0, 1, null);
        }
        return m3769constructorimpl(mutableIntList);
    }
}
