...
public final class NavigationDrawer_androidKt {
    private static final float PredictiveBackDrawerMaxScaleXDistanceGrow = Dp.m6989constructorimpl(12.0f);
    private static final float PredictiveBackDrawerMaxScaleXDistanceShrink = Dp.m6989constructorimpl(24.0f);
    private static final float PredictiveBackDrawerMaxScaleYDistance = Dp.m6989constructorimpl(48.0f);
    ...
    public static final void DrawerPredictiveBackHandler(final DrawerState drawerState, final Function3<? super DrawerPredictiveBackState, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i) {
        ...
        if ((i6 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            floatRef.element = density.mo700toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceGrow);
            floatRef2.element = density.mo700toPx0680j_4(PredictiveBackDrawerMaxScaleXDistanceShrink);
            floatRef3.element = density.mo700toPx0680j_4(PredictiveBackDrawerMaxScaleYDistance);
