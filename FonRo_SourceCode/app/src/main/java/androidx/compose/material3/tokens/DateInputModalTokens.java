...
public final class DateInputModalTokens {
    ...
    private static final float ContainerHeight = Dp.m6989constructorimpl(512.0f);
    ...
    private static final float ContainerWidth = Dp.m6989constructorimpl(328.0f);
    private static final float HeaderContainerHeight = Dp.m6989constructorimpl(120.0f);
    private static final float HeaderContainerWidth = Dp.m6989constructorimpl(328.0f);
    ...
    public final float m3263getHeaderContainerHeightD9Ej5fM() {
        return HeaderContainerHeight;
    }

    /* renamed from: getHeaderContainerWidth-D9Ej5fM, reason: not valid java name */
    public final float m3264getHeaderContainerWidthD9Ej5fM() {
