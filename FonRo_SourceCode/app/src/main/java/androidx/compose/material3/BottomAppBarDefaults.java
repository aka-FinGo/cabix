...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = Dp.m6989constructorimpl(0.0f);
    ...
    public final float m1894getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m1122onlybOOhFvg = WindowInsetsKt.m1122onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 6), WindowInsetsSides.m1134plusgK_yJZ4(WindowInsetsSides.INSTANCE.m1144getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m1142getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        ...
        ContentPadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }
}
