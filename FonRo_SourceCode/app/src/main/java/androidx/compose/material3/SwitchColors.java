...
public final class SwitchColors {
    ...
    public static /* synthetic */ SwitchColors m2658copyQ_H9qLU$default(SwitchColors switchColors, long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, int i, Object obj) {
        long j17;
        long j18;
        long j19;
        long j20;
    ...
    public final long m2678thumbColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2679trackColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2659borderColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public final long m2677iconColorWaAFU9c$material3_release(boolean enabled, boolean checked) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4385equalsimpl0(this.checkedThumbColor, switchColors.checkedThumbColor) && Color.m4385equalsimpl0(this.checkedTrackColor, switchColors.checkedTrackColor) && Color.m4385equalsimpl0(this.checkedBorderColor, switchColors.checkedBorderColor) && Color.m4385equalsimpl0(this.checkedIconColor, switchColors.checkedIconColor) && Color.m4385equalsimpl0(this.uncheckedThumbColor, switchColors.uncheckedThumbColor) && Color.m4385equalsimpl0(this.uncheckedTrackColor, switchColors.uncheckedTrackColor) && Color.m4385equalsimpl0(this.uncheckedBorderColor, switchColors.uncheckedBorderColor) && Color.m4385equalsimpl0(this.uncheckedIconColor, switchColors.uncheckedIconColor) && Color.m4385equalsimpl0(this.disabledCheckedThumbColor, switchColors.disabledCheckedThumbColor) && Color.m4385equalsimpl0(this.disabledCheckedTrackColor, switchColors.disabledCheckedTrackColor) && Color.m4385equalsimpl0(this.disabledCheckedBorderColor, switchColors.disabledCheckedBorderColor) && Color.m4385equalsimpl0(this.disabledCheckedIconColor, switchColors.disabledCheckedIconColor) && Color.m4385equalsimpl0(this.disabledUncheckedThumbColor, switchColors.disabledUncheckedThumbColor) && Color.m4385equalsimpl0(this.disabledUncheckedTrackColor, switchColors.disabledUncheckedTrackColor) && Color.m4385equalsimpl0(this.disabledUncheckedBorderColor, switchColors.disabledUncheckedBorderColor) && Color.m4385equalsimpl0(this.disabledUncheckedIconColor, switchColors.disabledUncheckedIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((Color.m4391hashCodeimpl(this.checkedThumbColor) * 31) + Color.m4391hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m4391hashCodeimpl(this.checkedBorderColor)) * 31) + Color.m4391hashCodeimpl(this.checkedIconColor)) * 31) + Color.m4391hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m4391hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m4391hashCodeimpl(this.uncheckedBorderColor)) * 31) + Color.m4391hashCodeimpl(this.uncheckedIconColor)) * 31) + Color.m4391hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m4391hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m4391hashCodeimpl(this.disabledCheckedBorderColor)) * 31) + Color.m4391hashCodeimpl(this.disabledCheckedIconColor)) * 31) + Color.m4391hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m4391hashCodeimpl(this.disabledUncheckedTrackColor)) * 31) + Color.m4391hashCodeimpl(this.disabledUncheckedBorderColor)) * 31) + Color.m4391hashCodeimpl(this.disabledUncheckedIconColor);
    }
}
