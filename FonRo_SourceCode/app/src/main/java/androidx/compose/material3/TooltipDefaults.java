...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7011DpSizeYgX7TsA(Dp.m6989constructorimpl(16.0f), Dp.m6989constructorimpl(8.0f));
    ...
    public final long m2945getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m2948richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        RichTooltipColors m2502copyjRlVdoo = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2502copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2502copyjRlVdoo;
    }
    ...
    public final PopupPositionProvider m2946rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        final int mo694roundToPx0680j_4 = ((Density) consume).mo694roundToPx0680j_4(f);
        ComposerKt.sourceInformationMarkerStart(composer, 1994502237, "CC(remember):Tooltip.kt#9igjgp");
        boolean changed = composer.changed(mo694roundToPx0680j_4);
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberPlainTooltipPositionProvider$1$1
                ...
                public long mo669calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    int left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7160getWidthimpl(popupContentSize)) / 2);
                    int top = (anchorBounds.getTop() - IntSize.m7159getHeightimpl(popupContentSize)) - mo694roundToPx0680j_4;
                    if (top < 0) {
                        top = anchorBounds.getBottom() + mo694roundToPx0680j_4;
                    }
    ...
    public final PopupPositionProvider m2947rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new PopupPositionProvider() { // from class: androidx.compose.material3.TooltipDefaults$rememberRichTooltipPositionProvider$1$1
                ...
                public long mo669calculatePositionllwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
                    ...
                    if (IntSize.m7160getWidthimpl(popupContentSize) + left > IntSize.m7160getWidthimpl(windowSize) && (left = anchorBounds.getRight() - IntSize.m7160getWidthimpl(popupContentSize)) < 0) {
                        left = anchorBounds.getLeft() + ((anchorBounds.getWidth() - IntSize.m7160getWidthimpl(popupContentSize)) / 2);
                    }
                    int top = (anchorBounds.getTop() - IntSize.m7159getHeightimpl(popupContentSize)) - mo694roundToPx0680j_4;
                    if (top < 0) {
                        top = anchorBounds.getBottom() + mo694roundToPx0680j_4;
