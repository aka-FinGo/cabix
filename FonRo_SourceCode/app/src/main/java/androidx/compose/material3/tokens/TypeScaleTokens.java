...
public final class TypeScaleTokens {
    ...
    static {
        ...
        TextUnitKt.m7196checkArithmeticR2X_6o(sp);
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.m7181getRawTypeimpl(sp), -TextUnit.m7183getValueimpl(sp));
