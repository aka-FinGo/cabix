...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m6989constructorimpl(64.0f);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3301getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m6989constructorimpl(80.0f);
    ...
    public final float m3446getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3447getContainerHeightD9Ej5fM() {
    ...
    public final float m3448getIconSizeD9Ej5fM() {
        return IconSize;
    }
