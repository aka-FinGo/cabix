...
public final class CheckboxKt {
    ...
    private static final float CheckboxDefaultPadding = Dp.m6989constructorimpl(2.0f);
    private static final float CheckboxSize = Dp.m6989constructorimpl(20.0f);
    private static final float StrokeWidth = Dp.m6989constructorimpl(2.0f);
    private static final float RadiusSize = Dp.m6989constructorimpl(2.0f);
    ...
    */
    ...
    public static final void m1956drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m4385equalsimpl0(j, j2)) {
            DrawScope.m4931drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(m4194getWidthimpl, m4194getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = m4194getWidthimpl - (f2 * 2.0f);
        DrawScope.m4931drawRoundRectuAw5IA$default(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = m4194getWidthimpl - f2;
        DrawScope.m4931drawRoundRectuAw5IA$default(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1957drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.INSTANCE.m4739getSquareKaPHkGw(), 0, null, 26, null);
        float m4194getWidthimpl = Size.m4194getWidthimpl(drawScope.mo4935getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * m4194getWidthimpl, lerp3 * m4194getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(lerp * m4194getWidthimpl, lerp2 * m4194getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * m4194getWidthimpl, m4194getWidthimpl * lerp4);
        ...
        DrawScope.m4925drawPathLG529CI$default(drawScope, checkDrawingCache.getPathToDraw(), j, 0.0f, stroke, null, 0, 52, null);
    }
}
