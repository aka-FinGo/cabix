...
public final class DateRangePickerKt {
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(Dp.m6989constructorimpl(24.0f), Dp.m6989constructorimpl(20.0f), 0.0f, Dp.m6989constructorimpl(8.0f), 4, null);
    private static final PaddingValues DateRangePickerTitlePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(Dp.m6989constructorimpl(64.0f), 0.0f, Dp.m6989constructorimpl(12.0f), 0.0f, 10, null);
    private static final PaddingValues DateRangePickerHeadlinePadding = PaddingKt.m1046PaddingValuesa9UjIt4$default(Dp.m6989constructorimpl(64.0f), 0.0f, Dp.m6989constructorimpl(12.0f), Dp.m6989constructorimpl(12.0f), 2, null);
    private static final float HeaderHeightOffset = Dp.m6989constructorimpl(60.0f);
    ...
    */
    ...
    public static final DateRangePickerState m2152rememberDateRangePickerStateIlFM19s(Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, Composer composer, int i2, int i3) {
        ...
        final int m2174getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m2174getPickerjFl4v0() : i;
        ...
        if (changedInstance || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function0) new Function0<DateRangePickerStateImpl>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1$1
                ...
                public final DateRangePickerStateImpl invoke() {
                    return new DateRangePickerStateImpl(l4, l5, l6, yearRange, m2174getPickerjFl4v0, allDates, defaultLocale, null);
                }
            };
            composer.updateRememberedValue(rememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        DateRangePickerStateImpl dateRangePickerStateImpl = (DateRangePickerStateImpl) RememberSaveableKt.m3923rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 0, 4);
    ...
    public static /* synthetic */ DateRangePickerState m2148DateRangePickerStateHVP43zI$default(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            l = null;
        }
        if ((i2 & 4) != 0) {
        ...
        return m2147DateRangePickerStateHVP43zI(locale, l, l2, l3, intRange, i, selectableDates);
    }

    /* renamed from: DateRangePickerState-HVP43zI, reason: not valid java name */
    public static final DateRangePickerState m2147DateRangePickerStateHVP43zI(Locale locale, Long l, Long l2, Long l3, IntRange intRange, int i, SelectableDates selectableDates) {
    ...
    public static final void m2149SwitchableDateEntryContentRN2D1Q(final Long l, final Long l2, final long j, final int i, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i2, final int i3) {
        int i4;
        Long l3;
        long j2;
        ...
        if ((i4 & 306783379) != 306783378 || (i5 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            CrossfadeKt.Crossfade(DisplayMode.m2166boximpl(i), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer3, Integer num) {
                    m2154invokeQujVXRc(displayMode.getValue(), composer3, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m2154invokeQujVXRc(int i6, Composer composer3, int i7) {
                    int i8;
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$3
                ...
                public final void invoke(Composer composer3, int i6) {
                    DateRangePickerKt.m2149SwitchableDateEntryContentRN2D1Q(l, l2, j, i, function2, function1, calendarModel, intRange, datePickerFormatter, selectableDates, datePickerColors, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1), RecomposeScopeImplKt.updateChangedFlags(i3));
                }
            });
        }
    }
    ...
    public static final void DateRangePickerContent(final Long l, final Long l2, final long j, final Function2<? super Long, ? super Long, Unit> function2, final Function1<? super Long, Unit> function1, final CalendarModel calendarModel, final IntRange intRange, final DatePickerFormatter datePickerFormatter, final SelectableDates selectableDates, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 306783379) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m1051paddingVpY3zN4$default = PaddingKt.m1051paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, obj);
            ...
            TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getDateLabelTextFont(), startRestartGroup, 6), ComposableLambdaKt.rememberComposableLambda(1090773432, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 3) != 2 || !composer2.getSkipping()) {
                        ...
                        String m3101getString2EP1pXo = Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_range_picker_scroll_to_previous_month), composer2, 0);
                        Strings.Companion companion2 = Strings.INSTANCE;
                        String m3101getString2EP1pXo2 = Strings_androidKt.m3101getString2EP1pXo(Strings.m3031constructorimpl(R.string.m3c_date_range_picker_scroll_to_next_month), composer2, 0);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(composer2);
                        customScrollActions = DateRangePickerKt.customScrollActions(lazyListState2, coroutineScope, m3101getString2EP1pXo, m3101getString2EP1pXo2);
                                                ...
                                                TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont(), composer3, 6), ComposableLambdaKt.rememberComposableLambda(1622100276, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1$1
                                                    ...
                                                    public final void invoke(Composer composer4, int i8) {
                                                        ...
                                                        if ((i8 & 3) != 2 || !composer4.getSkipping()) {
                                                            ...
                                                            TextKt.m2798Text4IGK_g(formatMonthYear, SemanticsModifierKt.semantics$default(padding, false, (Function1) rememberedValue5, 1, null), datePickerColors4.getSubheadContentColor(), 0L, (FontStyle) null, (FontWeight) null, (FontFamily) null, 0L, (TextDecoration) null, (TextAlign) null, 0L, 0, false, 0, 0, (Function1<? super TextLayoutResult, Unit>) null, (TextStyle) null, composer4, 0, 0, 131064);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
    ...
    public static final void m2151drawRangeBackgroundmxwnekA(ContentDrawScope contentDrawScope, SelectedRangeInfo selectedRangeInfo, long j) {
        float m4194getWidthimpl;
        float f = contentDrawScope.mo700toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = contentDrawScope.mo700toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = contentDrawScope.mo700toPx0680j_4(DatePickerModalTokens.INSTANCE.m3270getDateStateLayerHeightD9Ej5fM());
        float f4 = (f2 - f3) / 2.0f;
        float m4194getWidthimpl2 = (Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()) - (7.0f * f)) / 7.0f;
        long gridStartCoordinates = selectedRangeInfo.getGridStartCoordinates();
        int m7117getXimpl = IntOffset.m7117getXimpl(gridStartCoordinates);
        int m7118getYimpl = IntOffset.m7118getYimpl(gridStartCoordinates);
        long gridEndCoordinates = selectedRangeInfo.getGridEndCoordinates();
        int m7117getXimpl2 = IntOffset.m7117getXimpl(gridEndCoordinates);
        int m7118getYimpl2 = IntOffset.m7118getYimpl(gridEndCoordinates);
        float f5 = f + m4194getWidthimpl2;
        float f6 = m4194getWidthimpl2 / 2.0f;
        float f7 = (m7117getXimpl * f5) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / 2.0f : 0.0f) + f6;
        float f8 = (m7118getYimpl * f2) + f4;
        float f9 = m7117getXimpl2 * f5;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= 2.0f;
        }
        float f10 = f9 + f + f6;
        float f11 = (m7118getYimpl2 * f2) + f4;
        boolean z = contentDrawScope.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            f7 = Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()) - f7;
            f10 = Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()) - f10;
        }
        ContentDrawScope contentDrawScope2 = contentDrawScope;
        long Offset = OffsetKt.Offset(f7, f8);
        if (m7118getYimpl == m7118getYimpl2) {
            m4194getWidthimpl = f10 - f7;
        } else {
            m4194getWidthimpl = z ? -f7 : Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()) - f7;
        }
        DrawScope.m4929drawRectnJ9OG0$default(contentDrawScope2, j, Offset, SizeKt.Size(m4194getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (m7118getYimpl != m7118getYimpl2) {
            for (int i = (m7118getYimpl2 - m7118getYimpl) - 1; i > 0; i--) {
                DrawScope.m4929drawRectnJ9OG0$default(contentDrawScope2, j, OffsetKt.Offset(0.0f, (i * f2) + f8), SizeKt.Size(Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long Offset2 = OffsetKt.Offset(contentDrawScope.getLayoutDirection() != LayoutDirection.Ltr ? Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc()) : 0.0f, f11);
            if (z) {
                f10 -= Size.m4194getWidthimpl(contentDrawScope.mo4935getSizeNHjbRc());
            }
            DrawScope.m4929drawRectnJ9OG0$default(contentDrawScope2, j, Offset2, SizeKt.Size(f10, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
