...
final class TimePickerStateImpl implements TimePickerState {
    ...
    public TimePickerStateImpl(int i, int i2, boolean z) {
        ...
        this.is24hour = z;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(TimePickerSelectionMode.m2849boximpl(TimePickerSelectionMode.INSTANCE.m2856getHouryecRtBI()), null, 2, null);
    ...
    public int mo1864getSelectionyecRtBI() {
        return ((TimePickerSelectionMode) this.selection.getValue()).m2855unboximpl();
    }

    @Override // androidx.compose.material3.TimePickerState
    /* renamed from: setSelection-6_8s6DQ */
    public void mo1865setSelection6_8s6DQ(int i) {
        this.selection.setValue(TimePickerSelectionMode.m2849boximpl(i));
    }
