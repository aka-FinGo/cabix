        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new GenericShape(new Function3<Path, Size, LayoutDirection, Unit>() { // from class: androidx.compose.material3.carousel.CarouselItemScopeImpl$rememberMaskShape$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(Path path, Size size, LayoutDirection layoutDirection) {
                    m2987invoke12SF9DM(path, size.m4199unboximpl(), layoutDirection);
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-12SF9DM, reason: not valid java name */
                public final void m2987invoke12SF9DM(Path path, long j, LayoutDirection layoutDirection) {
                    Rect intersect = CarouselItemScopeImpl.this.getItemInfo().getMaskRect().intersect(SizeKt.m4215toRectuvyYCjk(j));
                    OutlineKt.addOutline(path, shape.mo614createOutlinePq9zytI(intersect.m4158getSizeNHjbRc(), layoutDirection, density));
                    path.mo4261translatek4lQ0M(OffsetKt.Offset(intersect.getLeft(), intersect.getTop()));
                }
            });
