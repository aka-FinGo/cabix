...
public class FloatingActionButtonElevation {
    ...
    public boolean equals(Object other) {
        ...
        if (Dp.m6994equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m6994equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m6994equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation)) {
            return Dp.m6994equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
        }
        return false;
    }

    public int hashCode() {
        return (((((Dp.m6995hashCodeimpl(this.defaultElevation) * 31) + Dp.m6995hashCodeimpl(this.pressedElevation)) * 31) + Dp.m6995hashCodeimpl(this.focusedElevation)) * 31) + Dp.m6995hashCodeimpl(this.hoveredElevation);
    }
}
