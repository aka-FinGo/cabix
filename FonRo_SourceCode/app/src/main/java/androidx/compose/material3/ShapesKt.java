...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), null, null, CornerSizeKt.m1334CornerSize0680j_4(Dp.m6989constructorimpl(0.0f)), 6, null);
    }
}
