...
public final class CheckboxDefaults {
    ...
    public final CheckboxColors m1953colors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        CheckboxColors m1940copy2qZNXz8 = getDefaultCheckboxColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1940copy2qZNXz8(m4420getUnspecified0d7_KjU3, Color.INSTANCE.m4419getTransparent0d7_KjU(), m4420getUnspecified0d7_KjU, Color.INSTANCE.m4419getTransparent0d7_KjU(), m4420getUnspecified0d7_KjU4, Color.INSTANCE.m4419getTransparent0d7_KjU(), m4420getUnspecified0d7_KjU6, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU4, m4420getUnspecified0d7_KjU5, m4420getUnspecified0d7_KjU6);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1940copy2qZNXz8;
    }
