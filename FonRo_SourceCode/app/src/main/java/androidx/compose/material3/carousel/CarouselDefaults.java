...
public final class CarouselDefaults {
    ...
    private static final float MinSmallItemSize = Dp.m6989constructorimpl(40.0f);
    private static final float MaxSmallItemSize = Dp.m6989constructorimpl(56.0f);
    private static final float AnchorSize = Dp.m6989constructorimpl(10.0f);
