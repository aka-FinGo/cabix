...
public final class CarouselAlignment {
    ...
    private static final int Start = m2975constructorimpl(-1);
    private static final int Center = m2975constructorimpl(0);
    private static final int End = m2975constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ CarouselAlignment m2974boximpl(int i) {
        return new CarouselAlignment(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m2975constructorimpl(int i) {
        return i;
    }
