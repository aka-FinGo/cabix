...
final class ModalBottomSheetDialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public ModalBottomSheetDialogLayout(Context context, Window window, boolean z, Function0<Unit> function0, Animatable<Float, AnimationVector1D> animatable, CoroutineScope coroutineScope) {
        ...
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ModalBottomSheet_androidKt.INSTANCE.m2077getLambda2$material3_release(), null, 2, null);
    ...
    private final void maybeRegisterBackCallback() {
        ...
        if (this.backCallback == null) {
            ...
            if (i >= 34) {
                createBackCallback = ComponentDialog$$ExternalSyntheticApiModelOutline0.m6m((Object) Api34Impl.createBackCallback(function0, this.predictiveBackProgress, this.scope));
            } else {
