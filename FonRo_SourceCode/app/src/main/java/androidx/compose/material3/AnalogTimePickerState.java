...
public final class AnalogTimePickerState implements TimePickerState {
    ...
    public int mo1864getSelectionyecRtBI() {
        return this.state.mo1864getSelectionyecRtBI();
    }
    ...
    public void mo1865setSelection6_8s6DQ(int i) {
        this.state.mo1865setSelection6_8s6DQ(i);
    }
    ...
    public final Object animateToCurrent(Continuation<? super Unit> continuation) {
        ...
        if (TimePickerSelectionMode.m2852equalsimpl0(mo1864getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2856getHouryecRtBI())) {
    ...
    private final boolean isUpdated() {
        if (TimePickerSelectionMode.m2852equalsimpl0(mo1864getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2856getHouryecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.hourAngle)) {
            return false;
        }
        return (TimePickerSelectionMode.m2852equalsimpl0(mo1864getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2857getMinuteyecRtBI()) && normalize(this.anim.getTargetValue().floatValue()) == normalize(this.minuteAngle)) ? false : true;
    }

    public final IntList getClockFaceValues() {
        IntList intList;
        IntList intList2;
        if (TimePickerSelectionMode.m2852equalsimpl0(mo1864getSelectionyecRtBI(), TimePickerSelectionMode.INSTANCE.m2857getMinuteyecRtBI())) {
