...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors iconButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m4394unboximpl = ((Color) consume).m4394unboximpl();
        IconButtonColors m2241defaultIconButtonColors4WTKRHQ$material3_release = m2241defaultIconButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m4394unboximpl);
        if (Color.m4385equalsimpl0(m2241defaultIconButtonColors4WTKRHQ$material3_release.getContentColor(), m4394unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2241defaultIconButtonColors4WTKRHQ$material3_release;
        }
        IconButtonColors m2233copyjRlVdoo$default = IconButtonColors.m2233copyjRlVdoo$default(m2241defaultIconButtonColors4WTKRHQ$material3_release, 0L, m4394unboximpl, 0L, Color.m4383copywmQWz5c$default(m4394unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m2233copyjRlVdoo$default;
    }

    /* renamed from: iconButtonColors-ro_MJ88, reason: not valid java name */
    public final IconButtonColors m2249iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        long j7;
        ...
        long m4420getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j;
        if ((i2 & 2) != 0) {
            ProvidableCompositionLocal<Color> localContentColor = ContentColorKt.getLocalContentColor();
            ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j5 = ((Color) consume).m4394unboximpl();
        } else {
            j5 = j2;
        }
        long m4420getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j8 = j5;
            j7 = Color.m4383copywmQWz5c$default(j8, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j6 = j8;
        } else {
            j6 = j5;
            j7 = j4;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m2236copyjRlVdoo = m2241defaultIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m4394unboximpl()).m2236copyjRlVdoo(m4420getUnspecified0d7_KjU, j6, m4420getUnspecified0d7_KjU2, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2236copyjRlVdoo;
    }

    /* renamed from: defaultIconButtonColors-4WTKRHQ$material3_release, reason: not valid java name */
    public final IconButtonColors m2241defaultIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), j, Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors iconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m4394unboximpl = ((Color) consume).m4394unboximpl();
        IconToggleButtonColors m2242defaultIconToggleButtonColors4WTKRHQ$material3_release = m2242defaultIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m4394unboximpl);
        if (Color.m4385equalsimpl0(m2242defaultIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), m4394unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2242defaultIconToggleButtonColors4WTKRHQ$material3_release;
        }
        IconToggleButtonColors m2258copytNS2XkQ$default = IconToggleButtonColors.m2258copytNS2XkQ$default(m2242defaultIconToggleButtonColors4WTKRHQ$material3_release, 0L, m4394unboximpl, 0L, Color.m4383copywmQWz5c$default(m4394unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
        return m2258copytNS2XkQ$default;
    }

    /* renamed from: iconToggleButtonColors-5tl4gsc, reason: not valid java name */
    public final IconToggleButtonColors m2250iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        long j10;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m4394unboximpl();
        } else {
            j7 = j2;
        }
        long m4420getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        if ((i2 & 8) != 0) {
            long j11 = j7;
            j9 = Color.m4383copywmQWz5c$default(j11, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j8 = j11;
        } else {
            j8 = j7;
            j9 = j4;
        }
        long m4420getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j5;
        long m4420getUnspecified0d7_KjU4 = (i2 & 32) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
            j10 = m4420getUnspecified0d7_KjU;
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long j12 = j10;
        IconToggleButtonColors m2259copytNS2XkQ = m2242defaultIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m4394unboximpl()).m2259copytNS2XkQ(j12, j8, m4420getUnspecified0d7_KjU2, j9, m4420getUnspecified0d7_KjU3, m4420getUnspecified0d7_KjU4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m2259copytNS2XkQ;
    }

    /* renamed from: defaultIconToggleButtonColors-4WTKRHQ$material3_release, reason: not valid java name */
    public final IconToggleButtonColors m2242defaultIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), j, Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), Color.INSTANCE.m4419getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, IconButtonTokens.INSTANCE.getSelectedIconColor()), null);
    ...
    public final IconButtonColors m2245filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long j5 = j;
        long m2034contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m2034contentColorForek8zF_U(j5, composer, i & 14) : j2;
        long m4420getUnspecified0d7_KjU = (i2 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        long m4420getUnspecified0d7_KjU2 = (i2 & 8) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors m2236copyjRlVdoo = getDefaultFilledIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2236copyjRlVdoo(j5, m2034contentColorForek8zF_U, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m2033contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getContainerColor())), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2246filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m4420getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j;
        long m4420getUnspecified0d7_KjU2 = (i2 & 2) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j2;
        long m4420getUnspecified0d7_KjU3 = (i2 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        long m4420getUnspecified0d7_KjU4 = (i2 & 8) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j4;
        long m4420getUnspecified0d7_KjU5 = (i2 & 16) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j5;
        long m2034contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2034contentColorForek8zF_U(m4420getUnspecified0d7_KjU5, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
            j7 = m4420getUnspecified0d7_KjU;
        ...
        IconToggleButtonColors m2259copytNS2XkQ = getDefaultFilledIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2259copytNS2XkQ(j7, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3, m4420getUnspecified0d7_KjU4, m4420getUnspecified0d7_KjU5, m2034contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getToggleUnselectedColor()), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getDisabledColor()), FilledIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m2033contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final IconButtonColors m2247filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        IconButtonColors m2236copyjRlVdoo = getDefaultFilledTonalIconButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2236copyjRlVdoo(j5, m2034contentColorForek8zF_U, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors getDefaultFilledTonalIconButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.m2033contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getContainerColor())), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final IconToggleButtonColors m2248filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m4420getUnspecified0d7_KjU = (i2 & 1) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j;
        long m2034contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m2034contentColorForek8zF_U(m4420getUnspecified0d7_KjU, composer, i & 14) : j2;
        long m4420getUnspecified0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j3;
        long m4420getUnspecified0d7_KjU3 = (i2 & 8) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j4;
        long m4420getUnspecified0d7_KjU4 = (i2 & 16) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j5;
        long m4420getUnspecified0d7_KjU5 = (i2 & 32) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j6;
        if (ComposerKt.isTraceInProgress()) {
            j7 = m4420getUnspecified0d7_KjU;
        ...
        IconToggleButtonColors m2259copytNS2XkQ = getDefaultFilledTonalIconToggleButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m2259copytNS2XkQ(j7, m2034contentColorForek8zF_U, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3, m4420getUnspecified0d7_KjU4, m4420getUnspecified0d7_KjU5);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors getDefaultFilledTonalIconToggleButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor()), ColorSchemeKt.m2033contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getUnselectedContainerColor())), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getDisabledColor()), FilledTonalIconButtonTokens.INSTANCE.getDisabledOpacity(), 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalIconButtonTokens.INSTANCE.getToggleSelectedColor()), null);
    ...
    public final IconButtonColors outlinedIconButtonColors(Composer composer, int i) {
        ...
        Object consume = composer.consume(localContentColor);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release = m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume).m4394unboximpl());
        ProvidableCompositionLocal<Color> localContentColor2 = ContentColorKt.getLocalContentColor();
        ComposerKt.sourceInformationMarkerStart(composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m4394unboximpl = ((Color) consume2).m4394unboximpl();
        if (Color.m4385equalsimpl0(m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release.getContentColor(), m4394unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release;
        }
        IconButtonColors m2233copyjRlVdoo$default = IconButtonColors.m2233copyjRlVdoo$default(m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release, 0L, m4394unboximpl, 0L, Color.m4383copywmQWz5c$default(m4394unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 5, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconButtonColors m2251outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        long j6;
        long j7;
        ...
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconButtonColors m2236copyjRlVdoo = m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m4394unboximpl()).m2236copyjRlVdoo(m4420getUnspecified0d7_KjU, j6, m4420getUnspecified0d7_KjU2, j7);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconButtonColors m2243defaultOutlinedIconButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
    ...
    public final IconToggleButtonColors outlinedIconToggleButtonColors(Composer composer, int i) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        long m4394unboximpl = ((Color) consume).m4394unboximpl();
        IconToggleButtonColors m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release = m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6), m4394unboximpl);
        if (Color.m4385equalsimpl0(m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release.getContentColor(), m4394unboximpl)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
            composer.endReplaceGroup();
            return m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release;
        }
        IconToggleButtonColors m2258copytNS2XkQ$default = IconToggleButtonColors.m2258copytNS2XkQ$default(m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release, 0L, m4394unboximpl, 0L, Color.m4383copywmQWz5c$default(m4394unboximpl, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), 0L, 0L, 53, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceGroup();
    ...
    public final IconToggleButtonColors m2252outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        long j8;
        long j9;
        ...
        if ((i2 & 8) != 0) {
            long j10 = j7;
            j9 = Color.m4383copywmQWz5c$default(j10, 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
            j8 = j10;
        } else {
            j8 = j7;
            j9 = j4;
        ...
        long m4420getUnspecified0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j5;
        long m2034contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m2034contentColorForek8zF_U(m4420getUnspecified0d7_KjU3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        Object consume2 = composer.consume(localContentColor2);
        ComposerKt.sourceInformationMarkerEnd(composer);
        IconToggleButtonColors m2259copytNS2XkQ = m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(colorScheme, ((Color) consume2).m4394unboximpl()).m2259copytNS2XkQ(m4420getUnspecified0d7_KjU, j8, m4420getUnspecified0d7_KjU2, j9, m4420getUnspecified0d7_KjU3, m2034contentColorForek8zF_U);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final IconToggleButtonColors m2244defaultOutlinedIconToggleButtonColors4WTKRHQ$material3_release(ColorScheme colorScheme, long j) {
        IconToggleButtonColors defaultIconToggleButtonColorsCached = colorScheme.getDefaultIconToggleButtonColorsCached();
        if (defaultIconToggleButtonColorsCached != null) {
            return defaultIconToggleButtonColorsCached;
        }
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), j, Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(j, 0.38f, 0.0f, 0.0f, 0.0f, 14, null), ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor()), ColorSchemeKt.m2033contentColorFor4WTKRHQ(colorScheme, ColorSchemeKt.fromToken(colorScheme, OutlinedIconButtonTokens.INSTANCE.getSelectedContainerColor())), null);
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m4383copywmQWz5c$default = ((Color) consume).m4394unboximpl();
            composer.endReplaceGroup();
        } else {
            ...
            Object consume2 = composer.consume(localContentColor2);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m4383copywmQWz5c$default = Color.m4383copywmQWz5c$default(((Color) consume2).m4394unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        ComposerKt.sourceInformationMarkerStart(composer, 176816691, "CC(remember):IconButton.kt#9igjgp");
        boolean changed = composer.changed(m4383copywmQWz5c$default);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BorderStrokeKt.m585BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m3482getUnselectedOutlineWidthD9Ej5fM(), m4383copywmQWz5c$default);
