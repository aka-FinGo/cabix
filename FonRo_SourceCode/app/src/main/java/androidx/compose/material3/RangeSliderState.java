...
public final class RangeSliderState {
    ...
    public final void onDrag$material3_release(boolean isStart, float offset) {
        ...
        long m2500scaleToUserValueowVgs5E = m2500scaleToUserValueowVgs5E(getMinPx(), getMaxPx(), SliderRange);
        if (SliderRange.m2622equalsimpl0(m2500scaleToUserValueowVgs5E, SliderKt.SliderRange(getActiveRangeStart(), getActiveRangeEnd()))) {
            return;
        }
        Function1<? super SliderRange, Unit> function1 = this.onValueChange;
        if (function1 == null) {
            setActiveRangeStart(SliderRange.m2624getStartimpl(m2500scaleToUserValueowVgs5E));
            setActiveRangeEnd(SliderRange.m2623getEndInclusiveimpl(m2500scaleToUserValueowVgs5E));
        } else if (function1 != null) {
            function1.invoke(SliderRange.m2619boximpl(m2500scaleToUserValueowVgs5E));
        }
    }
    ...
    private final long m2500scaleToUserValueowVgs5E(float minPx, float maxPx, long offset) {
        return SliderKt.m2608access$scaleziovWd0(minPx, maxPx, offset, this.valueRange.getStart().floatValue(), this.valueRange.getEndInclusive().floatValue());
    }
