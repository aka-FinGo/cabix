...
public final class ButtonDefaults {
    ...
    public final float m1922getMinWidthD9Ej5fM() {
        return MinWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM, reason: not valid java name */
    public final float m1921getMinHeightD9Ej5fM() {
        return MinHeight;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1919getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: getIconSpacing-D9Ej5fM, reason: not valid java name */
    public final float m1920getIconSpacingD9Ej5fM() {
        return IconSpacing;
    }
    ...
    public final ButtonColors m1913buttonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long j5 = j;
        long m4420getUnspecified0d7_KjU = (i2 & 2) != 0 ? Color.INSTANCE.m4420getUnspecified0d7_KjU() : j2;
        ...
        ButtonColors m1908copyjRlVdoo = getDefaultButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1908copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1908copyjRlVdoo;
    }
    ...
    public final ButtonColors m1915elevatedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1908copyjRlVdoo = getDefaultElevatedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1908copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultElevatedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getLabelTextColor()), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledContainerColor()), ElevatedButtonTokens.INSTANCE.getDisabledContainerOpacity(), 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, ElevatedButtonTokens.INSTANCE.getDisabledLabelTextColor()), ElevatedButtonTokens.INSTANCE.getDisabledLabelTextOpacity(), 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1917filledTonalButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1908copyjRlVdoo = getDefaultFilledTonalButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1908copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultFilledTonalButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getContainerColor()), ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getLabelTextColor()), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledContainerColor()), 0.12f, 0.0f, 0.0f, 0.0f, 14, null), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, FilledTonalButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1923outlinedButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1908copyjRlVdoo = getDefaultOutlinedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1908copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultOutlinedButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, OutlinedButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
    ...
    public final ButtonColors m1924textButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        ButtonColors m1908copyjRlVdoo = getDefaultTextButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).m1908copyjRlVdoo(j5, m4420getUnspecified0d7_KjU, m4420getUnspecified0d7_KjU2, m4420getUnspecified0d7_KjU3);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final ButtonColors getDefaultTextButtonColors$material3_release(ColorScheme colorScheme) {
        ...
        ButtonColors buttonColors = new ButtonColors(Color.INSTANCE.m4419getTransparent0d7_KjU(), ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getLabelTextColor()), Color.INSTANCE.m4419getTransparent0d7_KjU(), Color.m4383copywmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, TextButtonTokens.INSTANCE.getDisabledLabelTextColor()), 0.38f, 0.0f, 0.0f, 0.0f, 14, null), null);
        colorScheme.setDefaultTextButtonColorsCached$material3_release(buttonColors);
        return buttonColors;
    }

    /* renamed from: buttonElevation-R_JCAzs, reason: not valid java name */
    public final ButtonElevation m1914buttonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilledButtonTokens.INSTANCE.m3366getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = FilledButtonTokens.INSTANCE.m3372getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilledButtonTokens.INSTANCE.m3369getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilledButtonTokens.INSTANCE.m3370getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = FilledButtonTokens.INSTANCE.m3368getDisabledContainerElevationD9Ej5fM();
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1916elevatedButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = ElevatedButtonTokens.INSTANCE.m3285getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = ElevatedButtonTokens.INSTANCE.m3291getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = ElevatedButtonTokens.INSTANCE.m3288getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = ElevatedButtonTokens.INSTANCE.m3289getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = ElevatedButtonTokens.INSTANCE.m3287getDisabledContainerElevationD9Ej5fM();
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ButtonElevation m1918filledTonalButtonElevationR_JCAzs(float f, float f2, float f3, float f4, float f5, Composer composer, int i, int i2) {
        ...
        if ((i2 & 1) != 0) {
            f = FilledTonalButtonTokens.INSTANCE.m3389getContainerElevationD9Ej5fM();
        }
        float f6 = f;
        if ((i2 & 2) != 0) {
            f2 = FilledTonalButtonTokens.INSTANCE.m3395getPressedContainerElevationD9Ej5fM();
        }
        float f7 = f2;
        if ((i2 & 4) != 0) {
            f3 = FilledTonalButtonTokens.INSTANCE.m3392getFocusContainerElevationD9Ej5fM();
        }
        float f8 = f3;
        if ((i2 & 8) != 0) {
            f4 = FilledTonalButtonTokens.INSTANCE.m3393getHoverContainerElevationD9Ej5fM();
        }
        float f9 = f4;
        if ((i2 & 16) != 0) {
            f5 = Dp.m6989constructorimpl(0.0f);
        }
        float f10 = f5;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final BorderStroke getOutlinedButtonBorder(Composer composer, int i) {
        ...
        BorderStroke m585BorderStrokecXLIe8U = BorderStrokeKt.m585BorderStrokecXLIe8U(OutlinedButtonTokens.INSTANCE.m3471getOutlineWidthD9Ej5fM(), ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m585BorderStrokecXLIe8U;
    }
    ...
    public final BorderStroke outlinedButtonBorder(boolean z, Composer composer, int i, int i2) {
        ...
        float m3471getOutlineWidthD9Ej5fM = OutlinedButtonTokens.INSTANCE.m3471getOutlineWidthD9Ej5fM();
        if (z) {
            composer.startReplaceGroup(-855870548);
            ComposerKt.sourceInformation(composer, "893@41926L5");
            m4383copywmQWz5c$default = ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6);
            composer.endReplaceGroup();
        } else {
            composer.startReplaceGroup(-855783004);
            ComposerKt.sourceInformation(composer, "895@42011L5");
            m4383copywmQWz5c$default = Color.m4383copywmQWz5c$default(ColorSchemeKt.getValue(OutlinedButtonTokens.INSTANCE.getOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceGroup();
        }
        BorderStroke m585BorderStrokecXLIe8U = BorderStrokeKt.m585BorderStrokecXLIe8U(m3471getOutlineWidthD9Ej5fM, m4383copywmQWz5c$default);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    static {
        float m6989constructorimpl = Dp.m6989constructorimpl(24.0f);
        ButtonHorizontalPadding = m6989constructorimpl;
        float m6989constructorimpl2 = Dp.m6989constructorimpl(8.0f);
        ButtonVerticalPadding = m6989constructorimpl2;
        PaddingValues m1045PaddingValuesa9UjIt4 = PaddingKt.m1045PaddingValuesa9UjIt4(m6989constructorimpl, m6989constructorimpl2, m6989constructorimpl, m6989constructorimpl2);
        ContentPadding = m1045PaddingValuesa9UjIt4;
        float m6989constructorimpl3 = Dp.m6989constructorimpl(16.0f);
        ButtonWithIconHorizontalStartPadding = m6989constructorimpl3;
        ButtonWithIconContentPadding = PaddingKt.m1045PaddingValuesa9UjIt4(m6989constructorimpl3, m6989constructorimpl2, m6989constructorimpl, m6989constructorimpl2);
        float m6989constructorimpl4 = Dp.m6989constructorimpl(12.0f);
        TextButtonHorizontalPadding = m6989constructorimpl4;
        TextButtonContentPadding = PaddingKt.m1045PaddingValuesa9UjIt4(m6989constructorimpl4, m1045PaddingValuesa9UjIt4.getTop(), m6989constructorimpl4, m1045PaddingValuesa9UjIt4.getBottom());
        float m6989constructorimpl5 = Dp.m6989constructorimpl(16.0f);
        TextButtonWithIconHorizontalEndPadding = m6989constructorimpl5;
        TextButtonWithIconContentPadding = PaddingKt.m1045PaddingValuesa9UjIt4(m6989constructorimpl4, m1045PaddingValuesa9UjIt4.getTop(), m6989constructorimpl5, m1045PaddingValuesa9UjIt4.getBottom());
        MinWidth = Dp.m6989constructorimpl(58.0f);
        MinHeight = Dp.m6989constructorimpl(40.0f);
        IconSize = FilledButtonTokens.INSTANCE.m3371getIconSizeD9Ej5fM();
        IconSpacing = Dp.m6989constructorimpl(8.0f);
    }
}
