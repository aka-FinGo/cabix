...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public void serialize(Encoder encoder, CharSequence value) {
        ...
        SavedStateWriter.m7560putCharSequenceimpl(SavedStateWriter.m7550constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public CharSequence deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7481getCharSequenceimpl(SavedStateReader.m7464constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
