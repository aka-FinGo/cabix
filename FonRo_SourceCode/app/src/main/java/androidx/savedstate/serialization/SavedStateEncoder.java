...
public final class SavedStateEncoder extends AbstractEncoder {
    ...
    private final void checkDiscriminatorCollisions(Bundle savedState, String elementName) {
        if (this.configuration.getClassDiscriminatorMode() == 1) {
            boolean m7465containsimpl = SavedStateReader.m7465containsimpl(SavedStateReader.m7464constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            boolean areEqual = Intrinsics.areEqual(elementName, ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY);
            if (m7465containsimpl && areEqual) {
                throw new IllegalArgumentException("SavedStateEncoder for " + SavedStateReader.m7535getStringimpl(SavedStateReader.m7464constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY) + " has property '" + elementName + "' that conflicts with the class discriminator. You can rename a property with @SerialName annotation.");
            }
        }
    }
    ...
    public void encodeBoolean(boolean value) {
        SavedStateWriter.m7556putBooleanimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeByte(byte value) {
        SavedStateWriter.m7567putIntimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }
    ...
    public void encodeLong(long value) {
        SavedStateWriter.m7571putLongimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeFloat(float value) {
        SavedStateWriter.m7565putFloatimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeDouble(double value) {
        SavedStateWriter.m7563putDoubleimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeChar(char value) {
        SavedStateWriter.m7558putCharimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeString(String value) {
        Intrinsics.checkNotNullParameter(value, "value");
        SavedStateWriter.m7583putStringimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeEnum(SerialDescriptor enumDescriptor, int index) {
        Intrinsics.checkNotNullParameter(enumDescriptor, "enumDescriptor");
        SavedStateWriter.m7567putIntimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, index);
    }

    @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
    public void encodeNull() {
        SavedStateWriter.m7573putNullimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key);
    }

    private final void encodeIntList(List<Integer> value) {
        SavedStateWriter.m7569putIntListimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringList(List<String> value) {
        SavedStateWriter.m7585putStringListimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeBooleanArray(boolean[] value) {
        SavedStateWriter.m7557putBooleanArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeCharArray(char[] value) {
        SavedStateWriter.m7559putCharArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeDoubleArray(double[] value) {
        SavedStateWriter.m7564putDoubleArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeFloatArray(float[] value) {
        SavedStateWriter.m7566putFloatArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeIntArray(int[] value) {
        SavedStateWriter.m7568putIntArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeLongArray(long[] value) {
        SavedStateWriter.m7572putLongArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }

    private final void encodeStringArray(String[] value) {
        SavedStateWriter.m7584putStringArrayimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, value);
    }
    ...
    public CompositeEncoder beginStructure(SerialDescriptor descriptor) {
        ...
        SavedStateWriter.m7577putSavedStateimpl(SavedStateWriter.m7550constructorimpl(this.savedState), this.key, bundleOf);
    ...
    private final void putClassDiscriminatorIfRequired(SavedStateConfiguration configuration, SerialDescriptor descriptor, Bundle savedState) {
        if (configuration.getClassDiscriminatorMode() == 1 && !SavedStateReader.m7465containsimpl(SavedStateReader.m7464constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY)) {
            if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.CLASS.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.OBJECT.INSTANCE)) {
                SavedStateWriter.m7583putStringimpl(SavedStateWriter.m7550constructorimpl(savedState), ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, descriptor.getSerialName());
            }
        }
    }
