...
public final class SizeSerializer implements KSerializer<Size> {
    ...
    public void serialize(Encoder encoder, Size value) {
        ...
        SavedStateWriter.m7580putSizeimpl(SavedStateWriter.m7550constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
    }
    ...
    public Size deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7527getSizeimpl(SavedStateReader.m7464constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
