...
public final class SavedStateSerializer implements KSerializer<Bundle> {
    ...
    public void serialize(Encoder encoder, Bundle value) {
        ...
        if (Intrinsics.areEqual(savedStateEncoder.getKey(), "")) {
            SavedStateWriter.m7554putAllimpl(SavedStateWriter.m7550constructorimpl(savedStateEncoder.getSavedState()), value);
        } else {
            SavedStateWriter.m7577putSavedStateimpl(SavedStateWriter.m7550constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
        }
    }
    ...
    public Bundle deserialize(Decoder decoder) {
        ...
        return SavedStateReader.m7521getSavedStateimpl(SavedStateReader.m7464constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
    }
}
