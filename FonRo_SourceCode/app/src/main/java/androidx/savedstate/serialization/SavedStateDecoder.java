...
public final class SavedStateDecoder extends AbstractDecoder {
    ...
    public int decodeElementIndex(SerialDescriptor descriptor) {
        ...
        if (Intrinsics.areEqual(descriptor.getKind(), StructureKind.LIST.INSTANCE) || Intrinsics.areEqual(descriptor.getKind(), StructureKind.MAP.INSTANCE)) {
            m7544sizeimpl = SavedStateReader.m7544sizeimpl(SavedStateReader.m7464constructorimpl(this.savedState));
        } else {
            m7544sizeimpl = descriptor.getElementsCount();
        }
        while (true) {
            int i = this.index;
            if (i >= m7544sizeimpl || !descriptor.isElementOptional(i) || decodeElementIndex$presentInEncoding(this, descriptor, this.index)) {
                break;
            }
            this.index++;
        }
    ...
    private static final boolean decodeElementIndex$presentInEncoding(SavedStateDecoder savedStateDecoder, SerialDescriptor serialDescriptor, int i) {
        return SavedStateReader.m7465containsimpl(SavedStateReader.m7464constructorimpl(savedStateDecoder.savedState), serialDescriptor.getElementName(i));
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public boolean decodeBoolean() {
        return SavedStateReader.m7473getBooleanimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public byte decodeByte() {
        return (byte) SavedStateReader.m7495getIntimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public short decodeShort() {
        return (short) SavedStateReader.m7495getIntimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public int decodeInt() {
        return SavedStateReader.m7495getIntimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public long decodeLong() {
        return SavedStateReader.m7505getLongimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public float decodeFloat() {
        return SavedStateReader.m7491getFloatimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public double decodeDouble() {
        return SavedStateReader.m7487getDoubleimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public char decodeChar() {
        return SavedStateReader.m7477getCharimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public String decodeString() {
        return SavedStateReader.m7535getStringimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }
    ...
    private final List<Integer> decodeIntList() {
        return SavedStateReader.m7498getIntListimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final List<String> decodeStringList() {
        return SavedStateReader.m7538getStringListimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final boolean[] decodeBooleanArray() {
        return SavedStateReader.m7474getBooleanArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final char[] decodeCharArray() {
        return SavedStateReader.m7478getCharArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final double[] decodeDoubleArray() {
        return SavedStateReader.m7488getDoubleArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final float[] decodeFloatArray() {
        return SavedStateReader.m7492getFloatArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final int[] decodeIntArray() {
        return SavedStateReader.m7496getIntArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final long[] decodeLongArray() {
        return SavedStateReader.m7506getLongArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }

    private final String[] decodeStringArray() {
        return SavedStateReader.m7536getStringArrayimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }
    ...
    public CompositeDecoder beginStructure(SerialDescriptor descriptor) {
        ...
        return new SavedStateDecoder(SavedStateReader.m7521getSavedStateimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key), this.configuration);
    }

    @Override // kotlinx.serialization.encoding.AbstractDecoder, kotlinx.serialization.encoding.Decoder
    public boolean decodeNotNullMark() {
        return !SavedStateReader.m7543isNullimpl(SavedStateReader.m7464constructorimpl(this.savedState), this.key);
    }
