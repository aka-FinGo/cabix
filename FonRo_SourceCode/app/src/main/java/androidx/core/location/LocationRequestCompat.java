...
public final class LocationRequestCompat {
    ...
    public LocationRequest toLocationRequest(String str) {
        ...
        return ColorKt$$ExternalSyntheticApiModelOutline0.m7272m(Api19Impl.toLocationRequest(this, str));
    }
        ...
        public static Object toLocationRequest(LocationRequestCompat locationRequestCompat, String str) {
            try {
                ...
                if (sCreateFromDeprecatedProviderMethod == null) {
                    Method declaredMethod = cls.getDeclaredMethod("createFromDeprecatedProvider", String.class, Long.TYPE, Float.TYPE, Boolean.TYPE);
