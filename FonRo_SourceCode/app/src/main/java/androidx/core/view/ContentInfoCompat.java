...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m7326m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    public static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m7326m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m7336m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m7325m(contentInfoCompat.toContentInfo());
        }
