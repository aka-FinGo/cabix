...
public final class WindowInsetsAnimationCompat {
        ...
        public static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                if (windowInsetsCompat2 == null) {
                    windowInsetsCompat2 = ViewCompat.getRootWindowInsets(view);
                ...
                final BoundsCompat computeAnimationBounds = Impl21.computeAnimationBounds(windowInsetsCompat, windowInsetsCompat3, i3);
                ...
                duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.1
                    ...
                    public void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        Impl21.dispatchOnProgress(view, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat3, windowInsetsAnimationCompat.getInterpolatedFraction(), i3), Collections.singletonList(windowInsetsAnimationCompat));
                    }
                });
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m7332m = HalfKt$$ExternalSyntheticApiModelOutline0.m7332m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m7332m);
                    fraction = m7332m.getFraction();
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m7342m$1();
