...
public class NavGraph extends NavDestination implements Iterable<NavDestination>, KMappedMarker {
    ...
    public String toString() {
        ...
        if (findNode == null) {
            if (getStartDestinationRoute() != null) {
                ...
                String startDestIdName = this.impl.getStartDestIdName();
                NavGraphImpl navGraphImpl = this.impl;
                if (startDestIdName != null) {
                    sb.append(navGraphImpl.getStartDestIdName());
                } else {
                    sb.append("0x" + Integer.toHexString(navGraphImpl.getStartDestId()));
                }
            }
        } else {
            sb.append("{");
    ...
    /* compiled from: NavGraph.android.kt */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\u00020\u0005*\u00020\u0006H\u0007J\u0012\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00050\b*\u00020\u0006H\u0007¨\u0006\t"}, d2 = {"Landroidx/navigation/NavGraph$Companion;", "", "<init>", "()V", "findStartDestination", "Landroidx/navigation/NavDestination;", "Landroidx/navigation/NavGraph;", "childHierarchy", "Lkotlin/sequences/Sequence;", "navigation-common_release"}, k = 1, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes5.dex */
