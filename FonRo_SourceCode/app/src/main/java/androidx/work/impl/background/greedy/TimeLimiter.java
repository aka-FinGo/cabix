...
public final class TimeLimiter {
    ...
    */
    public /* synthetic */ TimeLimiter(androidx.work.RunnableScheduler r1, androidx.work.impl.WorkLauncher r2, long r3, int r5, kotlin.jvm.internal.DefaultConstructorMarker r6) {
        /*
            r0 = this;
            r5 = r5 & 4
            if (r5 == 0) goto L9
        ...
        L9:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.greedy.TimeLimiter.<init>(androidx.work.RunnableScheduler, androidx.work.impl.WorkLauncher, long, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public final void track(final StartStopToken token) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.work.impl.background.greedy.TimeLimiter$$ExternalSyntheticLambda0
            ...
            public final void run() {
                TimeLimiter.this.launcher.stopWork(token, 3);
            }
        };
