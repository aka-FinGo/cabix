    ...
    private float getPreCycleDistance() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (easing != null) {
                ...
                d3 = (((float) easing.get((f2 - f4) / r8)) * (f3 - f4)) + f4;
            }
        ...
        if (curveFitArr != null) {
            ...
            if (this.mTransformPivotTarget != -1) {
                ...
                if (motionWidget3 == null) {
                    motionWidget3 = motionWidget2.getParent().findViewById(this.mTransformPivotTarget);
                    this.mTransformPivotView = motionWidget3;
                }
                if (motionWidget3 != null) {
                    float top = (motionWidget3.getTop() + this.mTransformPivotView.getBottom()) / 2.0f;
