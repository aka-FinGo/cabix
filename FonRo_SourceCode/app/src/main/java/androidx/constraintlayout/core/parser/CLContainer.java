...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo7248clone() {
        CLContainer cLContainer = (CLContainer) super.mo7248clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo7248clone = it.next().mo7248clone();
            mo7248clone.setContainer(cLContainer);
            arrayList.add(mo7248clone);
        }
