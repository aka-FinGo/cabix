...
public final class Trace {
    ...
    private static boolean isEnabledFallback() {
        try {
            ...
            if (method == null) {
                ...
                method = android.os.Trace.class.getMethod("isTagEnabled", Long.TYPE);
                sIsTagEnabledMethod = method;
            }
            return ((Boolean) method.invoke(null, Long.valueOf(sTraceTagApp))).booleanValue();
        } catch (Exception e) {
    ...
    private static void beginAsyncSectionFallback(String str, int i) {
        try {
            ...
            if (method == null) {
                method = android.os.Trace.class.getMethod("asyncTraceBegin", Long.TYPE, String.class, Integer.TYPE);
                sAsyncTraceBeginMethod = method;
            }
            method.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
    ...
    private static void endAsyncSectionFallback(String str, int i) {
        try {
            ...
            if (method == null) {
                method = android.os.Trace.class.getMethod("asyncTraceEnd", Long.TYPE, String.class, Integer.TYPE);
                sAsyncTraceEndMethod = method;
            }
            method.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
    ...
    private static void setCounterFallback(String str, int i) {
        try {
            ...
            if (method == null) {
                method = android.os.Trace.class.getMethod("traceCounter", Long.TYPE, String.class, Integer.TYPE);
                sTraceCounterMethod = method;
            }
            method.invoke(null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
