...
public final class UnsignedKt {
    ...
    public static final int m8227uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m7970constructorimpl((int) ((i & 4294967295L) % (i2 & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m8226uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m7970constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m8228ulongDivideeb3DHEI(long j, long j2) {
        int compare;
        int compare2;
        if (j2 < 0) {
            compare2 = Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE);
            return compare2 < 0 ? ULong.m8049constructorimpl(0L) : ULong.m8049constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m8049constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        compare = Long.compare(ULong.m8049constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m8049constructorimpl(j2) ^ Long.MIN_VALUE);
        return ULong.m8049constructorimpl(j3 + (compare < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m8229ulongRemaindereb3DHEI(long j, long j2) {
        int compare;
        int compare2;
        if (j2 < 0) {
            compare2 = Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE);
            return compare2 < 0 ? j : ULong.m8049constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m8049constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        compare = Long.compare(ULong.m8049constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m8049constructorimpl(j2) ^ Long.MIN_VALUE);
        if (compare < 0) {
            j2 = 0;
        }
        return ULong.m8049constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m7970constructorimpl((int) d);
        }
        return UInt.m7970constructorimpl(UInt.m7970constructorimpl((int) (d - 2.147483647E9d)) + Integer.MAX_VALUE);
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m8049constructorimpl((long) d);
        }
        return ULong.m8049constructorimpl(ULong.m8049constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
