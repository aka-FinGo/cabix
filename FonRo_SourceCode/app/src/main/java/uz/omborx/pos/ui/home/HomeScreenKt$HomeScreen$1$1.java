...
@DebugMetadata(c = "uz.FonRo.pos.ui.home.HomeScreenKt$HomeScreen$1$1", f = "HomeScreen.kt", i = {}, l = {159}, m = "invokeSuspend", n = {}, nl = {160}, s = {}, v = 2)
...
public final class HomeScreenKt$HomeScreen$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public HomeScreenKt$HomeScreen$1$1(AppNavigator appNavigator, boolean z, Repo repo, MutableState<StoreStats> mutableState, MutableState<StoreStats> mutableState2, MutableState<Double> mutableState3, MutableState<Double> mutableState4, Continuation<? super HomeScreenKt$HomeScreen$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new HomeScreenKt$HomeScreen$1$1(this.$nav, this.$canStats, this.$repo, this.$today$delegate, this.$week$delegate, this.$paid$delegate, this.$debtToday$delegate, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Intrinsics.areEqual(this.$nav.getCurrent(), Routes.HOME)) {
                this.label = 1;
