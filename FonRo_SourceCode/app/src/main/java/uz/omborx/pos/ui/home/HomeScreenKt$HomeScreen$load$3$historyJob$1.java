...
@DebugMetadata(c = "uz.FonRo.pos.ui.home.HomeScreenKt$HomeScreen$load$3$historyJob$1", f = "HomeScreen.kt", i = {0, 0}, l = {129}, m = "invokeSuspend", n = {"$this$async", "$this$invokeSuspend_u24lambda_u240"}, nl = {128}, s = {"L$0", "L$1"}, v = 2)
/* loaded from: classes7.dex */
final class HomeScreenKt$HomeScreen$load$3$historyJob$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends List<? extends SaleRow>>>, Object> {
    ...
    public HomeScreenKt$HomeScreen$load$3$historyJob$1(Continuation<? super HomeScreenKt$HomeScreen$load$3$historyJob$1> continuation) {
        super(2, continuation);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        HomeScreenKt$HomeScreen$load$3$historyJob$1 homeScreenKt$HomeScreen$load$3$historyJob$1 = new HomeScreenKt$HomeScreen$load$3$historyJob$1(continuation);
        homeScreenKt$HomeScreen$load$3$historyJob$1.L$0 = obj;
        return homeScreenKt$HomeScreen$load$3$historyJob$1;
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<? extends List<SaleRow>>> continuation) {
        return ((HomeScreenKt$HomeScreen$load$3$historyJob$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i == 0) {
                ...
                Map<String, String> mapOf = MapsKt.mapOf(TuplesKt.to(TypedValues.CycleType.S_WAVE_PERIOD, "today"));
