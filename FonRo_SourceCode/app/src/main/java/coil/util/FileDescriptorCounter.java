...
final class FileDescriptorCounter {
    ...
    private final boolean checkFileDescriptors() {
        ...
        return i >= 30 || SystemClock.uptimeMillis() > lastFileDescriptorCheckTimestamp + WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS;
    }
}
