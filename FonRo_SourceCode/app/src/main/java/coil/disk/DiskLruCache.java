    ...
    */
    private final void readJournal() {
        /*
            ...
            coil.disk.DiskLruCache$fileSystem$1 r2 = r10.fileSystem
            ...
            r3 = r2
            okio.BufferedSource r3 = (okio.BufferedSource) r3     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r4 = r3.readUtf8LineStrict()     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r5 = r3.readUtf8LineStrict()     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r6 = r3.readUtf8LineStrict()     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r7 = r3.readUtf8LineStrict()     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r8 = r3.readUtf8LineStrict()     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r9 = "libcore.io.DiskLruCache"
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r4)     // Catch: java.lang.Throwable -> Lbb
            if (r9 == 0) goto L8c
            java.lang.String r9 = "1"
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r5)     // Catch: java.lang.Throwable -> Lbb
            if (r9 == 0) goto L8c
            int r9 = r10.appVersion     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch: java.lang.Throwable -> Lbb
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r6)     // Catch: java.lang.Throwable -> Lbb
            if (r9 == 0) goto L8c
            int r9 = r10.valueCount     // Catch: java.lang.Throwable -> Lbb
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch: java.lang.Throwable -> Lbb
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual(r9, r7)     // Catch: java.lang.Throwable -> Lbb
            if (r9 == 0) goto L8c
            r9 = r8
            ...
            r0 = 0
        L5d:
            java.lang.String r1 = r3.readUtf8LineStrict()     // Catch: java.io.EOFException -> L67 java.lang.Throwable -> Lbb
            r10.readJournalLine(r1)     // Catch: java.io.EOFException -> L67 java.lang.Throwable -> Lbb
            int r0 = r0 + 1
            goto L5d
        L67:
            java.util.LinkedHashMap<java.lang.String, coil.disk.DiskLruCache$Entry> r1 = r10.lruEntries     // Catch: java.lang.Throwable -> Lbb
            int r1 = r1.size()     // Catch: java.lang.Throwable -> Lbb
            int r0 = r0 - r1
            r10.operationsSinceRewrite = r0     // Catch: java.lang.Throwable -> Lbb
            boolean r0 = r3.exhausted()     // Catch: java.lang.Throwable -> Lbb
            if (r0 != 0) goto L7a
            r10.writeJournal()     // Catch: java.lang.Throwable -> Lbb
            goto L80
        L7a:
            okio.BufferedSink r0 = r10.newJournalWriter()     // Catch: java.lang.Throwable -> Lbb
            r10.journalWriter = r0     // Catch: java.lang.Throwable -> Lbb
        L80:
    ...
    private final BufferedSink newJournalWriter() {
        return Okio.buffer(new FaultHidingSink(appendingSink(this.journalFile), new Function1() { // from class: coil.disk.DiskLruCache$$ExternalSyntheticLambda0
            ...
            public final Object invoke(Object obj) {
                return DiskLruCache.newJournalWriter$lambda$3(DiskLruCache.this, (IOException) obj);
            }
        }));
    }
    ...
    /* compiled from: DiskLruCache.kt */
    @Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0018\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0086\u0004\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u000e\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012J\u0006\u0010\u0013\u001a\u00020\u0014J\u0006\u0010\u0015\u001a\u00020\u0014J\f\u0010\u0016\u001a\b\u0018\u00010\u0017R\u00020\u0004J\u0006\u0010\u0018\u001a\u00020\u0014J\u0010\u0010\u0019\u001a\u00020\u00142\u0006\u0010\u001a\u001a\u00020\nH\u0002R\u0015\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\t\u001a\u00020\nX\u0082\u000e¢\u0006\u0002\n\u0000R\u0011\u0010\u000b\u001a\u00020\f¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000e¨\u0006\u001b"}, d2 = {"Lcoil/disk/DiskLruCache$Editor;", "", "entry", "Lcoil/disk/DiskLruCache$Entry;", "Lcoil/disk/DiskLruCache;", "<init>", "(Lcoil/disk/DiskLruCache;Lcoil/disk/DiskLruCache$Entry;)V", "getEntry", "()Lcoil/disk/DiskLruCache$Entry;", "closed", "", "written", "", "getWritten", "()[Z", "file", "Lokio/Path;", FirebaseAnalytics.Param.INDEX, "", "detach", "", "commit", "commitAndGet", "Lcoil/disk/DiskLruCache$Snapshot;", "abort", "complete", FirebaseAnalytics.Param.SUCCESS, "coil-base_release"}, k = 1, mv = {2, 0, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes5.dex */
